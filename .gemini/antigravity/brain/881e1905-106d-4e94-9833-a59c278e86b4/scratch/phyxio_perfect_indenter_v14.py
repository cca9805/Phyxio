...
def phyxio_perfect_indenter_v14(file_path):
            ...
            if key in h:
                ...
                if target == -1: # es/en
                    if parent_key in ["meaning", "sign_meaning", "absolute_value_meaning"]: target = 8
                        ...
                        elif parent_key == "topic": target = 4 # id and title are children of topic
                        else: target = 6
    ...
    for root, dirs, files in os.walk(root_dir):
        for file in files:
            if file.endswith((".yaml")):
                ...
                if phyxio_perfect_indenter_v14(path):
                    count += 1
                    print(f"Perfect Indented V14: {path}")
