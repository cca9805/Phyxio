...
def phyxio_perfect_indenter_v17(file_path):
    ...
    for i in range(len(lines)):
        ...
        if m_list_item:
            ...
            # Special case for ui: groups: - title:
            ...
            elif parent_key == "items": target = 8 # items list under items key
    ...
    for root, dirs, files in os.walk(root_dir):
        for file in files:
            if file.endswith((".yaml")):
                ...
                if phyxio_perfect_indenter_v17(path):
                    count += 1
                    print(f"Perfect Indented V17: {path}")
