...
def phyxio_perfect_indenter_v26(file_path):
    ...
    depths = {
        ...
        "es": -1, "en": -1, "kind": 4, "nonnegative_only": 6, "expected_interval": 6,
    ...
    for i in range(len(lines)):
        ...
        if m_key:
            ...
            if key in depths:
                ...
                if val >= 0: target = val
                    ...
                    elif file_name == "formulas.yaml": target = 2
                    else: target = 4
                elif val == -5: # enabled
        ...
        if m_id:
            ...
            # Find the true parent (should be magnitudes/formulas/variables)
            p_idx = len(stack) - 1
    ...
    for root, dirs, files in os.walk(root_dir):
        for file in files:
            if file.endswith((".yaml")):
                ...
                if phyxio_perfect_indenter_v26(path):
                    count += 1
                    print(f"Perfect Indented V26: {path}")
