...
def phyxio_perfect_indenter_v8(file_path):
    ...
    for i in range(len(lines)):
        ...
        if m_key:
            ...
            absolute_root_keys = ["version", "area", "bloque", "subbloque", "parent_id", "ruta_relativa", "orden", "type", "niveles", "icon", "description_en", "pregunta_fisica_central", "representacion_dominante", "magnitud_dominante", "tags", "prerequisitos", "graficos", "dificultad", "tiempo_estimado_min", "interpretacion", "magnitudes", "formulas", "topic", "variables", "ui"]
        ...
        if m_id:
            ...
            modified = True
            # Dynamically determine the parent in stack
            p_key = "root"
    ...
    for root, dirs, files in os.walk(root_dir):
        for file in files:
            if file.endswith((".yaml")):
                ...
                if phyxio_perfect_indenter_v8(path):
                    count += 1
                    print(f"Perfect Indented V8: {path}")
