const e=`## 1. Acelerador electrostático de partículas (Van de Graaff)
...
La variable crítica que controla la energía de salida es [[V_A]] en el electrodo de alta tensión. El diseñador del acelerador no ajusta la fuerza instantánea sobre la partícula (que varía a lo largo del tubo) sino la diferencia de potencial entre los electrodos: esa diferencia, multiplicada por la carga de la partícula, determina directamente la energía cinética final. El modelo de [[U_e]] permite calcular la velocidad de las partículas sin conocer la geometría exacta del campo dentro del tubo.
...
La relación entre la energía almacenada y el potencial del condensador depende de su capacidad, pero el principio energético es invariable: todo el trabajo realizado por la fuente de alimentación al cargar el condensador queda almacenado como [[U_e]] y se libera íntegramente sobre la carga (el paciente) durante la descarga. La interpretación de [[U_e]] permite estimar si la energía almacenada es suficiente para producir la corriente terapéutica durante el tiempo necesario, sin necesitar conocer la forma exacta de la onda de descarga.
