const e=`## 1. Generadores eléctricos
...
La hipotesis dominante es que la bobina enlaza cambios de flujo repetibles y que [[N]] multiplica de forma efectiva. Si el campo no es uniforme o las espiras no son equivalentes, el modelo simple solo da una estimacion.
...
Variable dominante: rapidez de cambio de flujo [[r_Phi]] producida por el giro.
...
La aplicacion muestra por que [[N]] importa. Mas espiras secundarias aumentan la fem inducida si el flujo por espira es comparable. Sin embargo, aislamiento, resistencia y perdidas limitan el aumento util.
...
Variable dominante: numero de espiras [[N]] enlazadas por el flujo variable.
...
Un sensor inductivo detecta movimiento, posicion o presencia de metal mediante cambios de flujo enlazado. La señal electrica aparece porque [[Phi_B]] cambia cuando cambia el entorno magnetico de la bobina.
...
El diseño busca que el cambio util de flujo sea mayor que el ruido. Para ello se ajustan [[A]], numero de espiras, nucleo y electronica de lectura. La ley de Faraday ofrece la escala inicial de la señal.
...
Variable dominante: cambio detectable de flujo [[DeltaPhi_B]] producido por el objeto.
...
Esta aplicacion muestra una lectura fina: no se busca una fem maxima, sino una fem proporcional al movimiento. La calidad depende de mantener estable la relacion entre movimiento, [[DeltaPhi_B]] y [[epsilon_ind]].
