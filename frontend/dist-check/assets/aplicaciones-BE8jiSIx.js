const e=`## 1. Ecografía médica diagnóstica

El transductor ultrasónico emite pulsos de alta frecuencia que se propagan como ondas longitudinales a través del tejido blando del paciente. Cada interfaz entre tejidos con distinta [[Z]] (músculo-grasa, hígado-riñón, tejido-hueso) refleja una fracción de la energía que el transductor recoge como eco. A partir del tiempo de vuelo y la rapidez [[v]] conocida del tejido, el equipo reconstruye una imagen bidimensional o tridimensional de las estructuras internas.

La resolución axial del ecógrafo es proporcional a [[lambda]], que a su vez depende del cociente entre [[v]] y [[f]]. Frecuencias de 2 a 5 MHz permiten explorar órganos profundos con longitudes de onda de 0.3 a 0.8 mm, mientras que frecuencias de 12 a 18 MHz ofrecen resoluciones inferiores a 0.15 mm para estructuras superficiales como tiroides o vasos sanguíneos.

Variable dominante: la frecuencia [[f]] del transductor, que fija la resolución espacial mediante su relación inversa con [[lambda]].
...
Los buques y submarinos emplean transductores que emiten pulsos acústicos de frecuencias entre 1 kHz y 500 kHz en agua de mar. La onda longitudinal viaja a una rapidez [[v]] cercana a 1500 m/s y se refleja al encontrar un objeto cuya [[Z]] difiere de la del agua circundante (casco metálico, fondo rocoso, banco de peces). Midiendo el retardo del eco y la dirección de llegada, el sistema determina la posición del objetivo.

La impedancia acústica del agua de mar es aproximadamente 1.5×10⁶ kg/(m²·s), mientras que la del acero supera 4.5×10⁷ kg/(m²·s). Esta diferencia garantiza una reflexión fuerte en la superficie del casco de un submarino. Sin embargo, la propagación real depende de perfiles de temperatura y salinidad que crean capas con distintos [[v]], curvando los rayos acústicos y generando zonas de sombra.

Variable dominante: la rapidez [[v]], que varía con temperatura, salinidad y profundidad, determinando la curvatura de los rayos acústicos y la precisión de localización.
...
En prospección petrolera, camiones vibradores o cargas explosivas generan ondas longitudinales (ondas P) que penetran en la corteza terrestre. Al encontrar fronteras entre estratos geológicos con distinta [[Z]] (arenisca-arcilla, roca-petróleo), parte de la energía se refleja hacia la superficie, donde geófonos registran los ecos. La diferencia de tiempos de llegada entre capas permite reconstruir la geometría del subsuelo.

La rapidez [[v]] en rocas sedimentarias varía entre 2000 m/s y 6000 m/s según la porosidad, la saturación de fluidos y la presión litostática. La impedancia [[Z]] de cada estrato resulta del producto de su densidad y rapidez locales. Contrastes de impedancia de al menos un 5 % son necesarios para generar reflexiones detectables con la instrumentación convencional.

Variable dominante: el módulo de compresibilidad [[B]] del estrato, que determina la rapidez local y, junto con la densidad, la impedancia que produce las reflexiones.
...
En la inspección no destructiva de piezas metálicas y cerámicas, un transductor de contacto emite pulsos ultrasónicos de 0.5 a 25 MHz que recorren la pieza como ondas longitudinales. Cualquier discontinuidad interna (grieta, poro, inclusión) presenta una [[Z]] diferente a la del material base, generando un eco que el equipo detecta. La profundidad del defecto se calcula a partir del tiempo de vuelo y la rapidez [[v]] del material.

En acero, [[v]] es aproximadamente 5900 m/s, lo que a 5 MHz produce una [[lambda]] cercana a 1.2 mm. Defectos de tamaño inferior a [[lambda]] son difíciles de detectar; por ello, inspecciones de alta resolución emplean frecuencias más elevadas. La impedancia del acero ronda 4.6×10⁷ kg/(m²·s), mientras que la del aire atrapado en un poro es solo 415 kg/(m²·s), creando una reflexión prácticamente total que identifica claramente el defecto.
