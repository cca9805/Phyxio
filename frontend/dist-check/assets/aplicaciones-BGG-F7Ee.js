...
\r
Variable dominante: [[PB]].\r
\r
Limite de validez: observables suaves en el mismo espacio de fases.\r
\r
En problemas orbitales, el corchete con el hamiltoniano permite decidir si una cantidad se conserva antes de integrar la orbita. Si el corchete se anula, la conservacion tiene causa estructural; si no se anula, la cantidad cambia por el flujo. Esta aplicacion ensena al alumno a justificar una constante de movimiento y no solo a adivinarla por simetria visual.\r
\r
La pregunta profesional es si el observable tiene derecho a llamarse constante de movimiento. El criterio obliga a comparar el resultado con el flujo y evita justificar conservaciones por apariencia.\r
\r
## 2. Integradores hamiltonianos\r
\r
Variable dominante: [[PB]].\r
\r
Limite de validez: paso temporal pequeno y pares canonicos preservados.\r
\r
...
\r
La pregunta profesional es si el algoritmo mantiene la geometria que dice simular. El criterio permite detectar errores acumulados aunque la trayectoria dibujada parezca estable durante muchas vueltas.\r
\r
## 3. Simetrias infinitesimales\r
\r
Variable dominante: [[dA_dt]].\r
\r
Limite de validez: generadores diferenciables y sin singularidades.\r
\r
Una rotacion, traslacion o cambio interno puede estudiarse como flujo generado por un observable. La aplicacion muestra como una simetria causa una conservacion y como el corchete mide esa compatibilidad. Es una entrada natural al teorema de Noether desde el formalismo hamiltoniano.\r
\r
La pregunta profesional es que transformacion infinitesimal causa el cambio observado. El criterio une simetria, generador y respuesta dinamica en una sola lectura.\r
\r
## 4. Mecanica molecular\r
\r
Variable dominante: [[H]].\r
\r
Limite de validez: interacciones conservativas y variables canonicas bien definidas.\r
\r
...
\r
La pregunta profesional es si un observable colectivo describe una propiedad real del sistema molecular. El criterio separa fluctuacion esperada de ruptura del modelo.\r
\r
## 5. Puente hacia cuantizacion\r
\r
Variable dominante: [[PB]].\r
\r
Limite de validez: regimen clasico previo a operadores cuanticos.\r
\r
