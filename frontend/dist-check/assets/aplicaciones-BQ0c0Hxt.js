const e=`## 1. Sintonia en receptores y front-end de RF
...
En sistemas de medicion y acondicionamiento de señal, la resonancia define como de estrecha o amplia es la banda de paso. Esta aplicacion convierte [[Q]] y [[BW]] en parametros de diseño directo para decidir capacidad de rechazo fuera de banda.

Variable dominante: [[BW]].
...
En mantenimiento, la misma estructura facilita diagnostico: si cambia [[f0]], se revisa L y C efectivos; si cambia [[BW]], se revisa amortiguamiento y perdida; si sube [[Ires]], se revisa margen de proteccion.
...
En sistemas con digitalizacion de supervisión, estas aplicaciones pueden convertirse en indicadores combinados de salud: deriva de [[f0]], cambio de [[BW]] y aumento de [[Ires]]. Leer los tres en conjunto disminuye falsas alarmas y mejora diagnóstico temprano.
