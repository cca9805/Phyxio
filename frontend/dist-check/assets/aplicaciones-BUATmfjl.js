const e=`## 1. Gestión del frío en sistemas de climatización con agua como fluido caloportador\r
\r
Los sistemas de refrigeración de grandes edificios y centros de datos usan agua enfriada como fluido caloportador en circuitos cerrados. El agua absorbe el calor disipado por los equipos y lo transporta hasta las enfriadoras exteriores. La eficacia del sistema depende directamente de [[c]] del agua: al ser alto (4186 J/(kg·K)), se puede extraer una gran cantidad de calor con variaciones de temperatura modestas (típicamente [[DeltaT]] de 5 a 10 K entre ida y retorno). Esto reduce el caudal necesario y, en consecuencia, el consumo energético de las bombas.\r
\r
Si se usara un fluido con [[c]] más bajo, como aceite mineral (≈2000 J/(kg·K)), se necesitaría el doble de caudal másico para transferir la misma potencia con el mismo [[DeltaT]], lo que duplicaría la potencia hidráulica de las bombas y el coste operativo.\r
\r
Variable dominante: el calor específico [[c]] del fluido caloportador, que determina la energía por unidad de masa y de variación de temperatura que puede transportar el circuito.\r
Límite de validez: el modelo de calor sensible con [[c]] constante es válido mientras el fluido permanezca en fase líquida. Si la temperatura baja por debajo del punto de congelación del fluido, la mezcla anticongelante puede alterar [[c]] y el modelo requiere ajuste tabular.\r
\r
## 2. Identificación de materiales por calorimetría de mezclas en química analítica\r
\r
La determinación del calor específico de un material desconocido mediante calorimetría de mezclas es una técnica estándar en química analítica y ciencia de materiales. Se calienta una muestra del material hasta una temperatura conocida, se introduce en un calorímetro con agua a temperatura conocida, y se mide la temperatura de equilibrio. A partir de [[c]] del agua, la masa del material y del agua, y las variaciones de temperatura, se calcula [[c]] del material desconocido.\r
\r
