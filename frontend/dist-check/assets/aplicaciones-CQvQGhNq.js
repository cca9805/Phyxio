const e=`# Aplicaciones de la formulación integral de las ecuaciones de Maxwell
...
La aplicación más directa y masiva de la ley de Faraday en su forma integral es, sin duda, el transformador eléctrico. Este dispositivo es el responsable de que la electricidad pueda ser transportada a lo largo de miles de kilómetros con pérdidas mínimas. El principio de funcionamiento se basa en un núcleo ferromagnético que canaliza el flujo magnético [[flux_B]] generado por una bobina primaria conectada a una fuente de corriente alterna.

Al variar la corriente en la bobina primaria, el flujo magnético [[flux_B]] cambia en el tiempo, lo que genera una variación temporal del flujo [[dPhiB_dt]]. Según la ley de Faraday-Lenz, esta variación induce una fuerza electromotriz [[emf]] en la bobina secundaria que rodea el mismo núcleo. La formulación integral permite a los ingenieros calcular esta [[emf]] simplemente integrando el campo eléctrico inducido a lo largo de la longitud del cable del secundario. Si el secundario tiene $N$ espiras, la [[emf]] total es el resultado de la integral sobre ese camino extendido.
...
El diseño de antenas y sistemas de radiodifusión depende críticamente de la ley de Ampère-Maxwell. Durante décadas, la ley de Ampère original (sin el término de desplazamiento) fue suficiente para describir imanes y motores. Sin embargo, Maxwell predijo que un flujo eléctrico variable [[flux_E]] también debe actuar como fuente de campo magnético.

En una antena dipolo, las cargas oscilan de un extremo a otro, creando una corriente física [[I_enc]]. Pero entre los extremos de la antena, el campo eléctrico también oscila, creando una variación de flujo eléctrico [[dPhiE_dt]]. Este término de "corriente de desplazamiento" es el que permite que la circulación magnética [[cirB]] se cierre y se propague al espacio libre como una onda electromagnética. La formulación integral es la que nos permite calcular la intensidad total de la señal emitida integrando la densidad de flujo sobre una superficie esférica que rodea la antena.
...
- Variable dominante: [[cirB]] (circulación del campo magnético)
...
- Variable dominante: [[flux_B]] (densidad de flujo magnético)
...
Los detectores de metales que protegen aeropuertos y edificios públicos se basan en la interacción entre el flujo magnético [[flux_B]] y las corrientes inducidas. Una bobina emisora genera un flujo variable que atraviesa el arco de detección. Si una persona porta un objeto metálico, la variación del flujo [[dPhiB_dt]] induce pequeñas circulaciones eléctricas dentro del metal (corrientes de Foucault).

Estas corrientes internas, a su vez, generan su propio flujo magnético opuesto. Una bobina receptora detecta este pequeño cambio en el balance total de flujo [[flux_B]]. La formulación integral permite diseñar la geometría del arco para que sea sensible solo a objetos de cierto tamaño y conductividad, integrando la respuesta sobre toda la apertura del detector.
...
- Variable dominante: [[flux_B]] (detección de perturbaciones en el flujo)
...
La cocina de inducción es una aplicación moderna y eficiente de la ley de Faraday. Bajo el cristal cerámico, una bobina de cobre transporta una corriente alterna de alta frecuencia (entre 20 y 50 kHz). Esta corriente genera un flujo magnético [[flux_B]] que penetra en la base de la sartén.

Debido a la alta frecuencia, la variación del flujo [[dPhiB_dt]] es muy intensa, lo que induce grandes circulaciones eléctricas en el metal del recipiente. Estas corrientes generan calor por efecto Joule directamente en la base de la sartén, no en la placa. La formulación integral permite calcular la eficiencia de transferencia de energía integrando el vector de Poynting (flujo de energía) sobre la superficie de contacto entre la placa y la sartén.
...
- Variable dominante: [[flux_B]] (acoplamiento magnético)
