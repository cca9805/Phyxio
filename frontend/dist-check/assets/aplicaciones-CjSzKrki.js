const e=`## 1. Telescopio reflector newtoniano

Los telescopios reflectores utilizan un espejo concavo primario de gran diametro para recoger la luz de objetos astronomicos distantes. Los rayos paralelos procedentes de una estrella convergen en el foco del espejo primario, donde un espejo plano secundario redirige la imagen hacia el ocular lateral. La capacidad de captacion de luz depende del area del espejo primario, y la posicion focal esta determinada por [[f]], que a su vez depende de [[R]].
...
Los retrovisores exteriores de los automoviles son espejos convexos con radios de curvatura de 1 a 3 metros. Al tener [[f]] negativo, siempre producen imagenes virtuales, derechas y reducidas, lo que permite abarcar un campo de vision considerablemente mas amplio que un espejo plano del mismo tamano. Esta propiedad es critica para la seguridad vial, ya que el conductor puede observar carriles adyacentes y vehiculos en el angulo muerto.

El inconveniente es que los objetos reflejados parecen mas lejanos de lo que estan realmente, porque la imagen es reducida. Por eso la normativa obliga a incluir la advertencia "los objetos estan mas cerca de lo que aparentan". El aumento [[M]], siempre menor que uno en valor absoluto, determina exactamente cuanto se reduce la imagen y, por tanto, cuanto se subestima la distancia.
...
La posicion del punto focal depende de [[f]], y la concentracion maxima esta limitada por el tamano angular del disco solar y la calidad optica del espejo. Si la superficie no es exactamente parabolica, la aberracion esferica ensancha la mancha focal y reduce la densidad de energia. En instalaciones como el horno solar de Odeillo (Francia), espejos segmentados reproducen un perfil parabolico con precision milimetrica.
...
Aunque el reflector es parabolico y no esferico, el principio de funcionamiento se comprende a partir de la ecuacion del espejo: una fuente en el foco produce rayos reflejados paralelos al eje ([[d_o]] igual a [[f]] da [[d_i]] infinito). Si la bombilla se desplaza ligeramente respecto al foco, los rayos dejan de ser paralelos y el haz se ensancha o desvia, lo que permite ajustar la geometria del patron luminoso.
