const e=`## 1. Alternador de automóvil
...
Variable dominante: la potencia mecánica de entrada [[P_mec]] fija el techo energético de la potencia eléctrica útil.
...
La variable de diseño no es solo la tensión inducida. Importan la capacidad de entregar corriente, el rendimiento [[eta]], la refrigeración y las pérdidas del circuito magnético. Por eso una central puede manejar enormes [[P_elec]] sin requerir campos absurdos: aumenta escala, número de espiras, sección conductora y calidad de conversión.
...
Este caso es pedagógicamente valioso porque corrige la idea de que la fem inducida es gratuita. La intensidad de la luz depende de [[P_elec]], no solo de [[epsilon_0]]. A velocidades bajas, puede existir inducción insuficiente para alimentar bien la lámpara; a velocidades altas, la electrónica limita la tensión.
...
La hipótesis dominante es linealidad: desplazamientos pequeños, campo estable y bobina ligera. La interpretación física cambia respecto a una central eléctrica; no se prioriza [[P_elec]], sino que la fem siga la variación del movimiento sin distorsión apreciable.

Esta aplicación muestra que “generador” no significa siempre máquina de potencia. La misma física sirve para sensorizar movimiento. La señal inducida codifica rapidez y forma de la vibración, por lo que la fidelidad depende de mantener constantes [[B]], geometría y respuesta mecánica.

Variable dominante: el cambio de flujo [[DeltaPhi_B]] asociado al movimiento del diafragma determina la señal inducida.
