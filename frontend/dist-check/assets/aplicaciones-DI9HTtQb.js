const a=`# Aplicaciones de los modos en placas y membranas
...
Los parches de tambor, timbales y membranas de altavoz se entienden mediante modos de membrana. La fuerza restauradora dominante no es [[D_placa]], sino la tensión superficial [[T_mem]]. Al aumentar [[T_mem]], todas las frecuencias modales suben; al aumentar [[rho_mem]], bajan. Esta relación explica el afinado de un tambor y también por qué dos parches de igual tamaño pueden sonar distintos si tienen masas superficiales diferentes.
...
Variable dominante: tensión superficial homogénea del parche, representada por [[T_mem]].
...
ayuda a estimar la inercia superficial, mientras que [[D_placa]] describe la resistencia a la curvatura. Añadir una capa pesada aumenta la masa y suele mejorar el aislamiento en algunas bandas, pero puede desplazar resonancias. Cambiar la fijación de los bordes o desacoplar paneles puede alterar los modos dominantes sin cambiar demasiado la masa total.
