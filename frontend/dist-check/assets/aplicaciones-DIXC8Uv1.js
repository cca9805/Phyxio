const e=`# Aplicaciones de las Ondas Superficiales\r
\r
## 1. Diseño de Estructuras Off-shore y Plataformas Petrolíferas\r
El diseño de estructuras marinas requiere un conocimiento profundo de la cinemática de las olas para calcular las fuerzas de impacto sobre los pilares. En aguas aguas profundas, los ingenieros utilizan el modelo de regimen de aguas aguas profundas para determinar la longitud de onda [[lambda]] a partir del periodo de diseño. Esta longitud dicta la separación óptima entre las patas de la plataforma para minimizar los efectos de resonancia estructural que podrían colapsar la instalación. Además, se deben considerar las fuerzas de arrastre y de inercia (Ecuación de Morison) que dependen directamente de la velocidad [[c]] y la aceleración de las partículas de agua.\r
- **Variable dominante:** Longitud de onda [[lambda]].\r
- **Límite de validez:** Aplicable mientras la mitad de la longitud de onda. Si la plataforma se sitúa en la plataforma continental, el modelo debe ajustarse por efectos de profundidad.\r
\r
## 2. Sistemas de Alerta Temprana de Tsunamis\r
...
- **Variable dominante:** Profundidad [[h]].\r
- **Límite de validez:** Válido para ondas cuya longitud es órdenes de magnitud mayor que la profundidad del océano (el cociente entre profundidad y longitud de onda).\r
\r
## 3. Generación de Energía Undimotriz\r
...
- **Variable dominante:** Velocidad de fase [[c]].\r
- **Límite de validez:** Eficacia máxima en zonas de transición donde la energía se concentra antes de la ruptura de la ola.\r
\r
## 4. Teledetección y Radar Marítimo por Satélite\r
Los radares de apertura sintética (SAR) a bordo de satélites como los de la constelación Copernicus utilizan la reflexión de microondas en la superficie del agua para "ver" el oleaje desde el espacio, incluso a través de las nubes. Debido a que las ondas superficiales modulan la rugosidad del mar (ondas capilares), el radar puede inferir la dirección, el periodo y la longitud de onda [[lambda]] de los sistemas de tormentas distantes. Esta aplicación es vital para la navegación comercial y la seguridad en el mar, permitiendo a los barcos optimizar sus rutas y evitar zonas de condiciones climáticas extremas.\r
- **Variable dominante:** Longitud de onda [[lambda]].\r
- **Límite de validez:** Limitado por la resolución del sensor y la presencia de ondas capilares generadas por el viento local que pueden enmascarar la señal del oleaje principal.\r
\r
## 5. Acuicultura y Protección de Zonas Costeras\r
