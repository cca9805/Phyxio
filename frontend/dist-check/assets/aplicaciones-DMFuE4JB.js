const e=`## 1. Ensayos no destructivos por ultrasonidos (pulso-eco)
...
Variable dominante: el [[R_E]] en la interfaz material-defecto, que determina la detectabilidad del defecto.
...
Variable dominante: el contraste de [[Z_1]] y [[Z_2]] entre tejidos adyacentes, que determina la visibilidad de cada estructura.
...
Variable dominante: el [[T_E]] a traves del sistema multicapa, que se maximiza cuando cada capa cumple la condicion de impedancia geometrica media y espesor de cuarto de longitud de onda.
...
Variable dominante: el [[R_E]] acumulado en las sucesivas interfaces del sistema multicapa, que determina la reduccion sonora total.
