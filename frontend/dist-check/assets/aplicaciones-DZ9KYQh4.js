...
Límite de validez: el modelo de onda plana y la relación de dispersión del vacío son válidos cuando la antena opera en el espacio libre o en aire seco. En entornos con objetos conductores cercanos, reflexiones y difracción modifican la distribución de [[E]] y [[B]] alrededor de la antena.

## 2. Fibras ópticas y comunicaciones de alta velocidad

Las fibras ópticas de sílice confinan y guían ondas EM en la banda infrarroja, principalmente a [[lambda]] ≈ 1550 nm ([[omega]] ≈ 1.22×10¹⁵ rad/s), donde la atenuación del material es mínima. Dentro de la fibra, la velocidad de fase no es [[c]] sino [[c]] dividida por el índice de refracción n ≈ 1.46, lo que introduce un retardo de propagación de unos 4.88 ns/m respecto al vacío. Pero el problema más limitante no es la velocidad media sino la dispersión cromática: distintos componentes espectrales del pulso ([[omega]] ligeramente distintas) viajan a velocidades de grupo distintas porque n depende de [[omega]]. En una fibra convencional, la dispersión cromática es de unos 17 ps/(nm·km) a 1550 nm, lo que ensancha pulsos de picosegundo en microsegundos tras miles de kilómetros. La solución de ingeniería es usar fibras de dispersión desplazada o compensadores de dispersión para mantener la integridad del pulso.

Variable dominante: la velocidad de grupo d[[omega]]/d[[k]], que controla el ensanchamiento de los pulsos y limita la tasa de transmisión de datos.
...
Los sistemas de radar emiten pulsos de microondas con [[omega]] del orden de 10⁹–10¹⁰ rad/s y miden el tiempo que tarda el pulso en recorrer la distancia hasta el objetivo y regresar. La ecuación de onda garantiza que el pulso viaja a [[c]] en el aire (con corrección inferior al 0.03%), de modo que el tiempo de ida y vuelta dividido entre dos y multiplicado por [[c]] da la distancia con gran precisión. Un radar meteorológico de banda C ([[lambda]] ≈ 5 cm) detecta gotas de lluvia de diámetro comparable a [[lambda]] con la máxima eficiencia de retrodispersión según la teoría de Mie. Un radar de apertura sintética (SAR) aerotransportado logra resoluciones espaciales de decímetros calculando coherentemente la fase de los ecos recibidos en distintas posiciones, lo que solo es posible porque la ecuación de onda predice la fase con precisión.

Variable dominante: la velocidad de propagación [[c]], que convierte el tiempo de vuelo del pulso en distancia con una precisión de centímetros o mejor.
Límite de validez: la hipótesis de [[c]] constante en el aire falla cuando la troposfera tiene gradientes fuertes de temperatura y humedad (ductos atmosféricos), que pueden redirigir las ondas y producir ecos espurios a distancias aparentes incorrectas.
...
Desde 1983, el metro del SI se define exactamente a partir de [[c]]: un metro es la distancia que la luz recorre en el vacío durante 1/299 792 458 de segundo. Este cambio de paradigma invierte la relación entre medida y definición: antes se medía [[c]] y se definía el metro por medición de referencia; ahora [[c]] es un número exacto sin incertidumbre, y cualquier medida de distancia se obtiene midiendo tiempos de tránsito de la luz. Los interferómetros láser de precisión (como los del experimento LIGO para la detección de ondas gravitacionales) explotan directamente la ecuación de onda EM para convertir diferencias de fase óptica en desplazamientos con resolución de 10⁻¹⁸ m, 17 órdenes de magnitud por debajo del metro. La constante [[c]] también fija [[epsilon0]] desde la redefinición del SI de 2019, vinculando la permeabilidad del vacío [[mu0]] a la constante de estructura fina y a la carga elemental.

Variable dominante: [[c]] como constante universal que conecta tiempo y espacio, y que fija la escala de todas las medidas electromagnéticas del SI.
Límite de validez: la definición metrológica de [[c]] es exacta en el vacío. En medios materiales o en regiones con curvatura del espacio-tiempo apreciable (cerca de objetos masivos), la velocidad efectiva de propagación de la luz difiere de [[c]] y los instrumentos deben corregirse en consecuencia.
`;export{e as default};
