...
\r
## 5. Soldadura, impresión y recubrimientos\r
Variable dominante: [[theta]]\r
Límite de validez: superficie sólida homogénea, temperatura controlada y contacto estable.\r
\r
En recubrimientos, tintas y soldadura blanda, el ángulo de contacto [[theta]] decide si el líquido se extiende o se retrae. La hipótesis dominante es que la interfaz líquido-sólido define el mojado efectivo. Una gota de tinta que no moja produce manchas o bordes irregulares; una soldadura que no moja no forma unión fiable.\r
\r
La interpretación física es que no basta con conocer [[sigma]]: el mismo líquido puede comportarse de forma distinta sobre vidrio, polímero o metal. La decisión concreta consiste en preparar la superficie para obtener el ángulo de contacto deseado. Limpieza, rugosidad, temperatura y tratamiento químico son variables de ingeniería porque modifican el balance interfacial.\r
\r
...
\r
En todos los casos, la comparación con un dato experimental sencillo es decisiva: altura observada, radio de gota, forma del menisco o presión necesaria para mover una burbuja. Si esa observación no coincide con la predicción, no se debe forzar la fórmula; hay que revisar limpieza, ángulo de contacto, radio efectivo y presencia de surfactantes.\r
\r
La decisión final siempre debe vincular diseño y escala: no es lo mismo aumentar mojado, estabilizar una gota, romper un chorro o transportar líquido por un poro. La tensión superficial aporta el mecanismo, pero la aplicación concreta decide qué variable conviene controlar primero.`;export{e as default};
