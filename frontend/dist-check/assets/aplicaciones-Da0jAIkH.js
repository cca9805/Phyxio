const e=`## 1. Ensayos no destructivos en industrias aeroespaciales
...
Límite de validez: espesores inferiores a 3×[[L_d]] con relación señal/ruido superior a 10 dB; no válido en regiones con gradientes de propiedades sin análisis direccional completo
...
En hueso cortical sano, [[L_d]] ≈ 2-5 mm; en hueso osteoporótico puede aumentar hasta 10 mm. En tejidos musculares, [[L_d]] ≈ 50-100 mm; en tejido adiposo, [[L_d]] ≈ 150-200 mm. La variación con la frecuencia sigue ley de potencia con exponente [[n]] ≈ 1.1-1.3.

Variable dominante: longitud de atenuación [[L_d]], que correlaciona directamente con densidad mineral ósea y elasticidad tisular
...
En líquidos acuosos, valores típicos de [[L_db]] son 1-10 dB/cm; en productos cárnicos, 15-30 dB/cm; en productos horneados, 25-50 dB/cm. La dependencia con la temperatura sigue un coeficiente térmico de -0.2 a -0.5%/°C según el tipo de alimento.

Variable dominante: pérdida en decibelios [[L_db]] por unidad de espesor, que correlaciona con composición y textura del alimento
...
Variable dominante: factor de calidad Q, que correlaciona con [[alpha]] mediante Q = πf/(αv), donde [[f]] es la frecuencia y v la velocidad de propagación
