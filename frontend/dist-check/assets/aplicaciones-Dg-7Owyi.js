const e=`# Aplicaciones de los transformadores
...
Variable dominante: la potencia aparente [[S]] limita la capacidad máxima del transformador y decide cuántas viviendas puede alimentar sin sobrecarga térmica.
...
Variable dominante: la tensión secundaria [[V_2]] debe mantenerse dentro de límites estrictos aunque fluctúe la red primaria.
...
Variable dominante: la corriente secundaria [[I_2]] determina la intensidad del arco, la penetración y el régimen térmico de la soldadura.
...
Variable dominante: la relación de transformación [[N_1]]/[[N_2]] debe ser exacta y estable en todo el rango de operación.
...
La relación óptima de espiras es la raíz cuadrada de la relación de impedancias. En el ejemplo, la relación entre [[N_1]] y [[N_2]] debe aproximarse a la raíz cuadrada de 3000 entre 8, alrededor de 19.4. La hipótesis es que el transformador tiene respuesta de frecuencia plana en la banda de audio, entre 20 Hz y 20 kHz.
