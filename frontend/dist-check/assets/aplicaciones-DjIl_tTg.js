...
La corriente total [[I_tot]] se obtiene sumando las corrientes individuales que cada receptor demanda de la red. Como todos comparten la misma tensión [[V]], la potencia de cada uno determina su aporte a la corriente agregada. Un error común consiste en sumar potencias sin convertirlas a corriente, olvidando que la decisión técnica se toma en el dominio de la corriente que el cable debe transportar.

Variable dominante: [[I_tot]] en régimen de máxima demanda simultánea.
...
Una vivienda de más de treinta años dispone de circuitos protegidos a 10 A y 16 A. El propietario desea instalar un aire acondicionado de 2500 W. La cuestión no es si el aparato funciona, sino si el circuito elegido puede transportar la [[I_tot]] resultante sin que [[margen_uso]] se aproxime peligrosamente al límite.
...
Variable dominante: [[I_tot]] agregada en configuración de extensión múltiple.
...
El estudio de viabilidad debe verificar que la corriente de diseño no supere el calibre en ningún escenario horario. La optimización económica no puede violar la condición física de seguridad. El análisis requiere conocer [[I_max]] de cada circuito afectado y compararlo con la [[I_tot]] proyectada en la nueva franja de uso.
...
El calibre del circuito [[I_max]] representa el límite absoluto que no debe superarse. Si la redistribución de cargas concentra demasiada potencia en una misma franja horaria, el ahorro económico se verá anulado por los disparos frecuentes del magnetotérmico. El análisis debe anticipar estos escenarios antes de comprometerse con la nueva tarifa.

Variable dominante: [[I_max]] del circuito en relación con la redistribución de cargas.
