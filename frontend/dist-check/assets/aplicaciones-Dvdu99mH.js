...
La educación energética explota la capacidad humana de optimización cuando se proporciona información completa. La potencia instantánea [[P]] es la derivada temporal de energía; integrada sobre el tiempo de uso [[t_h]] produce la energía consumida [[E_kWh]]. Multiplicando por la tarifa unitaria se obtiene el coste monetario directo del acto de consumo.
...
- Monitores de energía en tiempo real mostrando [[P]] instantánea y [[E_kWh]] acumulada diaria.
...
2. Calcular corriente individual de cada aparato dividiendo su [[P]] entre 230 V. Resultado en amperios.
3. Estimar simultaneidad realista (ej. cocina: horno + vitro + microondas nunca al 100% simultáneamente).
4. Calcular [[I]] máxima simultánea por circuito.
5. Comparar contra [[I]] nominal del magnetotérmico y sección del cable (1.5 mm² → ~16 A, 2.5 mm² → ~25 A).
