...
Variable dominante: La longitud de la cuerda [[L]] determina la frecuencia fundamental para una velocidad de propagación dada, siendo el parámetro geométrico más directo en el diseño.
...
La síntesis aditiva genera sonidos complejos sumando senoides puras en frecuencias donde [[f_n]] sigue la serie marcada por [[n]] y [[f_1]], con amplitudes controladas independientemente. La síntesis sustractiva, por otro lado, comienza con un espectro rico en armónicos (como una onda diente de sierra) y filtra las componentes no deseadas.

Variable dominante: El número de armónico [[n]] y su amplitud relativa determinan el contenido espectral y, por tanto, el timbre percibido del sonido sintetizado.
...
Variable dominante: La velocidad de propagación [[v]], que depende de la tensión y las propiedades del material, determina las frecuencias armónicas medidas en el ensayo modal.
