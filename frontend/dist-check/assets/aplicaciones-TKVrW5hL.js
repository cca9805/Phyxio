const e=`## 1. Caracterizacion elastica por ultrasonidos
...
Variable dominante: los cocientes [[ratio_G_E]] y [[ratio_K_E]], que se comparan con tablas de materiales conocidos para verificar la identidad y calidad del material.
...
En ingenieria mecanica, la seleccion de materiales para componentes estructurales requiere conocer la particion entre rigidez a cizalla y rigidez a compresion. Un componente sometido a torsion necesita alto [[G_shear]]; un componente sometido a presion hidrostatica necesita alto [[K_bulk]]. Las relaciones de conversion permiten estimar ambos a partir de E y nu tabulados, sin realizar ensayos adicionales.
...
Los codigos de elementos finitos para solidos isotropos requieren como entrada los parametros de Lame ([[lambda_lame]] y [[G_shear]]) o, equivalentemente, E y nu. Las relaciones de conversion se aplican dentro del propio codigo para transformar los datos de entrada del usuario en los parametros del tensor de rigidez.
...
Variable dominante: [[lambda_lame]] y [[G_shear]] como entrada directa del tensor constitutivo.
...
Variable dominante: [[nu_poisson]] como parametro de diseño, con los cocientes [[ratio_G_E]] y [[ratio_K_E]] como funciones objetivo.
...
En todas estas aplicaciones, la utilidad practica del leaf no esta en memorizar una tabla de conversion, sino en decidir que par de constantes conviene medir o especificar. Para ensayos rapidos suele bastar E y nu; para ondas se prefiere G y K porque conectan directamente con velocidades P y S; para simulacion tensorial son naturales [[lambda_lame]] y [[G_shear]]. Esa eleccion reduce errores de escala, evita extrapolar fuera del rango elastico y hace visible cuando un material requiere un modelo anisotropo o no lineal.
`;export{e as default};
