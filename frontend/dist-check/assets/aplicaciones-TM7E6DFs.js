...
En este contexto, la fuerza de Coulomb [[F_C]] entre la carga efectiva de la punta y la carga local de la muestra determina la deflexión del cantilever. La ley de Coulomb predice que [[F_C]] varía inversamente con el cuadrado de la distancia punta-muestra [[r12]], lo que permite obtener imágenes de resolución sub-nanométrica: cambios de décimas de nanómetro en [[r12]] producen variaciones mensurables en [[F_C]].

Variable dominante: la separación entre la punta y la muestra [[r12]], ya que [[F_C]] es extremadamente sensible a pequeñas variaciones de distancia a escala nanométrica, siendo el parámetro de control en la realimentación del instrumento.
...
La ley de Coulomb permite estimar la perturbación que un ion con carga [[q1]] ejerce sobre un vecino con carga [[q2]] separado una distancia [[r12]] dentro de la trampa. Para iones de carga elemental a distancias de micras, [[F_C]] puede ser del orden de femtonewtons, pero dado que la masa iónica es del orden de daltons, produce aceleraciones apreciables que el operador del instrumento debe compensar.

Variable dominante: la distancia entre iones confinados [[r12]], que controla la perturbación mutua entre trayectorias; aumentar la dilución del haz iónico (mayor [[r12]] promedio) reduce drásticamente [[F_C]] y mejora la resolución espectral.
...
La ley de Coulomb predice que la energía de atracción entre iones opuestos es proporcional al producto de sus cargas y decae con [[r12]]. En la posición de equilibrio del cristal, la distancia interionica [[r12]] resulta del balance entre la atracción coulombiana y la repulsión de corto alcance entre núcleos. Modificar la presión equivale a cambiar [[r12]], lo que modifica [[F_C]] de forma inversa cuadrática y se refleja en el módulo de compresibilidad del cristal.

Variable dominante: la distancia interionica [[r12]], que determina tanto la cohesión (atracción entre iones opuestos [[F_C]]) como la resistencia a la compresión; la curva [[F_C]] vs [[r12]] tiene un mínimo en la distancia de equilibrio de red.
