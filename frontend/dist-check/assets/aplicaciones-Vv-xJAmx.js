...
En dispersion de particulas, el leaf ayuda a escoger entre una descripcion reducida y otra mas completa. Se comienza con el modelo ideal para localizar la causa principal, y solo despues se decide si una extension aporta informacion nueva. Asi se evita confundir complejidad con precision.

Variable dominante: [[Ueff]] separa el mecanismo esencial de los efectos accesorios. Si domina claramente, la descripcion reducida conserva valor explicativo; si compite con terminos omitidos, la reduccion pierde fuerza.
...
En pozos de estabilidad, la aplicacion se centra en margen de diseño. Una frontera, una geometria o una condicion inicial se modifica lentamente para ver cuanto tarda el sistema en abandonar el regimen seguro. El resultado se interpreta como margen operativo, no como cifra aislada.

Variable dominante: [[Ueff]] mide la distancia conceptual hasta el cambio de comportamiento. Su sensibilidad frente a pequeñas variaciones indica si el diseño es robusto o delicado.
...
En lectura de puntos de retorno, el uso principal es evaluar comprension. El alumno debe justificar sistema, unidades, signo, escala y caso limite antes de presentar la conclusion. Esta aplicacion convierte el leaf en una guia de razonamiento y no solo en una coleccion de formulas.

Variable dominante: [[Ueff]] funciona como pregunta de control. Si el alumno no puede explicar que representa, tampoco puede defender el resultado aunque el algebra este bien escrita.
