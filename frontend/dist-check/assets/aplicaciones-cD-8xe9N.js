const e=`## 1. Correccion de miopia con lente divergente

El ojo miope forma la imagen de objetos lejanos delante de la retina porque el globo ocular es demasiado largo o el cristalino converge en exceso. Para corregir este defecto, se antepone una lente divergente ([[f]] negativo) que reduce la convergencia total del sistema ojo-lente. La lente divergente desplaza el foco imagen hacia atras, hasta que coincide con la retina.
...
Variable dominante: la distancia focal [[f]] de la lente correctora, que determina cuanto se reduce la convergencia del sistema.
...
Un tecnico utiliza una lupa de 50 mm de focal para inspeccionar soldaduras en una placa de circuito impreso. Al colocar la placa a unos 40 mm de la lente (ligeramente menos que [[f]]), obtiene una imagen virtual amplificada y derecha que observa mirando a traves de la lupa.

El aumento angular es aproximadamente el cociente entre la distancia convencional de vision nitida (250 mm) y [[f]] (50 mm), lo que da un factor de 5. Las soldaduras de 0.3 mm aparecen como si midieran 1.5 mm, suficiente para detectar defectos de flujo o microfisuras. La imagen es virtual porque [[d_o]] es menor que [[f]] en una lente convergente.

Variable dominante: la distancia focal [[f]] de la lupa, que fija el aumento maximo utilizable antes de que la aberracion cromatica degrade la imagen.
