const e=`## 1. Diseño estructural de vigas y columnas de acero

El dimensionamiento de elementos estructurales en construccion civil depende directamente del [[E_young]] del acero. Un ingeniero estructural necesita garantizar que la flecha maxima de una viga bajo carga de servicio no supere una fraccion permitida de la luz (tipicamente la longitud dividida entre 250 o 300). La flecha es inversamente proporcional al modulo de Young: a mayor rigidez, menor deformacion bajo la misma carga.

Para una viga simplemente apoyada con carga puntual centrada, la flecha maxima depende del cubo de la luz, de la carga y del producto del modulo de Young por el momento de inercia de la seccion. La decision de diseño consiste en elegir un perfil cuyo momento de inercia, combinado con el [[E_young]] del acero (200 GPa), mantenga la flecha dentro del limite. Si se usa aluminio (70 GPa), la seccion debe ser significativamente mayor para lograr la misma rigidez.

Variable dominante: el [[E_young]] del material, que controla la deformacion elastica de la estructura bajo cargas de servicio.
...
La medicion de velocidades de ondas ultrasonicas en una pieza permite determinar sus constantes elasticas sin dañarla. La velocidad longitudinal depende del modulo de onda plana (combinacion de [[K_bulk]] y [[G_shear]]) y la velocidad transversal depende exclusivamente de [[G_shear]]. Con ambas velocidades y la densidad se calculan todos los modulos.
...
Variable dominante: el [[G_shear]] del material, cuya variacion local senala la presencia de defectos o cambios microestructurales.
...
El diseño de un resorte helicoidal para una suspension de vehiculo exige conocer el [[G_shear]] del acero del alambre. La constante de rigidez del resorte es directamente proporcional al modulo de cizalla y a la cuarta potencia del diametro del alambre, e inversamente proporcional al cubo del diametro medio de la espira y al numero de espiras activas.

El ingeniero debe seleccionar un acero con [[G_shear]] adecuado (tipicamente 80 GPa para aceros de resorte) y verificar que la tension tangencial maxima no supere el limite de fatiga del material. Un error en el modulo de cizalla produce un resorte demasiado blando o demasiado rigido, comprometiendo el confort o la seguridad del vehiculo.

Variable dominante: el [[G_shear]] del material del alambre, que fija la constante de rigidez del resorte.
...
Variable dominante: la relacion entre [[K_bulk]] y [[G_shear]] en cada capa geologica, que determina las velocidades de onda y la existencia o ausencia de ondas transversales.
...
En la implantologia ortopedica, la seleccion del material de una protesis de cadera o rodilla debe considerar la compatibilidad elastica con el hueso circundante. Si el [[E_young]] del implante es muy superior al del hueso (hueso cortical tiene aproximadamente 15-25 GPa, mientras que aleaciones de titanio tienen 110 GPa y acero inoxidable 200 GPa), se produce el fenomeno de apantallamiento de tension (stress shielding): el implante absorbe la mayor parte de la carga y el hueso adyacente, al no ser estimulado mecanicamente, se reabsorbe y debilita.

Para mitigar este problema, la ingenieria biomedica desarrolla materiales porosos o espumas metalicas cuyo [[E_young]] efectivo se aproxima al del hueso, asi como aleaciones de titanio beta con modulos mas bajos (50-80 GPa). El [[nu_poisson]] del material tambien influye en la distribucion de tensiones en la interfaz hueso-implante.

Variable dominante: el [[E_young]] del material del implante, cuya discrepancia con el del hueso determina el grado de apantallamiento de tension.
