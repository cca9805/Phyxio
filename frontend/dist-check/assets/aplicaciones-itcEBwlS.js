...
El motor de corriente continua convierte energía eléctrica en mecánica mediante la fuerza de Lorentz magnética. Una bobina de varias espiras que conduce una corriente [[I]] se coloca en un campo magnético [[B]] permanente. La fuerza [[F_m]] sobre los lados activos de la bobina genera un par de torsión que hace girar el rotor. Un conmutador invierte automáticamente el sentido de la corriente cada media vuelta para mantener el par siempre en el mismo sentido de giro.

El par máximo disponible es proporcional a [[B]], a [[I]] y al área de la bobina. Aumentar [[B]] con imanes más potentes (neodimio-hierro-boro en motores modernos) permite reducir el tamaño y el peso del motor para la misma potencia. Los motores de vehículos eléctricos actuales usan campos de 0.8 a 1.5 T y producen pares de cientos de N·m en volúmenes del orden de decenas de litros.

Variable dominante: el campo magnético [[B]] del estátor, que escala directamente con el par disponible y la eficiencia energética del motor.
...
Variable dominante: el campo magnético [[B]] en la región de curvatura, que determina el radio de separación entre iones de distinta relación masa-carga y por tanto la resolución másica del instrumento.
...
Variable dominante: la intensidad del campo magnético [[B]], que junto con el campo eléctrico aplicado determina la velocidad de selección y el poder discriminante del filtro.
Límite de validez: el selector asume que [[B]] y el campo eléctrico aplicado son perfectamente uniformes en el volumen de selección. Inhomogeneidades del campo por encima del 0.1% amplían el rango de velocidades transmitidas y reducen la resolución del selector.

## 5. Blindaje magnético en instalaciones sensibles

Los magnetómetros de alta sensibilidad, los tubos fotomultiplicadores, los detectores de partículas y ciertos instrumentos de metrología requieren ser operados en entornos con campo magnético reducido a niveles del orden de nanoteslas o menos. Para conseguirlo se usan blindajes de materiales de alta permeabilidad relativa (permalloy, mu-metal) que concentran las líneas de campo [[B]] en su interior, desviándolas de la cavidad que contienen.
...
Variable dominante: el campo magnético [[B]] residual en el interior de la cavidad blindada, que determina si los instrumentos sensibles pueden operar sin distorsiones causadas por el campo magnético ambiental.
