const e=`## 1. Classic ballistic pendulum\r
\r
...
\r
Dominant variable: the key quantity is the longitudinal total momentum before the coupler locks.\r
\r
Validity limit: one must correct it if automatic brakes or additional stops act during contact.\r
\r
## 3. Training sled tackle\r
\r
...
\r
Dominant variable: the dominant variable is the total attached mass after impact and the player entry speed.\r
\r
Validity limit: the reading changes when the player keeps pushing actively after the first contact.\r
\r
## 4. Magnetic capture in orbit\r
\r
...
\r
Dominant variable: the key quantity is total momentum before the capture system closes and rigidifies the union.\r
\r
Validity limit: it is not directly valid when thrusters are firing simultaneously or the union rebounds before locking.\r
\r
## 5. Debris embedded in a shield\r
\r
...
\r
Dominant variable: the governing quantity is the added mass of debris plus moving shield along the impact direction.\r
\r
Validity limit: the model breaks down when the debris perforates, rebounds, or drags material out of the union region.\r
`;export{e as default};
