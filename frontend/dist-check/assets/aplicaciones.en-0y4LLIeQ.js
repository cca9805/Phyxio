const e=`## 1. Non-destructive ultrasonic testing in bars and cables
...
Dominant variable: the impedance [[Z_barra]] of the bars, which must be similar to the specimen's to maximise energy transmission and minimise parasitic reflections.
...
Dominant variable: [[Z_barra]] of the transfer bar, which must be carefully matched to transmit sufficient energy to the secondary charge without excessive reflections that could generate premature initiations from rebound.
