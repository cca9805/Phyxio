const e=`## 1. Structural design of steel beams and columns

The sizing of structural elements in civil construction depends directly on the [[E_young]] of steel. A structural engineer needs to guarantee that the maximum deflection of a beam under service load does not exceed a permitted fraction of the span (typically the length divided by 250 or 300). Deflection is inversely proportional to the Young modulus: the greater the stiffness, the smaller the deformation under the same load.

For a simply supported beam with a centred point load, the maximum deflection depends on the cube of the span, the load and the product of the Young modulus and the moment of inertia of the cross-section. The design decision consists of choosing a profile whose moment of inertia, combined with the [[E_young]] of steel (200 GPa), keeps the deflection within limits. If aluminium (70 GPa) is used, the cross-section must be significantly larger to achieve the same stiffness.

Dominant variable: the [[E_young]] of the material, which controls the elastic deformation of the structure under service loads.
...
Measuring ultrasonic wave velocities in a part allows determining its elastic constants without damaging it. The longitudinal velocity depends on the plane-wave modulus (combination of [[K_bulk]] and [[G_shear]]) and the transverse velocity depends exclusively on [[G_shear]]. With both velocities and the density, all moduli are calculated.
...
Dominant variable: the [[G_shear]] of the material, whose local variation signals the presence of defects or microstructural changes.
...
The design of a helical spring for a vehicle suspension requires knowing the [[G_shear]] of the wire steel. The spring rate is directly proportional to the shear modulus and to the fourth power of the wire diameter, and inversely proportional to the cube of the mean coil diameter and the number of active coils.

The engineer must select a steel with adequate [[G_shear]] (typically 80 GPa for spring steels) and verify that the maximum shear stress does not exceed the fatigue limit of the material. An error in the shear modulus produces a spring that is too soft or too stiff, compromising vehicle comfort or safety.

Dominant variable: the [[G_shear]] of the wire material, which sets the spring rate.
...
Seismologists use the velocities of P (longitudinal) and S (transverse) waves recorded by station networks to infer the distribution of [[K_bulk]] and [[G_shear]] in the Earth interior. The disappearance of S waves when crossing the outer core demonstrated that it is liquid, because a fluid has zero [[G_shear]] and does not support transverse waves.
...
Dominant variable: the ratio between [[K_bulk]] and [[G_shear]] in each geological layer, which determines wave velocities and the presence or absence of transverse waves.
...
In orthopaedic implantology, the material selection for a hip or knee prosthesis must consider elastic compatibility with the surrounding bone. If the [[E_young]] of the implant is much higher than that of bone (cortical bone has approximately 15-25 GPa, while titanium alloys have 110 GPa and stainless steel 200 GPa), the phenomenon of stress shielding occurs: the implant absorbs most of the load and the adjacent bone, not being mechanically stimulated, resorbs and weakens.

To mitigate this problem, biomedical engineering develops porous materials or metallic foams whose effective [[E_young]] approaches that of bone, as well as beta titanium alloys with lower moduli (50-80 GPa). The [[nu_poisson]] of the material also influences the stress distribution at the bone-implant interface.

Dominant variable: the [[E_young]] of the implant material, whose discrepancy with that of bone determines the degree of stress shielding.
