const e=`## 1. Inspection of welds in nuclear plant pipework
...
The part is submerged in a water bath that acts as a low-[[Z_ac]] coupling agent (1.5 MRayl versus 17 MRayl for aeronautical aluminium). The [[R_ac]] at the water-aluminium interface is approximately 0.84, implying transmission losses of around 29% in amplitude. Scanning is performed with 10 MHz transducers producing wavelengths of 0.6 mm in aluminium, sufficient to detect inclusions larger than 0.3 mm. [[d_defecto]] of each detected reflector is calculated with the time-of-flight formula using [[v_us]] of 6300 m/s for aeronautical aluminium.
...
The acoustic contrast between a well-bonded adhesive ([[Z_ac]] of 2–3 MRayl) and the air of a disbond ([[Z_ac]] of 400 Rayl) produces [[R_ac]] close to 1 in the disbond zone, compared to an [[R_ac]] of approximately 0.3 in the correctly bonded zone. The presence of a strong reflection at the [[t_vuelo]] corresponding to the adhesive-composite interface signals a disbond. The amplitude of the second interface echo (panel interior) disappears in disbond zones because energy is almost completely reflected at the first interface.

Dominant variable: [[R_ac]] at the adhesive-substrate interface, which determines whether the first-interface echo is high (disbond, [[R_ac]] close to 1) or low (correct bonding, low [[R_ac]]).
