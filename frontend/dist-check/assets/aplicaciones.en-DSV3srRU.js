const e=`# Applications of modes in plates and membranes
...
Dominant variable: [[T_mem]], because the membrane frequency is mainly set by surface tension in instruments such as drums and loudspeaker membranes.
...
Dominant variable: [[D_placa]], because bending stiffness controls the breakup of diaphragms and determines the first problematic mode in many audio devices.
...
helps estimate surface inertia, while [[D_placa]] describes resistance to curvature. Adding a heavy layer increases mass and often improves insulation in some bands, but it can shift resonances. Changing edge fixation or decoupling panels can alter dominant modes without greatly changing total mass.
