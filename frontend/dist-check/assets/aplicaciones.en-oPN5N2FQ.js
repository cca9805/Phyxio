const e=`# Applications of electric motors
...
The critical quantity in the servo motor is the torque constant, which groups the factors [[N_c]], [[L_c]], [[B]] and [[r_a]]. A high torque constant allows the desired torque to be obtained with little current, reducing winding heating and improving precision. That is why modern servo motors use rare-earth permanent magnets, which generate fields [[B]] of up to 1.2 T in a compact volume.
...
The design of these motors maximises the product [[N_c]] times [[L_c]] times [[B]] times [[r_a]] to obtain high back-EMF at low currents, reducing Joule losses. Efficiency analysis is central: high [[eta]] reduces generated heat and prolongs system life, which in a hard drive may operate uninterrupted for years.
