...
\r
La traduccion usa la relacion \`A_x = A cos(theta), A_y = A sin(theta), A = sqrt(A_x^2 + A_y^2)\`. El dato conocido se coloca en el papel geometrico adecuado: modulo, radio, hipotenusa, cateto, arco, componente o coordenada. Si el angulo se mide desde otro eje, la funcion usada puede cambiar.\r
\r
...
## Resultado dado\r
\r
Supongamos que aparece una expresion como \`A_x = A cos(theta), A_y = A sin(theta), A = sqrt(A_x^2 + A_y^2)\` ya escrita en una solucion. La pregunta inversa es: que geometria tuvo que existir para que esa expresion fuera razonable.\r
\r
