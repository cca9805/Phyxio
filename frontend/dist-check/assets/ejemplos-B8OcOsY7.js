...
- Cambio de flujo [[DeltaPhi_B]]: aumento de 0.0040 Wb.
- Intervalo [[Deltat]]: 0.050 s.
- Numero de espiras [[N]]: 1.
- Normal positiva: hacia el iman.
- El circuito esta cerrado y puede circular corriente inducida.

## Definición del sistema

El sistema es una espira cerrada. La superficie es la encerrada por la espira y la normal positiva apunta hacia el iman. Con esa convencion, el acercamiento aumenta [[Phi_B]], por lo que el cambio tiene signo positivo.

## Modelo físico

Se usa la ley de Lenz en la forma media de Faraday. La fem inducida debe tener signo opuesto al aumento de flujo. Si circula corriente, su campo magnetico asociado debe intentar frenar el aumento de [[Phi_B]].

## Justificación del modelo

El enunciado fija las tres piezas que hacen aplicable a Lenz: una superficie encerrada por la espira, una normal positiva hacia el iman y un aumento de [[Phi_B]] durante [[Deltat]]. Con esas referencias, el problema no es ambiguo: se sabe que el cambio de flujo es positivo y que la respuesta inducida debe tener signo contrario.
...
Primero se calcula la rapidez media de cambio:
...
El flujo aumenta 0.0040 Wb en 0.050 s. La rapidez media de cambio tiene modulo 0.080 Wb/s y signo positivo respecto a la normal elegida.

Como [[N]] es 1, el modulo medio de [[epsilon_ind]] es 0.080 V. El signo de la fem es negativo respecto a la referencia positiva asociada al aumento de flujo, porque Lenz exige oposicion al cambio.
...
Weber dividido por segundo produce voltio, coherente con [[epsilon_ind]]. [[N]] es adimensional y no cambia unidades. La regla de signos usa [[s_flujo]] y [[s_ind]] solo como indicadores conceptuales.
...
Si se invierte la normal elegida, los signos escritos de [[DeltaPhi_B]] y [[epsilon_ind]] cambian, pero la conclusion fisica no cambia. La cara de la espira sigue oponiendose al acercamiento del iman. Esta comprobacion evita confundir convencion matematica con sentido fisico real.
