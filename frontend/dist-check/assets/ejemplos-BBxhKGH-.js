...
Un motor de corriente continua tiene [[N_c]] iguales a 400 conductores activos, longitud activa [[L_c]] de 0.06 m, campo magnético [[B]] de 0.9 T y radio de armadura [[r_a]] de 0.04 m. El motor opera con [[sin_theta]] igual a 1. La corriente de armadura [[I]] es de 4 A y la velocidad angular [[omega]] es de 80 rad/s. La potencia eléctrica consumida [[P_elec]] es de 210 W. Calcular la fuerza de Laplace total, el par motor, la fem contraelectromotriz, la potencia mecánica y el rendimiento del motor.

## Datos

- [[N_c]] es 400 conductores activos
- [[L_c]] es 0.06 m
- [[B]] es 0.9 T
- [[r_a]] es 0.04 m
- [[sin_theta]] es 1
...
La fuerza de Laplace total sobre todos los conductores activos es el producto de [[N_c]], [[I]], [[L_c]], [[B]] y [[sin_theta]].

El par motor es el producto de [[F_L]] por [[r_a]], o de forma equivalente el producto de todos los factores anteriores más [[r_a]].

La fem contraelectromotriz es el producto de [[N_c]], [[L_c]], [[B]], [[r_a]] y [[omega]].

La potencia mecánica es el producto de [[tau_m]] y [[omega]].

El rendimiento es el cociente entre [[P_mec]] y [[P_elec]].

## Sustitución numérica

La fuerza de Laplace total [[F_L]] resulta del producto de 400 por 4 A por 0.06 m por 0.9 T por 1, que da 86.4 N.
...
La potencia mecánica [[P_mec]] es 3.456 N·m por 80 rad/s, igual a 276.5 W.

El rendimiento [[eta]] es 276.5 W dividido entre 210 W, igual a 1.317.

## Validación dimensional

Para [[F_L]]: adimensional por A por m por T. Como T es kg·A⁻¹·s⁻², el resultado es A·m·kg·A⁻¹·s⁻² igual a kg·m·s⁻², que es N. Correcto.
...
Para [[P_mec]]: N·m por rad/s igual a W. Correcto.
...
Un motor de CC de uso educativo equipado en un laboratorio de bachillerato tiene [[N_c]] iguales a 250 conductores activos, [[L_c]] de 0.05 m, [[B]] de 0.8 T y [[r_a]] de 0.035 m. Opera a [[omega]] de 1200 rpm con [[sin_theta]] igual a 1. Se mide una corriente de armadura [[I]] de 3 A y una potencia eléctrica consumida [[P_elec]] de 155 W.

## Estimación física

Convertir primero la velocidad: 1200 rpm multiplicado por 2π/60 da aproximadamente 125.7 rad/s.

La fuerza de Laplace total [[F_L]] es 250 por 3 A por 0.05 m por 0.8 T por 1, que resulta 30 N.
...
La potencia mecánica [[P_mec]] es 1.05 N·m por 125.7 rad/s, aproximadamente 132 W.
