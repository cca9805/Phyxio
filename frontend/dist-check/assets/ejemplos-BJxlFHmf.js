...
El sistema consta de una fuente laser que emite luz polarizada linealmente y un unico polarizador analizador. La intensidad incidente [[I_0]] corresponde directamente a la salida del laser, sin reduccion previa. La variable de control es el angulo [[theta_p]] entre la direccion de polarizacion del haz y el eje de transmision del analizador.

## Modelo fisico

El fenomeno se describe mediante la **ley de Malus**, que relaciona [[I]] con [[I_0]] y [[theta_p]]. Este modelo es valido porque la fuente es un laser monocromatico coherente y completamente polarizado, y el polarizador se considera ideal con alta relacion de extincion.
...
Sustituimos [[I_0]] y [[theta_p]] para obtener [[I]].

Para la segunda parte, necesitamos el angulo [[theta_p]] que hace que [[I]] sea igual a un cuarto de [[I_0]]. Despejando de la ley de Malus, el coseno cuadrado de [[theta_p]] debe ser igual a un cuarto, de modo que el coseno de [[theta_p]] es un medio, lo que corresponde a 60 grados.

## Sustitucion numerica

Para la intensidad transmitida a 35 grados: multiplicar 500 W/m² por el coseno cuadrado de 35 grados. El coseno de 35 grados es aproximadamente 0.8192; elevarlo al cuadrado da 0.6710. Multiplicar por 500 da aproximadamente 335.5 W/m². Por tanto [[I]] ≈ 335.5 W/m².

Para el angulo que da un cuarto de la intensidad: el coseno cuadrado de [[theta_p]] debe igualar 0.25; la raiz cuadrada de 0.25 es 0.5; el arcocoseno de 0.5 es 60 grados. Por tanto [[theta_p]] ≈ 60 grados (equivalente a 1.047 rad). Notese que este angulo es diferente de [[theta_B]], que depende de los indices de refraccion y no del coseno cuadrado de la intensidad.
...
Si se aumentara [[I_0]] manteniendo el mismo angulo, [[I]] creceria proporcionalmente, confirmando la linealidad respecto a la intensidad incidente. En cambio, si [[theta_p]] variase manteniendo [[I_0]] fija, la respuesta seria cuadratica, lo que resulta clave para disenar atenuadores opticos precisos.
...
Sustituyendo [[n_1]] igual a 1.00 (aire) y [[n_2]] igual a 1.33 (agua) en la ley de Brewster, el arcotangente de 1.33 dividido por 1.00 da aproximadamente 53.1 grados. Por tanto [[theta_B]] ≈ 53.1 grados.
