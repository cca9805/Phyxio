...
\r
La traduccion usa la relacion \`theta = s/r, s = r theta, omega = Delta theta / Delta t\`. El dato conocido se coloca en el papel geometrico adecuado: modulo, radio, hipotenusa, cateto, arco, componente o coordenada. Si el angulo se mide desde otro eje, la funcion usada puede cambiar.\r
\r
...
## Resultado dado\r
\r
Supongamos que aparece una expresion como \`theta = s/r, s = r theta, omega = Delta theta / Delta t\` ya escrita en una solucion. La pregunta inversa es: que geometria tuvo que existir para que esa expresion fuera razonable.\r
\r
