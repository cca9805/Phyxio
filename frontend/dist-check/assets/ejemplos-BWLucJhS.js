...
\r
La traduccion usa la relacion \`x = r cos(theta), y = r sin(theta)\`. El dato conocido se coloca en el papel geometrico adecuado: modulo, radio, hipotenusa, cateto, arco, componente o coordenada. Si el angulo se mide desde otro eje, la funcion usada puede cambiar.\r
\r
...
## Resultado dado\r
\r
Supongamos que aparece una expresion como \`x = r cos(theta), y = r sin(theta)\` ya escrita en una solucion. La pregunta inversa es: que geometria tuvo que existir para que esa expresion fuera razonable.\r
\r
