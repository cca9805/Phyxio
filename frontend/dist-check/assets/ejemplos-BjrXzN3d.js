...
El valor en A utiliza el potencial [[V_A]] en ese punto y la carga [[q]] del protón. La energía en B se obtiene de la misma fórmula con el potencial correspondiente al punto B.

La variación de energía potencial al pasar de A a B sigue la definición:

{{f:variacion_energia_potencial}}

La diferencia es [[DeltaU_e]], que resulta de restar la energía final menos la inicial. El trabajo del campo eléctrico sobre el protón durante el desplazamiento es el negativo de [[DeltaU_e]].

Por conservación de energía mecánica (sin fuerzas externas adicionales), la energía cinética ganada por el protón es igual al trabajo del campo, que a su vez es el negativo de [[DeltaU_e]]. Partiendo del reposo, la energía cinética final iguala ese trabajo. A partir de la energía cinética final se despeja la velocidad del protón en B.

## Sustitución numérica

Energía potencial en A: la carga del protón es 1.6×10⁻¹⁹ C y el potencial en A es 400 V. Multiplicando ambos valores se obtiene que [[U_e]] en A es aproximadamente 6.4×10⁻¹⁷ J.

Energía potencial en B: el potencial en B es 100 V. Multiplicando por la misma carga se obtiene que [[U_e]] en B es aproximadamente 1.6×10⁻¹⁷ J.

Variación de energía potencial: restando la energía en B menos la energía en A, [[DeltaU_e]] resulta aproximadamente −4.8×10⁻¹⁷ J. El signo negativo confirma que la energía potencial del protón disminuyó al moverse de A a B.

Trabajo del campo: el trabajo del campo sobre el protón es el negativo de [[DeltaU_e]], es decir, aproximadamente 4.8×10⁻¹⁷ J. El campo realizó trabajo positivo sobre el protón, lo que es coherente con que el protón se movió de mayor a menor potencial (la fuerza eléctrica sobre una carga positiva apunta de mayor a menor potencial).
