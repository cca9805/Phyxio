...
\r
## Contexto\r
En el diseño de un sistema de extinción de incendios para un edificio, se debe asegurar que el agua llegue al hidrante más alejado con una presión mínima de 2text{ bar}. La tubería tiene 100text{ m} de longitud y el rozamiento genera una caída de presión que debe compensarse para garantizar la seguridad de los ocupantes.\r
\r
## Estimación física\r
Si el hidrante requiere un caudal [[Q]] de 0.02text{ m}^3text{/s} y usamos una tubería de 10text{ cm} de diámetro (f approx 0.02), la velocidad será de unos 2.5text{ m/s}. La caída de presión estimada será:\r
\r
Delta p  igual a  0.02 cdot frac{100}{0.1} cdot frac{1000 cdot 2.5^2}{2}  igual a  62,500text{ Pa}  igual a  0.625text{ bar}\r
\r
Este **orden de magnitud** nos indica que la fricción consume casi un tercio de la presión requerida en el hidrante. Además, si consideramos la rugosidad de una tubería vieja, este valor podría aumentar significativamente.\r
\r
## Interpretación\r
Este cálculo **significa** que la presión en la base del edificio debe ser de al menos 2.625text{ bar} (más la altura hidrostática). Si el sistema no se dimensiona considerando este [[dp]], el chorro de agua no tendrá la fuerza suficiente para alcanzar el fuego, comprometiendo la seguridad del edificio. Este análisis nos **indica** la necesidad crítica de balances hidráulicos precisos en ingeniería civil y la importancia de los factores de seguridad.\r
`;export{e as default};
