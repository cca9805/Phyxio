...
\r
La traduccion usa la relacion \`a^2 + b^2 = c^2, razones iguales en triangulos semejantes\`. El dato conocido se coloca en el papel geometrico adecuado: modulo, radio, hipotenusa, cateto, arco, componente o coordenada. Si el angulo se mide desde otro eje, la funcion usada puede cambiar.\r
\r
...
## Resultado dado\r
\r
Supongamos que aparece una expresion como \`a^2 + b^2 = c^2, razones iguales en triangulos semejantes\` ya escrita en una solucion. La pregunta inversa es: que geometria tuvo que existir para que esa expresion fuera razonable.\r
\r
