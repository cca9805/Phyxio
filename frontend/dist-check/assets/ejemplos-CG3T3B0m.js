...
El sistema físico es una onda electromagnética monocromática idealizada. La magnitud espacial de entrada es [[lambda]], la magnitud temporal que se quiere obtener es [[f]], y la constante que une ambas en el vacío es [[c]]. Después, con [[h]], se estima [[E_foton]] para un fotón individual de esa radiación.

La región espectral se determina por el orden de magnitud de [[f]] y por la lectura inversa entre [[lambda]] y [[f]]. Una longitud de onda visible, mucho menor que la de radio y mucho mayor que la de rayos X, debe producir una frecuencia intermedia dentro del espectro óptico.

## Modelo físico

Se usa el modelo de onda electromagnética plana en vacío o aire. En ese modelo, la misma velocidad [[c]] conecta la escala espacial [[lambda]] con el ritmo temporal [[f]]. Para pasar de la lectura ondulatoria a la lectura corpuscular elemental, se usa la energía de un fotón mediante [[h]].
...
Primero se relacionan [[lambda]], [[f]] y [[c]]:

{{f:relacion_dispersion_espectral}}

Para obtener [[f]], se toma la velocidad de propagación y se divide por la longitud de onda. La relación muestra que, en el mismo medio, una [[lambda]] menor implica una [[f]] mayor.

Después se convierte esa frecuencia en energía por fotón:

{{f:energia_foton}}

La segunda relación no mide la intensidad de la luz. Solo asigna a cada fotón una energía proporcional a [[f]], con [[h]] como constante de escala cuántica.

## Sustitución numérica

Para la frecuencia, dividir 2.998×10⁸ m/s entre 5.00×10⁻⁷ m da aproximadamente 6.00×10¹⁴ Hz. Por tanto [[f]] ≈ 6.00×10¹⁴ Hz.

Para la energía por fotón, multiplicar 6.626×10⁻³⁴ J s por 6.00×10¹⁴ Hz da aproximadamente 3.98×10⁻¹⁹ J. Por tanto [[E_foton]] ≈ 3.98×10⁻¹⁹ J.
...
En la relación ondulatoria, una rapidez en m/s dividida por una longitud en m produce un ritmo por segundo. Dimensionalmente, el cociente corresponde a \`[T⁻¹]\`, que es la dimensión de [[f]].

En la energía fotónica, una constante con dimensión de acción \`J s\` multiplicada por una frecuencia con dimensión \`[T⁻¹]\` produce julios. Por tanto el resultado tiene dimensión \`[M L² T⁻²]\`, coherente con [[E_foton]].

## Interpretación física

El resultado significa que la luz verde no se distingue por viajar más rápido que otras regiones del espectro en el vacío, sino por tener una combinación concreta de [[lambda]] y [[f]]. La frecuencia calculada indica un ritmo de oscilación muy alto respecto a microondas o radio, pero menor que el de radiación ultravioleta, rayos X o gamma.

Si la longitud de onda se redujera a la mitad manteniendo el mismo medio, la frecuencia se duplicaría y también aumentaría [[E_foton]]. Físicamente, eso desplazaría la radiación hacia colores más azulados o hacia regiones todavía más energéticas. Si [[lambda]] aumentara, ocurriría lo contrario: menor [[f]], menor energía por fotón y una interacción menos localizada con la materia.

La energía por fotón no dice cuánta energía total entrega la fuente. Una lámpara intensa y una señal débil pueden compartir el mismo valor de [[E_foton]] si tienen la misma frecuencia; lo que cambia es el número de fotones emitidos o recibidos por unidad de tiempo. Por eso el espectro organiza la naturaleza de la radiación, no por sí solo su potencia.
...
La decisión práctica depende de la región espectral. Si la radiación estuviera en infrarrojo cercano, algunos sensores de silicio responderían aún bien pero el color no sería visible para un operario. Si estuviera en ultravioleta, aparecerían requisitos de protección y materiales distintos. La lectura de [[lambda]], [[f]] y [[E_foton]] evita confundir color, potencia y seguridad.

## Estimación física

Tomando 530 nm como 5.30×10⁻⁷ m y usando [[c]] ≈ 3.00×10⁸ m/s, la frecuencia estimada sale del orden de 5.7×10¹⁴ Hz. Con [[h]] ≈ 6.63×10⁻³⁴ J s, la energía por fotón queda del orden de 3.8×10⁻¹⁹ J.

La estimación cuantitativa es suficiente para clasificar la emisión como visible verde. Además muestra que cada fotón tiene mucha más energía que un fotón de microondas, pero menos que un fotón ultravioleta capaz de provocar efectos fotoquímicos más agresivos. La magnitud dominante para clasificar el dispositivo es [[f]], mientras que [[lambda]] ayuda a comparar con filtros, rejillas y tamaños ópticos.
...
Si el máximo del LED se desplazara hacia longitudes de onda mucho menores, la misma potencia óptica estaría repartida en fotones más energéticos y cambiarían los riesgos de exposición. Si se desplazara hacia longitudes mucho mayores, habría menos energía por fotón y podría perderse la señal visible. Por eso el cálculo de [[f]] y [[E_foton]] no es una sustitución aislada, sino una lectura física que orienta diseño, seguridad y selección de instrumentos.
`;export{e as default};
