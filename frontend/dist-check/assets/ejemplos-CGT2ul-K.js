...
Se aplica el modelo LHI estático: [[C_d]] = [[epsilon_r]] · [[C_0]] y [[E_d]] = campo externo / [[epsilon_r]]. Las magnitudes núcleo del leaf son [[C_d]], [[epsilon_r]], [[C_0]], [[E_d]] y [[P_pol]]. La condición de validez es que [[E_d]] esté por debajo de la tensión de ruptura del material; [[P_pol]] se puede calcular a partir de [[E_d]] y [[epsilon_r]] pero en este ejemplo no es dato de entrada.
...
Apartado (a): La capacitancia con dieléctrico se obtiene multiplicando [[C_0]] por [[epsilon_r]]:

{{f:capacitancia_dielectrico}}

Apartado (b): La carga almacenada se obtiene multiplicando [[C_d]] por la tensión aplicada. Usando la definición de capacitancia, la carga es el producto de la capacitancia y la tensión.
...
Apartado (d): La condición de seguridad exige que [[E_d]] sea mucho menor que la tensión de ruptura del material.

Apartado (e): La polarización volumétrica del material se obtiene a partir de [[E_d]] y del factor de susceptibilidad ([[epsilon_r]] menos uno):

{{f:polarizacion_dielectrico}}

## Sustitución numérica

Apartado (a): Multiplicando 4.5 por 20 pF se obtiene 90 pF. Por tanto [[C_d]] ≈ 90 pF.
...
Apartado (c): El campo externo en vacío es 100 V entre 2 mm, que da 50 000 V/m o 50 kV/m. Dividiendo entre [[epsilon_r]] = 4.5 se obtiene aproximadamente 11 111 V/m, es decir, unos 11.1 kV/m. Por tanto [[E_d]] ≈ 11.1 kV/m.

Apartado (d): La tensión de ruptura del material es 10 MV/m, equivalente a 10 000 kV/m. El campo de operación [[E_d]] ≈ 11.1 kV/m representa apenas el 0.11 % de ese límite, muy por debajo del margen de seguridad del 20 %. El condensador opera en el régimen seguro sin riesgo de ruptura dieléctrica.

Apartado (e): La permitividad del vacío es 8.85 × 10⁻¹² F/m. El factor de susceptibilidad es 4.5 menos 1, es decir 3.5. Multiplicando 8.85 × 10⁻¹² F/m por 3.5 y por 11 111 V/m se obtiene [[P_pol]] ≈ 344 × 10⁻¹² C/m², equivalente a aproximadamente 344 pC/m².

## Validación dimensional

Apartado (a): La expresión [[C_d]] = [[epsilon_r]] · [[C_0]] combina un factor adimensional por faradios, que resulta faradios. Expresando en unidades SI fundamentales, el faradio tiene dimensión de C²·s²/(kg·m²); multiplicar por un adimensional no altera las dimensiones \`[M⁻¹ L⁻² T⁴ I²]\` ✓

Apartado (c): Para [[E_d]], la relación es tensión entre longitud dividida entre un adimensional. El voltio se descompone en kg·m²·A⁻¹·s⁻³; dividido entre metros resulta kg·m·A⁻¹·s⁻³, que son las unidades correctas del campo eléctrico \`[M L T⁻³ I⁻¹]\` ✓
...
Un ingeniero de electrónica de potencia necesita seleccionar el material dieléctrico para un condensador de filtrado en una fuente de alimentación conmutada. Los requisitos son: capacitancia mínima de 100 nF, tensión de operación de 400 V, temperatura de trabajo hasta 85 °C y frecuencia de conmutación de 100 kHz. La geometría disponible permite un condensador de placas con [[C_0]] = 10 nF.

## Estimación física

Para obtener [[C_d]] = 100 nF con [[C_0]] = 10 nF, se necesita un [[epsilon_r]] de aproximadamente 10. Los candidatos con [[epsilon_r]] entre 8 y 15 son el polipropileno ([[epsilon_r]] ≈ 2.2, insuficiente), el poliéster/PET ([[epsilon_r]] ≈ 3.3, insuficiente), la mica ([[epsilon_r]] ≈ 7, límite), la alúmina ([[epsilon_r]] ≈ 10, adecuado) y el vidrio estándar ([[epsilon_r]] ≈ 8).

A 100 kHz el polipropileno tiene pérdidas mínimas (factor de disipación menor de 0.0005) y la alúmina tiene pérdidas moderadas (factor de disipación alrededor de 0.001). Para la tensión de operación de 400 V, el campo [[E_d]] en el condensador con separación de 1 mm sería de 400 kV/m dividido entre [[epsilon_r]]: para alúmina con [[epsilon_r]] = 10, el campo interior es 40 kV/m, frente a una tensión de ruptura de 13 MV/m. El margen de seguridad es de más de 300 veces, aceptable.
