...
El modelo aplicable es la ley de Coulomb para cargas puntuales en el vacío. Las magnitudes que intervienen son [[q1]], [[q2]], [[r12]] y [[k_e]]. La fórmula da el módulo de [[F_C]], que es siempre positivo; el carácter de la interacción se determina por separado comparando los signos de las cargas.
...
La expresión para el módulo de la fuerza de Coulomb es la fórmula del leaf. Despejando [[F_C]] directamente:
...
Dividiendo [[F_C]] entre [[q2]] se obtiene además el campo eléctrico [[E_C]] creado por [[q1]] en la posición de [[q2]]:

{{f:campo_electrico_coulomb}}

Para la segunda parte del problema, reducir [[r12]] a la mitad (a 4.0 cm) con las mismas cargas. Como [[r12]] entra al cuadrado en el denominador, reducir [[r12]] a la mitad multiplica el denominador por un cuarto, lo que cuadruplica [[F_C]].
...
Dividiendo: 0.2157 dividido entre 6.4 × 10⁻³ resulta aproximadamente 33.7. Así [[F_C]] ≈ 33.7 N.
...
Con el resultado de [[F_C]] también es posible calcular el campo eléctrico [[E_C]] que [[q1]] crea en la posición de [[q2]]:

{{f:campo_electrico_coulomb}}

Sustituyendo [[q1]] de 4.0 × 10⁻⁶ C y [[r12]] de 8.0 × 10⁻² m, se obtiene [[E_C]] ≈ 5.62 × 10⁶ N/C en esa posición. Este campo es independiente de [[q2]]: si se colocara una carga diferente en ese punto, [[E_C]] no cambiaría.

El resultado de [[F_C]] ≈ 33.7 N indica una fuerza atractiva de casi 34 Newtons entre las dos esferas. Esta es una fuerza considerable para un sistema de laboratorio: equivale al peso de aproximadamente 3.4 kg. La razón de que sea tan intensa es la combinación de cargas de varios microcoulombios —que requieren una máquina electrostática para alcanzarse— a una separación de solo 8 cm.
...
Aplicando la ley de Coulomb con los valores del problema, el módulo de [[F_C]] resulta:
...
Dividido entre el cuadrado de [[r12]] (0.05 m)², que vale 2.5 × 10⁻³, resulta [[F_C]] ≈ 3.6 × 10⁻⁸ N.
