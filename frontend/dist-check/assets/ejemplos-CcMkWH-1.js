...
Se aplica la ecuacion de la lente delgada a cada lente por separado, usando [[d_o]], [[d_i]] y [[f]] para el objetivo. La imagen intermedia se convierte en objeto del ocular. El aumento total [[M_micro]] se obtiene como producto del aumento lateral del objetivo por el aumento angular del ocular, utilizando [[L]], [[f_obj]], [[f_oc]] y [[d_pp]].
...
Para la imagen intermedia, con [[d_o]] de 0.0042 m y [[f]] de 0.004 m, operar con el inverso de 0.004 menos el inverso de 0.0042 y tomar el inverso del resultado. El inverso de 0.004 es 250, el inverso de 0.0042 es aproximadamente 238.1, la diferencia es 11.9 y su inverso da [[d_i]] aproximadamente 0.084 m, es decir, 84 mm. La imagen intermedia se forma a 84 mm del objetivo, dentro del tubo.

Para el aumento total del microscopio, dividir [[L]] entre [[f_obj]]: 0.16 dividido entre 0.004 da 40. Dividir [[d_pp]] entre [[f_oc]]: 0.25 dividido entre 0.025 da 10. Multiplicar ambos factores: 40 por 10 da [[M_micro]] igual a 400.

Para el aumento angular del ocular, dividir 0.25 entre 0.025 y obtener [[M_angular]] igual a 10.
