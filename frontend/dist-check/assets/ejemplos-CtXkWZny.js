...
## Enunciado\r
\r
Un operario debe elevar una carga de 60 kg utilizando un sistema de polea móvil simple. Se desea determinar la fuerza que debe ejercer el operario sobre el cable y la longitud de cable que debe tirar para elevar la carga 2 metros. Se considera un sistema ideal sin rozamiento ni peso de la polea.\r
\r
## Datos\r
\r
...
\r
El sistema consiste en una carga suspendida de una polea móvil simple. La cuerda pasa por la polea móvil, con un extremo fijo en un punto superior y el otro extremo libre donde el operario aplica la fuerza. La polea móvil se desplaza verticalmente junto con la carga.\r
\r
## Modelo físico\r
\r
Se aplica el modelo ideal de poleas simples, donde:\r
- La cuerda es inextensible y de masa despreciable\r
- La polea no tiene masa ni rozamiento en su eje\r
- El sistema está en equilibrio estático o movimiento cuasi-estático\r
\r
...
\r
El modelo ideal es adecuado porque:\r
- La carga es mucho mayor que el peso típico de una polea pequeña (< 5% error)\r
- Se asume operación lenta (velocidad constante, aceleración despreciable)\r
- El sistema está bien lubricado (rozamiento mínimo)\r
\r
...
\r
Equivalente a aproximadamente 30 kgf, una fuerza que un adulto promedio puede ejercer sostenidamente.\r
\r
...
\r
Coherencia física: La fuerza calculada (294 N) es menor que el peso (588 N), consistente con la ventaja mecánica de la polea móvil. El desplazamiento de cuerda (4 m) es mayor que la elevación (2 m), consistente con el principio de conservación de energía.\r
\r
...
\r
Este ejemplo ilustra el principio fundamental de todas las máquinas simples: la ventaja mecánica multiplica la fuerza pero no puede multiplicar el trabajo, ya que el trabajo es el producto de fuerza por distancia y este producto permanece constante (menos pérdidas) en el sistema ideal.\r
\r
# Ejemplo de aplicación real\r
\r
## Contexto\r
\r
En un taller de carpintería, un trabajador necesita elevar paneles de madera de 45 kg hasta una altura de 1.5 metros para colocarlos en un almacén elevado. El trabajador puede ejercer una fuerza máxima sostenida de aproximadamente 300 N (equivalente a levantar un objeto de unos 30 kg).\r
\r
Se dispone de dos configuraciones: una polea fija anclada en el techo, o una polea móvil suspendida de la carga. Se debe determinar qué configuración permite realizar la tarea de forma segura y eficiente.\r
\r
## Estimación física\r
\r
...
\r
El trabajador necesitaría ejercer 441 N, superando su capacidad sostenida de 300 N. Esta configuración no es viable para operación manual continua.\r
\r
...
\r
El trabajador ejerce 221 N, bien dentro de su capacidad de 300 N. Esta configuración es viable.\r
\r
Desplazamiento de cuerda:
