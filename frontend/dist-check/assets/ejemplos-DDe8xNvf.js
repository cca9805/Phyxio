...
- Tensión de contacto: [[V_contacto]] = 230 V AC
- Resistencia corporal (condiciones húmedas, normativa IEC 60479): [[R_cuerpo]] = 1 000 Ω
- Umbral del diferencial instalado: [[I_diferencial]] de 30 mA (0.030 A)
- Umbral del diferencial alternativo: [[I_diferencial]] de 10 mA (0.010 A)
- Umbral de fibrilación ventricular: [[I_segura]] = 30 mA
...
Se aplica el modelo resistivo ideal de seguridad eléctrica, que trata el cuerpo humano como resistencia pura [[R_cuerpo]] constante durante el contacto. La relación fundamental es la Ley de Ohm aplicada al circuito de contacto:
...
La corriente corporal es [[V_contacto]] dividida entre [[R_cuerpo]].

Para el [[margen]] de protección:

{{f:margen_proteccion}}

El [[margen]] con el diferencial de 30 mA es [[I_diferencial]] (0.030 A) dividido entre [[I_cuerpo]]. Con el diferencial de 10 mA el numerador cambia a 0.010 A.

Para evaluar el riesgo fisiológico directo de forma cuantitativa, usamos el cociente de seguridad:

{{f:ratio_seguridad}}

El cociente se calcula como el valor de [[I_cuerpo]] dividido entre [[I_segura]].

## Sustitución numérica

**Apartado a — Corriente corporal:**

Dividiendo la tensión de contacto (230 V) entre la resistencia corporal (1000 Ω) se obtiene la corriente. El resultado es 0.230 A. Por tanto [[I_cuerpo]] ≈ 230 mA.
...
En el baño, con [[R_cuerpo]] estimada en 800 Ω (piel mojada tras ducha), un contacto directo con una fase de 230 V produciría [[I_cuerpo]] = 230/800 ≈ 288 mA. Este valor supera masivamente el umbral de 30 mA, pero la corriente ya supera el [[margen]] residual de 15 mA disponible, con lo que el diferencial dispararía ante cualquier fuga adicional superior a 15 mA, incluido el propio contacto corporal.
