...
Se aplica el modelo de **carga puntual cuantizada**: cada electrón transferido aporta una carga negativa de módulo [[e]] a la carga total del objeto A. La magnitud dominante es [[q]], obtenida directamente de la cuantización de la carga. La carga neta del sistema {A + B} se obtiene por suma algebraica de [[q_pos]] y [[q_neg]].
...
El objeto A ha ganado electrones, por lo que [[n]] es negativo (exceso de electrones respecto al estado neutro). El número de cargas elementales es menos 8.01×10¹² y la carga [[q]] del objeto A resulta de multiplicar [[n]] por [[e]].
...
Para la carga del objeto A: multiplicar el número de electrones (8.01×10¹²) por la carga de un electrón (1.602×10⁻¹⁹ C con signo negativo). El producto de 8.01×10¹² por 1.602×10⁻¹⁹ da aproximadamente 1.2832×10⁻⁶ C. Con signo negativo, la carga del objeto A es aproximadamente menos 1.28 µC. Por tanto [[q]] del objeto A es aproximadamente menos 1.28 µC.

Verificación de cuantización: dividir 1.28×10⁻⁶ C entre 1.602×10⁻¹⁹ C da aproximadamente 7.99×10¹² ≈ 8.01×10¹² (pequeña diferencia por redondeo). [[n]] resulta entero negativo, coherente con la cuantización.
...
En un proceso industrial de pintura electrostática, una pistola aplica una tensión que electriza las partículas de pintura pulverizadas. Las partículas adquieren carga negativa por efecto corona y son atraídas hacia la pieza metálica puesta a tierra (con carga neta cero inicialmente). El control de [[q]] en las partículas determina la eficiencia de deposición y la uniformidad del recubrimiento.
...
La carga eléctrica de las partículas es la variable que controla la eficiencia del proceso. Si [[q]] por partícula es demasiado pequeña, las partículas no son desviadas suficientemente hacia la pieza y se desperdician. Si [[q]] es demasiado grande, las partículas pueden repelerse entre sí (todas tienen el mismo signo) y dispersarse antes de llegar a la pieza: esto es el efecto de carga espacial.
