...
Un transformador monofásico tiene un devanado primario de [[N_1]] igual a 800 espiras y un devanado secundario de [[N_2]] igual a 160 espiras. El primario se conecta a una tensión alterna de [[V_1]] igual a 230 V. El transformador alimenta una carga resistiva que consume una potencia activa de [[P_2]] igual a 500 W. El rendimiento del transformador [[eta]] es de 0.96. Calcular la tensión secundaria, la corriente en ambos devanados, la potencia de entrada y las pérdidas totales del transformador.
...
Los datos describen un transformador reductor porque el devanado secundario tiene menos espiras que el primario. La carga se interpreta desde [[P_2]], no desde una resistencia dada, de modo que primero debe obtenerse [[V_2]] y despues deducirse [[I_2]]. El rendimiento [[eta]] no modifica la relacion de espiras, pero si permite estimar [[P_1]] y las perdidas [[P_p]].
...
Se aplica el modelo de transformador ideal con pérdidas consideradas mediante el rendimiento. La relación entre [[V_1]] y [[V_2]] queda controlada por [[N_1]] y [[N_2]], mientras que la relación entre [[I_1]] y [[I_2]] es inversa a la de espiras. La potencia aparente [[S]] sirve como referencia de capacidad de los devanados, y [[eta]] cuantifica la fracción de potencia activa transferida al secundario.
...
[[I_1]] es igual a [[I_2]] multiplicado por [[N_2]] dividido por [[N_1]]
...
[[P_1]] es igual a [[P_2]] dividido por [[eta]]

Las pérdidas totales son la diferencia entre potencia de entrada y salida:

{{f:perdidas_totales}}

[[P_p]] es igual a [[P_1]] menos [[P_2]]

## Sustitución numérica

La relación de transformación es 800 entre 160 igual a 5.

La tensión secundaria [[V_2]] es 230 V multiplicado por 160 dividido entre 800 igual a 46 V.

La corriente secundaria [[I_2]] es 500 W dividido entre 46 V aproximadamente 10.87 A.

La corriente primaria [[I_1]] es 10.87 A multiplicado por 160 dividido entre 800 aproximadamente 2.17 A.

La potencia de entrada [[P_1]] es 500 W dividido entre 0.96 aproximadamente 520.8 W.

Las pérdidas totales [[P_p]] son 520.8 W menos 500 W igual a 20.8 W.

## Validación dimensional

Para [[V_2]]: V por adimensional entre adimensional da V. Correcto.

Para [[I_2]]: W dividido entre V da A. Correcto.

Para [[I_1]]: A por adimensional entre adimensional da A. Correcto.

Para [[P_1]]: W entre adimensional da W. Correcto.

Para [[P_p]]: W menos W da W. Correcto.
...
La corriente nominal secundaria se estima como [[S]] dividido entre [[V_2]] igual a 50000 VA entre 230 V aproximadamente 217 A.
