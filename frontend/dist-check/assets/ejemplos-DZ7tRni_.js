...
De esta relación, la densidad de energía se obtiene dividiendo el flujo entre la velocidad de propagación; para la cuerda ideal equivale al factor energético medio del modelo de cuerda sin el factor [[v]].

Para la potencia total transportada aplicamos:

{{f:potencia_desde_flujo}}

Donde [[A_seccion]] en una cuerda unidimensional se interpreta como la longitud efectiva que intercepta el flujo. En este contexto, la potencia total a lo largo de la cuerda se calcula considerando que el flujo se distribuye sobre esa extensión.
