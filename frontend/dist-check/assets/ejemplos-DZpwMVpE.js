...
El sistema es un montaje interferencial con dos caminos que se recombinan sobre un detector. La fuente aporta [[tau_c]], que se convierte en [[L_c]]. El montaje aporta [[Delta_L]], y el patron medido permite obtener [[V]] a partir de [[I_max]] e [[I_min]].

La magnitud que decide si la interferencia temporal sobrevive es la comparacion entre [[Delta_L]] y [[L_c]]. La visibilidad experimental indica despues si el contraste realmente observado coincide con esa expectativa.
...
La coherencia relativa [[C_rel]] se usa como indicador pedagogico monotono. No sustituye una funcion de correlacion completa, pero permite leer si la diferencia de caminos esta dentro o fuera de la escala de coherencia.

## Justificación del modelo

El modelo es apropiado porque el problema ofrece [[tau_c]], [[Delta_L]], [[I_max]] e [[I_min]], que son justamente las magnitudes necesarias para conectar fuente, montaje y detector. Ademas, el aire permite usar [[c]] como velocidad de propagacion aproximada.
...
Despues se estima la coherencia relativa comparando [[Delta_L]] con [[L_c]]:

{{f:coherencia_relativa}}

Finalmente se calcula la visibilidad experimental a partir del contraste entre [[I_max]] e [[I_min]]:

{{f:visibilidad_franjas}}

Antes de sustituir, se espera que [[L_c]] sea del mismo orden que fracciones de milimetro. Si [[Delta_L]] queda por debajo de esa escala, deberian sobrevivir franjas con contraste apreciable.

## Sustitución numérica

Para la longitud de coherencia, multiplicar 3.00×10⁸ m/s por 2.0×10⁻¹² s da 6.0×10⁻⁴ m. Por tanto [[L_c]] ≈ 0.60 mm.

Para la coherencia relativa, comparar 0.60 mm con un desajuste de 0.30 mm da un indicador de aproximadamente 0.67. Por tanto [[C_rel]] queda en una zona donde las franjas deberian seguir siendo observables.

Para la visibilidad, la diferencia entre 9.0 y 3.0 es 6.0, y la suma es 12.0. El cociente normalizado da 0.50. Por tanto [[V]] ≈ 0.50.

## Validación dimensional

En la longitud de coherencia, una velocidad con dimension \`[L T⁻¹]\` multiplicada por un tiempo con dimension \`[T]\` produce una longitud \`[L]\`, coherente con [[L_c]].
...
Si [[Delta_L]] aumentara hasta varios milimetros manteniendo la misma fuente, [[C_rel]] bajaria y el patron perderia contraste. Si se usara una fuente con mayor [[tau_c]], [[L_c]] aumentaria y el mismo interferometro podria admitir brazos mas desiguales.
...
La fuente se elige de forma que [[L_c]] sea suficientemente pequeña para discriminar capas cercanas, pero no tan pequeña que el detector pierda toda señal util.

## Estimación física

Si una fuente tiene [[L_c]] del orden de 10 micrometros, solo caminos que coincidan dentro de esa escala contribuyen con interferencia fuerte. Una diferencia de camino de 100 micrometros queda un orden de magnitud por encima y reduce mucho la coherencia relativa.
