...
El sistema es una esfera aislante con distribución de carga volumétrica uniforme. La simetría esférica de la distribución permite elegir superficies gaussianas esféricas concéntricas con la esfera cargada. Cada superficie gaussiana esférica garantiza que [[E_G]] es constante en módulo y perpendicular a la superficie en todos sus puntos, lo que permite aplicar directamente la fórmula del campo gaussiano.

Para el punto exterior (r₁ > R): la superficie gaussiana es una esfera de radio r₁ que encierra completamente la carga Q. La carga encerrada [[Q_enc]] coincide con la carga total: 4.8×10⁻⁶ C.

Para el punto interior (r₂ < R): la superficie gaussiana es una esfera de radio r₂ que solo encierra la fracción de carga contenida en esa esfera. Como la distribución es uniforme, [[Q_enc]] es proporcional al volumen y escala con el cubo del radio relativo respecto a R.

## Modelo físico

El modelo se basa en la ley de Gauss con simetría esférica perfecta. Se aplica la fórmula que extrae [[E_G]] de la integral de flujo:
...
Las hipótesis del modelo son: distribución de carga esféricamente simétrica, vacío (permitividad [[epsilon_0]]), y cargas en reposo. La simetría esférica garantiza que [[E_G]] es constante sobre cualquier esfera concéntrica, validando la extracción del campo de la integral.
...
Dividiendo [[Q_enc]] entre [[epsilon_0]], el flujo resulta 4.8×10⁻⁶ / 8.854×10⁻¹². El resultado, cerca de 5.42×10⁵ N·m²·C⁻¹, es el valor de [[Phi_E]] para el punto exterior.

Área gaussiana exterior [[A_G]]: cuatro veces pi por 0.0625 m² da aproximadamente 0.785 m².

Campo exterior: dividiendo el flujo entre [[A_G]], el resultado es 5.42×10⁵ / 0.785, cerca de 6.91×10⁵ N/C. Ese es el valor de [[E_G]] en el punto exterior.
...
Carga encerrada interior: multiplicando 4.8×10⁻⁶ por (0.08/0.15)³ (aproximadamente 0.1521) da cerca de 7.30×10⁻⁷ C. Ese es el valor de [[Q_enc]] para el punto interior.

Área gaussiana interior [[A_G]]: cuatro veces pi por 0.0064 m² da aproximadamente 0.0804 m².

Flujo interior: dividiendo 7.30×10⁻⁷ entre [[epsilon_0]], el resultado es cerca de 8.24×10⁴ N·m²·C⁻¹. Ese es el valor de [[Phi_E]] para el punto interior.

Campo interior: dividiendo el flujo entre [[A_G]] se obtiene 8.24×10⁴ / 0.0804, cerca de 1.03×10⁶ N/C. Ese es el valor de [[E_G]] en el punto interior.

## Validación dimensional

Flujo [[Phi_E]]: \`[I T] / [M⁻¹ L⁻³ T⁴ I²]\` se reduce a \`[M L³ T⁻³ I⁻¹]\`, equivalente a N·m²·C⁻¹ ✓

Campo [[E_G]]: \`[I T] / ([M⁻¹ L⁻³ T⁴ I²] · [L²])\` se reduce a \`[M L T⁻³ I⁻¹]\`, equivalente a N/C ✓
...
El campo interior calculado (cerca de 1.03×10⁶ N/C a 0.08 m del centro) es mayor que el exterior, lo que puede sorprender. Ocurre porque, aunque [[Q_enc]] disminuye con el cubo del radio, [[A_G]] disminuye con el cuadrado, y la tasa de decaimiento del área domina para radios pequeños dentro de la esfera, aumentando [[E_G]]. Si aumentáramos la distancia hacia R, el campo interior se acercaría al valor en la superficie.
...
Consideramos una punta conductora aproximada como una esfera de radio 5 mm (equivalente a 5×10⁻³ m), cargada a un potencial alto. En el diseño de pararrayos, la carga [[Q_enc]] acumulada antes de la descarga puede ser del orden de 1 μC.
...
Dividiendo [[Q_enc]] entre [[epsilon_0]], el flujo es 10⁻⁶ / 8.854×10⁻¹², cerca de 1.13×10⁵ N·m²·C⁻¹. Ese es el valor de [[Phi_E]]. Dividiendo [[Phi_E]] entre el área [[A_G]] de 3.14×10⁻⁴ m², el campo resultante es cerca de 3.6×10⁸ N/C. Ese es el valor de [[E_G]], más de cien veces el campo de ruptura del aire.
