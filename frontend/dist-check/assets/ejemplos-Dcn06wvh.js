...
## Enunciado\r
\r
Una cuerda de guitarra tiene longitud vibrante de 0.65 m entre la cejilla y el puente. La velocidad de propagacion de las ondas transversales en esta cuerda es de 312 m/s. Se pide determinar la longitud de onda y frecuencia del modo fundamental, calcular la frecuencia y longitud de onda del tercer modo estacionario, y hallar la nueva frecuencia fundamental cuando el guitarrista presiona la cuerda en un traste que reduce la longitud vibrante a 0.433 m.\r
\r
## Datos\r
\r
- Longitud vibrante de la cuerda: [[longitud_cuerda]] vale 0.65 m\r
- Velocidad de propagacion de ondas transversales: [[velocidad_propagacion]] vale 312 m/s\r
- Numero de modo para el fundamental: [[numero_armonico]] vale 1\r
- Numero de modo para el tercer armonico: [[numero_armonico]] vale 3\r
- Longitud vibrante reducida al presionar el traste: 0.433 m\r
\r
## Definición del sistema\r
\r
El sistema es una cuerda con extremos fijos en ambos extremos de la longitud vibrante. Los modos estacionarios son los patrones de vibracion que satisfacen las condiciones de contorno de nodos permanentes en los extremos. Cada modo contiene exactamente [[numero_armonico]] medias longitudes de onda [[longitud_onda_estacionaria]] dentro de la longitud [[longitud_cuerda]].\r
\r
## Modelo físico\r
\r
El modelo de ondas estacionarias con extremos fijos cuantiza la longitud de onda [[longitud_onda_estacionaria]] en funcion del modo [[numero_armonico]] y la longitud [[longitud_cuerda]]. La frecuencia de cada modo [[frecuencia_modo]] se obtiene combinando la longitud de onda cuantizada con la velocidad de propagacion [[velocidad_propagacion]] del medio. Para el primer modo, la frecuencia fundamental [[frecuencia_fundamental]] establece la base de la serie armonica.\r
\r
## Justificación del modelo\r
\r
Las condiciones de contorno fuerzan nodos permanentes en los extremos de la cuerda. Esto cuantiza la longitud de onda al imponer que [[numero_armonico]] medias longitudes de onda caben exactamente en [[longitud_cuerda]]. La misma velocidad [[velocidad_propagacion]] aplica a todos los modos porque depende de la tension y densidad lineal de la cuerda, que son uniformes. El espectro armonico resultante (donde [[frecuencia_modo]] es exactamente [[numero_armonico]] veces [[frecuencia_fundamental]]) es una consecuencia directa de la linealidad del sistema y de las condiciones de contorno identicas para todos los modos.\r
\r
## Resolución simbólica\r
\r
Para la longitud de onda del modo n-esimo:\r
\r
{{f:longitud_onda_estacionaria}}\r
\r
Para la frecuencia del modo n-esimo:\r
\r
{{f:frecuencia_estacionaria}}\r
\r
Para la frecuencia fundamental con [[numero_armonico]] igual a 1:\r
\r
{{f:frecuencia_fundamental}}\r
\r
Para localizar los nodos del patron en el modo n:\r
\r
{{f:posicion_nodos}}\r
\r
Para localizar los vientres del patron en el modo n:\r
\r
{{f:posicion_vientres}}\r
\r
Para la forma completa de la onda estacionaria:\r
\r
{{f:funcion_onda_estacionaria}}\r
\r
## Sustitución numérica\r
\r
**Modo fundamental (n igual a 1, L igual a 0.65 m, v igual a 312 m/s)**\r
\r
Longitud de onda: dos veces 0.65 dividido entre 1. Resultado: [[longitud_onda_estacionaria]] aproximadamente 1.30 m.\r
\r
Frecuencia fundamental: 312 dividido entre dos veces 0.65. Resultado: [[frecuencia_fundamental]] aproximadamente 240 Hz.\r
\r
Numero de vientres: exactamente 1. Numero de nodos: exactamente 2 (los dos extremos).\r
\r
**Tercer modo (n igual a 3)**\r
\r
Longitud de onda: dos veces 0.65 dividido entre 3. Resultado: [[longitud_onda_estacionaria]] aproximadamente 0.433 m.\r
\r
Frecuencia: tres veces 240. Resultado: [[frecuencia_modo]] aproximadamente 720 Hz.\r
\r
Numero de vientres: exactamente 3. Numero de nodos: exactamente 4 (dos extremos mas dos nodos interiores).\r
\r
**Cuerda acortada (L reducida a 0.433 m)**\r
\r
Nueva frecuencia fundamental: 312 dividido entre dos veces 0.433. Resultado: [[frecuencia_fundamental]] aproximadamente 360 Hz.\r
\r
Incremento respecto al original: 360 dividido entre 240, que es aproximadamente 1.5. La frecuencia aumenta un 50%.\r
\r
## Validación dimensional\r
\r
Para la longitud de onda [[longitud_onda_estacionaria]]: la formula combina metros divididos entre adimensional, resultando en unidades de longitud \`[L]\`. Dimension correcta en metros.\r
\r
Para la frecuencia [[frecuencia_modo]]: la formula combina metros por segundo divididos entre metros, resultando en \`[T⁻¹]\`. Dimension correcta en Hz equivalente a ciclos por segundo.\r
\r
La verificacion cruzada del producto de [[longitud_onda_estacionaria]] por [[frecuencia_modo]] debe dar [[velocidad_propagacion]]. Para el fundamental: 1.30 m multiplicado por 240 Hz da 312 m/s, coincidiendo con [[velocidad_propagacion]] dado. Consistencia verificada.\r
\r
