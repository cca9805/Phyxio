...
## Enunciado\r
\r
Un gas ideal diatómico contenido en un cilindro con émbolo de fricción despreciable recibe 800 J de calor de una fuente externa mientras se expande y realiza 320 J de trabajo sobre el émbolo. Determina la variación de energía interna del gas, clasifica el proceso según el segundo principio e indica si la entropía del sistema aumenta, disminuye o permanece constante.\r
\r
## Datos\r
\r
- Calor recibido por el sistema: 800 J\r
- Trabajo realizado por el sistema sobre el émbolo: 320 J (convención ingeniería) → con convención IUPAC, el sistema cede trabajo, por lo que W es negativo: W = −320 J\r
- Sistema: gas ideal diatómico en cilindro con émbolo\r
- Tipo de frontera: permeable al calor, móvil (trabajo pV), impermeable a la materia\r
\r
## Definición del sistema\r
\r
El sistema termodinámico es el gas ideal contenido en el interior del cilindro. La frontera está definida por las paredes del cilindro, la cabeza del émbolo y la tapa del fondo. La frontera transmite calor desde la fuente externa (no es adiabática) y puede desplazarse cuando el émbolo se mueve (permite trabajo de presión-volumen). No hay flujo de materia: el gas no escapa. El sistema es, por lo tanto, un sistema cerrado.\r
\r
## Modelo físico\r
\r
El sistema se modela como un **sistema cerrado** con intercambio de calor y trabajo mecánico con el entorno. Se aplica el primer principio con convención IUPAC: [[Q]] positivo (el sistema absorbe calor), [[W]] negativo (el sistema realiza trabajo, cediendo energía al entorno). La variación de [[DeltaU]] resulta de la diferencia entre la energía recibida como calor y la cedida como trabajo.\r
\r
## Justificación del modelo\r
\r
El modelo de sistema cerrado es válido porque el gas permanece dentro del cilindro durante todo el proceso: no hay flujo de masa a través de ninguna parte de la frontera. La frontera es claramente no adiabática (recibe calor de una fuente) y no rígida (el émbolo se desplaza), lo que descarta el modelo de sistema aislado. Al no haber flujo de masa, el modelo de sistema abierto tampoco aplica.\r
\r
## Resolución simbólica\r
\r
Aplicando el primer principio al sistema cerrado con convención IUPAC:\r
\r
{{f:primer_principio_cerrado}}\r
\r
Con [[Q]] positivo igual a 800 J y [[W]] negativo igual a menos 320 J (el sistema realiza trabajo, lo que equivale a recibir W negativo en convención IUPAC):\r
\r
El resultado es que [[DeltaU]] es igual a Q más W, es decir, 800 J más (menos 320 J), lo que da 480 J positivos.\r
\r
Para el segundo principio, como el proceso recibe calor a temperatura positiva y no se específica que sea reversible, la variación de [[S]] es mayor o igual que Q/T, con T la temperatura de la fuente. Como Q es positivo, [[S]] es positiva o cero.\r
\r
## Sustitución numérica\r
\r
Aplicando directamente la fórmula del primer principio:\r
\r
[[DeltaU]] es igual a 800 J más (menos 320 J), lo que resulta en 480 J.\r
\r
El gas ha ganado 480 J de energía interna. Para un gas ideal diatómico a temperatura moderada, la energía interna depende solo de la temperatura, por lo que este aumento de 480 J corresponde a un aumento de temperatura proporcional a la capacidad calorífica isocórica del gas.\r
\r
