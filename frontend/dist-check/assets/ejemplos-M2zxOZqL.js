...
## Enunciado\r
\r
Un disco uniforme gira alrededor de su eje central. Su momento de inercia respecto a ese eje es \`0.80 kg m^2\`. Inicialmente gira con velocidad angular \`6 rad/s\` y un motor lo acelera hasta \`14 rad/s\`. Se pide calcular la energía cinética rotacional inicial, la energía final y el trabajo rotacional neto realizado sobre el disco.\r
\r
## Datos\r
\r
Los datos relevantes son [[I]] igual a \`0.80 kg m^2\`, velocidad angular inicial\r
\r
{{f:energia_rotacional_basica}}\r
\r
 y velocidad angular final\r
\r
{{f:energia_rotacional_basica}}\r
\r
. La magnitud buscada en cada estado es [[Erot]], y para el proceso se busca [[Wrot]]. No hay información sobre traslación, así que el centro del disco se considera fijo.\r
\r
## Definición del sistema\r
\r
El sistema elegido es el disco. El motor actúa como agente externo que realiza trabajo sobre él. No incluimos el motor dentro del sistema porque entonces habría que describir también energía eléctrica, pérdidas internas y energía térmica. Esta elección permite usar directamente el balance\r
\r
{{f:energia_rotacional_basica}}\r
\r
.\r
