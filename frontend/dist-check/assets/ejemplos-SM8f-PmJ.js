...
Distancia focal [[f]] de 15 cm (positiva, lente convergente). Distancia del objeto [[d_o]] de 25 cm. Altura del objeto de 4 cm.
...
Se aplica el modelo de lente delgada en aproximacion paraxial. La formacion de la imagen se rige por la ecuacion de la lente delgada, que relaciona [[f]], [[d_o]] y [[d_i]]. El aumento lateral [[m]] se obtiene como cociente de distancias con signo.
...
[[d_i]] se obtiene como el producto de [[f]] por [[d_o]] dividido por la diferencia entre [[d_o]] y [[f]].

El aumento lateral:

{{f:aumento_lateral}}

La altura de la imagen es el producto del modulo de [[m]] por la altura del objeto, con el signo de [[m]] indicando la orientacion.
...
Para [[m]]: menos 37.5 dividido entre 25 da menos 1.5.

Altura de la imagen: modulo de 1.5 por 4 cm da 6 cm. El signo negativo de [[m]] indica que la imagen esta invertida.

## Validacion dimensional

La distancia [[d_i]] se expresa en centimetros, coherente con las unidades de entrada. El aumento [[m]] es adimensional (cociente de dos longitudes). La altura de la imagen se expresa en centimetros, coherente con la altura del objeto.

## Interpretacion fisica

La imagen se forma a 37.5 cm al otro lado de la lente. Es real porque [[d_i]] es positivo: puede proyectarse en una pantalla colocada a esa distancia. Es invertida porque [[m]] es negativo, lo que significa que los rayos se cruzan al atravesar la lente y la imagen aparece volteada respecto al objeto. Es amplificada porque el modulo de [[m]] es 1.5, mayor que uno: cada centimetro del objeto se traduce en 1.5 cm en la imagen.

Fisicamente, este resultado se explica porque el objeto esta entre una y dos distancias focales de la lente, la zona donde las imagenes reales resultan amplificadas. Si acercaramos el objeto al foco, [[d_i]] creceria sin limite y la imagen se agrandaria enormemente, situacion aprovechada en proyectores. Si lo alejaramos mas alla de dos focales, el modulo de [[m]] caeria por debajo de uno y la imagen se reduciria, como ocurre en el ojo humano al observar objetos lejanos.

La coherencia de signos confirma la validez del resultado: [[d_i]] positivo con [[m]] negativo corresponde al par imagen real invertida, exactamente lo que predice el trazado de rayos. Si hubieramos obtenido [[d_i]] positivo con [[m]] positivo, esa combinacion violaria la convencion de signos y senalaria un error algebraico. Este tipo de autocontrol es esencial en problemas de optica geometrica.
...
Para refinar: [[d_o]] resulta aproximadamente 82 mm (ligeramente mayor que [[f]]). El aumento [[m]] es del orden de menos 37 (imagen invertida, que el proyector corrige colocando la diapositiva invertida). La imagen en pantalla mide aproximadamente 89 cm, valor razonable para proyeccion en aula.

El modelo de lente delgada es aplicable porque la lente del proyector tiene focal de 80 mm y su espesor tipico es del orden de 8 mm (una decima parte de la focal), dentro del limite de validez. La lente esta fabricada con vidrio de indice [[n]] aproximadamente 1.5 y radio de primera superficie [[R1]] del orden de 60 mm, parametros que la ecuacion del fabricante conecta con la focal resultante.
