...
\r
\r
La resolucion no se apoya solo en una analogia verbal con el MRUA, sino en relaciones concretas de la cinematica rotacional con aceleracion angular constante.\r
\r
Si el problema se plantea en funcion del tiempo, la formula clave es la ecuacion de posicion angular con aceleracion constante, porque permite reconstruir la evolucion angular completa del sistema:\r
\r
{{f:mcua_posicion}}\r
\r
Esta expresión no se introduce como una fórmula aislada, sino como la traducción rotacional del mismo esquema estructural que en movimiento rectilíneo uniformemente acelerado. En este problema permite reconstruir el estado angular del sistema a partir de condiciones iniciales bien definidas y una aceleración angular [[alpha]] constante.\r
\r
Cuando el problema se formula en terminos de velocidades angulares y tiempo, tambien puede intervenir la relacion para la velocidad angular [[omega]] final, pero aqui la ecuacion de posicion es la que organiza la resolucion porque conecta directamente el estado inicial con el desplazamiento angular observado.\r
\r
La lectura fisica del paso simbolico es importante: no se trata de sumar terminos mecanicamente, sino de reconocer que el sistema gira cada vez mas deprisa o cada vez mas despacio segun el signo de [[alpha]], y que ese cambio modifica el angulo total barrido durante el intervalo considerado.\r
\r
La evolución angular del sistema se construye usando explícitamente las relaciones del modelo.\r
\r
En primer lugar, la velocidad angular en funcion del tiempo se obtiene mediante la ecuacion de velocidad angular con aceleracion constante, que describe como cambia la velocidad bajo aceleracion angular constante:\r
\r
{{f:mcua_velocidad}}\r
\r
A partir de esa evolucion, la posicion angular [[theta]] se determina con la relacion independiente del tiempo, que permite relacionar directamente estado inicial y final sin necesidad de reconstruir toda la trayectoria temporal:\r
\r
{{f:mcu_posicion}}\r
\r
De forma complementaria, cuando el movimiento es uniforme, la posicion angular se describe mediante la ecuacion de MCU, que conecta directamente angulo y tiempo bajo velocidad constante:\r
\r
{{f:mcu_posicion}}\r
\r
Estas tres relaciones no se usan como formulas aisladas, sino como partes de un mismo esquema: la ecuacion de velocidad fija la evolucion temporal, la relacion independiente del tiempo conecta estados sin tiempo, y la ecuacion de MCU aparece como caso limite cuando la aceleracion angular desaparece.\r
\r
