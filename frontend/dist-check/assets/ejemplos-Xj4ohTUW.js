...
## Enunciado\r
\r
En un laboratorio se funden 500 g de hielo a cero grados Celsius mediante un bano térmico que se mantiene a la misma temperatura durante todo el proceso. El cambio se idealiza como reversible porque el sistema y el entorno intercambian calor sin salto finito de temperatura. El calor latente de fusion del hielo es 334 J/g. Calcula la variación de entropía [[DeltaS]] del hielo, la variación de entropía del bano y la variación total del universo.\r
\r
## Datos\r
\r
La masa de hielo es 500 g. La temperatura absoluta de fusion que se usa como [[T_abs]] es 273 K. El calor latente de fusion es 334 J por cada gramo. El hielo absorbe calor, de modo que su [[Q_rev]] es positivo; el bano entrega la misma cantidad de energía y su [[Q_rev]] tiene signo negativo. El proceso se trata como isotérmico y reversible.\r
\r
## Definición del sistema\r
\r
El sistema principal es el hielo que pasa de solido a liquido. El entorno inmediato es el bano térmico. La magnitud que se pide es [[DeltaS]], no la entropía absoluta [[S]], por lo que basta comparar el estado inicial y el estado final. Como el cambio de fase ocurre a temperatura constante, la lectura física depende de dos cantidades: el calor reversible [[Q_rev]] intercambiado y la temperatura absoluta [[T_abs]] a la que ocurre el intercambio.\r
\r
## Modelo físico\r
\r
El modelo apropiado es el de un cambio de fase isotérmico. Durante la fusion, la temperatura no aumenta: el calor suministrado se dedica a romper la estructura cristalina y a aumentar los microestados disponibles en el liquido. Por eso se usa la relación de Clausius para proceso isotérmico.\r
\r
{{f:entropia_isotermica}}\r
\r
La misma relación se aplica al bano con el signo contrario del calor. La hipótesis reversible es importante: no describe una fusion real rápida con un bano mucho más caliente, sino el camino limite que permite calcular [[DeltaS]] como función de estado.\r
\r
## Justificación del modelo\r
\r
La formula es válida porque [[T_abs]] permanece constante durante todo el cambio de fase y porque el calor considerado es [[Q_rev]], es decir, el calor que intercambiaria el sistema en un camino reversible entre los mismos estados. Si la temperatura cambiara apreciablemente, habria que pasar al modelo integral de variación de entropía, no a esta division directa. Si el intercambio fuera irreversible, [[DeltaS]] del hielo seguiria calculandose con el camino reversible equivalente, mientras que la entropía generada en el universo seria positiva.\r
\r
## Resolucion simbolica\r
\r
Primero se obtiene el calor reversible absorbido por el hielo a partir de la masa y del calor latente. Despues se introduce ese calor en la definición isotermica de [[DeltaS]]. Para el bano se conserva el mismo modulo de energía, pero con signo negativo porque el bano cede calor.\r
\r
{{f:entropia_isotermica}}\r
\r
{{f:definicion_entropia_clausius}}\r
\r
La variación total del universo se obtiene sumando la contribucion del sistema y la del entorno. En el limite reversible ambas contribuciones tienen el mismo modulo y signos opuestos.\r
\r
...
\r
La unidad de [[Q_rev]] es joule y la unidad de [[T_abs]] es kelvin. La division produce joule por kelvin, que es la unidad de [[DeltaS]]. El orden de magnitud también es razonable: fundir medio kilogramo de hielo implica una transferencia de calor grande, así que una variación de varios cientos de J/K es esperable.\r
\r
## Interpretacion física\r
\r
El signo positivo de [[DeltaS]] para el hielo indica aumento de dispersion energética y de configuraciones moleculares accesibles. El hielo liquido no es simplemente "más caliente"; de hecho, esta a la misma temperatura. Lo que cambia es la forma en que la energía queda distribuida entre microestados: la fase liquida admite muchas más posiciones y orientaciones que la red cristalina.\r
\r
El signo negativo del bano no contradice la segunda ley, porque la segunda ley se aplica al conjunto sistema más entorno. En este caso ideal, el bano pierde exactamente la misma entropía que gana el hielo. Un proceso real requeriria un bano algo más caliente para que el flujo ocurriera en tiempo finito; entonces el bano perderia menos entropía en modulo y el universo ganaria una cantidad positiva. Esa diferencia es la irreversibilidad que la entropía permite medir.\r
\r
