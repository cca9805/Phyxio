...
El sistema consta de un rayo que viaja por el vacío (o aire, con índice aproximado de uno) e incide sobre una interfaz plana vacío-vidrio. El plano de incidencia contiene el rayo, la normal a la superficie y el rayo refractado. Las magnitudes relevantes son [[n]] (índice del vidrio), [[c]], [[v_medio]], [[lambda_0]], [[lambda_medio]], [[theta_1]] y [[theta_2]].

## Modelo físico

Se aplica el modelo de óptica geométrica con interfaz plana entre un medio de índice uno (vacío) y un medio de índice [[n]] (vidrio). La luz es monocromática, el medio es homogéneo e isótropo y la interfaz es ideal. La fórmula de definición del índice de refracción proporciona [[n]], la relación de longitudes de onda proporciona [[lambda_medio]] y la ley de Snell proporciona [[theta_2]].
...
La secuencia completa permite obtener las tres magnitudes pedidas de forma encadenada: primero [[n]], luego [[lambda_medio]] y finalmente [[theta_2]].

## Sustitución numérica

Para el índice: dividir 2.998 por diez elevado a ocho entre 1.97 por diez elevado a ocho da aproximadamente 1.522. Por tanto [[n]] ≈ 1.522.
...
El ángulo de refracción de 27.7 grados, menor que los 45 grados de incidencia, confirma que el rayo se acerca a la normal al entrar en un medio de mayor índice. Si aumentáramos [[theta_1]] hasta el ángulo crítico (calculado como el arco seno de la inversa de [[n]], aproximadamente 41.1 grados desde dentro del vidrio), observaríamos reflexión total interna. Este fenómeno delimita la frontera del modelo: más allá del ángulo crítico no existe rayo refractado.

# Ejemplo de aplicación real

## Contexto

Un técnico de telecomunicaciones debe verificar que una fibra óptica de sílice dopada conduce correctamente la señal láser infrarroja de 1550 nm. La fibra tiene un núcleo con índice [[n]] de 1.468 y un revestimiento con índice menor. El técnico necesita estimar la velocidad de propagación de la señal y la longitud de onda de la luz dentro del núcleo para comprobar que las condiciones de interferencia constructiva se cumplen en la guía de ondas.

## Estimación física

Dividir [[c]] (2.998 por diez elevado a ocho metros por segundo) entre [[n]] de 1.468 da una velocidad en el núcleo de aproximadamente 2.042 por diez elevado a ocho metros por segundo. Por tanto [[v_medio]] ≈ 2.042 por diez elevado a ocho m/s.
...
La velocidad de la señal en la fibra (aproximadamente dos tercios de [[c]]) implica una latencia de unos 4.9 microsegundos por kilómetro de fibra. Para una conexión transatlántica de 6000 km, la latencia mínima teórica por propagación sería de unos 29 milisegundos, dato crucial para aplicaciones de alta frecuencia en mercados financieros.
