...
## Enunciado\r
\r
Se presenta un sistema clasico regular en el lenguaje de Transformaciones canonicas. Decide si puede usarse el formalismo avanzado, identifica la magnitud dominante [[C]] y declara que estructura fisica se esta poniendo a prueba. Las magnitudes relevantes son [[q]], [[p]], [[Q]], [[P]], [[K]], [[Fgen]], [[C]].\r
\r
## Datos\r
\r
...
## Modelo fisico\r
\r
El modelo usa [[C]] como magnitud central porque determina la lectura fisica del leaf. Las formulas forman parte del modelo y deben aplicarse como pruebas estructurales:\r
\r
...
\r
Elige una estimacion de escala unidad para el sistema original. Las formulas mostradas deben mantener [[C]] en la escala esperada. Si una comprobacion estructural exacta deberia ser cero o uno, una deriva apreciable no es redondeo; indica una hipotesis rota. Si una frecuencia, accion o hamiltoniano transformado cambia mas de aproximadamente diez por ciento bajo una aproximacion pequena, el modelo debe revisarse.\r
\r
## Validacion dimensional\r
\r
Cada termino debe preservar la unidad declarada para [[C]] o para su cantidad asociada. La comprobacion es fisica: una unidad incorrecta significa que la expresion formal ya no representa el mismo modelo.\r
\r
...
## Contexto\r
\r
Un profesor compara dos soluciones del mismo problema de mecanica avanzada. Una solucion es mas corta; la otra comprueba explicitamente la estructura de Transformaciones canonicas. La segunda se prefiere porque demuestra que la simplificacion no cambio el sistema fisico.\r
\r
## Estimacion fisica\r
\r
...
## Interpretacion\r
\r
Fisicamente, el ejemplo muestra que la mecanica avanzada es un lenguaje diagnostico. Ayuda a decidir si un resultado es valido, preservado, equivalente, separable o coherente. Por eso [[C]] debe interpretarse, no solo calcularse.\r
\r
En una correccion de examen, el profesor debe buscar tres evidencias: que el alumno no confunde cambio de notacion con transformacion canonica, que obtiene las variables nuevas desde la generatriz y que revisa la condicion de preservacion. Si el hamiltoniano cambia por dependencia temporal, esa correccion debe interpretarse como parte del modelo, no como error.\r
\r
...
\r
Para completar el ejemplo, conviene pedir una verificacion verbal final: que variables se abandonan, que variables se introducen y que condicion demuestra que el flujo conserva forma hamiltoniana. Esta verificacion evita que el alumno trate cualquier sustitucion como cambio canonico. Tambien permite comparar dos soluciones: la mejor es la que conserva reconstruccion e interpreta el hamiltoniano transformado.\r
\r
\r
## Extension didactica del ejemplo\r
\r
El ejemplo tambien puede ampliarse pidiendo al alumno que proponga un cambio no canonico parecido al correcto. Al compararlos, se ve que dos sustituciones pueden simplificar la expresion y, sin embargo, solo una conserva la forma de las ecuaciones. Esta comparacion es muy eficaz para docencia avanzada porque muestra que el criterio canonico no es burocratico. Es la frontera entre describir el mismo sistema con mejores variables o construir sin querer otro sistema. La extension obliga a justificar reversibilidad, generatriz, corchetes y significado del hamiltoniano transformado.\r
`;export{e as default};
