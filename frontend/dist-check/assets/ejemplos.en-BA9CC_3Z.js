...
\r
The translation uses the relation \`x = r cos(theta), y = r sin(theta), r = sqrt(x^2+y^2)\`. The known datum is placed in its geometric role: magnitude, radius, hypotenuse, leg, arc, component, or coordinate. If the angle is measured from another axis, the function used may change.\r
\r
...
## Given result\r
\r
Suppose an expression such as \`x = r cos(theta), y = r sin(theta), r = sqrt(x^2+y^2)\` appears already written in a solution. The inverse question is: what geometry must have existed for that expression to be reasonable?\r
\r
