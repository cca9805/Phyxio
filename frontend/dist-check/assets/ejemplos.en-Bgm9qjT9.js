...
The system is the rotating coil and its mechanical shaft. The relevant physical interaction is the variation of [[Phi_B]] as the coil rotates in the field. The electrical output is first interpreted as ideal [[epsilon_0]] and then as useful [[P_elec]] when losses are included through [[eta]].

## Physical model

We use an ideal sinusoidal generator model for peak emf and a mean Faraday reading for the flux-change test. The model includes [[N]], [[B]], [[A]], [[omega]], [[DeltaPhi_B]], [[Delta_t]], [[P_mec]], and [[eta]]. Useful power is computed after induction, because induced voltage and delivered power are not the same quantity.
...
Efficiency compares useful output with mechanical input:
...
Multiplying 200 turns by 0.25 T and by 0.015 m² gives 0.75 Wb. Therefore [[Phi_B]] ≈ 0.75 Wb.
...
The efficiency of 78 % is used as the fraction 0.78. Multiplying 0.78 by 85 W gives 66.3 W. Therefore [[P_elec]] ≈ 66.3 W.

## Dimensional validation

The product of turns, tesla, and square metre gives weber, with dimension \`[M L² T⁻² I⁻¹]\`, consistent with [[Phi_B]].

Multiplying weber by angular speed expressed per second gives volt, with dimension \`[M L² T⁻³ I⁻¹]\`, consistent with [[epsilon_0]].

Dividing flux change by time also gives volt. Efficiency is dimensionless, and useful power keeps dimension \`[M L² T⁻³]\`.
...
The useful power of 66.3 W means that part of the 85 W mechanical input is lost. Physically, those losses may be friction, winding heating, or magnetic losses. If [[eta]] decreased, [[P_elec]] would fall even if the ideal coil emf did not change.
