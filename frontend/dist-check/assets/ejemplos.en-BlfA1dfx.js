...
\r
The translation uses the relation \`theta = s/r, s = r theta, omega = Delta theta / Delta t\`. The known datum is placed in its geometric role: magnitude, radius, hypotenuse, leg, arc, component, or coordinate. If the angle is measured from another axis, the function used may change.\r
\r
...
## Given result\r
\r
Suppose an expression such as \`theta = s/r, s = r theta, omega = Delta theta / Delta t\` appears already written in a solution. The inverse question is: what geometry must have existed for that expression to be reasonable?\r
\r
