...
{{f:dv}}\r
\r
The symbolic solution begins with the direct reading. Using p, the velocity change follows from the natural logarithm of the mass ratio multiplied by the exhaust speed. If the unknown is the admissible final mass, then p_solve_mf and the derived formula [[mf]] rewrite the problem as a decaying exponential. If the question is reversed again, namely which initial mass is needed to obtain a given velocity change while preserving a chosen final mass, then m0_from_p becomes the useful tool. And if the hard constraint is not mass but the available engine, p converts the mission requirement into a propulsion requirement. That variety of rearrangements is central to the leaf: the equation is not merely descriptive, it is a design instrument.\r
\r
## Numerical substitution\r
\r
In the direct scenario, with [[m0]] equal to 1200 kg, [[mf]] equal to 800 kg, and [[ve]] equal to 2500 m/s, the mass ratio is 1.5. Applying \`p\`, the natural logarithm of 1.5 is about 0.405, so the velocity change is roughly 1014 m/s. The maneuver is moderate and does not consume the whole propellant reserve.\r
\r
In the inverse scenario, a velocity change of 1500 m/s is demanded with the same engine and the same initial mass. Using \`p_solve_mf\`, one gets a final mass close to 659 kg. That means the desired maneuver would require ending with substantially less remaining mass than in the base case.\r
\r
If [[mf]] equal to 800 kg had to be preserved and a velocity change of 1500 m/s were still required, \`m0_from_p\` gives an initial mass of approximately 1458 kg. And if neither the initial nor the final mass could change, \`p\` would require an exhaust speed of about 3700 m/s. That figure already points to a more efficient propulsion system than the initially available one.\r
\r
## Dimensional validation\r
\r
Dimensional validation checks that [[DeltaV]] and [[ve]] remain in m/s, while [[m0]] and [[mf]] remain in kg. It also requires reviewing physical restrictions that are more than algebraic: one must have [[m0]] greater than [[mf]], [[mf]] greater than zero, and the logarithm must act on a dimensionless mass ratio. If a calculation returned [[mf]] larger than [[m0]], that would not be a small arithmetic slip; it would show that the physical meaning of the maneuver or the exponent sign has been mishandled.\r
\r
