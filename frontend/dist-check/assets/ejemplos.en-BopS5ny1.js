...
There is also a safety implication: higher force under poor geometry raises injury and tool-slip risk. A robust procedure combines quick torque estimation, tool-limit verification, and ergonomic adjustment. In this way, torque becomes a decision criterion in real field work, not just a classroom calculation.\r
`;export{e as default};
