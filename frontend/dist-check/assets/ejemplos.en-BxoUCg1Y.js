...
The mechanical impedance model for plane waves is applied using the fundamental formula [[Z_mec]] = [[rho]] · [[c_s]] · [[A_sec]], followed by the velocity amplitude reflection [[R_Z]] and transmission [[T_Z]] coefficients. Transmitted power is calculated as a fraction of incident power.
...
For medium 1 (steel): [[Z_mec]]₁ = [[rho]]₁ · [[c_s]]₁ · [[A_sec]]₁

For medium 2 (aluminium): [[Z_mec]]₂ = [[rho]]₂ · [[c_s]]₂ · [[A_sec]]₂
...
Power fraction transmitted: η = (Z₁/Z₂) · [[T_Z]]² = 1 - [[R_Z]]²

## Numerical substitution

For [[Z_mec]]₁ (steel), multiply 7900 kg/m³ by 5790 m/s by 4.91 × 10⁻⁴ m². This gives approximately 22 460 kg/s. Therefore [[Z_mec]]₁ ≈ 22 460 kg/s.

For [[Z_mec]]₂ (aluminium), multiply 2700 kg/m³ by 6320 m/s by 9.00 × 10⁻⁴ m². This gives approximately 15 340 kg/s. Therefore [[Z_mec]]₂ ≈ 15 340 kg/s.

For [[R_Z]], the difference (15340 - 22460) divided by the sum (15340 + 22460) gives approximately -0.188. Therefore [[R_Z]] ≈ -0.188.

For [[T_Z]], twice Z₂ (30680) divided by the sum (37800) gives approximately 0.812. Consistency check: 1 + (-0.188) = 0.812 ✓. Therefore [[T_Z]] ≈ 0.812.
...
- [[Z_mec]]: density times velocity times area gives \`[M L⁻³] · [L T⁻¹] · [L²] = [M T⁻¹]\` which corresponds to kg/s ✓
- [[R_Z]]: ratio of two impedances gives \`[M T⁻¹] / [M T⁻¹] = [1]\` dimensionless, as expected for a reflection coefficient ✓
- [[T_Z]]: same dimensional structure as [[R_Z]], also dimensionless \`[M T⁻¹] / [M T⁻¹] = [1]\` ✓
...
The ideal matching layer impedance must be the geometric mean of both media impedances. The square root of the product 34 × 46 gives approximately 39.5 MRayl (working with specific impedances). To convert to total mechanical impedance [[Z_mec]], multiply by the active transducer section. A piezoelectric disc of 10 mm diameter has [[A_sec]] of about 78.5 mm², giving a crystal mechanical impedance of approximately 34 × 10⁶ × 78.5 × 10⁻⁶ ≈ 2670 kg/s.

Without matching layer, calculating [[R_Z]] as the difference (46 minus 34) divided by the sum (46 plus 34) yields a reflection coefficient of approximately 0.15. The reflected power is the square of that value, amounting to 2.3% loss.
