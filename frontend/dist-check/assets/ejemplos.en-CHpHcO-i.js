...
- Electric oven: [[P]]_oven = 2200 W
- Microwave: [[P]]_micro = 1200 W
- Coffee maker: [[P]]_coffee = 800 W
- Additional toaster (part d): [[P]]_toast = 1000 W
- Grid voltage: [[V]] = 230 V
- Circuit protection: [[I]]_max = 16 A
...
The parallel connection implies that all appliances share the same potential difference [[V]] = 230 V, while the total current [[I]]_total is the algebraic sum of individual currents consumed by each load.
...
Where [[R]]_eq is the equivalent resistance of the set, and [[R]]₁, [[R]]₂, [[R]]₃ are the individual resistances of each appliance.
...
[[P]]_total = [[P]]_oven + [[P]]_micro + [[P]]_coffee

**(b) Total current**

Applying the power equation [[P]] = [[V]]·[[I]], we solve for current:

[[I]]_total = [[P]]_total / [[V]]

**(c) Equivalent resistance**

First we calculate individual resistances of each appliance using [[R]] = [[V]]² / [[P]]:

- [[R]]_oven = [[V]]² / [[P]]_oven
- [[R]]_micro = [[V]]² / [[P]]_micro
- [[R]]_coffee = [[V]]² / [[P]]_coffee

Then we apply the parallel resistance formula to obtain [[R]]_eq.

**(d) With additional toaster**

The new total power includes the toaster:

[[P]]_new = [[P]]_total + [[P]]_toast

The new current is calculated by dividing [[P]]_new by [[V]].

**(e) Energy consumed over 2 hours of normal use**

Accumulated energy [[E_kWh]] over a time [[t_h]] is obtained with:
...
[[P]]_total ≈ 4200 W (4.2 kW)

**(b) Total current calculation**

Dividing [[P]]_total by [[V]]: 4200 W divided by 230 V gives approximately 18.26 A.
...
For the oven: squaring 230 V and dividing by 2200 W gives approximately 24.0 Ω. Therefore [[R]]_oven ≈ 24.0 Ω.

For the microwave: squaring 230 V and dividing by 1200 W gives approximately 44.1 Ω. Therefore [[R]]_micro ≈ 44.1 Ω.

For the coffee maker: squaring 230 V and dividing by 800 W gives approximately 66.1 Ω. Therefore [[R]]_coffee ≈ 66.1 Ω.

Applying the parallel formula (inverse of the sum of inverses):

[[R]]_eq ≈ 12.6 Ω

Verification: dividing [[V]] (230 V) by [[I]]_total (18.26 A) also gives approximately 12.6 Ω.

**(e) Energy consumed over 2 [[t_h]] with three appliances running**

Multiplying [[P]]_total (4.2 kW) by [[t_h]] (2 h):

[[E_kWh]] ≈ 8.4 kWh (approximately €1.26 at average tariff of €0.15/kWh).
...
[[P]]_new ≈ 5200 W (5.2 kW)

New total current:

Dividing new total power by [[V]]: 5200 W divided by 230 V.

[[I]]_new ≈ 22.6 A

## Dimensional validation

For the power equation ([[P]] equal to [[V]] times [[I]]):
...
For the resistance equation ([[R]] equal to [[V]] squared divided by [[P]]):
...
- Conductance units (1/[[R]]): \`[M⁻¹ L⁻² T³ I²]\` (siemens)
...
To diagnose María's problem, we apply the fundamental power and current relationships from this leaf. In addition to current, we calculate the energy [[E_kWh]] consumed during breakfast (approximately 15 minutes, or 0.25 [[t_h]]) to quantify the economic impact.
...
Dividing [[P]]_total by [[V]]: 4150 W divided by 230 V.
...
The [[E_kWh]] consumed during that 0.25 [[t_h]] breakfast is calculated with the energy formula:

{{f:energia}}

[[P]]_kW × [[t_h]] = 4.15 kW × 0.25 h ≈ 1.04 kWh (approximately €0.16 at average tariff).
...
Current [[I]] ≈ 8.5 A (within safe margin < 16 A)
...
Current [[I]] ≈ 13.7 A (within acceptable margin, though high)
...
Maximum current [[I]] ≈ 10.2 A (comfortable and safe margin)
