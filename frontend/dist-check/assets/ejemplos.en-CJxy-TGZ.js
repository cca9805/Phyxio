...
The first sphere acts as [[q1]] (source charge) and the second as [[q2]] (receiving charge). The distance [[r]] is the separation between centres.

## Physical model

The applicable model is **Coulomb's law for point charges** in vacuum. The core magnitudes are [[q1]], [[q2]] and [[r]], and the result magnitude is [[F_C]]. The electric field [[E_C]] created by [[q1]] at the location of [[q2]] is calculated using the second formula of the leaf.
...
Applying Coulomb's law to obtain [[F_C]]:
...
In this calculation [[q1]] is the source charge and [[r]] is the same separation distance. The result [[E_C]] is positive because [[q1]] is positive (the field points outward from [[q1]]).
...
Dividing: [[F_C]] is approximately −215.7×10⁻³ / 0.0144, giving [[F_C]] ≈ −15.0 N.

For the electric field: the numerator is 8.988×10⁹ × 4.0×10⁻⁶, giving approximately 35952 N·m²/C. Dividing by (0.12)² gives [[E_C]] ≈ 35952 / 0.0144 ≈ 2496 kN/C, that is, [[E_C]] ≈ 2.50×10⁶ N/C.

## Dimensional validation

For [[F_C]]: the constant [[k_e]] has units \`[M L³ T⁻⁴ I⁻²]\`, each charge has units \`[I T]\`, and the squared distance has units \`[L²]\`. The quotient gives \`[M L³ T⁻⁴ I⁻²] · [I T]² / [L²]\`, which reduces to \`[M L T⁻²]\`, that is, newtons. ✓

For [[E_C]]: the quotient gives units \`[M L³ T⁻⁴ I⁻²] · [I T] / [L²]\`, which reduces to \`[M L T⁻³ I⁻¹]\`, that is, N/C. ✓

## Physical interpretation

The result [[F_C]] ≈ −15.0 N indicates that the force is **attractive**: the second sphere is pulled towards the first with an intensity of 15 N. This value is considerable: it is equivalent to supporting a weight of approximately 1.5 kg. For charges of only a few microcoulombs at 12 cm distance, this result illustrates the enormous strength of the electric force compared to gravity at laboratory scale.
...
The electric field [[E_C]] ≈ 2.50×10⁶ N/C is a property of the first sphere at that point in space, independent of the second. If [[q2]] were doubled (−12 µC instead of −6 µC), [[F_C]] would also double (≈ −30.0 N), but [[E_C]] would not change because it depends only on [[q1]] and [[r]]. This difference between [[F_C]] and [[E_C]] is the conceptual core of the leaf.
...
Converting: [[q1]] of the electrode equals 2.0×10⁻⁴ C; [[q2]] of the particle equals −5.0×10⁻¹⁰ C; [[r]] of 5 cm equals 0.05 m.

Applying Coulomb's law: the numerator is 8.988×10⁹ × 2.0×10⁻⁴ × (−5.0×10⁻¹⁰), giving approximately −8.988×10⁻⁴ N·m². The denominator is (0.05)², that is, 2.5×10⁻³ m². The force [[F_C]] is of order −8.988×10⁻⁴ / 2.5×10⁻³, giving [[F_C]] ≈ −0.36 N.
...
If the distance [[r]] were halved (2.5 cm), [[F_C]] would quadruple (≈ 1.44 N), increasing the acceleration by the same factor. This quadratic behaviour **describes** how tapered or convergent-geometry electrodes concentrate the force in the capture zone.
`;export{e as default};
