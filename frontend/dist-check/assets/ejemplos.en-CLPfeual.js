...
- Frequency: 440 Hz
- Amplitude: 3 mm equivalent to 3×10⁻³ m
...
From this relation, energy density is obtained by dividing flux by propagation velocity; for the ideal string it equals the average energy factor of the string model without the [[v]] factor.

For the total power transported we apply:

{{f:potencia_desde_flujo}}

Where [[A_seccion]] in a one-dimensional string is interpreted as the effective length intercepting the flux. In this context, total power along the string is calculated by considering that the flux is distributed over that extension.
