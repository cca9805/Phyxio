...
\r
A signal is reduced by half every fixed interval. The question is how much remains after several intervals.\r
\r
...
\r
The tool is exponential because change occurs by factor, not by constant subtraction. If each interval keeps 1/2, the quantity is multiplied repeatedly.\r
\r
...
\r
After n intervals, N = N0 (1/2)^n remains. If n = 3, N0/8 remains. If N/N0 is known and n is requested, a logarithm is used.\r
\r
...
\r
The result means remaining fraction. It is not linear loss: early intervals remove more absolute amount than later intervals.\r
\r
...
## Given result\r
\r
If ln(N0/N) appears, the natural physical question is how long an exponential decay takes to reach a given fraction.\r
\r
...
\r
Solve the same setup after changing one input by a factor \`10\` or \`1/10\`. Observe whether the result changes linearly, inversely, through a power, or through an accumulated factor. That comparison reveals the real structure of logarithms and exponentials.\r
\r
## Advanced level\r
\r
