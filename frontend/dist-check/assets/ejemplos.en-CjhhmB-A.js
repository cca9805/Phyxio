...
Two small metallic spheres of negligible mass are fixed on a horizontal plane. The first sphere carries a charge [[q1]] of 4.0 μC and the second carries a charge [[q2]] of −6.0 μC. The separation between the centres of the spheres is [[r12]] of 8.0 cm. Determine the magnitude of the Coulomb force exerted by each sphere on the other. State whether the force is attractive or repulsive and estimate how much the magnitude of [[F_C]] would change if the distance were reduced to half.
...
The system consists of two point charges at rest on a horizontal axis. The separation of 8.0 cm is much larger than the size of the spheres, so the point charge hypothesis is valid. The magnitude of [[F_C]] on either sphere is requested (by Newton's third law, both magnitudes are equal).
...
The applicable model is Coulomb's law for point charges in vacuum. The relevant magnitudes are [[q1]], [[q2]], [[r12]] and [[k_e]]. The formula gives the magnitude of [[F_C]], which is always positive; the character of the interaction is determined separately by comparing the signs of the charges.
...
The expression for the magnitude of the Coulomb force is the leaf formula. Solving directly for [[F_C]]:
...
Dividing [[F_C]] by [[q2]] also yields the electric field [[E_C]] that [[q1]] creates at the position of [[q2]]:

{{f:campo_electrico_coulomb}}

For the second part of the problem, reducing [[r12]] to half (to 4.0 cm) with the same charges: since [[r12]] enters squared in the denominator, halving [[r12]] divides the denominator by four, quadrupling [[F_C]].
...
Dividing: 0.2157 divided by 6.4 × 10⁻³ results in approximately 33.7. Thus [[F_C]] ≈ 33.7 N.
...
With the result of [[F_C]] it is also possible to compute the electric field [[E_C]] that [[q1]] creates at the position of [[q2]]:

{{f:campo_electrico_coulomb}}

Substituting [[q1]] of 4.0 × 10⁻⁶ C and [[r12]] of 8.0 × 10⁻² m gives [[E_C]] ≈ 5.62 × 10⁶ N/C at that position. This field is independent of [[q2]]: if a different charge were placed at that point, [[E_C]] would not change.

The result [[F_C]] ≈ 33.7 N indicates an attractive force of nearly 34 Newtons between the two spheres. This is a considerable force for a laboratory system: equivalent to the weight of approximately 3.4 kg. The reason it is so intense is the combination of several-microcoulomb charges — which require an electrostatic machine to achieve — at a separation of only 8 cm.
...
Applying Coulomb's law with the problem values, the magnitude of [[F_C]] is:
...
Divided by the square of [[r12]] (0.05 m)², which equals 2.5 × 10⁻³, this gives [[F_C]] ≈ 3.6 × 10⁻⁸ N.
...
The efficiency of an electrostatic precipitator depends crucially on the inverse-square dependence of [[F_C]] on [[r12]]. When the particle is still far from the electrode (several centimetres), the Coulomb force is small and the particle advances slowly. As it approaches, the force grows with the inverse square of the distance: when [[r12]] is halved, the force quadruples, and the acceleration towards the electrode increases rapidly.
