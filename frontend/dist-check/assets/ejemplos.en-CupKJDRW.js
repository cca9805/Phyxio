...
The system is an insulating sphere with uniform volumetric charge distribution. The spherical symmetry of the distribution allows the choice of concentric spherical Gaussian surfaces. Each spherical Gaussian surface guarantees that [[E_G]] is constant in magnitude and perpendicular to the surface at every point, enabling direct application of the Gaussian field formula.

For the exterior point (r₁ > R): the Gaussian surface is a sphere of radius r₁ that completely encloses the charge Q. The enclosed charge [[Q_enc]] equals the total charge: 4.8×10⁻⁶ C.

For the interior point (r₂ < R): the Gaussian surface is a sphere of radius r₂ that encloses only the fraction of charge contained in that sphere. Since the distribution is uniform, [[Q_enc]] is proportional to volume and scales with the cube of the relative radius with respect to R.

## Physical model

The model is based on Gauss's law with perfect spherical symmetry. The formula that extracts [[E_G]] from the flux integral is applied:
...
The model hypotheses are: spherically symmetric charge distribution, vacuum (permittivity [[epsilon_0]]), and charges at rest. Spherical symmetry guarantees that [[E_G]] is constant over any concentric sphere, validating the extraction of the field from the integral.
...
The enclosed charge [[Q_enc]] equals the total charge Q. The Gaussian surface area [[A_G]] is four times pi times the square of r₁.
...
The exterior field grows with [[Q_enc]] and decreases with the square of [[A_G]], that is, with the square of r₁. This behaviour is identical to that of a point charge of value Q at the centre.

**Interior point (r₂ < R):**

The enclosed charge [[Q_enc]] is the volumetric fraction of Q that fits inside a sphere of radius r₂. Since the charge density is uniform, [[Q_enc]] scales with the cube of the relative radius.

The Gaussian surface area [[A_G]] is four times pi times the square of r₂. The resulting interior field grows linearly with r₂ and decreases with R cubed.

## Numerical substitution

**Exterior point (distance 0.25 m):**

Dividing [[Q_enc]] by [[epsilon_0]], the flux is 4.8×10⁻⁶ / 8.854×10⁻¹². The result, near 5.42×10⁵ N·m²·C⁻¹, is the value of [[Phi_E]] for the exterior point.

Exterior Gaussian area [[A_G]]: four times pi times 0.0625 m² gives approximately 0.785 m².

Exterior field: dividing [[Phi_E]] by [[A_G]], the result is 5.42×10⁵ / 0.785, near 6.91×10⁵ N/C. That is the value of [[E_G]] at the exterior point.
...
Interior enclosed charge: multiplying 4.8×10⁻⁶ by (0.08/0.15)³ (approximately 0.1521) gives near 7.30×10⁻⁷ C. That is the value of [[Q_enc]] for the interior point.

Interior Gaussian area [[A_G]]: four times pi times 0.0064 m² gives approximately 0.0804 m².

Interior flux: dividing 7.30×10⁻⁷ by [[epsilon_0]], the result is near 8.24×10⁴ N·m²·C⁻¹. That is the value of [[Phi_E]] for the interior point.

Interior field: dividing [[Phi_E]] by [[A_G]] gives 8.24×10⁴ / 0.0804, near 1.03×10⁶ N/C. That is the value of [[E_G]] at the interior point.

## Dimensional validation

Flux [[Phi_E]]: \`[I T] / [M⁻¹ L⁻³ T⁴ I²]\` reduces to \`[M L³ T⁻³ I⁻¹]\`, equivalent to N·m²·C⁻¹ ✓

Field [[E_G]]: \`[I T] / ([M⁻¹ L⁻³ T⁴ I²] · [L²])\` reduces to \`[M L T⁻³ I⁻¹]\`, equivalent to N/C ✓
...
The interior field calculated (near 1.03×10⁶ N/C at 0.08 m from the centre) is larger than the exterior, which may seem surprising. This occurs because, although [[Q_enc]] decreases with the cube of the radius, [[A_G]] decreases with the square, and the area decay rate dominates for small radii inside the sphere, increasing [[E_G]]. As the distance increases toward R, the interior field approaches the field value at the sphere's surface.
...
We consider a conducting tip approximated as a sphere of radius 5 mm (equivalent to 5×10⁻³ m), charged to a high potential. In lightning rod design, the charge [[Q_enc]] accumulated before discharge can be of the order of 1 μC.
...
Dividing [[Q_enc]] by [[epsilon_0]], the flux is 10⁻⁶ / 8.854×10⁻¹², near 1.13×10⁵ N·m²·C⁻¹. That is the value of [[Phi_E]]. Dividing [[Phi_E]] by the surface area [[A_G]] of 3.14×10⁻⁴ m² gives near 3.6×10⁸ N/C. That is the value of [[E_G]], which is more than a hundred times the breakdown field of air.
