...
- Flux change [[DeltaPhi_B]]: increase of 0.0040 Wb.
- Interval [[Deltat]]: 0.050 s.
- Number of turns [[N]]: 1.
...
The system is a closed loop. The surface is the one enclosed by the loop, and the positive normal points toward the magnet. With that convention, approaching the magnet increases [[Phi_B]], so the change has positive sign.

## Physical model

Lenz's law is used in the average Faraday form. Induced emf must have sign opposite to the flux increase. If current flows, its associated magnetic field must try to slow the increase of [[Phi_B]].

## Model justification

The statement fixes the three pieces that make Lenz applicable: a surface enclosed by the loop, a positive normal pointing toward the magnet, and an increase of [[Phi_B]] during [[Deltat]]. With these references, the problem is not ambiguous: flux change is positive and the induced response must have the opposite sign.
...
First compute the average rate of change:
...
Flux increases by 0.0040 Wb in 0.050 s. The average rate of change has magnitude 0.080 Wb/s and positive sign relative to the chosen normal.

Because [[N]] is 1, the average magnitude of [[epsilon_ind]] is 0.080 V. The sign of emf is negative relative to the positive reference associated with flux increase, because Lenz requires opposition to the change.
...
Weber divided by second produces volt, coherent with [[epsilon_ind]]. [[N]] is dimensionless and does not change units. The sign rule uses [[s_flujo]] and [[s_ind]] only as conceptual indicators.
...
If the chosen normal is reversed, the written signs of [[DeltaPhi_B]] and [[epsilon_ind]] change, but the physical conclusion does not. The face of the loop still opposes the approaching magnet. This check prevents confusing mathematical convention with real physical direction.
