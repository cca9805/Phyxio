...
The system is a monochromatic electromagnetic wave passing from vacuum into glass. The reference quantities are [[c]] and [[lambda0]]. The material quantities are [[n]], [[epsilon_r]], and [[mu_r]]. The quantities to be read inside the glass are [[v_m]] and [[lambda_m]].
...
The model is propagation in a linear, homogeneous, isotropic medium. In this model [[n]] summarizes the effective electromagnetic response and allows [[v_m]] to be calculated from [[c]]. It also converts [[lambda0]] into [[lambda_m]].
...
For the phase speed inside the medium, use the relation between [[c]], [[n]], and [[v_m]]:
...
For the wavelength inside glass, relate [[lambda0]], [[n]], and [[lambda_m]]:

{{f:longitud_onda_en_medio}}

The expected physical order is clear before substitution: with an index above one, [[v_m]] must be smaller than [[c]] and [[lambda_m]] must be smaller than [[lambda0]].
...
In the material reading, [[epsilon_r]], [[mu_r]], and [[n]] are dimensionless. The operation combines relative medium responses and produces another unitless number.
...
For a vacuum wavelength of 1550 nm and a core index near 1.45, the wavelength inside the core is of order 1070 nm. The phase speed is of order 2.1×10⁸ m/s, clearly smaller than [[c]] but still enormous on a human scale.
