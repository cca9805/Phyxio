...
## Given result\r
\r
Suppose an expression such as \`sin(theta)=opuesto/hipotenusa, cos(theta)=adyacente/hipotenusa, tan(theta)=opuesto/adyacente\` appears already written in a solution. The inverse question is: what geometry must have existed for that expression to be reasonable?\r
\r
