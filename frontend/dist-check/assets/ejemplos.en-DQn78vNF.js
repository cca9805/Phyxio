...
- Poisson ratio: 0.30
- Hydrostatic pressure change for volumetric check: [[DeltaP]] of 50 MPa
- Measured relative volume change: [[DeltaV_rel]] of -3.7 times ten to the minus four
...
The model is based on Hooke law for an isotropic solid under uniaxial tension. The core leaf magnitudes are [[E_young]], [[nu_poisson]] and [[G_shear]], connected by the fundamental relationship between moduli. The applied [[sigma]] produces a longitudinal [[epsilon]] and a transverse [[epsilon_transv]] coupled by [[nu_poisson]]. The [[G_shear]] is obtained from [[E_young]] and [[nu_poisson]] through the thermodynamic isotropic relation.
...
If the same steel were subjected to a tangential test, the shear stress [[tau]] would be the applied load and the angular strain [[gamma]] would be the observable response associated with [[G_shear]]; here the shear modulus is computed by isotropic coherence, not by a direct shear measurement.

As an independent volumetric check, the bulk modulus relation is used between pressure change [[DeltaP]] and relative volume change [[DeltaV_rel]]:
...
For the shear modulus, dividing 200 GPa by the product of 2 times (1 plus 0.30), that is dividing by 2.60, gives approximately 76.9 GPa. Therefore [[G_shear]] ≈ 76.9 GPa.

For the volumetric check, dividing the pressure change [[DeltaP]] of 50 MPa by the absolute value of [[DeltaV_rel]] gives approximately 135 GPa. Therefore [[K_bulk]] remains in the expected order for steel, without contradicting the tensile response.
...
From the velocities and density, the shear modulus is obtained as the product of density and the square of transverse velocity. Multiplying 2700 kg/m³ by the square of 3100 m/s (9.61×10⁶ m²/s²) gives approximately 25.9 GPa. Therefore [[G_shear]] ≈ 25.9 GPa.
...
The bulk modulus is obtained by subtracting four-thirds of [[G_shear]] from the plane-wave modulus. Subtracting 34.6 GPa from 108.9 GPa gives approximately 74.3 GPa. Therefore [[K_bulk]] ≈ 74.3 GPa.
...
Finally, [[E_young]] is obtained through the fundamental relation, multiplying 2 by [[G_shear]] by the sum of 1 plus [[nu_poisson]], which gives approximately 69.5 GPa.
