...
The static LHI model is applied: [[C_d]] = [[epsilon_r]] · [[C_0]] and [[E_d]] = external field / [[epsilon_r]]. The core magnitudes of this leaf are [[C_d]], [[epsilon_r]], [[C_0]], [[E_d]], and [[P_pol]]. The validity condition is that [[E_d]] must remain below the breakdown field of the material; [[P_pol]] can be derived from [[E_d]] and [[epsilon_r]] but is not a direct input in this example.
...
Part (a): The capacitance with dielectric is obtained by multiplying [[C_0]] by [[epsilon_r]]:

{{f:capacitancia_dielectrico}}

Part (b): The stored charge is obtained by multiplying [[C_d]] by the applied voltage. Using the definition of capacitance, the charge is the product of capacitance and voltage.
...
Part (d): The safety condition requires [[E_d]] to be much smaller than the breakdown field of the material.

Part (e): The volumetric polarisation of the material is obtained from [[E_d]] and the susceptibility factor ([[epsilon_r]] minus one):

{{f:polarizacion_dielectrico}}

## Numerical substitution

Part (a): Multiplying 4.5 by 20 pF gives 90 pF. Therefore [[C_d]] ≈ 90 pF.

Part (b): Multiplying 90 pF by 100 V gives 9000 pC, equivalent to 9 nC. The stored charge is approximately 9 nC.

Part (c): The vacuum external field is 100 V divided by 2 mm, giving 50 000 V/m or 50 kV/m. Dividing by [[epsilon_r]] = 4.5 gives approximately 11 111 V/m, that is, about 11.1 kV/m. Therefore [[E_d]] ≈ 11.1 kV/m.

Part (d): The breakdown field of the material is 10 MV/m, equivalent to 10 000 kV/m. The operating field [[E_d]] ≈ 11.1 kV/m represents only 0.11 % of that limit, well below the 20 % safety margin. The capacitor operates in the safe regime with no risk of dielectric breakdown.

Part (e): The permittivity of vacuum is 8.85 × 10⁻¹² F/m. The susceptibility factor is 4.5 minus 1, that is 3.5. Multiplying 8.85 × 10⁻¹² F/m by 3.5 and by 11 111 V/m gives [[P_pol]] ≈ 344 × 10⁻¹² C/m², equivalent to approximately 344 pC/m².

## Dimensional validation

Part (a): The expression [[C_d]] = [[epsilon_r]] · [[C_0]] combines a dimensionless factor with farads, yielding farads. Expressing in fundamental SI units, the farad has dimension C²·s²/(kg·m²); multiplying by a dimensionless quantity does not alter the dimensions \`[M⁻¹ L⁻² T⁴ I²]\` ✓

Part (c): For [[E_d]], the relation is voltage over length divided by a dimensionless quantity. The volt decomposes into kg·m²·A⁻¹·s⁻³; divided by metres this yields kg·m·A⁻¹·s⁻³, which are the correct units of the electric field \`[M L T⁻³ I⁻¹]\` ✓
...
The interior field [[E_d]] ≈ 11.1 kV/m is 4.5 times smaller than the field that would exist in vacuum (50 kV/m). This reduction is the macroscopic manifestation of polarisation: the dipoles in the material create an opposing field that attenuates the free field. The fact that the operating field is only 0.11 % of the breakdown voltage indicates that the design is extremely conservative and that the operating voltage could be increased by a factor of up to 900 before reaching the material's failure limit.

If [[epsilon_r]] were increased while keeping the geometry fixed, [[C_d]] would grow linearly and [[E_d]] would decrease proportionally. However, materials with very high [[epsilon_r]] (such as barium titanate) typically have higher loss factors, stronger temperature dependence, and greater non-linearity, which limits their use to applications where compactness is the priority over stability.
...
To obtain [[C_d]] = 100 nF with [[C_0]] = 10 nF, an [[epsilon_r]] of approximately 10 is needed. Candidates with [[epsilon_r]] between 8 and 15 are polypropylene ([[epsilon_r]] ≈ 2.2, insufficient), polyester/PET ([[epsilon_r]] ≈ 3.3, insufficient), mica ([[epsilon_r]] ≈ 7, borderline), alumina ([[epsilon_r]] ≈ 10, suitable), and standard glass ([[epsilon_r]] ≈ 8).

At 100 kHz, polypropylene has minimal losses (dissipation factor below 0.0005) and alumina has moderate losses (dissipation factor around 0.001). For the 400 V operating voltage, the field [[E_d]] in the capacitor with a 1 mm separation would be 400 kV/m divided by [[epsilon_r]]: for alumina with [[epsilon_r]] = 10, the interior field is 40 kV/m, compared to a breakdown voltage of 13 MV/m. The safety margin is more than 300 times, acceptable.
