...
For the particular case of the first harmonic, [[n]] is 1 and the fundamental appears:
...
To obtain the fundamental frequency [[f_1]], divide the velocity [[v]] (312 m/s) by twice the length [[L]] (1.30 m), using the first harmonic [[n]] equal to 1

**Part b) Fifth harmonic**

For the fifth harmonic, [[n]] is 5. Using the general relation:
...
Where the harmonic number [[n]] multiplies the fundamental [[f_1]] to give the desired harmonic frequency
...
The wavelength of the fifth harmonic [[lambda_n]] results from dividing twice the string length [[L]] by the harmonic number [[n]] (five)
...
The new fundamental frequency [[f_1]] is calculated with the new length [[L]] in the denominator, keeping velocity [[v]] and harmonic number [[n]] equal to 1 constant
...
For the fifth harmonic, multiply 5 by the fundamental frequency. With [[f_1]] ≈ 240 Hz, the general magnitude [[f_n]] takes approximately 1200 Hz when [[n]] is five.

{{f:longitud_onda_armonica}}

For the wavelength, divide twice the length (1.30 m) by 5, giving approximately 0.26 m.

For [[n]] equal to five, [[lambda_n]] ≈ 0.26 m (26 cm).
...
If the string tension were increased (turning the tuning peg), velocity [[v]] would increase raising all frequencies proportionally, allowing the instrument to be tuned.
