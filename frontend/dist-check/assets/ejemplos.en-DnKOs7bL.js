...
(a) The wave propagation velocity [[v]] and the corresponding wavelength.
...
The fundamental magnitudes are energy density [[u_energia]] which varies spatially and temporally, total energy per cycle [[E_onda]], and transported power [[P_onda]]. The relationship between them is governed by wave energy transport formulas.
...
(a) The propagation velocity [[v]] on a string under tension is obtained from the tension divided by the linear density, in square root. Wavelength results from dividing [[v]] by the frequency, or equivalently multiplying [[v]] by the characteristic angular period.
...
Alternatively, it can be obtained as [[E_onda]]·v/[[lambda]], which is equivalent.
...
(a) Propagation velocity [[v]] calculated from tension and linear density: the square root of the quotient between 800 N and 5.0 thousandths of kg/m gives approximately 400 m/s. Wavelength results from the quotient between [[v]] and the frequency of 440 Hz, obtaining approximately 0.91 m.

(b) Total energy in one cycle:

To apply the formula, we first evaluate the individual factors. The square of the angular frequency results in approximately 7.645 × 10⁶ rad²/s². The square of the amplitude gives 9.0 × 10⁻⁶ m². Multiplying the linear density by these factors yields approximately 344 J/m. Finally, applying the total energy formula with the half factor and the wavelength, the result is approximately 156 J.
...
The factors are the same up to the square of the amplitude, but now we multiply by [[v]] instead of half the wavelength. This gives approximately 1.38 × 10⁵ W. Applying the half factor, the power results in approximately 69 kW. The alternative verification using total energy multiplied by velocity and divided by wavelength confirms this numerical result.
...
- Wavelength: \`[L T⁻¹] / [T⁻¹] = [L]\` ✓ m correct
- Energy: \`[M L⁻¹]·[T⁻¹]²·[L]²·[L] = [M L² T⁻²]\` ✓ J correct
- Power: \`[M L⁻¹]·[T⁻¹]²·[L]²·[L T⁻¹] = [M L² T⁻³]\` ✓ W correct

## Physical interpretation

The energy of 156 J in a single wave cycle is considerable, equivalent to the kinetic energy of a tennis ball at about 25 m/s. This energy travels along the string at 400 m/s, passing a given point in approximately 2.3 ms (the oscillation period).

The power of 69 kW is notably high for a musical string, indicating that waves in plucked string instruments transport significant energy in short intervals. In practice, the string only vibrates with this amplitude for a brief time (milliseconds after the initial pluck), and the time-averaged power in a musical performance is much lower due to silences between notes and natural decay.

If the amplitude were reduced to 1 mm (one third), the energy and power would fall to one ninth (factor 1/3² = 1/9), resulting in approximately 17 J and 7.7 kW respectively. This quadratic dependence explains why playing "louder" (greater amplitude) dramatically increases perceived volume.
