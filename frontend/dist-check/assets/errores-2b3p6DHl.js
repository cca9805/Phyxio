...
El estudiante aprende que el campo se "siente" como una fuerza y que ambos están relacionados. La analogía intuitiva lleva a pensar que [[E]] y [[F_e]] son la misma cosa medida en unidades distintas, o que el campo es simplemente la fuerza que actúa sobre la carga de interés.

**Por qué es incorrecto**

[[E]] es una propiedad del espacio en un punto, independiente de la carga que se coloque allí. [[F_e]] es la fuerza que experimenta una carga específica [[q_0]] colocada en ese punto. El campo existe aunque no haya ninguna carga de prueba presente; la fuerza no existe sin la carga. La dependencia de [[F_e]] con [[q_0]] es exactamente la que separa las dos magnitudes.

**Señal de detección**

El alumno sustituye directamente [[E]] en lugar de [[F_e]] en la segunda ley de Newton, o calcula la aceleración de una partícula dividiéndola entre la carga en lugar de entre la masa.

**Corrección conceptual**

La fuerza sobre una carga real [[q_0]] se obtiene multiplicando el campo [[E]] por esa carga. El campo es el "catálogo" del entorno; la fuerza es el resultado de aplicar ese catálogo a una carga concreta.
...
Las líneas de campo nacen en cargas positivas (fuentes) y terminan en cargas negativas (sumideros). Para una carga negativa, [[E]] en cualquier punto cercano apunta hacia ella, no alejándose.
...
Antes de aplicar la fórmula puntual, verificar que la distancia de evaluación [[r]] sea al menos diez veces mayor que la dimensión característica del objeto cargado. Si no se cumple, usar la ley de Gauss o integración directa.
...
La dependencia de [[r]] en el denominador lleva a algunos estudiantes a escribir simplemente la distancia en lugar de su cuadrado, posiblemente por analogía incorrecta con otras fórmulas donde la variable aparece en primer orden.

**Por qué es incorrecto**

La ley cuadrática inversa es una consecuencia fundamental de la geometría tridimensional (el área de una esfera crece como el cuadrado del radio). Omitir el cuadrado produce un campo que decae mucho más lentamente con la distancia, sobreestimando la intensidad a grandes [[r]].

**Señal de detección**

El campo calculado a doble distancia es la mitad del original en lugar de la cuarta parte. Si duplicar [[r]] divide [[E]] entre dos, la fórmula usada tiene [[r]] en primer orden, no al cuadrado.

**Corrección conceptual**

En la fórmula de Coulomb, el denominador es siempre [[r]] al cuadrado. La regla práctica: duplicar la distancia divide el campo entre cuatro; triplicar la distancia lo divide entre nueve.
...
[[E]] nulo en un punto solo garantiza que la fuerza neta sobre una carga de prueba allí colocada sería cero. No garantiza ausencia de carga en el entorno. Para saber si hay carga, hay que aplicar la ley de Gauss sobre una superficie cerrada y calcular el flujo.

**Mini-ejemplo de contraste**

En el punto central exacto entre dos cargas iguales y de mismo signo, [[E]] es exactamente cero. Sin embargo, hay dos cargas muy próximas. El campo nulo no indica "vacío eléctrico" sino equilibrio de contribuciones.

## Regla de autocontrol rápido

Antes de dar por bueno un cálculo de campo eléctrico, verificar mentalmente:

1. ¿El denominador de la fórmula de Coulomb contiene [[r]] al cuadrado?
2. ¿El resultado tiene unidades de N/C?
3. ¿El módulo de [[E]] es positivo?
