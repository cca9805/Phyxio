...
Faraday exige cambio de flujo enlazado. Un [[Phi_B]] constante puede existir sin producir [[epsilon_ind]] media.
...
Busca siempre [[DeltaPhi_B]]. Sin cambio de flujo durante [[Deltat]], no hay fem inducida media.
...
El flujo depende de la parte que atraviesa la superficie. En el modelo uniforme, esa parte queda representada por [[B_perp]], no por cualquier componente tangente.
...
La rapidez de cambio de flujo usa segundos. Un error de unidad cambia [[r_Phi]] y [[epsilon_ind]] por factores enormes.
...
Convierte [[Deltat]] a segundos antes de dividir [[DeltaPhi_B]]. Despues aplica [[N]] y el signo de Lenz.
...
Antes de sustituir, verifica cuatro puntos: superficie enlazada, normal elegida, cambio de flujo y tiempo en segundos. Si no puedes decir cual es [[DeltaPhi_B]], no estas aplicando Faraday sino mirando un estado magnetico.

Despues revisa tres coherencias: [[N]] multiplica solo espiras equivalentes, [[B_perp]] representa la componente que atraviesa y el signo de [[epsilon_ind]] debe expresar oposicion al cambio.
`;export{e as default};
