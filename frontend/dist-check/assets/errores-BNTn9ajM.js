...
La placa y la membrana tienen mecanismos físicos de restitución fundamentalmente distintos. La placa se resiste a doblarse por su rigidez elástica, proporcional al cubo del espesor. La membrana ideal no tiene rigidez a la flexión; su restitución viene exclusivamente de la tensión superficial [[T_mem]]. Una placa sin tensión y una membrana sin rigidez son sistemas completamente diferentes: la primera puede sostenerse sola, la segunda colapsaría. Además, la placa exhibe dispersión de velocidad (las ondas de alta frecuencia son más rápidas), mientras que la membrana es no dispersiva.

**Señal de detección**

El alumno aplica la fórmula de placa a un parche de batería (que es una membrana) o intenta calcular [[D_placa]] para una membrana de mylar usando su módulo de Young, sin considerar que a esos espesores (80 µm) la rigidez a la flexión es completamente despreciable frente a la tensión.
...
### Error 1: Calcular [[D_placa]] sin el factor (1 − nu²) en el denominador

**Por qué parece correcto**

El alumno recuerda que la rigidez a la flexión de una viga es E·I, donde I es el momento de inercia de la sección. Para una placa de ancho unitario y espesor h, el momento de inercia es h³/12. El alumno escribe la rigidez de placa directamente como [[E_young]]·[[h_placa]]³/12, omitiendo el factor (1−[[nu_p]]²) que diferencia la placa de la viga.

**Por qué es incorrecto**

La placa está restringida en la dirección transversal por su propia extensión bidimensional; no puede contraerse lateralmente como una viga. Esto genera una tensión biaxial adicional, recogida en la fórmula de [[D_placa]] mediante el término de Poisson del denominador. Omitir este término sobreestima [[D_placa]] y todas las frecuencias modales; para el acero con [[nu_p]] de 0.3, el incremento de frecuencia es aproximadamente 1.047: un error del 5 % en cada frecuencia.

**Señal de detección**

Todos los valores de [[f_mn]] calculados resultan ligeramente más altos que los medidos experimentalmente, en un porcentaje constante independiente del modo. Comprobar si el valor de [[D_placa]] incluye el factor (1−[[nu_p]]²) en el denominador.
...
Para acero con [[nu_p]] de 0.3, el factor (1−0.09) da 0.91. Omitirlo sobreestima [[D_placa]] en un 10 % y [[f_mn]] en un 5 %. Para goma con [[nu_p]] de 0.49, el factor es 0.76, y omitirlo sobreestima [[f_mn]] en un 15 %.
...
1. **Unidades de [[E_young]]:** debe estar en Pa (no en GPa). Multiplicar por 10⁹ si está en GPa.
2. **Densidad superficial calculada:** verificar que [[rho_s]] se ha obtenido como [[rho_vol]] × [[h_placa]] en kg/m².
3. **Factor (1−[[nu_p]]²) en el denominador de [[D_placa]]:** no debe estar en el numerador ni omitido.
