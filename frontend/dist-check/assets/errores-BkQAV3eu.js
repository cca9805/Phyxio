const e=`# Errores frecuentes en Routhiano y coordenadas ciclicas
...
**Senal de deteccion**
El resultado parece numericamente razonable pero no permite explicar que mecanismo domina ni que cambio observable produciria [[Routh]].

**Correccion conceptual**
Antes de operar, escribe una frase causal: [[Routh]] aumenta, disminuye o cambia de regimen porque modifica una parte concreta del modelo.
...
**Correccion conceptual**
Cada transformacion debe conservar unidades, signo esperado y dependencia con [[Routh]]. Si una de esas tres cosas falla, el despeje no es valido.
...
**Senal de deteccion**
La conclusion no dice que pasaria si [[Routh]] aumenta o disminuye, ni menciona validez, limite o consecuencia observable.
...
Antes de aceptar una solucion, aplica cuatro controles: mismo sistema, unidades coherentes, caso limite reconocible y lectura causal de [[Routh]]. Si uno falla, la respuesta no esta lista para publicarse como conclusion fisica.
`;export{e as default};
