const e=`# Errores comunes: sistemas aislados\r
\r
## Errores conceptuales\r
\r
### Error 1: Confundir la definición formal de sistemas aislados con la intuición cotidiana\r
\r
**Por qué parece correcto:**\r
La intuición cotidiana sobre sistemas aislados funciona en contextos simples, así que parece correcta siempre.\r
\r
**Por qué es incorrecto:**\r
La definición física de sistemas aislados incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.\r
\r
...
Un alumno aplica sistemas aislados sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.\r
\r
## Errores de modelo\r
\r
### Error 2: Aplicar el modelo ideal de sistemas aislados fuera de su dominio de validez\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Aplicar la fórmula ideal de sistemas aislados a velocidades relativistas da un error >5 % cuando la velocidad supera el 10% de la velocidad de la luz.\r
\r
## Errores matemáticos\r
\r
### Error 3: Error de signo al proyectar vectores en el cálculo de sistemas aislados\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Una partícula se mueve hacia la izquierda respecto al eje x. Si se asume una velocidad positiva en vez de negativa, el momento calculado apunta al lado equivocado.\r
\r
...
\r
**Mini-ejemplo de contraste:**\r
El alumno obtiene un momento de -12 kg·m/s y escribe solo "12". El signo negativo indica dirección opuesta al eje elegido, información que se pierde.\r
\r
