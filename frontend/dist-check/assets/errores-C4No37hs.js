...
La energía procede de [[P_mec]]. La inducción convierte trabajo mecánico en separación de cargas y luego en [[P_elec]] si hay carga conectada.
...
El alumno recuerda que el flujo interviene en Faraday y sustituye cualquier valor de [[Phi_B]] sin atender al intervalo. Es una sustitución mecánica de símbolos.

**Por qué es incorrecto**

La fem media depende de [[DeltaPhi_B]] durante [[Delta_t]], no del valor máximo aislado. Sin cambio de flujo, la fem media desaparece.
...
El alumno calcula [[P_elec]] multiplicando la amplitud al cuadrado por la conductancia de la carga sin el factor un medio, obteniendo el doble de la potencia real.
...
Antes de cerrar un problema de generadores, comprueba cuatro preguntas: qué cambia en [[Phi_B]], durante cuánto tiempo cambia, qué magnitud eléctrica se pide y si la respuesta es fem o potencia. Después revisa que [[eta]] no supere la unidad y que [[P_elec]] no sea mayor que [[P_mec]].
