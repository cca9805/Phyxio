const e=`# Errores frecuentes en Corchetes de Poisson\r
\r
## Errores conceptuales\r
\r
### Error 1: Tratar la notacion como fisica\r
\r
Por que parece correcto: los simbolos de Corchetes de Poisson parecen potentes y compactos.\r
\r
Por que es incorrecto: [[PB]] solo tiene significado fisico cuando se cumplen las hipotesis de dominio.\r
\r
...
\r
Por que es incorrecto: la interpretacion se organiza alrededor de [[PB]], porque determina la lectura fisica del leaf.\r
\r
Senal de deteccion: la respuesta final contiene formulas pero no dice que significa [[PB]].\r
\r
Correccion conceptual: termina toda solucion con una frase sobre el papel fisico de [[PB]].\r
\r
