...
La fuerza eléctrica es un vector. Dos fuerzas iguales en módulo pero opuestas en dirección producen [[F_total]] nulo, no el doble. La suma escalar siempre sobreestima la magnitud de [[F_total]] salvo cuando todas las contribuciones son estrictamente paralelas y del mismo sentido, que es el caso menos frecuente en geometrías reales.

**Señal de detección**

El alumno obtiene [[F_total]] como la suma aritmética de los módulos individuales, sin descomponer en componentes ni usar el teorema de Pitágoras. El resultado es siempre mayor o igual que cualquier contribución individual.
