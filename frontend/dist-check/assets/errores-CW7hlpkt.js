const e=`# Errores comunes en la ley de Biot Savart
...
La analogia con sumar intensidades positivas hace pensar que cada [[dB]] solo aumenta el campo total. El alumno usa una generalizacion excesiva de problemas de una dimension.
...
El alumno usa solo [[r]] y [[I]] aunque el enunciado describe radio de espira [[R]], arco o longitud finita.

**Corrección conceptual**

Elige la formula integrada solo despues de reconocer la geometria. Si no hay simetria suficiente, vuelve a [[dB]].

**Mini-ejemplo de contraste**

Un punto en el centro de una espira no ve un hilo infinito. La direccion de las contribuciones se organiza axialmente y depende de [[R]], no de una distancia perpendicular a un hilo largo.
...
Antes de calcular, responde cinco preguntas: que geometria tiene la corriente, donde esta el punto, que representa [[r]], que papel tiene [[s_theta]] y que componentes de [[dB]] se cancelan. Si una respuesta falta, no sustituyas datos.
`;export{e as default};
