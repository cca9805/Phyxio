const e=`# Errores comunes: ecuación del cohete\r
\r
## Errores conceptuales\r
\r
### Error 1: Confundir la definición formal de ecuación del cohete con la intuición cotidiana\r
\r
**Por qué parece correcto:**\r
La intuición cotidiana sobre ecuación del cohete funciona en contextos simples, así que parece correcta siempre.\r
\r
**Por qué es incorrecto:**\r
La definición física de ecuación del cohete incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.\r
\r
...
Un alumno aplica ecuación del cohete sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.\r
\r
## Errores de modelo\r
\r
### Error 2: Aplicar el modelo ideal de ecuación del cohete fuera de su dominio de validez\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Aplicar la fórmula ideal de ecuación del cohete a velocidades relativistas da un error >5 % cuando v > 0.1c.\r
\r
## Errores matemáticos\r
\r
### Error 3: Error de signo al proyectar vectores en el cálculo de ecuación del cohete\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Una partícula se mueve hacia la izquierda respecto al eje x. Si se usa una velocidad positiva en vez de negativa, el momento calculado apunta al lado equivocado.\r
\r
...
\r
**Mini-ejemplo de contraste:**\r
El alumno calcula un momento lineal negativo y escribe solo el módulo, descartando la información de signo. El signo negativo indica dirección opuesta al eje elegido, información que se pierde.\r
\r
