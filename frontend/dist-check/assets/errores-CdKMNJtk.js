const e=`# Errores comunes: conservación del momento angular\r
\r
## Errores conceptuales\r
\r
### Error 1: Confundir la definición formal de conservación del momento angular con la intuición cotidiana\r
\r
**Por qué parece correcto:**\r
La intuición cotidiana sobre conservación del momento angular funciona en contextos simples, así que parece correcta siempre.\r
\r
**Por qué es incorrecto:**\r
La definición física de conservación del momento angular incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.\r
\r
...
Un alumno aplica conservación del momento angular sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.\r
\r
## Errores de modelo\r
\r
### Error 2: Aplicar el modelo ideal de conservación del momento angular fuera de su dominio de validez\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Aplicar la fórmula ideal de conservación del momento angular a velocidades relativistas da un error >5 % cuando\r
\r
{{f:cons}}\r
\r
.\r
...
\r
### Error 3: Error de signo al proyectar vectores en el cálculo de conservación del momento angular\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Una partícula se mueve hacia la izquierda respecto al eje x. Si se pone\r
\r
{{f:cons}}\r
\r
 en vez de\r
...
{{f:cons}}\r
\r
, el momento calculado apunta al lado equivocado.\r
\r
...
{{f:cons}}\r
\r
kg·m/s y escribe solo "12". El signo negativo indica dirección opuesta al eje elegido, información que se pierde.\r
\r
...
4. **Caso límite**: ¿la fórmula se reduce a un resultado conocido cuando un parámetro tiende a cero o a infinito?`;export{e as default};
