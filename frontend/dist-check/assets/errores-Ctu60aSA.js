...
**Correccion conceptual**
El primer polarizador reduce la intensidad a la mitad **solo** si la fuente es natural. A partir de ahi, cada etapa se rige por la ley de Malus con [[I_0]] igual a la intensidad de salida de la etapa previa.
...
**Por que es incorrecto**
La [[I]] es proporcional al cuadrado de la amplitud del campo. Proyectar el campo da un factor coseno, pero al elevar al cuadrado aparece el coseno cuadrado. Usar solo el coseno sobrestima la intensidad transmitida en los angulos intermedios.

**Senal de deteccion**
A 60 grados el alumno obtiene una intensidad de la mitad de [[I_0]] (coseno de 60 grados igual a 0.5) cuando el valor correcto es un cuarto de [[I_0]] (coseno cuadrado de 60 grados igual a 0.25).

**Correccion conceptual**
La ley de Malus establece que [[I]] es igual a [[I_0]] multiplicado por el coseno cuadrado de [[theta_p]]. El exponente dos no es opcional: refleja que la intensidad es cuadratica en la amplitud del campo.

**Mini-ejemplo de contraste**
A 60 grados, con coseno da 0.5 veces [[I_0]]; con coseno cuadrado da 0.25 veces [[I_0]]. La diferencia es del doble, facilmente detectable al comparar con la medida experimental.
...
1. **[[I]] no supera [[I_0]]**: si la intensidad transmitida supera la incidente, hay un error de datos o de formula.
2. **Polarizadores cruzados dan [[I]] nula**: si el angulo es 90 grados y la intensidad no se anula, revisar si se uso coseno en lugar de coseno cuadrado o si la fuente no es completamente polarizada.
3. **[[theta_B]] esta en rango razonable**: para interfases comunes (aire-vidrio, aire-agua), el angulo de Brewster cae entre 50 y 60 grados. Un valor fuera de 40 a 70 grados debe revisarse.
`;export{e as default};
