const e=`# Errores frecuentes en Ecuacion de Binet y orbitas
...
**Senal de deteccion**
El resultado parece numericamente razonable pero no permite explicar que mecanismo domina ni que cambio observable produciria [[u]].

**Correccion conceptual**
Antes de operar, escribe una frase causal: [[u]] aumenta, disminuye o cambia de regimen porque modifica una parte concreta del modelo.
...
**Correccion conceptual**
Cada transformacion debe conservar unidades, signo esperado y dependencia con [[u]]. Si una de esas tres cosas falla, el despeje no es valido.
...
**Senal de deteccion**
La conclusion no dice que pasaria si [[u]] aumenta o disminuye, ni menciona validez, limite o consecuencia observable.
...
Antes de aceptar una solucion, aplica cuatro controles: mismo sistema, unidades coherentes, caso limite reconocible y lectura causal de [[u]]. Si uno falla, la respuesta no esta lista para publicarse como conclusion fisica.
`;export{e as default};
