...
[[P]] representa rapidez de transferencia energetica y [[E]] representa acumulacion en un intervalo. Igual energia acumulada puede venir de perfiles de potencia muy distintos.
#### Senal de deteccion
...
#### Mini-ejemplo
Dos cargas consumen la misma [[E]] diaria. La carga A opera suave todo el dia; la carga B concentra la demanda en minutos con [[P]] alta. La B puede exigir cableado mas robusto pese a igual energia total.
...
#### Por que es incorrecto
Si la carga no es predominantemente resistiva, la equivalencia simple entre variables puede romperse y la estimacion de [[P]] perder validez.
#### Senal de deteccion
El resultado no coincide con mediciones directas de [[V]] e [[I]] o el calentamiento observado es incompatible con el calculo.
#### Correccion conceptual
Empezar desde medicion directa en el elemento y usar forma resistiva solo cuando [[R]] efectiva este justificada en el regimen de trabajo.
#### Mini-ejemplo
...
## Errores matemáticos
### Error 1: Mezcla de unidades de [[t]]
#### Por que parece correcto
...
#### Mini-ejemplo
Con la misma [[P]], usar una hora como si fueran segundos multiplica artificialmente la energia y puede simular un consumo imposible.
...
1. Pregunta minima: estoy reportando [[P]] o [[E]]?
