...
En un medio isotropo, la simetria esferica reduce el tensor de rigidez a exactamente dos parametros independientes. Conocer E y [[nu_poisson]] es suficiente para calcular [[G_shear]] y [[K_bulk]] sin ensayos adicionales. Los tres modulos estan vinculados algebraicamente.
...
Cuando [[nu_poisson]] es exactamente 0.5, el denominador se anula y [[K_bulk]] diverge. Esto no es un error matematico sino una singularidad fisica real (material incompresible). Si el alumno sustituye nu de 0.5 sin precaucion, obtiene K infinito o una division por cero.
