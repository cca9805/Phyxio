const e=`\uFEFF# Errores Frecuentes en Definicion de Torque\r
\r
...
**Por qué es incorrecto:** I depende del eje de giro. Pensar que cualquier valor de I es intercambiable lleva a una aceleracion angular incorrecta, aunque la aritmetica sea perfecta.\r
...
**Corrección conceptual:** Verificar que el eje para el que se calcula I coincide exactamente con el eje de giro declarado en el problema. Usar Steiner si es necesario trasladar el eje. La relacion correcta es\r
\r
...
**Por qué es incorrecto:** sin(40°) ≈ 0.643, pero sin(40 rad) ≈ 0.745. El error es del 16%, que puede cambiar el diagnostico en un diseño ajustado.\r
...
{{f:torque_por_angulo}}\r
\r
. Si se usa sin(45 rad) ≈ 0.851, se obtiene\r
\r
{{f:torque_por_angulo}}\r
\r
. Error del 20%.\r
...
**Por qué es incorrecto:** Un signo erroneo en [[F_x]] o [[F_y]] invierte el sentido de giro de [[tau_z]]. El numero puede ser correcto en modulo pero equivocado en signo, lo que implica error de direccion de giro.\r
...
\r
Si una de estas siete comprobaciones falla, no se debe dar el resultado por cerrado. Repetir el calculo con trazabilidad suele ahorrar tiempo frente a corregir consecuencias de una decision basada en torque mal interpretado.\r
`;export{e as default};
