const e=`# Errores comunes: Introducción a ondas en sólidos
...
Antes de sustituir valores, identificar el tipo de onda. Longitudinal en barra: [[E_young]]. Transversal: [[G_mod]]. Longitudinal en medio extenso: módulo de onda plana. Siempre verificar que la velocidad transversal sea menor que la longitudinal.

**Mini-ejemplo de contraste**

Acero con [[E_young]] de 200 GPa, [[G_mod]] de 80 GPa, [[rho]] de 7800 kg/m³. Velocidad longitudinal (barra): aproximadamente 5064 m/s. Velocidad transversal: aproximadamente 3202 m/s. Si se usa [[E_young]] para la transversal erróneamente, se obtiene 5064 m/s (un 58% mayor que el valor correcto).
...
Con [[E_young]] de 200 GPa y [[rho]] de 7800 kg/m³: sin raíz se obtiene 25.6 × 10⁶ m²/s² (no tiene sentido). Con raíz: 5064 m/s (valor correcto y con las unidades adecuadas).
...
Si [[E_young]] se deja en GPa (10⁹ Pa) pero [[rho]] se deja en g/cm³ (10³ kg/m³) sin conversión coherente, los factores 10⁹ y 10³ pueden cancelarse parcialmente dando resultados que parecen razonables pero son incorrectos.
...
Convertir todo al sistema internacional antes de sustituir: [[E_young]] en Pa, [[rho]] en kg/m³. El resultado saldrá directamente en m/s.

**Mini-ejemplo de contraste**

Aluminio: si se sustituye [[E_young]] como 69 (sin 10⁹) y [[rho]] como 2.7 (sin 10³), se obtiene √(69/2.7) ≈ 5.05 m/s, que es absurdamente bajo. Con las unidades correctas: √(69×10⁹/2700) ≈ 5055 m/s.
...
Identificar la geometría: si el frente de onda cubre una sección mucho mayor que la longitud de onda, usar el módulo de onda plana en lugar de [[E_young]] solo. Para acero, la velocidad en medio extenso es de unos 5900 m/s frente a 5064 m/s en barra.

**Mini-ejemplo de contraste**

Acero: velocidad en barra delgada ([[E_young]] sola) unos 5064 m/s. Velocidad en medio extenso (módulo de onda plana) unos 5900 m/s. La diferencia del 16% puede ser significativa en ensayos de precisión.

## Errores matemáticos

### Error: Olvidar la raíz cuadrada en la fórmula de velocidad

La fórmula de velocidad de fase incluye siempre una raíz cuadrada del cociente entre el módulo elástico y la densidad. Un error algebraico frecuente es calcular directamente [[E_young]] dividido entre [[rho]] sin extraer la raíz. El resultado tiene unidades de m²/s² en lugar de m/s y da valores absurdamente altos (del orden de millones). Si [[v_fase]] supera 50000 m/s en un sólido, casi con certeza falta la raíz cuadrada.

### Error: Errores de conversión de unidades

Al usar datos de tablas, [[E_young]] suele darse en GPa y [[rho]] en g/cm³. Si se sustituyen directamente sin convertir a Pa y kg/m³, los factores 10⁹ y 10³ se cancelan parcialmente y el resultado puede parecer razonable pero está equivocado. Siempre convertir al sistema internacional antes de sustituir.
...
La frecuencia [[f]] la fija la fuente y se conserva en todas las interfaces. Lo que cambia es [[lambda]] porque [[v_fase]] es diferente en cada medio. La condición de continuidad temporal en la interfaz impone que la frecuencia sea la misma a ambos lados.

**Señal de detección**

El alumno calcula frecuencias diferentes a ambos lados de una interfaz, o modifica [[f]] al cambiar de material.

**Corrección conceptual**

La frecuencia se conserva siempre. Al cambiar de medio: [[lambda]] nueva es igual a la nueva [[v_fase]] dividida entre la misma [[f]]. Solo cambia la longitud de onda, nunca la frecuencia.
