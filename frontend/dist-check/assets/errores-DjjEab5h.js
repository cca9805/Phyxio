const e=`# Errores comunes: definición del momento angular\r
\r
## Errores conceptuales\r
\r
### Error 1: Confundir la definición formal de definición del momento angular con la intuición cotidiana\r
\r
**Por qué parece correcto:**\r
La intuición cotidiana sobre definición del momento angular funciona en contextos simples, así que parece correcta siempre.\r
\r
**Por qué es incorrecto:**\r
La definición física de definición del momento angular incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.\r
\r
...
Un alumno aplica definición del momento angular sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.\r
\r
## Errores de modelo\r
\r
### Error 2: Aplicar el modelo ideal de definición del momento angular fuera de su dominio de validez\r
\r
**Por qué parece correcto:**\r
...
\r
**Mini-ejemplo de contraste:**\r
Aplicar la fórmula ideal de definición del momento angular a velocidades relativistas da un error >5 % cuando\r
\r
{{f:p}}\r
\r
.\r
...
\r
### Error 3: Error de signo al proyectar vectores en el cálculo de definición del momento angular\r
\r
**Por qué parece correcto:**\r
