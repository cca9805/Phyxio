...
### Error 2: Creer que mayor [[R_ac]] implica siempre mayor peligrosidad del defecto

**Por qué parece correcto**

Un eco de mayor amplitud en el A-scan parece indicar un defecto más severo. Como [[R_ac]] gobierna la amplitud del eco, se establece la equivalencia mental: más [[R_ac]] es igual a más peligro.

**Por qué es incorrecto**

[[R_ac]] mide el contraste acústico en la interfaz del defecto, no su peligrosidad mecánica. Una fisura muy pequeña llena de aire produce [[R_ac]] próximo a 1 (eco máximo) pero puede ser mecánicamente irrelevante. Una inclusión de material duro con [[Z_ac]] parecida a la del acero puede tener [[R_ac]] casi nulo (eco mínimo) y aun así ser peligrosa por su fragilidad o por la concentración de tensiones que genera.
...
La peligrosidad de un defecto se evalúa con criterios de mecánica de fractura (tamaño crítico, factor de intensidad de tensiones) que requieren conocer el tamaño, la geometría y la posición del defecto, no solo su contraste acústico. [[R_ac]] informa sobre la naturaleza de la interfaz, no sobre la criticidad estructural.

**Mini-ejemplo de contraste**

Un poro esférico de 0.1 mm de diámetro lleno de aire tiene [[R_ac]] próximo a 1 pero es indetectable en la práctica por ser más pequeño que la longitud de onda. Una inclusión plana de 5 mm de espesor de material cerámico puede tener [[R_ac]] de 0.3 y ser estructuralmente crítica por delaminar bajo carga.
...
### Error 5: Interpretar el signo de [[R_ac]] como dirección de propagación

**Por qué parece correcto**

En física, el signo de una magnitud a menudo indica dirección (positivo hacia la derecha, negativo hacia la izquierda). El alumno aplica esta convención y concluye que [[R_ac]] negativo significa que el eco viaja en dirección contraria o que la onda se transmite hacia el interior en lugar de reflejarse.

**Por qué es incorrecto**

El signo de [[R_ac]] indica si la onda reflejada está en fase o en contrafase con la incidente, es decir, si hay inversión de fase en la reflexión. Un [[R_ac]] negativo significa que el segundo medio es acústicamente más blando que el primero (menor [[Z_ac]]), y la onda reflejada tiene presión de signo opuesto. No indica dirección de propagación: la onda reflejada siempre viaja de vuelta hacia el transductor independientemente del signo de [[R_ac]].

**Señal de detección**

El alumno escribe que con [[R_ac]] negativo la onda "no regresa al transductor" o que "la energía solo se transmite y no se refleja". También puede calcular la fracción de energía reflejada usando [[R_ac]] negativo directamente en lugar de su módulo al cuadrado.

**Corrección conceptual**

El módulo de [[R_ac]] al cuadrado da la fracción de intensidad reflejada; el módulo de [[R_ac]] (siempre positivo) da la fracción de amplitud reflejada. El signo solo indica la polaridad del eco. La onda reflejada siempre existe cuando [[R_ac]] es distinto de cero, independientemente de su signo.

**Mini-ejemplo de contraste**

En la interfaz agua-aire (siendo el segundo medio el aire, más blando), [[R_ac]] es negativo y próximo a -1. Esto no implica que no haya reflexión; al contrario, casi toda la energía se refleja. La diferencia observable es que el eco llega con presión de signo opuesto al pulso original, algo que el equipo puede detectar invirtiendo la polaridad del pico en el A-scan.
...
3. **El módulo de [[R_ac]] está entre 0 y 1**: un valor fuera de este rango indica error algebraico en el cálculo de [[Z_ac]] de los dos medios o uso de unidades distintas para cada uno.
