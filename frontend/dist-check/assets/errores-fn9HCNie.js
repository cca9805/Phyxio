const e=`# Errores frecuentes en Teorema de transporte de Reynolds
...
**Senal de deteccion**
El resultado parece numericamente razonable pero no permite explicar que mecanismo domina ni que cambio observable produciria [[B]].

**Correccion conceptual**
Antes de operar, escribe una frase causal: [[B]] aumenta, disminuye o cambia de regimen porque modifica una parte concreta del modelo.
...
**Correccion conceptual**
Cada transformacion debe conservar unidades, signo esperado y dependencia con [[B]]. Si una de esas tres cosas falla, el despeje no es valido.
...
**Senal de deteccion**
La conclusion no dice que pasaria si [[B]] aumenta o disminuye, ni menciona validez, limite o consecuencia observable.
...
Antes de aceptar una solucion, aplica cuatro controles: mismo sistema, unidades coherentes, caso limite reconocible y lectura causal de [[B]]. Si uno falla, la respuesta no esta lista para publicarse como conclusion fisica.
`;export{e as default};
