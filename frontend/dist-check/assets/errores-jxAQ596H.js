const e=`# Errores frecuentes en interferencia de la luz
...
El alumno usa la fórmula de posición de franjas [[y_m]] = [[m]] × [[lambda]] × [[L]] / [[d]] sustituyendo [[d]] por el ancho de la rendija en lugar de la separación entre rendijas.

**Corrección conceptual**

Distinguir claramente entre [[d]] como separación entre rendijas (parámetro de interferencia) y el ancho de rendija (parámetro de difracción). La difracción de una sola rendija produce un patrón amplio centrado, mientras que la interferencia de doble rendija produce franjas múltiples dentro de esa envolvente.

**Mini-ejemplo de contraste**

Con una sola rendija de ancho 0.1 mm iluminada con [[lambda]] = 600 nm a distancia [[L]] = 1 m, el primer mínimo de difracción está a 6 mm del centro. Con dos rendijas separadas [[d]] = 0.5 mm, las franjas de interferencia están separadas 1.2 mm. Si el alumno confunde ambos fenómenos y usa 0.1 mm como [[d]], obtiene franjas separadas 6 mm, confundiendo el mínimo de difracción con una franja de interferencia.
...
La fórmula [[y_m]] = [[m]] × [[lambda]] × [[L]] / [[d]] es simple y directa. El alumno la aplica para cualquier valor de [[m]] sin verificar su rango de validez.

**Por qué es incorrecto**

La aproximación sin(θ) ≈ θ solo es válida para ángulos menores que 0.1 radianes. Para órdenes altos donde [[m]] × [[lambda]] / [[d]] supera 0.1, el error crece rápidamente y la posición real difiere significativamente de la predicha por la fórmula lineal.

**Señal de detección**

El alumno obtiene valores de [[y_m]] que se acercan o superan a [[L]], o calcula implícitamente ángulos superiores a 6 grados sin reconocer la invalidez de la aproximación.

**Corrección conceptual**

Verificar que [[m]] × [[lambda]] / [[d]] < 0.1 antes de usar la aproximación. Para órdenes altos, usar la expresión exacta con arcoseno.

**Mini-ejemplo de contraste**

Para [[d]] = 0.1 mm y [[lambda]] = 600 nm, el orden [[m]] = 100 da un ángulo sin(θ) = 0.6, equivalente a 37 grados. La fórmula lineal predice [[y_m]] = 1.2 m para [[L]] = 2 m. La expresión exacta da [[y_m]] = 2 m × tan(37°) = 1.5 m, un error del 25%.
...
Los datos de los problemas vienen en unidades cómodas: [[lambda]] en nm y [[d]] en mm. El alumno los introduce directamente en la fórmula sin convertir.
...
Con [[lambda]] = 600 nm y [[d]] = 0.5 mm a [[L]] = 1.5 m: usando unidades correctas, [[Delta_y]] = 6 × 10⁻⁷ × 1.5 / (5 × 10⁻⁴) = 1.8 mm. Si el alumno usa 600 y 0.5 sin convertir, obtiene 600 × 1.5 / 0.5 = 1800 unidades sin sentido.
...
Antes de dar por bueno un resultado sobre interferencia, verificar las siguientes condiciones. La separación entre franjas debe estar en el rango de milímetros para parámetros típicos de laboratorio. El orden [[m]] debe ser entero para máximos perfectos. La posición [[y_m]] debe ser mucho menor que [[L]] si se usó la aproximación de ángulos pequeños. Las unidades deben ser consistentes en metros en toda la fórmula. La intensidad total integrada sobre la pantalla debe ser igual a la suma de las intensidades individuales de cada rendija.
`;export{e as default};
