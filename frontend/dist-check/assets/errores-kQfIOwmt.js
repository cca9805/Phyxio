...
La radiación electromagnética no es una vibración de átomos, sino la oscilación autoinducida de campos eléctricos [[E0]] y magnéticos [[B0]] en el espacio vacío. Según las leyes del electromagnetismo, un campo variable induce al otro de forma mutua y perpetua sin depender de la materia.

**Señal de detección**
Intentar buscar un término de densidad de partículas o módulo elástico del medio al calcular la velocidad de la luz [[c]].
...
**Por qué es incorrecto**
En el Sistema Internacional de Unidades, el campo eléctrico [[E0]] (en voltios por metro) y el campo magnético [[B0]] (en teslas) están escalados por la inmensa constante de la velocidad de la luz [[c]]. Esto provoca una gran asimetría en sus valores numéricos.

**Señal de detección**
Obtener resultados numéricos donde la amplitud magnética [[B0]] es del mismo orden de magnitud que la amplitud eléctrica [[E0]] (ej. obtener un campo magnético de 10 T para un campo eléctrico de 10 V/m).

**Corrección conceptual**
Usa siempre la relación [[E0]] = [[c]] [[B0]]. El valor numérico del campo magnético siempre será minúsculo en el SI frente al eléctrico.
...
**Corrección conceptual**
Tanto [[E0]] como [[B0]] alcanzan sus máximos, mínimos y ceros en perfecto sincronismo temporal y espacial en una onda plana libre.
...
Antes de dar por bueno cualquier cálculo o análisis, aplica esta regla operativa infalible: multiplica siempre el valor hallado del campo magnético [[B0]] por el factor de escala de la velocidad de la luz \\(3 \\cdot 10^8\\,\\mathrm{m/s}\\). El resultado obtenido debe ser idéntico al valor de tu campo eléctrico [[E0]]. Si no coinciden en este factor inmenso de escala, has cometido un error algebraico o de unidades.
`;export{e as default};
