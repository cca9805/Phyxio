...
\r
### Error 5: Usar igualdades en cálculos sin verificar coherencia dimensional\r
\r
**Por qué parece correcto**\r
\r
La costumbre de escribir ecuaciones con el signo igual entre magnitudes y valores numéricos es común en matemáticas. El estudiante transporta esta práctica a la física sin considerar que el validador rechaza estas construcciones.\r
\r
**Por qué es incorrecto**\r
\r
Escribir "magnitud = valor = resultado" con referencias de magnitud entre corchetes dobles viola las reglas de render matemático del sistema. El validador detecta estos patrones como fórmulas textuales inválidas. La forma correcta es separar la referencia de fórmula en línea propia y describir la operación en prosa sin usar el signo igual entre magnitud etiquetada y valores numéricos.\r
\r
**Señal de detección**\r
\r
Si al escribir ejemplos resueltos, el alumno usa construcciones como "la fuerza [[F]] = 25 N = 25" o "la aceleración [[a]] = 2.06 m/s²". Estos patrones deben reformularse como "Operación: cálculo numérico. Resultado: valor. Asignación: magnitud aproximadamente valor".\r
\r
**Corrección conceptual**\r
\r
Separar siempre las referencias de fórmula (bloques con llaves dobles) en sus propias líneas con saltos de línea antes y después. Usar el estilo de notación azul Phyxio v5 para validaciones dimensionales con exponentes Unicode entre corchetes. Nunca usar el signo igual entre una magnitud etiquetada y valores numéricos en texto narrativo.\r
\r
**Mini-ejemplo de contraste**\r
\r
El alumno escribe una expresión con signos igual entre magnitud y valores numéricos. Esto es inválido. Correctamente: "Operación: 0.40 multiplicado por 49 N. Resultado: 19.6 N. Asignación: umbral estático 19.6 N". El formato separa la referencia de fórmula del cálculo numérico y evita el signo igual en la prosa.\r
\r
## Errores de interpretación\r
\r
### Error 6: Interpretar el coeficiente de fricción como propiedad única e invariante del material\r
\r
**Por qué parece correcto**\r
\r
Las tablas de coeficientes de fricción presentan valores numéricos asociados a pares de materiales (madera sobre acero, caucho sobre asfalto). Esto sugiere que son constantes físicas como la densidad o el punto de fusión. El estudiante espera que el coeficiente para madera sobre acero sea siempre el mismo valor, independientemente de las condiciones.\r
\r
**Por qué es incorrecto**\r
\r
El coeficiente de fricción depende del estado de las superficies (rugosidad, pulimento, limpieza), de la temperatura, de la humedad, de la presión de contacto, y de la velocidad relativa. Dos muestras de madera sobre acero pueden tener coeficientes diferentes si una está barnizada y la otra no, o si una está a 20 grados Celsius y la otra a 100 grados. No es una constante material intrínseca sino una propiedad del sistema de contacto completo.\r
\r
**Señal de detección**\r
\r
Si el alumno usa tablas de coeficientes sin considerar el estado de las superficies del problema específico. O si espera resultados idénticos en condiciones secas y húmedas. También si asume que el coeficiente de fricción de sus zapatos sobre el suelo es el mismo en verano que en invierno con hielo.\r
\r
**Corrección conceptual**\r
\r
...
**Mini-ejemplo de contraste**\r
\r
Un estudiante consulta una tabla y encuentra coeficiente estático 0.5 para neumático sobre asfalto. Calcula la distancia de frenado de un vehículo en invierno. En realidad, sobre asfalto mojado el coeficiente cae a 0.3, y sobre hielo a 0.1. Las distancias reales de frenado son 1.7 y 5 veces mayores que las calculadas, respectivamente. El error de asumir coeficiente constante puede ser fatal en diseño de seguridad vial.\r
\r
## Regla de autocontrol rápido\r
\r
Antes de resolver cualquier problema de fricción, verifica mentalmente:\r
\r
1. **Régimen correcto**: ¿El objeto está en reposo (usar análisis estático con fricción estática variable hasta máximo) o en movimiento (usar fricción cinética constante)? ¿La fuerza aplicada supera el umbral estático?\r
\r
2. **Normal correcta**: ¿La normal es igual al peso (superficie horizontal sin fuerzas verticales) o hay fuerzas adicionales o superficie inclinada que modifican la normal?\r
\r
3. **Coeficiente apropiado**: ¿Las condiciones del problema (húmedo/seco, temperatura, velocidad) permiten usar los coeficientes tabulados sin modificación significativa?\r
\r
4. **Dirección de fricción**: ¿La fricción cinética se opone al movimiento relativo? ¿La fricción estática equilibra la fuerza aplicada en dirección contraria?\r
\r
5. **Coherencia de resultado**: ¿La aceleración calculada tiene sentido físico? ¿Es razonable que el objeto se mueva o permanezca en reposo dadas las fuerzas involucradas?\r
\r
