...
Las ondas S requieren un modulo de cizalla [[G_shear]] distinto de cero. Los fluidos ideales no resisten cizalla: [[G_shear]] es exactamente cero, lo que hace que [[v_s]] se anule. Solo las ondas P (que usan [[K_bulk]]) sobreviven en un fluido.

**Senal de deteccion**

Si en un calculo aparece [[v_s]] finita para un medio declarado como liquido, el alumno ha asumido incorrectamente un [[G_shear]] distinto de cero.

**Correccion conceptual**

En cualquier fluido, [[G_shear]] es cero y [[v_s]] es cero. Las ondas S solo existen en solidos. Las ondas en el agua son P (compresion) o superficiales (Rayleigh, Love).

**Mini-ejemplo de contraste**

Agua: [[K_bulk]] de 2.2 GPa, [[G_shear]] nulo, densidad 1000 kg/m3. Aplicando la formula de [[v_s]] con [[G_shear]] cero se obtiene [[v_s]] cero: la onda S no existe. Solo [[v_p]] da 1483 m/s.

### Error 2: Confundir velocidad en barra con velocidad de onda P en medio infinito

**Por que parece correcto**

Ambas son "velocidades de onda longitudinal en solido" y ambas dependen de un modulo elastico y la densidad. El alumno asocia la formula de barra (raiz de E entre rho) con la de onda P (que incluye [[K_bulk]] mas 4/3 de [[G_shear]]).

**Por que es incorrecto**

La formula de barra usa el modulo de Young porque la barra se deforma libremente en la direccion transversal. En medio infinito la deformacion lateral esta confinada, por lo que aparece [[K_bulk]] mas el termino de cizalla. Para acero, la velocidad en barra es 5100 m/s pero la de la onda P en medio infinito es 5960 m/s (un 16 por ciento mas).

**Senal de deteccion**

El alumno usa solo el modulo de Young en la formula de onda P, o usa [[K_bulk]] mas [[G_shear]] para una barra. Los resultados difieren un 10–20 por ciento de los valores tabulados.

**Correccion conceptual**

En barra esbelta: raiz de E entre rho. En medio infinito: raiz de ([[K_bulk]] mas 4/3 [[G_shear]]) entre [[rho_medio]]. Son formulas distintas para geometrias distintas.
...
El alumno recuerda que [[v_p]] depende de [[K_bulk]] y [[G_shear]] pero omite el coeficiente 4/3 delante de [[G_shear]]. Parece logico sumar los dos modulos directamente.
...
El valor de [[v_p]] calculado es ligeramente inferior al esperado (porque falta la contribucion completa de [[G_shear]]). Tambien el [[ratio_vp_vs]] sale menor del esperado.

**Correccion conceptual**

La formula correcta es raiz de ([[K_bulk]] mas 4/3 [[G_shear]]) entre [[rho_medio]]. El 4/3 no es negociable.

**Mini-ejemplo de contraste**

Con [[K_bulk]] de 75 GPa y [[G_shear]] de 32 GPa: correcto, K mas 4/3 G da 117.7 GPa. Incorrecto (sin 4/3), K mas G da 107 GPa. La diferencia en [[v_p]] es de 300 m/s (un 5 por ciento).
...
La ausencia de S no significa ausencia de sismo. Significa que entre foco y estacion hay una capa de [[G_shear]] nulo (fluido). Es un dato geofisico valioso, no un fallo instrumental.
