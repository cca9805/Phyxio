const e=`# Errores comunes en la ley de Ampere
...
La ley usa [[I_enc]], no corriente cercana. Solo importa la corriente que atraviesa la superficie limitada por la curva elegida.
...
Una corriente paralela situada fuera de una circunferencia puede modificar [[B]] localmente, pero no añade corriente encerrada. La circulacion neta asociada a esa curva sigue dependiendo de los cruces interiores.
...
Ampere siempre impone una condicion global, pero solo calcula [[B]] directamente si la curva hace que el campo sea constante, tangente o nulo por tramos.
...
Una curva irregular alrededor de un hilo encierra la misma corriente que una circunferencia, pero no permite sacar [[B]] de la integral. La circunferencia si aprovecha la simetria.
...
[[C_B]] y [[I_enc]] son cantidades orientadas. Cambiar el sentido de recorrido cambia la normal positiva asociada y el signo de la corriente.
...
[[C_B]] puede anularse por cancelacion global aunque existan valores locales de [[B]] sobre la curva.
...
Antes de calcular, responde cuatro preguntas: que curva usas, que sentido de recorrido elegiste, que corriente atraviesa la superficie y que simetria permite simplificar [[B]]. Si alguna respuesta no esta clara, no sustituyas datos.
`;export{e as default};
