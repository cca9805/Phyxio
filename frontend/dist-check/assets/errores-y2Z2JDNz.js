...
Para el tercer armónico, con [[n]] igual a 3, el alumno erróneo calcula la longitud de onda dividiendo 1.5 m entre 3, obteniendo 0.5 m y una frecuencia triple de la real. El cálculo correcto divide dos veces 1.5 m entre 3, dando 1.0 m, con frecuencia 50 % menor que la estimación errónea.
...
La fundamental es el armónico con [[n]] igual a 1, el de menor frecuencia posible para ese sistema con extremos fijos. Su intensidad relativa depende del mecanismo de excitación pero su definición es puramente frecuencial: la fundamental es menor que el segundo armónico, que es menor que el tercero, y así sucesivamente
