const e=`# Frequent errors in Hamilton-Jacobi Theory\r
\r
## Conceptual errors\r
\r
### Error 1: Treating notation as physics\r
\r
Why it seems correct: the symbols of Hamilton-Jacobi Theory look powerful and compact.\r
\r
Why it is incorrect: [[S]] only has physical meaning when the domain assumptions are satisfied.\r
\r
...
\r
Why it is incorrect: the interpretation is organized around [[S]], because it determines the physical reading of the leaf.\r
\r
Detection signal: the final answer contains formulas but no statement about what [[S]] means.\r
\r
Conceptual correction: end every solution with a sentence about the physical role of [[S]].\r
\r
