const n=`# Common mistakes: conservation of angular momentum\r
\r
## Conceptual errors\r
\r
### Error 1: Confusing the formal definition of conservation of angular momentum with everyday intuition\r
\r
**Why it seems correct:**\r
Everyday intuition about conservation of angular momentum works in simple contexts, so it seems always correct.\r
\r
**Why it is wrong:**\r
The physics definition of conservation of angular momentum includes restrictions (vector nature, sign, reference frame) that intuition ignores.\r
\r
**Detection signal:**\r
...
A student applies conservation of angular momentum without considering the vector sign and gets a positive result where it should be negative; the magnitude is correct but the direction is not.\r
\r
## Model errors\r
\r
### Error 2: Applying the ideal model of conservation of angular momentum outside its validity domain\r
\r
**Why it seems correct:**\r
...
\r
**Mini contrast example:**\r
Applying the ideal formula for conservation of angular momentum at relativistic speeds gives >5 % error when\r
\r
{{f:cons}}\r
\r
.\r
...
\r
### Error 3: Sign error when projecting vectors in the calculation of conservation of angular momentum\r
\r
**Why it seems correct:**\r
...
\r
**Mini contrast example:**\r
A particle moves leftward along the x-axis. When\r
\r
{{f:Iomega}}\r
\r
...
4. **Limiting case**: does the formula reduce to a known result when a parameter goes to zero or infinity?`;export{n as default};
