const e=`\uFEFF# Common mistakes: Tension in Ropes and Cables
...
Before closing a problem, check five items: selected model, axis and sign consistency, correct use of [[T]] versus [[Tx]] and [[Ty]], dimensional coherence including [[dT_dy]], and final interpretation linked to physical validity. If one fails, the result is not ready for technical decisions.\r
`;export{e as default};
