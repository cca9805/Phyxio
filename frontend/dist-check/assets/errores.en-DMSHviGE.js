const e=`# Common mistakes: rocket equation\r
\r
## Conceptual errors\r
\r
### Error 1: Confusing the formal definition of rocket equation with everyday intuition\r
\r
**Why it seems correct:**\r
Everyday intuition about rocket equation works in simple contexts, so it seems always correct.\r
\r
**Why it is wrong:**\r
The physics definition of rocket equation includes restrictions (vector nature, sign, reference frame) that intuition ignores.\r
\r
**Detection signal:**\r
...
A student applies rocket equation without considering the vector sign and gets a positive result where it should be negative; the magnitude is correct but the direction is not.\r
\r
## Model errors\r
\r
### Error 2: Applying the ideal model of rocket equation outside its validity domain\r
\r
**Why it seems correct:**\r
...
\r
**Mini contrast example:**\r
Applying the ideal formula for rocket equation at relativistic speeds gives >5 % error when v > 0.1c.\r
\r
## Mathematical errors\r
\r
### Error 3: Sign error when projecting vectors in the calculation of rocket equation\r
\r
**Why it seems correct:**\r
...
\r
**Mini contrast example:**\r
A particle moves leftward along the x-axis. If a positive velocity is used instead of a negative one, the computed momentum points the wrong way.\r
\r
...
\r
**Mini contrast example:**\r
The student computes a negative linear momentum and writes only the magnitude, discarding the sign information. The negative sign indicates the opposite direction to the chosen axis, which is lost information.\r
\r
