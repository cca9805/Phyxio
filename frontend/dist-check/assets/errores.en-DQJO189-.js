const n=`# Common mistakes: definition of angular momentum\r
\r
## Conceptual errors\r
\r
### Error 1: Confusing the formal definition of definition of angular momentum with everyday intuition\r
\r
**Why it seems correct:**\r
Everyday intuition about definition of angular momentum works in simple contexts, so it seems always correct.\r
\r
**Why it is wrong:**\r
The physics definition of definition of angular momentum includes restrictions (vector nature, sign, reference frame) that intuition ignores.\r
\r
**Detection signal:**\r
...
A student applies definition of angular momentum without considering the vector sign and gets a positive result where it should be negative; the magnitude is correct but the direction is not.\r
\r
## Model errors\r
\r
### Error 2: Applying the ideal model of definition of angular momentum outside its validity domain\r
\r
**Why it seems correct:**\r
...
\r
**Mini contrast example:**\r
Applying the ideal formula for definition of angular momentum at relativistic speeds gives >5 % error when\r
\r
{{f:p}}\r
\r
.\r
...
\r
### Error 3: Sign error when projecting vectors in the calculation of definition of angular momentum\r
\r
**Why it seems correct:**\r
