...
For the third harmonic, with [[n]] equal to 3, the erroneous student calculates the wavelength by dividing 1.5 m by 3, obtaining 0.5 m and triple the real frequency. The correct calculation divides twice 1.5 m by 3, giving 1.0 m, 50 % lower frequency than the wrong estimate.
...
The **fundamental** is strictly the lowest frequency harmonic, the case where [[n]] is 1, regardless of its intensity. The ear may perceive melodic **pitch** as the fundamental even if physically attenuated (virtual pitch effect), but physically the fundamental remains the frequency corresponding to velocity divided by twice the length.
...
The fundamental is the harmonic with [[n]] equal to 1, the lowest possible frequency for that fixed-end system. Its relative intensity depends on the excitation mechanism but its definition is purely frequency-based: the fundamental is lower than the second harmonic, which is lower than the third, and so on
