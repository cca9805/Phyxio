const e=`# Frequent errors in transformers
...
The student applies the same turns ratio to currents as to voltages, calculating [[I_2]] as [[I_1]] multiplied by [[N_2]]/[[N_1]], following direct proportionality logic.

**Why it is incorrect**

Power conservation requires that the voltage-current product remains constant. If voltage increases by ratio [[N_2]]/[[N_1]], current must decrease by that same proportion to conserve power. The correct current ratio follows [[N_2]]/[[N_1]], that is, the inverse of the voltage ratio.
...
With no load connected, the student reasons that there is no current in the secondary and therefore the primary current must be zero. The ideal model predicts exactly that: zero primary current when [[I_2]] is zero.
