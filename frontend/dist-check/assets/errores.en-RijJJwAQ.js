...
## Quick diagnosis\r
\r
Input error: using a datum without unit, scale, or a decision about whether it is constant. In proportionality and scaling, an isolated number rarely contains all the physical information.\r
\r
