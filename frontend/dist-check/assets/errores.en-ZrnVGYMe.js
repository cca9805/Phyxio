const e=`# Common errors in Vorticity and Circulation
...
**Detection signal**
The result looks numerically plausible but cannot explain which mechanism dominates or what observable change [[omega]] would produce.

**Conceptual correction**
Before operating, write a causal sentence: [[omega]] increases, decreases, or changes regime because it modifies a concrete part of the model.
...
**Conceptual correction**
Every transformation must preserve units, expected sign, and dependence on [[omega]]. If one of these three checks fails, the rearrangement is invalid.
...
**Detection signal**
The conclusion does not state what would happen if [[omega]] increased or decreased, and it does not mention validity, limit, or observable consequence.
...
Before accepting a solution, apply four controls: same system, coherent units, recognizable limiting case, and causal reading of [[omega]]. If one fails, the answer is not ready to be published as a physical conclusion.
`;export{e as default};
