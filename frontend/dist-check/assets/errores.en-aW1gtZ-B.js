...
Coulomb's law has [[r12]] squared in the denominator. The relationship is inverse-square, not inverse-linear. When [[r12]] doubles, [[F_C]] decreases by a factor of four, not two. This mathematical structure is a geometric consequence of the isotropic propagation of the interaction in three-dimensional space, and it is experimentally verified with very high precision.

**Detection signal**

If the student writes that doubling the distance halves the force, or constructs a table where [[F_C]] and [[r12]] change in the same proportion, this is an unambiguous sign of the error.
...
Two charges at 2 cm produce [[F_C]] of 1 N. When separated to 4 cm (double), the correctly computed force is 0.25 N. The classic error gives 0.5 N. The difference is a factor of two, which is experimentally detectable.
...
Coulomb's constant [[k_e]] is expressed in SI units (N·m²·C⁻²). For the dimensional analysis of the formula to be consistent, [[r12]] must be in metres. Using centimetres without converting introduces a factor of 10⁻² in [[r12]] which, when squared in the denominator, produces a four-order-of-magnitude error in [[F_C]].

**Detection signal**

The result of [[F_C]] is ten thousand times larger than the correct value for the same configuration. Or the student writes the distance in centimetres (for example, five) and substitutes it directly into the formula without converting to metres.
...
Two charges of 1 μC at 10 cm separation. With [[r12]] in metres (0.10 m): [[F_C]] ≈ 0.9 N. With [[r12]] in centimetres (10): the incorrectly computed [[F_C]] is 9×10⁻⁴ N. The four-order-of-magnitude difference is undetectable without a unit check.

## Interpretation errors

### Error 5: Interpreting negative [[F_C]] as attractive force
...
The student computes [[F_C]] as the algebraic product (with sign) of [[q1]], [[q2]], [[k_e]] and the inverse square of [[r12]], and then interprets the negative result as an attractive force, accepting it as correct.

**Conceptual correction**

The magnitude of [[F_C]] is always computed using the absolute values of the charges. The attractive or repulsive character is qualitative information determined by comparing the signs of [[q1]] and [[q2]], and communicated by describing the vector direction of the force, not as the sign of the magnitude.
...
1. Is the magnitude of [[F_C]] positive? If not, there is an error in the formula used.
2. Has [[r12]] been converted to metres? Multiply by 0.01 if it was in centimetres.
3. Does doubling [[r12]] reduce [[F_C]] to one quarter? Verify with a simple case.
