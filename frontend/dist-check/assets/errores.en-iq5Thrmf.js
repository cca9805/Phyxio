...
**Why it is incorrect**
Electromagnetic radiation is not a physical vibration of atoms, but the self-induced oscillation of electric fields [[E0]] and magnetic fields [[B0]] in empty space. According to the laws of electromagnetism, a time-varying field mutually and perpetually induces the other without depending on matter.

**Detection signal**
Attempting to search for a particle density term or elastic modulus of the medium when calculating the speed of light [[c]].
...
**Why it is incorrect**
In the International System of Units, the electric field [[E0]] (in volts per meter) and the magnetic field [[B0]] (in teslas) are scaled by the immense constant of the speed of light [[c]]. This causes a large asymmetry in their numerical values.

**Detection signal**
Obtaining numerical results where the magnetic amplitude [[B0]] is of the same order of magnitude as the electric amplitude [[E0]] (e.g., obtaining a magnetic field of 10 T for an electric field of 10 V/m).

**Conceptual correction**
Always use the relation [[E0]] = [[c]] [[B0]]. The numerical value of the magnetic field in the SI will always be minuscule compared to the electric field.
...
**Conceptual correction**
Both [[E0]] and [[B0]] reach their maxima, minima, and zeros in perfect temporal and spatial synchrony in a free plane wave.
...
Before accepting any calculation or analysis, apply this infallible operational rule: always multiply the found value of the magnetic field [[B0]] by the speed of light scale factor \\(3 \\cdot 10^8\\,\\mathrm{m/s}\\). The result obtained must be identical to the value of your electric field [[E0]]. If they do not match by this immense scale factor, you have committed an algebraic or units error.
`;export{e as default};
