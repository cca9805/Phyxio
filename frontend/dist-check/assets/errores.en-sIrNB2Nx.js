const e=`# Common Errors in the Differential Formulation
...
**Why it is incorrect**: They have opposite physical and geometric meanings. [[divE]] measures how much the field "leaves" or "enters" an infinitesimal point (charge sources), while [[curlE]] measures how much the field "spins" or circulates locally around that point. A high divergence does not imply a high curl, and vice versa.
...
**Why it is incorrect**: Without the term proportional to the time variation of the electric field [[dE_dt]], Maxwell's equations are mathematically inconsistent in the presence of varying fields and violate the law of conservation of charge. Furthermore, this term is what physically allows the fields to self-sustain as waves traveling through the vacuum.
...
**Why it seems correct**: In early learning, it is tempting to insert the total charge in Gauss's differential law instead of the volumetric charge density [[rho]], or the total current instead of the density [[J]].
...
**Why it seems correct**: An attempt is made to calculate the [[divE]] or [[curlB]] right at the boundary or separation surface between two materials (such as air and metal) to see how the field changes when "crossing".
