const e=`# Frequent errors in Small Oscillations and Normal Modes\r
\r
## Conceptual errors\r
\r
### Error 1: Treating notation as physics\r
\r
Why it seems correct: the symbols of Small Oscillations and Normal Modes look powerful and compact.\r
\r
Why it is incorrect: [[omega]] only has physical meaning when the domain assumptions are satisfied.\r
\r
...
\r
Why it is incorrect: the interpretation is organized around [[omega]], because it determines the physical reading of the leaf.\r
\r
Detection signal: the final answer contains formulas but no statement about what [[omega]] means.\r
\r
Conceptual correction: end every solution with a sentence about the physical role of [[omega]].\r
\r
