const e=`version: 1\r
formulas:\r
- id: fuerza_ficticia_traslacional\r
  title:\r
    es: Fuerza ficticia traslacional\r
    en: Translational fictitious force\r
  ...
  physical_meaning:\r
    es: Relacion fisica usada en concepto fuerzas ficticias.\r
    en: Physical relation used in the concept of fictitious forces.\r
  constraints:\r
  - expr: m > 0\r
    message:\r
...
- id: segunda_ley_marco_no_inercial\r
  title:\r
    es: Segunda ley en marco no inercial (1D)\r
    en: Second law in a non-inertial frame (1D)\r
  ...
  - target: F_fict\r
    ...
    constraints: []\r
  - target: m\r
    equation: m = (F_res + F_fict)/a_rel\r
    latex: m=\\frac{F_{res}+F_{fict}}{a_{rel}}\r
    constraints: []\r
  category: operative\r
  relation_type: derived_relation\r
  physical_meaning:\r
  ...
  - expr: a_rel != 0\r
    message:\r
      es: a_rel no puede ser 0 para despejar m.\r
      en: a_rel cannot be zero when solving for m.\r
  validity:\r
    es: Valida dentro del dominio de aplicacion del modelo usado.\r
    en: Valida dentro del dominio de aplicacion del modelo usado.\r
  dimension_check: Comprobar unidades antes de interpretar.\r
  ...
  - when: 'true'\r
    message:\r
      es: Comprueba signos, unidades y significado del resultado.\r
      en: Check signs, units, and meaning of the result.\r
- id: relacion_aceleraciones\r
  title:\r
    es: Relacion entre aceleraciones (traslacion)\r
    en: Relation between accelerations (translation)\r
  ...
  - when: 'true'\r
    message:\r
      es: Comprueba signos, unidades y significado del resultado.\r
      en: Check signs, units, and meaning of the result.\r
- id: ecuacion_vectorial_conceptual\r
  title:\r
    es: Ecuacion vectorial completa (conceptual)\r
    en: Complete vector equation (conceptual)\r
  equation: F_res + F_fict = m*a_rel\r
  latex: \\sum\\vec F_{res}+\\vec F_{fict}=m\\vec a_{rel}\r
  rearrangements: []\r
  category: operative\r
  relation_type: derived_relation\r
  physical_meaning:\r
  ...
  motivo_no_calculable:\r
    es: Es una relacion vectorial general. La calculadora opera con proyecciones escalares\r
      por eje.\r
    en: It is a general vector relation. The calculator operates with scalar projections\r
      along each axis.\r
  used_in:\r
  - concepto-fuerzas-ficticias\r
  interpretation_tags:\r
