...
- id: m
  ...
  si_unit: kg
formulas:
- id: aceleracion_rotante_general
  title:
    es: Aceleracion en marco rotante
    en: Aceleracion en marco rotante
  equation: a_abs=a_abs
  latex: \\vec a=\\vec a_O+\\vec a_{rel}+2\\vec\\Omega\\times\\vec v_{rel}+\\vec\\Omega\\times(\\vec\\Omega\\times\\vec r)+\\dot{\\vec\\Omega}\\times\\vec r
  ...
  - target: a_abs
    equation: a_abs=a_abs
    latex: \\vec a=\\vec a_O+\\vec a_{rel}+2\\vec\\Omega\\times\\vec v_{rel}+\\vec\\Omega\\times(\\vec\\Omega\\times\\vec r)+\\dot{\\vec\\Omega}\\times\\vec r
- id: fuerza_coriolis_vectorial
  title:
    es: Fuerza de Coriolis vectorial
    en: Fuerza de Coriolis vectorial
  equation: a_rel=a_rel
  latex: \\vec F_{cor}=-2m\\vec\\Omega\\times\\vec v_{rel}
  category: fundamental
  relation_type: model_relation
  physical_meaning:
    es: Relacion nuclear del leaf; vincula magnitudes medibles con una decision fisica sobre regimen, validez o reduccion del modelo.
  ...
  - target: a_rel
    equation: a_rel=a_rel
    latex: \\vec F_{cor}=-2m\\vec\\Omega\\times\\vec v_{rel}
- id: fuerza_centrifuga_vectorial
  title:
    es: Fuerza centrifuga vectorial
    en: Fuerza centrifuga vectorial
  equation: r=r
  latex: \\vec F_{cf}=-m\\vec\\Omega\\times(\\vec\\Omega\\times\\vec r)
  category: fundamental
  relation_type: model_relation
  physical_meaning:
    es: Relacion nuclear del leaf; vincula magnitudes medibles con una decision fisica sobre regimen, validez o reduccion del modelo.
...
- id: fuerza_euler
  title:
    ...
    en: Fuerza de Euler
  equation: F_E=F_E
  latex: \\vec F_E=-m\\dot{\\vec\\Omega}\\times\\vec r
  category: fundamental
  relation_type: model_relation
  physical_meaning:
    es: Relacion nuclear del leaf; vincula magnitudes medibles con una decision fisica sobre regimen, validez o reduccion del modelo.
