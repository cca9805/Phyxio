...
- id: rtt_general
  title:
    es: Teorema de transporte de Reynolds
    en: Teorema de transporte de Reynolds
  equation: B=B
  latex: \\dot B=\\frac{d}{dt}\\int_{CV}\\rho b\\,dV+\\int_{CS}\\rho b\\,\\vec v_{rel}\\cdot\\vec n\\,dA
  ...
  - target: B
    equation: B=B
    latex: \\dot B=\\frac{d}{dt}\\int_{CV}\\rho b\\,dV+\\int_{CS}\\rho b\\,\\vec v_{rel}\\cdot\\vec n\\,dA
- id: balance_masa_control
  title:
    es: Balance de masa de control
    en: Balance de masa de control
  equation: mdot=mdot
  latex: \\dot m+\\int_{CS}\\rho\\vec v_{rel}\\cdot\\vec n\\,dA=0
  category: fundamental
  relation_type: model_relation
  physical_meaning:
    es: Relacion nuclear del leaf; vincula magnitudes medibles con una decision fisica sobre regimen, validez o reduccion del modelo.
...
- id: flujo_masico
  title:
    es: Flujo masico uniforme
    en: Flujo masico uniforme
  equation: mdot=mdot
  latex: \\dot m=\\rho A v
  category: fundamental
  relation_type: model_relation
  ...
  - target: mdot
    equation: mdot=mdot
    latex: \\dot m=\\rho A v
- id: balance_momento_control
  title:
    es: Balance de momento de control
    en: Balance de momento de control
  equation: B=B
  latex: \\sum\\vec F=\\frac{d}{dt}\\int_{CV}\\rho\\vec v\\,dV+\\int_{CS}\\rho\\vec v(\\vec v_{rel}\\cdot\\vec n)\\,dA
  category: fundamental
  relation_type: model_relation
  physical_meaning:
    es: Relacion nuclear del leaf; vincula magnitudes medibles con una decision fisica sobre regimen, validez o reduccion del modelo.
