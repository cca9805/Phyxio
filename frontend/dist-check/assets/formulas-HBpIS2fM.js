...
- id: P
  ...
  dimension_check: { es: M L T^-1, en: M L T^-1 }
  calculable: true
  motivo_no_calculable: null
  used_in: [ theory ]
  interpretation_tags: [ definicion, estado ]
  result_semantics: { target: P, meaning: Momento lineal de la partícula. }
  domain_checks: []
  coherence_checks: []
  graph_implications: [ Relación lineal entre momento y velocidad para una masa constante. ]
  pedagogical_triggers: []
...
- id: DeltaP
  ...
  motivo_no_calculable: null
  used_in: [ theory ]
  interpretation_tags: [ cambio, balance ]
  result_semantics: { target: DeltaP, meaning: Variación neta del momento total. }
  domain_checks: []
  coherence_checks: []
  graph_implications: [ Representa el salto vertical entre dos niveles de momento constante. ]
  pedagogical_triggers: []
...
- id: cond
  ...
  constraints: []
  validity:
    es: Requisito estricto para la aplicación del principio de conservación.
    en: Strict requirement for applying the conservation principle.
  dimension_check: { es: M L T^-2, en: M L T^-2 }
  calculable: false
  motivo_no_calculable: Se trata de una condición lógica de contorno, no de un cálculo operativo.
  used_in: [ theory ]
  interpretation_tags: [ condicion, aislamiento ]
  result_semantics: { target: Fext, meaning: Fuerza neta externa nula. }
  domain_checks: []
  coherence_checks: []
  graph_implications: [ Asegura que la pendiente del momento respecto al tiempo sea cero. ]
  pedagogical_triggers: []
...
- id: pi
  ...
  - target: v1i
    ...
    latex: \\vec{v}_{1i} = \\frac{\\vec{P}_i - m_2 \\vec{v}_{2i}}{m_1}
    constraints: [ { expr: m1 > 0 } ]
  constraints: []
  validity:
  ...
  motivo_no_calculable: null
  used_in: [ theory ]
  interpretation_tags: [ suma, inicial ]
  result_semantics: { target: Pinitial, meaning: Momento total de entrada. }
  domain_checks: []
  coherence_checks: []
  graph_implications: [ Define el valor de la meseta inicial en la gráfica de P(t). ]
  pedagogical_triggers: []

- id: pf
  title:
    es: Momento Lineal Final (Suma)
    en: Final Linear Momentum (Sum)
  equation: Pfinal = m1*v1f + m2*v2f
  latex: \\vec{P}_f = m_1 \\vec{v}_{1f} + m_2 \\vec{v}_{2f}
  category: formal
  relation_type: definition
  physical_meaning:
    es: Suma de los momentos de las partículas después de la interacción.
    en: Sum of the momenta of the particles after the interaction.
  rearrangements:
  - target: v1f
    equation: v1f = (Pfinal - m2*v2f)/m1
    latex: \\vec{v}_{1f} = \\frac{\\vec{P}_f - m_2 \\vec{v}_{2f}}{m_1}
    constraints: [ { expr: m1 > 0 } ]
  constraints: []
  validity:
    es: Válida para un sistema de dos partículas tras la interacción.
    en: Valid for a two-particle system after interaction.
  dimension_check: { es: M L T^-1, en: M L T^-1 }
  calculable: true
  motivo_no_calculable: null
  used_in: [ theory ]
  interpretation_tags: [ suma, final ]
  result_semantics: { target: Pfinal, meaning: Momento total de salida. }
  domain_checks: []
  coherence_checks: []
  graph_implications: [ Define el valor de la meseta final en la gráfica de P(t). ]
  pedagogical_triggers: []
`;export{n as default};
