...
La necesidad no era academica. Telegrafia, instrumentacion temprana y diseno de fuentes requerian estimar corrientes y caidas sin rehacer el razonamiento completo para cada configuracion. Sin una nocion de [[Req]], cada ajuste de componente exigia recomenzar desde cero y la tasa de errores crecia.

## Dificultad conceptual previa
La dificultad principal consistia en separar dos ideas que en la intuicion inicial se mezclaban: continuidad de [[I]] y reparto de [[Vi]]. Mucha gente interpretaba que cada elemento "gastaba" corriente, de modo que se esperaba una [[I]] distinta en distintos puntos de una cadena serie. Esa lectura era plausible desde la experiencia cotidiana, pero incompatible con conservacion de carga en regimen estacionario.

Otra dificultad fue distinguir topologia de parametro. Cambiar un [[Ri]] no cambia el hecho de que la ruta sea unica, pero si cambia el reparto de [[Vt]] y la magnitud de [[I]]. Sin ese marco, se confundian cambios estructurales con cambios numericos y el analisis perdia poder explicativo.

## Qué cambió
El cambio decisivo fue adoptar un enfoque de modelo: reemplazar la cadena por una resistencia equivalente [[Req]] para calcular estado global y luego recuperar estado local con caidas [[Vi]]. Este paso permitio unificar calculo rapido y lectura fisica.

Con la integracion de leyes de malla, el metodo gano una verificacion natural: la suma de caidas debia reconstruir [[Vt]] bajo una convencion de signos coherente. Asi, el analisis dejo de ser una lista de recetas y se convirtio en una estructura con chequeos internos de consistencia.
