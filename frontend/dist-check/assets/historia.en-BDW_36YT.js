const e=`# History of Euler Equations for a Rigid Body

## Historical problem

The historical problem was finding a way to preserve physical reading when systems could no longer be reduced to a single elementary law. Euler equations describe rigid-body rotation in principal axes, where each angular component couples to the other two. The student learns that in three dimensions moment of inertia is not a single number.
