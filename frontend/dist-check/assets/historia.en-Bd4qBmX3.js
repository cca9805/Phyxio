const e=`# History of Effective Potential and Radial Equation

## Historical problem

The historical problem was finding a way to preserve physical reading when systems could no longer be reduced to a single elementary law. Effective potential converts the geometry of a central orbit into a radial energy reading. The angular barrier is not a new force: it summarizes the geometric resistance to falling toward the center when angular momentum is conserved.
