const e=`# History of Euler Equation for Fluids

## Historical problem

The historical problem was finding a way to preserve physical reading when systems could no longer be reduced to a single elementary law. Euler equation for fluids expresses the balance among material inertia, pressure, and body forces when viscosity is neglected. Its didactic value is showing where ideal-fluid reasoning begins and where it ends.
