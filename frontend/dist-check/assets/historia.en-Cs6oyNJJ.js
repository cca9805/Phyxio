const e=`# History of Nonholonomic Constraints

## Historical problem

The historical problem was finding a way to preserve physical reading when systems could no longer be reduced to a single elementary law. A nonholonomic constraint restricts admissible velocities and cannot always be integrated into a position constraint. The didactic point is understanding that not every differential condition simply reduces the number of coordinates.
