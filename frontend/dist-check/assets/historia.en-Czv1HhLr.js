const e=`# History of Reynolds Transport Theorem

## Historical problem

The historical problem was finding a way to preserve physical reading when systems could no longer be reduced to a single elementary law. Reynolds transport theorem translates a law written for a material system into a control-volume balance. The didactic key is separating accumulation inside the volume from flux crossing its boundary.
