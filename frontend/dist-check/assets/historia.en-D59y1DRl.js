const e=`# History of the Field of Continuous Charge Distributions
...
Siméon Denis Poisson was the first to formulate, between 1812 and 1813, the complete mathematical theory of the potential of continuous distributions. He explicitly introduced the volume density [[rho_vol]] as a function of space, established the differential equation bearing his name — connecting the charge distribution to the electric potential — and demonstrated that integrating [[dE]] over the entire distribution yielded the resultant field [[E]] by superposition. This advance transformed the computation of the electric field from a vague physical problem into a systematic mathematical procedure.

Carl Friedrich Gauss complemented this advance in 1835 with his flux law: the flux of [[E]] through any closed surface is proportional to the total enclosed charge. This formulation is mathematically equivalent to direct integration of [[dE]], but exploits geometric symmetry far more efficiently for the infinite wire, infinite plane, and sphere.
