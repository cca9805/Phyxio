...
The first systematic studies were carried out by Charles Dalziel at the University of California (Berkeley) during the 1940s and 1950s. Dalziel asked whether it was possible to define safety curves in the current-time plane that separated safe from dangerous conditions for humans. His work, continued by European researchers such as Biegelmeier in Austria, laid the foundations for what is now IEC 60479 —the document establishing the [[I_segura]] thresholds used in all domestic electrical protection design worldwide.
...
The standardization of physiological thresholds radically transformed electrical installation design. Before IEC 60479, differentials were designed empirically with arbitrary safety intervals. Afterward, the entire design chain —from differential sensitivity ([[I_diferencial]]) to maximum ground resistance— was derived from physiological thresholds through Ohm's Law applied to the human body.

The deepest impact was conceptual: it unified electrical physics (Ohm's Law applied to the body) with cardiac physiology (susceptible oscillator model) into a single predictive framework. Body resistance [[R_cuerpo]] ceased to be a biological curiosity and became the central design parameter of electrical protection systems worldwide.
...
The same physics of [[I_cuerpo]] that protects people from domestic risks is applied at the opposite end of the spectrum: cardiac defibrillation uses currents of 1–10 A for 5–10 ms to restore normal sinus rhythm to a fibrillating heart. The quantitative understanding of physiological thresholds makes it possible both to protect from accidental damage and to reverse damage already produced.
`;export{e as default};
