const e=`# History and evolution of plugs and sockets\r
\r
## Historical problem\r
\r
The central problem that motivated the development of the domestic socket was to connect and disconnect electrical devices from the network without modifying the fixed installation wiring. In the first domestic distribution systems (Edison, Swan, 1880s), devices were connected directly to the terminals of the fixed installation, implying high risk and making portable device use impossible. The need for a safe, repeatable connection point manipulable by users without technical knowledge defined the design problem.\r
\r
## Prior conceptual difficulty\r
\r
The main difficulty was not electrical but mechanical: creating a repeatable metallic contact with low [[R_contacto]] that did not degrade with use and was safe for manipulation. The first open-pin plugs (without insulating casing over the pins) allowed accidental contact with live conductors. Introducing insulated-casing pins and guided insertion geometry solved the safety problem, but created a new challenge: ensuring [[R_contacto]] remained low after thousands of insertion and extraction cycles.\r
\r
