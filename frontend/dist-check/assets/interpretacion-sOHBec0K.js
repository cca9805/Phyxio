const e=`version: 2\r
id: interpretacion-definicion-fuerza-coriolis\r
leaf_id: definicion-fuerza-coriolis\r
nombre:\r
  es: Interpretacion de Definicion fuerza coriolis\r
  en: Interpretation of Definition of the Coriolis Force\r
scope:\r
...
dependencies:\r
  formulas:\r
  - modulo_fuerza_coriolis\r
  - aceleracion_coriolis\r
  - relacion_fuerza_aceleracion\r
...
targets:\r
  F_cor:\r
    ...
    - id: F_cor_physical
      ...
      status: info
      text:
        es: F_cor aumenta porque crecen omega, v_rel o sin(alpha), y por tanto indica una desviacion lateral mas intensa dentro del marco rotatorio.
        en: F_cor grows because omega, v_rel, or sin(alpha) grow, and therefore it indicates a stronger lateral deflection inside the rotating frame.
  ...
  a_cor:\r
    ...
    - id: a_cor_physical\r
      ...
      status: info\r
      text:\r
        es: La lectura de a_cor debe conectarse con el fenomeno fisico descrito.\r
        en: The reading of a_cor must connect with the described physical phenomenon.\r
    model_validity_rules:\r
    - id: a_cor_validity\r
      when: 'true'\r
      status: ok\r
