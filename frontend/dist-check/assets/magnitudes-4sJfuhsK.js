...
magnitudes:
  - id: R_amp
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Confundir el signo de [[R_amp]] con energia negativa; el signo solo indica fase de la onda reflejada."
    typical_range: "[-1, 1] en interfaces pasivas a incidencia normal"
    value_nature:
      kind: scalar_signed
  ...
  - id: T_amp
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Pensar que [[T_amp]] mayor que uno viola energia; la energia tambien depende de la impedancia."
    typical_range: "[0, 2] en interfaces pasivas a incidencia normal"
    value_nature:
  ...
  - id: R_E
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Usar [[R_amp]] directamente como fraccion de energia; para energia se usa [[R_E]]."
    typical_range: "[0, 1] para interfaces pasivas"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
  ...
  - id: T_E
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Olvidar que [[T_E]] debe cerrar el balance energetico con [[R_E]] en incidencia normal sin perdidas."
    typical_range: "[0, 1] para interfaces pasivas"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
  ...
  - id: Z_1
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Invertir [[Z_1]] y [[Z_2]] cambia el signo de [[R_amp]] y altera la lectura de fase."
    typical_range: "10^3 a 10^8 Pa s/m segun el medio"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
      expected_interval: "[10^3, 10^8] Pa s/m"
    nombre:
  ...
  - id: Z_2
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Tratar [[Z_2]] como una propiedad del defecto sin especificar el medio transmitido real."
    typical_range: "10^3 a 10^8 Pa s/m segun el medio"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
  ...
  - id: Z_medio
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Calcular [[Z_medio]] con densidad de un material y velocidad de otro medio."
    typical_range: "10^2 a 10^8 Pa s/m desde gases hasta metales"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
      expected_interval: "[10^2, 10^8] Pa s/m"
    nombre:
  ...
  - id: rho_medio
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Usar una densidad nominal sin comprobar que corresponde al medio donde viaja la onda."
    typical_range: "1 a 22000 kg/m^3"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
      expected_interval: "[1, 22000] kg/m^3"
    nombre:
  ...
  - id: v_onda
    ...
    used_in:
      ...
      - ejemplos
      - interpretacion
    common_mistake: "Mezclar velocidad longitudinal y transversal al calcular la impedancia de la interfaz."
    typical_range: "300 a 12000 m/s segun el medio y el tipo de onda"
    value_nature:
      kind: scalar_unsigned
      nonnegative_only: true
      expected_interval: "[300, 12000] m/s"
    nombre:
