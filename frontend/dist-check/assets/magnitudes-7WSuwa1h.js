...
- id: theta
  ...
  descripcion:
    es: Ángulo girado usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Angular displacement used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: rad
  dimension: '1'
  is_vector: false
  components: null
...
- id: omega
  ...
  nombre:
    ...
    en: angular velocity
  descripcion:
    es: Velocidad angular usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Angular velocity used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: rad/s
  dimension: T^{-1}
  is_vector: false
  components: null
...
- id: alpha
  ...
  descripcion:
    es: Aceleración angular usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Angular acceleration used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: rad/s^2
  dimension: T^{-2}
  is_vector: false
  components: null
...
- id: tau
  ...
  nombre:
    ...
    en: torque
  descripcion:
    es: Torque usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Torque used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: N m
  dimension: ML^2T^{-2}
  is_vector: false
  components: null
...
- id: I
  ...
  descripcion:
    es: Momento de inercia usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Moment of inertia used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: kg m^2
  dimension: ML^2
  is_vector: false
  components: null
...
- id: R
  ...
  nombre:
    ...
    en: radius
  descripcion:
    es: Radio usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Radius used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: m
  dimension: L
  is_vector: false
  components: null
...
- id: m
  ...
  nombre:
    ...
    en: mass
  descripcion:
    es: Masa usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Mass used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: kg
  dimension: M
  is_vector: false
  components: null
...
- id: v_cm
  ...
  descripcion:
    es: Velocidad del centro de masas usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Center-of-mass velocity used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: m/s
  dimension: LT^{-1}
  is_vector: false
  components: null
...
- id: a_cm
  ...
  descripcion:
    es: Aceleración del centro de masas usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Center-of-mass acceleration used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: m/s^2
  dimension: LT^{-2}
  is_vector: false
  components: null
...
- id: K_total
  ...
  descripcion:
    es: Energía cinética total usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Total kinetic energy used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: J
  dimension: ML^2T^{-2}
  is_vector: false
  components: null
...
- id: E_total
  ...
  descripcion:
    es: Energía mecánica total usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Total mechanical energy used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: J
  dimension: ML^2T^{-2}
  is_vector: false
  components: null
...
- id: g
  ...
  descripcion:
    es: Gravedad usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Gravitational acceleration used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: m/s^2
  dimension: LT^{-2}
  is_vector: false
  components: null
...
- id: phi
  ...
  nombre:
    ...
    en: incline angle
  descripcion:
    es: Ángulo del plano usada para interpretar estrategia-para-problemas-de-rodadura.
    en: Incline angle used to interpret estrategia-para-problemas-de-rodadura.
  unidad_si: rad
  dimension: '1'
  is_vector: false
  components: null
