...
- id: Xc
  ...
  unidad_si: ohm
  descripcion:
    es: Oposición al paso de corriente alterna debida al capacitor, dependiente de frecuencia.
    en: Opposition to alternating current caused by the capacitor, frequency-dependent.
  dimension: ML^2T^{-3}I^{-2}
  is_vector: false
  components: []
  category: derived
  physical_role: physical_quantity
  used_in: [ reactancia_capacitiva, corriente_capacitiva, reactiva_capacitiva ]
  common_mistake: Tratarla como resistencia disipativa constante.
  typical_range: Disminuye al aumentar frecuencia o capacitancia.
  sign_behavior:
    has_sign: false
    meaning:
  ...
  zero_behavior:
    allowed: false
    meaning:
      es: En modelo ideal no puede anularse para frecuencia finita.
      en: In ideal model it cannot vanish at finite frequency.
  value_nature:
    kind: scalar
    nonnegative_only: true
    expected_interval: '(0, inf)'
  interpretation_role:
    primary_for: [ reactancia-capacitiva ]
    secondary_for: [ corriente-alterna ]
  graph_binding:
    channels: [ reactancia ]
  pedagogical_notes: Es clave distinguir su carácter no disipativo.
- id: omega
  symbol: \\omega
  nombre:
  ...
  category: parameter
  physical_role: physical_quantity
  used_in: [ reactancia_capacitiva, omega_f ]
  ...
  graph_binding:
    channels: [ frecuencia ]
  pedagogical_notes: Controla la escala temporal del fenómeno capacitivo.
- id: C
  symbol: C
  nombre:
    es: capacitancia
  ...
  unidad_si: F
  descripcion:
    es: Capacidad del capacitor para almacenar carga por unidad de tensión.
    en: Ability of the capacitor to store charge per unit voltage.
  dimension: M^{-1}L^{-2}T^{4}I^{2}
  is_vector: false
  components: []
  category: parameter
  physical_role: physical_quantity
  used_in: [ reactancia_capacitiva ]
  common_mistake: No convertir microfaradios a faradios.
  typical_range: Positiva y definida por diseño del componente.
  sign_behavior:
    has_sign: false
    meaning:
  ...
  zero_behavior:
    allowed: false
    meaning:
      es: Cero eliminaría el comportamiento capacitivo.
      en: Zero would remove capacitive behavior.
  value_nature:
    kind: scalar
    nonnegative_only: true
    expected_interval: '(0, inf)'
  ...
  graph_binding:
    channels: [ parametro ]
  pedagogical_notes: Su efecto en reactancia es inverso y no lineal con frecuencia.
- id: f
  symbol: f
  nombre:
    es: frecuencia
  ...
  zero_behavior:
    allowed: true
    meaning:
      es: En cero el capacitor ideal se aproxima a circuito abierto.
      en: At zero, the ideal capacitor approaches open circuit behavior.
  value_nature:
    kind: scalar
    nonnegative_only: true
    expected_interval: '[0, inf)'
  ...
  graph_binding:
    channels: [ frecuencia ]
  pedagogical_notes: Determina la rapidez con que varía la reactancia capacitiva.
- id: V
  symbol: V
  nombre:
    es: tension eficaz
  ...
  unidad_si: V
  descripcion:
    es: Tensión eficaz aplicada a la rama capacitiva.
    en: RMS voltage applied to the capacitive branch.
  dimension: ML^2T^{-3}I^{-1}
  is_vector: false
  components: []
  category: parameter
  physical_role: physical_quantity
  used_in: [ corriente_capacitiva, reactiva_capacitiva ]
  ...
  zero_behavior:
    allowed: true
    meaning:
      es: Si es cero no hay corriente capacitiva forzada.
      en: If zero there is no forced capacitive current.
  value_nature:
    kind: scalar
    nonnegative_only: true
    expected_interval: '[0, inf)'
  interpretation_role:
    primary_for: []
    secondary_for: [ reactancia-capacitiva ]
  graph_binding:
    channels: [ excitacion ]
...
- id: Ic
  ...
  unidad_si: A
  descripcion:
    es: Corriente eficaz que circula por la rama capacitiva en AC.
    en: RMS current flowing through the capacitive branch in AC.
  dimension: I
  is_vector: false
  components: []
  category: derived
  ...
  typical_range: Crece al disminuir reactancia capacitiva.
  sign_behavior:
    has_sign: false
    meaning:
  ...
  graph_binding:
    channels: [ corriente ]
  pedagogical_notes: Conecta la oposición capacitiva con exigencia de corriente de línea.
- id: Qc
  symbol: Q_C
  nombre:
  ...
  unidad_si: var
  descripcion:
    es: Magnitud de intercambio reactivo asociado a la rama capacitiva.
    en: Magnitude of reactive exchange associated with the capacitive branch.
  dimension: ML^2T^{-3}
  is_vector: false
  components: []
  category: derived
  physical_role: physical_quantity
  used_in: [ reactiva_capacitiva ]
