...
niveles:
  ...
  - University
icon: 🌀
descripcion: Vorticidad y circulacion en mecanica avanzada.
description_en: Vorticity and Circulation in advanced mechanics.
descripcion_corta: vorticidad mide giro local y circulacion resume el giro acumulado alrededor de un contorno
...
pregunta_fisica_central:
  es: ¿Como conectan vorticidad y circulacion la rotacion local del fluido con efectos globales de sustentacion?
  en: How do vorticity and circulation connect local fluid rotation with global lift effects?
prerequisitos:
