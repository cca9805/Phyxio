...
niveles:
  ...
  - University
icon: 📐
descripcion: Ecuacion de Binet y orbitas en mecanica avanzada.
description_en: Binet Equation and Orbits in advanced mechanics.
descripcion_corta: la ecuacion de Binet usa el radio inverso para convertir dinamica central en geometria orbital
magnitud_dominante: u
representacion_dominante: none
physical_role:
  es: metodo de resolucion
  en: resolution method
pregunta_fisica_central:
  es: ¿Como transforma la ecuacion de Binet una fuerza central en la forma geometrica de la orbita?
  en: How does Binet equation transform a central force into the geometric shape of the orbit?
prerequisitos:
