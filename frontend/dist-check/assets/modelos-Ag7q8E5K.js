const e=`# Modelos fisicos: precesion\r
\r
## Modelo ideal\r
\r
El modelo ideal de precesion supone que basta con relacionar torque aplicado y cambio gradual de la direccion del momento angular. Se conserva solo la estructura imprescindible para que la relacion principal describa el mecanismo dominante y para que la lectura del diagrama siga siendo limpia. En este nivel se eliminan detalles secundarios del material, del fluido o del contacto porque todavia no cambian la conclusion esencial. Esa simplificacion es valiosa siempre que el alumno pueda explicar que fenomeno se ha descartado y por que su ausencia no altera la interpretacion principal.\r
\r
## Hipótesis\r
\r
