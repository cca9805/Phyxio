const e=`\uFEFF# Principio de Pascal - Modelo y validez
...
Mientras que el modelo de Pascal es perfecto para el dimensionamiento básico de gatos y prensas, los modelos extendidos son obligatorios para diseñar sistemas de control de vuelo por cable (fly-by-wire) donde la latencia de la onda de presión y la deformación del aceite son críticas para la seguridad.\r
\r
\r
`;export{e as default};
