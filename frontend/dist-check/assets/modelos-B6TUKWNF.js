...
Las magnitudes que se conservan en el modelo son la rigidez a la flexión EI (producto de [[E_young]] por [[I_seccion]]) y la masa lineal [[rho_lin]]. Se ignora completamente la deformación por cortante transversal y la inercia rotacional de las secciones.
...
- **Material elástico lineal, isótropo y homogéneo:** [[E_young]] y [[rho_vol]] son constantes en toda la viga. Para materiales viscoelásticos o compuestos, los parámetros se vuelven funciones de la frecuencia o de la posición.

- **Sección transversal constante:** [[I_seccion]] y [[A_seccion]] no varían a lo largo del eje. Vigas de sección variable requieren métodos numéricos o la aproximación WKB.
...
Para vigas con amortiguamiento interno, el modelo se extiende reemplazando [[E_young]] real por un módulo complejo, lo que introduce atenuación dependiente de la frecuencia además de la dispersión.
...
| Validez | k·r_g menor que 0.3 | Todo el rango de frecuencias |
