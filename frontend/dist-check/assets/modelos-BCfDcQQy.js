const e=`# Modelos de Ligaduras no holonomas

## Modelo ideal

El modelo ideal supone que una ligadura no holonoma restringe velocidades admisibles y no puede integrarse siempre como restriccion de posicion. Se conserva la estructura que hace legible el fenomeno y se ignoran efectos secundarios como rozamiento residual, perturbaciones externas, deformaciones, ruido experimental o acoplamientos pequenos.

La simplificacion central es fisica: aisla el mecanismo que controla [[Aai]] y permite decidir si el resultado tiene sentido antes de introducir correcciones.
...
El modelo falla si [[Aai]] cambia de signo sin causa fisica, si un caso limite no recupera una expresion conocida, si las unidades no cierran o si una correccion crece hasta dominar el termino que se habia elegido como principal.
...
La transicion explicita es esta: cuando conviene pasar al modelo extendido, el dato observable ya no se explica con una ligadura no holonoma restringe velocidades admisibles y no puede integrarse siempre como restriccion de posicion y la correccion supera el orden de magnitud permitido.
