const e=`# Introducción al Sonido - Modelos y Validez
...
La **transición al modelo no lineal** es necesaria cuando la intensidad sonora es extrema. Conviene cambiar al modelo de acústica no lineal cuando la perturbación de presión perturbacion de presion supera el 10% de la presión ambiental. En este punto, las crestas de la onda viajan más rápido que los valles, lo que inevitablemente termina en la formación de una **onda de choque** (un salto discontinuo de presión). Asimismo, si se estudia el sonido en fluidos a escalas microscópicas (nanofluídica), el modelo de medio continuo debe abandonarse en favor de la dinámica molecular, ya que el sonido ya no "ve" un fluido suave, sino una lluvia de partículas individuales.`;export{e as default};
