...
El modelo ideal trata al capacitor como elemento puramente reactivo, con comportamiento lineal y sin pérdidas dominantes. En ese marco, la oposición [[Xc]] se explica solo por [[omega]] y [[C]], la corriente [[Ic]] se determina con tensión eficaz [[V]], y la magnitud [[Qc]] resume intercambio reactivo en régimen sinusoidal estacionario.
...
Cuarta hipótesis metrológica: [[V]] e [[Ic]] son magnitudes RMS coherentes y obtenidas en condiciones comparables. Quinta hipótesis operativa: frecuencia y capacitancia están expresadas con unidades correctas y trazables.

## Dominio de validez cuantitativo
Como criterio operativo, el modelo mínimo es fiable cuando THD <= 5%, cuando la frecuencia se mantiene dentro de 0.98 <= f_medida/f_nominal <= 1.02 y cuando el parámetro de pérdidas relativo se mantiene bajo, por ejemplo ESR/[[Xc]] <= 0.10 en la banda de trabajo principal.
...
La transición explícita es esta: cuando conviene cambiar a modelo alternativo ocurre si ESR/[[Xc]] > 0.10, si THD supera el 5%, o si la deriva de frecuencia sale del intervalo operacional definido. En esos casos, mantener el modelo ideal como único soporte de decisión puede producir diagnóstico incompleto.
