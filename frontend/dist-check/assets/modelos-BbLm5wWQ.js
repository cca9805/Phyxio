const e=`# Modelos de la ley de Biot Savart

## Modelo ideal

El modelo ideal es magnetostatico: la corriente [[I]] es estacionaria, el conductor es delgado y el medio se aproxima como vacio. En ese marco, cada elemento orientado [[dl]] produce una contribucion [[dB]] que luego se suma vectorialmente.

La simplificacion central consiste en tratar la corriente como una linea geometrica. Se conservan distancia [[r]], orientacion y factor angular [[s_theta]], pero se ignoran el grosor real del conductor, la estructura microscopica de la corriente y los retardos electromagneticos.

## Hipótesis

- Corriente estacionaria: si [[I]] cambia rapidamente, aparecen efectos de propagacion y el modelo local magnetostatico queda incompleto.
...
- Punto de observacion fuera del conductor ideal: si [[r]] se aproxima a cero, el modelo de linea pierde sentido fisico.

## Dominio de validez cuantitativo

El modelo de hilo largo es razonable cuando la longitud recta supera en al menos un orden de magnitud la distancia [[r]] al punto. Como criterio operativo, usarlo es defendible si la longitud del tramo recto > 20 veces la distancia perpendicular.
...
Una señal clara de fallo aparece cuando puntos que el modelo trataba como simetricos miden campos distintos. Si [[B]] cambia mucho al mover ligeramente la sonda, la geometria real no coincide con la ideal.

Otra señal es que el campo no crece linealmente con [[I]]. Eso puede indicar calentamiento, material magnetico no lineal, corrientes inducidas o una fuente que no mantiene corriente estacionaria.
