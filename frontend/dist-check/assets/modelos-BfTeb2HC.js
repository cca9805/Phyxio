...
Bajo estas condiciones, la propagación se describe con una ecuación de onda escalar de segundo orden cuya velocidad de fase depende exclusivamente de [[B]] y [[rho]]. Se ignoran la viscosidad del fluido, la conductividad térmica, la rotación del medio y cualquier efecto de borde o geometría.
...
- **Homogeneidad e isotropía**: [[B]] y [[rho]] son constantes en todo el volumen. Si se viola (gradientes de temperatura, salinidad o presión), la onda sufre refracción y la rapidez [[v]] varía de punto a punto.

- **Compresión adiabática**: no hay intercambio de calor apreciable durante el ciclo de compresión-rarefacción. Si se viola (frecuencias extremadamente bajas o fluidos con alta conductividad térmica), [[B]] debe sustituirse por el módulo isotérmico, alterando [[v]].
...
Para gases ideales a temperaturas entre 200 K y 2000 K y presiones entre 10 kPa y 10 MPa, el módulo adiabático se relaciona bien con la presión y el coeficiente adiabático. Fuera de esos rangos, el gas muestra desviaciones del comportamiento ideal que afectan la predicción de [[v]].
...
- **Dependencia de la rapidez con la frecuencia**: en el modelo ideal [[v]] no depende de [[f]]. Si mediciones experimentales muestran dispersión (frecuencias altas viajando a rapidez distinta), el medio presenta relajación molecular o efectos viscoelásticos.
