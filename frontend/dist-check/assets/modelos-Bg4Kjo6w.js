...
El modelo ideal para la interpretación física de Maxwell es el de la **onda plana armónica en el vacío**. En este marco, se asume que los campos eléctrico [[E]] y magnético [[B]] son perpendiculares entre sí y también a la dirección de propagación. Además, se considera que el medio es un vacío perfecto, lo que significa que no hay cargas ni corrientes libres que puedan dispersar o absorber la energía. Bajo estas condiciones, la relación entre las amplitudes de los campos es constante e igual a la velocidad de la luz [[c]], y la energía se transporta sin ninguna pérdida de intensidad a medida que la onda avanza. Este modelo permite simplificar las ecuaciones vectoriales de Maxwell en relaciones escalares directas entre densidades de energía [[u]] e intensidades medias [[I]], proporcionando una base clara para entender el transporte de potencia electromagnética.
...
2.  **Linealidad del medio**: Se considera que el vacío (o el medio analizado) es lineal, isótropo y homogéneo, lo que garantiza que la velocidad [[c]] sea constante y no dependa de la frecuencia o la dirección.
...
4.  **Régimen estacionario o armónico**: Se asume que las fuentes han estado oscilando el tiempo suficiente para que los campos sigan un patrón sinusoidal regular, facilitando el uso de la intensidad media [[I]] como medida de potencia.
...
-   **Desfase entre campos**: Si los campos [[E]] y [[B]] no están en fase (sus máximos no coinciden en el tiempo), significa que el medio tiene pérdidas significativas o es conductor.
-   **Inconsistencia en la relación E/B**: Si el cociente entre las magnitudes de los campos se desvía significativamente de la velocidad de la luz [[c]], indica la presencia de campos cercanos reactivos o efectos de reflexión.
-   **Atenuación no geométrica**: Si la intensidad media [[I]] disminuye más rápido de lo que predice la ley del inverso del cuadrado de la distancia, existe absorción en el medio.
