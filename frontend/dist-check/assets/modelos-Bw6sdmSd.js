...
El modelo ideal trata el solido como un continuo elastico lineal isotropo. La respuesta mecanica queda completamente descrita por dos constantes independientes: [[E_young]] y [[nu_poisson]] (o equivalentemente [[G_shear]] y [[K_bulk]]). La relacion tension-deformacion es lineal, reversible e instantanea. El material no tiene memoria, no disipa energia y sus propiedades son identicas en todas las direcciones.
...
- El material es isotropo: sus propiedades elasticas no dependen de la direccion de aplicacion del esfuerzo. Si esta hipotesis se viola, se necesitan mas de dos constantes y la relacion entre [[E_young]], [[G_shear]] y [[nu_poisson]] deja de ser valida.
...
- El [[G_shear]] calculado a partir de [[E_young]] y [[nu_poisson]] difiere del medido experimentalmente en mas de un 10 %: posible anisotropia.
