...
El modelo ideal trata la cuerda como un medio continuo, flexible, uniforme y sometido a una tension constante. La perturbacion transversal es pequena, de modo que la tension no cambia de forma apreciable durante la oscilacion. En este marco, la rapidez [[v]] se determina por el balance entre [[T]] y [[mu]].
...
- **Tension constante:** [[T]] no cambia durante la oscilacion pequena.
...
- **Medio no dispersivo:** para el rango usado, [[v]] no depende de [[f]].

Estas hipotesis convierten el problema en una lectura mecanica limpia. La fuente puede cambiar [[f]], pero el medio mantiene su rapidez si [[T]] y [[mu]] permanecen iguales.

## Dominio de validez cuantitativo

El modelo es una buena aproximacion si la amplitud transversal es menor que el 5 % de [[L]], si la variacion relativa de tension durante la oscilacion es menor que el 10 %, y si la cuerda puede considerarse uniforme en el tramo medido. Para cuerdas musicales o de laboratorio, tambien conviene que la rigidez de flexion sea pequena frente a la tension aplicada.

Como criterio operativo, si una medicion de [[v]] repetida a dos frecuencias distintas cambia menos del 5 % manteniendo la misma cuerda y tension, el modelo no dispersivo es razonable. Si la diferencia supera ese margen, hay que sospechar rigidez, amortiguamiento, error de montaje o variacion de tension.

## Señales de fallo del modelo

Una senal clara de fallo aparece cuando pulsos de distinta anchura viajan a velocidades distintas. Eso indica dispersion o comportamiento no ideal. Otra senal es que al aumentar moderadamente [[T]] la rapidez medida no siga la tendencia esperada: puede haber deslizamiento en los soportes, mala medida de [[mu]] o tension real diferente de la nominal.
...
Un modelo extendido puede incluir rigidez de flexion, amortiguamiento y tension dependiente de la deformacion. En instrumentos reales, estas correcciones explican inarmonicidad, perdida de energia y diferencias entre cuerdas con la misma [[T]] y [[mu]] nominales.
...
El modelo ideal es preferible para aprender la causa fisica de [[v]] y resolver problemas basicos. Conviene cambiar a un modelo extendido cuando las medidas revelan dispersion, perdidas fuertes o desviaciones sistematicas, lo que marca la transicion al analisis avanzado.
`;export{e as default};
