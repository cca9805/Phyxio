const e=`# Modelos de Ecuaciones de Euler del solido rigido

## Modelo ideal

El modelo ideal supone que las ecuaciones de euler describen la rotacion de un solido rigido desde ejes principales, donde cada componente angular se acopla con las otras dos. Se conserva la estructura que hace legible el fenomeno y se ignoran efectos secundarios como rozamiento residual, perturbaciones externas, deformaciones, ruido experimental o acoplamientos pequenos.

La simplificacion central es fisica: aisla el mecanismo que controla [[tau1]] y permite decidir si el resultado tiene sentido antes de introducir correcciones.
...
El modelo falla si [[tau1]] cambia de signo sin causa fisica, si un caso limite no recupera una expresion conocida, si las unidades no cierran o si una correccion crece hasta dominar el termino que se habia elegido como principal.
...
La transicion explicita es esta: cuando conviene pasar al modelo extendido, el dato observable ya no se explica con las ecuaciones de euler describen la rotacion de un solido rigido desde ejes principales, donde cada componente angular se acopla con las otras dos y la correccion supera el orden de magnitud permitido.
