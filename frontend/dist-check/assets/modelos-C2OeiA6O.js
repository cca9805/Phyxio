...
- **Referencia en el infinito**: la energía potencial se toma como cero cuando las cargas están infinitamente separadas. Consecuencia de violarla (cambio de referencia): los valores numéricos de [[U_e]] cambian, pero las diferencias [[DeltaU_e]] son independientes de la referencia elegida.
...
- **Energía que diverge al acercar las cargas sin límite**: en el modelo clásico, [[U_e]] crece sin límite cuando [[r_12]] tiende a cero. En la realidad, antes de llegar a distancias atómicas, la mecánica cuántica introduce efectos de intercambio y exclusión que estabilizan el sistema.
- **Resultado dependiente de la trayectoria**: si al calcular el trabajo del campo mediante el producto fuerza por desplazamiento a lo largo de una trayectoria se obtiene un resultado diferente al dado por la diferencia de [[U_e]] entre los extremos, hay un error en el cálculo de la fuerza o en la integración; el campo electrostático siempre es conservativo.
...
- **Signo de [[U_e]] incorrecto para el tipo de interacción**: si se calcula [[U_e]] positiva para cargas de signo opuesto, o negativa para cargas del mismo signo, hay un error en el uso de los signos de las cargas.
