...
- **Material isótropo y homogéneo:** [[E_young]], [[nu_p]] y [[rho_vol]] son uniformes en toda la placa. Los materiales estratificados o con gradiente de propiedades requieren parámetros efectivos.
...
- **Tensión uniforme en la membrana:** [[T_mem]] es la misma en todas las direcciones y en todo punto de la membrana. Una distribución no uniforme de tensión altera los patrones nodales y las frecuencias.
...
Para la membrana ideal, el modelo falla cuando el ratio de rigidez a la flexión respecto a la tensión supera el 1 %: concretamente cuando [[D_placa]]/(T × a²) > 0.01. Para un parche de batería de mylar de 80 µm de espesor y tensión de 1500 N/m, este ratio es inferior a 0.001, validando plenamente el modelo de membrana pura.
...
Cuando conviene pasar al modelo de Mindlin: cuando el espesor [[h_placa]] supera el 10 % de la dimensión menor, o cuando las frecuencias de interés superan el umbral de 50 kHz·mm para el acero. Cuando conviene pasar al modelo placa-membrana: cuando [[D_placa]]/(T × a²) está entre 0.01 y 1, es decir, cuando ni la rigidez ni la tensión dominan claramente.

## Comparación operativa

| Criterio | Modelo placa (Kirchhoff) | Modelo membrana (Helmholtz) |
|---|---|---|
| Fuerza restauradora | Rigidez a la flexión [[D_placa]] | Tensión superficial [[T_mem]] |
| Dispersión | Sí (velocidad depende de la frecuencia) | No (velocidad constante) |
| Parámetro de afinado | [[h_placa]], [[E_young]] (fijos en fabricación) | [[T_mem]] (ajustable) |
