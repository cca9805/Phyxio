...
El modelo ideal de generador considera una bobina rígida de [[N]] espiras que gira con [[omega]] constante en un campo [[B]] uniforme. La geometría efectiva se resume en [[A]], y el resultado eléctrico principal es una [[epsilon_0]] sinusoidal. Se conserva la relación entre trabajo mecánico, cambio de [[Phi_B]] y fem inducida, pero se ignoran resistencia interna, rozamiento, saturación magnética y calentamiento.
...
- Campo magnético aproximadamente uniforme: si se viola, [[B]] deja de representar el campo que atraviesa toda la bobina.
- Giro estable: si [[omega]] fluctúa mucho, la señal deja de tener una amplitud y frecuencia bien definidas.
- Área efectiva fija: si la bobina se deforma, [[A]] cambia y el flujo enlazado no es constante de una vuelta a otra.
- Pérdidas despreciables en la estimación de fem: si hay calentamiento o rozamiento significativo, [[P_elec]] queda por debajo de la salida ideal.
...
El modelo ideal es razonable cuando las variaciones de velocidad son menores del 5 %, las pérdidas internas son inferiores al 10 % de [[P_mec]] y el campo se mantiene lejos de saturación. En bobinas educativas, suele funcionar con [[B]] entre 0.01 T y 0.5 T, [[omega]] por debajo de 500 rad/s y áreas menores que 0.1 m².
