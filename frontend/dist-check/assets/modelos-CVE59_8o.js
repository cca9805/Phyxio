const e=`# Modelos de la interferencia de la luz

## Modelo ideal

El modelo ideal de interferencia de doble rendija describe dos rendijas puntuales separadas por una distancia [[d]], iluminadas por una fuente monocromática con longitud de onda [[lambda]] perfectamente definida. La luz es completamente coherente, con relación de fase estable entre ambos haces. Las amplitudes en ambas rendijas son iguales y la polarización es idéntica y paralela en ambos haces emergentes. La pantalla plana está ubicada a distancia [[L]] mucho mayor que [[d]].

Bajo estas condiciones, la intensidad en la pantalla sigue una distribución cosinusoidal cuadrada que predice franjas de igual intensidad y separación uniforme, con visibilidad perfecta. La posición de cada máximo depende linealmente del orden [[m]] según la relación [[y_m]] = [[m]] × [[lambda]] × [[L]] / [[d]], y la separación entre franjas consecutivas es constante e igual a [[lambda]] × [[L]] / [[d]].

## Hipótesis

Las hipótesis del modelo ideal son las siguientes. Las rendijas se consideran fuentes puntuales sin ancho finito. Si las rendijas tienen ancho comparable a [[d]], aparece difracción que modula la envolvente del patrón de interferencia, atenuando los órdenes laterales. Se asume coherencia perfecta: la fase relativa entre los haces es constante en el tiempo. Si la coherencia es parcial, la visibilidad del patrón disminuye y el contraste entre franjas se reduce. Se considera una única longitud de onda [[lambda]]. Si la luz es policromática, cada longitud de onda produce un patrón con separación diferente, resultando en franjas coloreadas que pierden definición fuera del centro. Se asume la aproximación de ángulos pequeños. Si el ángulo de observación es grande, las franjas dejan de estar equiespaciadas y la fórmula de posición pierde precisión. Se asume polarización paralela en ambos haces. Si las polarizaciones son perpendiculares, no hay interferencia y el patrón desaparece.

## Dominio de validez cuantitativo

El modelo ideal es válido cuando la separación entre rendijas satisface la relación 10 × [[lambda]] < [[d]] < 1000 × [[lambda]]. Si [[d]] es menor que 10 longitudes de onda, los patrones de difracción de cada rendija se solapan fuertemente. Si [[d]] supera 1000 longitudes de onda, las franjas están tan juntas que se vuelven indistinguibles para detectores ordinarios.

La distancia a la pantalla debe cumplir [[L]] > 10 × [[d]] para que la aproximación de ángulos pequeños tenga error menor al 1%. El orden observable está limitado por la condición [[m]] < [[d]] / [[lambda]], ya que para órdenes superiores el ángulo de observación se vuelve significativo y la fórmula lineal pierde precisión.

La coherencia espacial de la fuente debe satisfacer que el ángulo subtendido por la fuente sea menor que [[lambda]] / [[d]]. Si no se cumple, los patrones de diferentes partes de la fuente se desfasan y el contraste disminuye. Para [[lambda]] = 600 nm y [[d]] = 0.2 mm, la relación [[d]] / [[lambda]] = 333 permite observar órdenes hasta aproximadamente 10 a 15 antes de que la difracción limite la intensidad.
