...
El modelo ideal trata cada lente del instrumento optico como una **lente delgada perfecta** inmersa en aire, sin espesor, sin aberraciones cromaticas ni esfericas y con transmision total de luz. Los rayos cumplen la ley de Snell en la aproximacion de angulos pequenos y la formacion de imagen se describe mediante la ecuacion de la lente delgada. En este marco, el aumento angular de la lupa depende unicamente de [[d_pp]] y [[f_lupa]], y el aumento del microscopio se reduce al producto de los cocientes [[L]] dividido entre [[f_obj]] y [[d_pp]] dividido entre [[f_oc]]. El modelo ignora la difraccion, la dispersion cromatica y las perdidas por reflexion en las superficies.
