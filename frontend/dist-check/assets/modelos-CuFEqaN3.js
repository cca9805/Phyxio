...
- La superficie enlazada esta definida; si se viola, [[Phi_B]] no tiene signo claro.
- La normal se mantiene fija; si se viola, cambian los signos aparentes.
- El cambio de flujo se puede resumir con [[DeltaPhi_B]] o [[r_Phi]].
...
El modelo medio es razonable si el cambio de flujo puede compararse entre dos estados y si [[Deltat]] es mayor que 1 ms en bobinas pequeñas de laboratorio. En ese rango, la polaridad inducida suele leerse sin resolver propagacion.

Criterio cuantitativo de uso: si [[Deltat]] < 1 microsegundo o si el circuito tiene dimensiones mayores que 0.1 m, conviene sospechar retardos, capacitancias e inductancias parasitas. La regla de oposicion sigue orientando, pero el modelo elemental puede no bastar.
...
| Complejidad | Usa [[DeltaPhi_B]], [[r_Phi]] y [[epsilon_ind]] | Añade resistencia, parasitos, fuerzas y geometria |
