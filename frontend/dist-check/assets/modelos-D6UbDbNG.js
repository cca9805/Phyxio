...
El modelo ideal de la fuerza eléctrica trata [[q1]] y [[q2]] como **cargas puntuales** situadas en posiciones fijas del espacio. En este modelo se asume que toda la carga de cada objeto está concentrada en un único punto geométrico sin extensión espacial, y que el medio entre ellas es el vacío. La fuerza resultante depende únicamente de los valores de [[q1]], [[q2]] y de la distancia [[r]] entre los puntos.

La simplificación central de este modelo es ignorar la distribución interna de carga y la estructura atómica del material. Esto es válido siempre que el tamaño de los objetos sea mucho menor que la distancia entre ellos. Bajo este supuesto, [[F_C]] queda completamente determinada por tres números: [[q1]], [[q2]] y [[r]], lo que hace el modelo matemáticamente tratable y pedagógicamente transparente.

Las magnitudes que se conservan en el modelo ideal son [[q1]], [[q2]] y [[k_e]]. La magnitud que cambia libremente es [[r]], la variable independiente del problema. El modelo ignora los efectos relativistas, la cuantización de la carga y cualquier interacción de orden superior.
...
- **Divergencia de la fuerza al reducir r**: si al disminuir [[r]] la fuerza calculada supera valores del orden de 10⁸ N para cargas de laboratorio, es señal de que el modelo puntual ha alcanzado su límite.
- **Resultados negativos de [[r]]**: si al despejar [[r]] de la ley de Coulomb se obtiene un valor negativo o imaginario, hay inconsistencia en los datos de entrada.
- **Fuerza excesivamente grande para cargas pequeñas**: si [[F_C]] supera varios newtons con cargas de microcoulombios y distancias de laboratorio (centímetros), revisar la conversión de unidades.
...
Cuando conviene pasar al modelo extendido: cuando el tamaño del objeto cargado es comparable a la distancia [[r]] entre objetos (r < 10·a), cuando el medio no es el vacío, o cuando se requiere precisión en problemas con geometrías no esféricas.
