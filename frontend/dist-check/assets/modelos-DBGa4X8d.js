const e=`# Modelos de la diferencia de potencial

## Modelo ideal

El modelo estándar de la diferencia de potencial trata el campo eléctrico como un campo conservativo en el vacío. [[V_AB]] se define como el trabajo por unidad de carga positiva que el campo realiza al mover una carga de A a B, siendo este trabajo independiente de la trayectoria elegida.
...
- La carga de prueba [[q]] es suficientemente pequeña para no perturbar el campo que se mide.
...
- **Aproximación de campo uniforme**: la fórmula campo por distancia introduce un error inferior al 1 % cuando las dimensiones laterales de las placas son al menos 10 veces mayores que la separación [[d_AB]].
