const e=`# Modelos del transformador

## Modelo ideal

El modelo ideal del transformador describe un dispositivo con dos devanados acoplados perfectamente a través de un núcleo ferromagnético de permeabilidad infinita. En este modelo, todo el flujo magnético generado por el primario enlaza completamente con el secundario, sin fugas. Las tensiones siguen directamente la relación de espiras [[N_1]]/[[N_2]], mientras que las corrientes siguen la relación inversa.

En el modelo ideal, la potencia aparente se conserva entre primario y secundario. No existen pérdidas ni caídas de tensión internas. El rendimiento [[eta]] toma su valor máximo ideal, y las pérdidas [[P_p]] son nulas. Este modelo es la base conceptual para el análisis de transformadores y permite cálculos rápidos de primera aproximación.
...
El modelo con resistencias de devanado incluye la resistencia eléctrica del primario y del secundario como parámetros internos no tratados por la calculadora básica del leaf. Esto permite calcular las caídas de tensión resistivas y las pérdidas de cobre [[P_Cu]] con precisión. La corriente de carga ahora produce una reducción medible de [[V_2]] respecto al valor ideal.

El modelo con pérdidas magnéticas separa las pérdidas en hierro [[P_Fe]], consideradas aproximadamente constantes a tensión fija, de las pérdidas en cobre [[P_Cu]], que varían con el cuadrado de la corriente. Este modelo permite predecir el rendimiento máximo típicamente al 50-75% de carga.
