const e=`# Flotación - Modelo y validez
...
El modelo ideal es suficiente para el diseño preliminar de barcos, boyas y cálculos de carga de icebergs. Sin embargo, para la navegación en mar abierto o el diseño de submarinos (donde la densidad del fluido varía con la salinidad y temperatura a diferentes profundidades), se requieren los modelos extendidos para garantizar la seguridad estructural y la maniobrabilidad.`;export{e as default};
