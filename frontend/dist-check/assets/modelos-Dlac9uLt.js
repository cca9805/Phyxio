...
El modelo ideal es un **semiespacio elastico homogeneo, isotropo y lineal** con una superficie libre plana. En este marco, la onda de Rayleigh se propaga sin dispersion a velocidad [[v_R]] constante (independiente de la frecuencia), su amplitud decae exponencialmente con la profundidad [[z_prof]] y las particulas describen elipses retrogradas cuyo semieje mayor es vertical.

Este modelo permite derivar la ecuacion secular de Rayleigh, la aproximacion de Viktorov para [[v_R]] y la relacion entre profundidad de penetracion [[d_pen]] y longitud de onda [[lambda_R]].
...
- Longitud de onda de Rayleigh mucho mayor que las heterogeneidades del medio: [[lambda_R]] > 10 veces el tamaño de grano o fractura.
...
- Diferencias de [[v_R]] con la direccion de propagacion mayores del 5 por ciento: indica anisotropia del medio.
