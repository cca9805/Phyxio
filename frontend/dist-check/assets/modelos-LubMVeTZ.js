...
Esta idealización conserva la energía total del sistema (la energía perdida por la onda se convierte en calor) pero ignora la complejidad microestructural real. Las magnitudes que se mantienen son la frecuencia [[f]] y la velocidad de propagación, mientras que se desprecian los efectos de dispersión geométrica, scattering por granos, y la dependencia de [[alpha]] con la frecuencia.
...
El modelo exponencial es válido cuando la distancia de propagación es mayor que 10 veces la longitud de onda pero menor que 3 veces la longitud de atenuación [[L_d]]. Para frecuencias típicas de ensayo industrial (0.5-20 MHz), esto corresponde a distancias entre 1 mm y 100 mm dependiendo del material.
...
- **Desviación de la linealidad en escala logarítmica**: Si el gráfico de ln([[A]]/[[A0]]) vs [[x]] no es una línea recta, el modelo exponencial falla. Esto indica variación de [[alpha]] con la distancia o efectos de dispersión geométrica no compensados.
...
| **Parámetros requeridos** | [[alpha]], [[x]], [[A0]] | [[alpha]]([[f]]), geometría haz, anisotropía |
