const e=`# Modelos fisicos: movimiento vertical bajo gravedad\r
\r
## Modelo ideal\r
\r
El modelo ideal de movimiento vertical bajo gravedad supone que basta con leer el movimiento vertical como un caso unidimensional gobernado por la aceleracion gravitatoria. Se conserva solo la estructura imprescindible para que la relacion principal describa el mecanismo dominante y para que la lectura del diagrama siga siendo limpia. En este nivel se eliminan detalles secundarios del material, del fluido o del contacto porque todavia no cambian la conclusion esencial. Esa simplificacion es valiosa siempre que el alumno pueda explicar que fenomeno se ha descartado y por que su ausencia no altera la interpretacion principal.\r
\r
## Hipótesis\r
\r
...
\r
El modelo extendido introduce correcciones cuando se ignora el signo de g, cambia el sentido positivo o ya no puede despreciarse el aire. En esa ampliacion reaparecen terminos asociados a geometria real, variaciones del medio, no linealidades o redistribuciones internas. El objetivo no es complicar por inercia, sino decidir que refinamiento cambia de verdad la prediccion y cual solo anade ruido algebraico. Un buen criterio consiste en comparar cuanto se modifica la magnitud buscada al activar cada correccion por separado.\r
\r
