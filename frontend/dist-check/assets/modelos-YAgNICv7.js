...
Las magnitudes que el modelo conserva son [[Phi_E]], [[Q_enc]] y [[epsilon_0]]. Las magnitudes que el modelo ignora incluyen los efectos de polarización de medios dieléctricos, la radiación por aceleración de cargas y los efectos cuánticos a escala atómica.
...
- **Campo dentro de un conductor no nulo**: si al aplicar la ley de Gauss se obtiene [[E_G]] distinto de cero dentro de un conductor en equilibrio, hay un error en la identificación de [[Q_enc]] o la geometría de la superficie. El modelo ideal predice campo nulo en el interior.
