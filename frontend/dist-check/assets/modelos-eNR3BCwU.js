const e=`# Modelos de Ecuacion de Euler de fluidos

## Modelo ideal

El modelo ideal supone que la ecuacion de euler de fluidos expresa el balance entre inercia material, presion y fuerzas de volumen cuando la viscosidad se desprecia. Se conserva la estructura que hace legible el fenomeno y se ignoran efectos secundarios como rozamiento residual, perturbaciones externas, deformaciones, ruido experimental o acoplamientos pequenos.

La simplificacion central es fisica: aisla el mecanismo que controla [[DvDt]] y permite decidir si el resultado tiene sentido antes de introducir correcciones.
...
El modelo falla si [[DvDt]] cambia de signo sin causa fisica, si un caso limite no recupera una expresion conocida, si las unidades no cierran o si una correccion crece hasta dominar el termino que se habia elegido como principal.
...
La transicion explicita es esta: cuando conviene pasar al modelo extendido, el dato observable ya no se explica con la ecuacion de euler de fluidos expresa el balance entre inercia material, presion y fuerzas de volumen cuando la viscosidad se desprecia y la correccion supera el orden de magnitud permitido.
