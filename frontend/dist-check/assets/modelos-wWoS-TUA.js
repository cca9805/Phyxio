const e=`# Modelos para Hamilton-Jacobi\r
\r
## Modelo ideal\r
\r
El modelo ideal es un sistema clasico regular en el que funcion principal de accion, ecuacion diferencial parcial, separacion de variables, integrabilidad e interpretacion de frentes de accion puede describirse con variables suaves [[S]], [[W]], [[H]], [[E]], [[qi]], [[pi]], [[t]]. El modelo asume que la estructura analitica es el objeto que se pone a prueba, no una decoracion opcional.\r
\r
## Hipotesis\r
\r
...
- La magnitud dominante [[S]] tiene el papel fisico declarado en magnitudes.yaml.\r
