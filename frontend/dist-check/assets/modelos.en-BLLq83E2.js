...
This model retains the essential magnitudes of the leaf — [[q1]], [[q2]], [[r12]], [[F_C]] and [[k_e]] — and deliberately ignores the real geometry of the objects, surface charge redistribution, relativistic effects, and any magnetic interaction. It is exact in the mathematical sense when the dimensions of the objects are much smaller than [[r12]].
...
- **No nearby conductors**: the presence of conducting surfaces redistributes charges by induction, creating image forces that modify [[F_C]]. The ideal model ignores these effects.
...
At distances greater than 1 m with laboratory charges (microcoulombs), [[F_C]] falls below 10⁻³ N and may become comparable to spurious mechanical forces, making direct measurement difficult but not invalidating the model.

## Model failure signals

- **Negative [[F_C]] result**: the scalar model always gives positive magnitudes. A negative result indicates that the signed product of charges is being used instead of the absolute value, or that there is a conceptual error in the applied formula.
- **[[F_C]] increasing as [[r12]] increases**: Coulomb's law produces a force that decreases with distance. If experimental data show the opposite, there is influence from additional charges, induction from nearby conductors, or measurement error.
...
- **Divergence near the origin**: in numerical simulations, if [[r12]] approaches zero, [[F_C]] grows without bound. This signal indicates that the model has reached its singularity and the computation must be stopped.
