const e=`# Models of Potential Difference

## Ideal model

The standard model of potential difference treats the electric field as a conservative field in vacuum. [[V_AB]] is defined as the work per unit positive charge that the field does when moving a charge from A to B, with this work being independent of the chosen path.
...
- The test charge [[q]] is small enough not to perturb the field being measured.
...
- **Uniform field approximation**: the field-times-distance formula introduces an error below 1 % when the plate lateral dimensions are at least 10 times greater than the separation [[d_AB]].
