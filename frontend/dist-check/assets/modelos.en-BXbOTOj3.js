...
In this model, the conserved magnitudes are [[V]], [[I]] and [[R]], related through Ohm's law. The ignored magnitudes include temporal variations of resistance with temperature, inductive and capacitive effects, and wiring connection resistance. This simplification enables direct calculations without numerical methods or complex simulations.

The physical meaning of the central simplification lies in that, for purely resistive loads in steady state, the dissipated power depends only on the applied voltage and load resistance, with [[P]] proportional to the square of [[V]] and inversely proportional to [[R]]. This approximation captures the essential system behavior without introducing parameters that would unnecessarily complicate preliminary estimation analysis.
...
**Validity inequality for voltage:** 207 V ≤ [[V]] ≤ 253 V (230 V ± 10% per European standard EN 50160). Outside this range, domestic equipment may malfunction or suffer damage.

**Current range per circuit:** 0.1 A ≤ [[I]] ≤ 25 A, where the upper limit depends on conductor cross-section (1.5 mm² → ~16 A, 2.5 mm² → ~25 A) and the type of installed protection.

**Unit power order of magnitude:** 20 W ≤ [[P]] ≤ 4000 W for individual appliances. Lower powers correspond to standby state or small electronics; higher powers typically require dedicated circuits according to the Low Voltage Electrotechnical Regulation (REBT).

**Operational resistance range:** 1 Ω ≤ [[R]] ≤ 100 kΩ. Resistances below 1 Ω indicate probable short circuit; above 100 kΩ correspond to leakage or insulation, not operational loads.
...
- **Power factor correction**: For inductive loads (motors, transformers, fluorescent lights), the extended model distinguishes between active power (W), reactive power (VAR) and apparent power (VA), calculating actual current by dividing [[P]] by the product of [[V]] and the power factor cos φ.
