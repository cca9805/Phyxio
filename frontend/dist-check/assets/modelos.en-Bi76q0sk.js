...
The canonical model of wave types in solids assumes a **linear elastic, isotropic and homogeneous medium** of infinite extent (or half-space for surface waves). In this framework, the only information needed is two independent elastic constants — for example, [[E_young]] and [[nu]], or equivalently [[G_corte]] and [[rho]] — together with density.
...
|---|---|---|---|
| Input variables | [[E_young]], [[G_corte]], [[rho]], [[nu]] | [[E_young]], [[G_corte]], [[rho]], [[nu]], loss factor | Per-layer properties, thicknesses |
