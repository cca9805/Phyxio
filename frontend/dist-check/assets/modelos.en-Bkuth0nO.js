...
The ideal model is a **homogeneous, isotropic, linearly elastic half-space** with a flat free surface. In this framework, the Rayleigh wave propagates without dispersion at constant velocity [[v_R]] (independent of frequency), its amplitude decays exponentially with depth [[z_prof]], and particles describe retrograde ellipses whose major semi-axis is vertical.

This model allows deriving the Rayleigh secular equation, the Viktorov approximation for [[v_R]], and the relationship between penetration depth [[d_pen]] and wavelength [[lambda_R]].
...
- Rayleigh wavelength much larger than medium heterogeneities: [[lambda_R]] at least 10 times larger than grain or fracture size.
...
- Differences in [[v_R]] with propagation direction exceeding 5 percent: indicates medium anisotropy.
