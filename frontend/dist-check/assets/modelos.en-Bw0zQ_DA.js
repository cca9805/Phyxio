...
In the Kirchhoff plate, the fundamental hypothesis is that cross-sections remain plane and perpendicular to the mid-surface during deformation. This condition eliminates transverse shear deformation and simplifies the governing differential equation to the bilaplacian of the displacement. The restoring force is the bending stiffness [[D_placa]], proportional to the cube of thickness [[h_placa]].

In the ideal membrane, bending stiffness is exactly zero. The only restoring force is surface tension [[T_mem]], and the system is the two-dimensional analogue of the vibrating string. The model ignores any bending stiffness of the real membrane, which always has some finite thickness.
...
- **Isotropic and homogeneous material:** [[E_young]], [[nu_p]] and [[rho_vol]] are uniform throughout the plate. Layered or property-gradient materials require effective parameters.
...
- **Uniform membrane tension:** [[T_mem]] is the same in all directions and at all points of the membrane. A non-uniform tension distribution alters the nodal patterns and frequencies.
...
For the ideal membrane, the model fails when the bending-to-tension stiffness ratio exceeds 1 %: specifically when [[D_placa]]/(T × a²) > 0.01. For an 80 µm mylar drum head under 1500 N/m tension, this ratio is below 0.001, fully validating the pure membrane model.
