...
The ideal model treats the solid as a linear elastic isotropic continuum. The mechanical response is completely described by two independent constants: [[E_young]] and [[nu_poisson]] (or equivalently [[G_shear]] and [[K_bulk]]). The stress-strain relationship is linear, reversible and instantaneous. The material has no memory, does not dissipate energy and its properties are identical in all directions.
...
- The material is isotropic: its elastic properties do not depend on the direction of applied stress. If this hypothesis is violated, more than two constants are needed and the relationship between [[E_young]], [[G_shear]] and [[nu_poisson]] ceases to be valid.
...
- The [[G_shear]] calculated from [[E_young]] and [[nu_poisson]] differs from the experimentally measured value by more than 10%: possible anisotropy.
