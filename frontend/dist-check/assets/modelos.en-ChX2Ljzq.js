const e=`# Physical Models of Longitudinal Waves
...
While the ideal model allows for a simple analytical resolution using trigonometric functions and a constant speed [[c]], extended models require complex numerical methods and consider that energy is transferred between different frequencies due to wave profile distortion.`;export{e as default};
