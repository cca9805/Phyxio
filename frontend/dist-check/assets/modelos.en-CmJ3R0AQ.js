const e=`# Models for energy in rolling\r
\r
## Ideal model\r
\r
...
## Hypotheses\r
\r
The hypotheses are rigidity, constant effective radius, defined central axis, and no slipping at the contact. The moment of inertia [[I]] is assumed constant, and mass [[m]] remains distributed in a stable way. If [[a_cm]] is used together with [[alpha]], the same pure-rolling kinematic condition is being accepted.\r
\r
## Quantitative validity domain\r
\r
The model is reliable if deformation changes [[R]] by less than \`2%\`, thermal loss is below \`5%\` of [[K_total]], and the contact can provide the required torque without exceeding the adhesion limit. On an incline, angle [[phi]] must be compatible with enough static friction; otherwise slipping appears.\r
\r
## Model failure signals\r
\r
Observable failure appears when the contact mark skids, when [[v_cm]] does not match [[R]] times [[omega]], when the object vibrates, or when mechanical energy [[E_total]] decreases without a declared loss term. The model also fails if [[I]] belongs to the wrong axis or if the effective radius changes because the material deforms.\r
\r
