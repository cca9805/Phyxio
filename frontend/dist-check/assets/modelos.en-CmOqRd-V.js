const e=`# Physical models: external impulse and breakdown of conservation\r
\r
## Ideal model\r
\r
The ideal model for external impulse and breakdown of conservation assumes that it is enough to measure how an external impulse breaks or corrects ideal conservation. Only the indispensable structure is kept so that the main relation captures the dominant mechanism and the diagram remains readable. At this level, secondary details of the material, fluid, or contact are removed because they do not change the essential conclusion yet. That simplification is useful only if the learner can explain which phenomenon was neglected and why its absence does not alter the main interpretation. Otherwise the simplification becomes a slogan instead of a model.\r
\r
\r
## Hypotheses\r
\r
The fundamental hypotheses of this model are: point-like or rigid bodies, negligible net external forces during the interaction, and an inertial reference frame. Any violation of these conditions requires checking whether the model remains applicable or whether an extension is needed.\r
\r
