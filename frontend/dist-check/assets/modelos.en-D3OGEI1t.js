...
The quantities preserved in the model are bending stiffness EI (product of [[E_young]] and [[I_seccion]]) and linear mass [[rho_lin]]. Transverse shear deformation and rotational inertia of sections are completely ignored.
...
- **Linear elastic, isotropic and homogeneous material:** [[E_young]] and [[rho_vol]] are constant throughout the beam. For viscoelastic or composite materials, parameters become functions of frequency or position.

- **Constant cross-section:** [[I_seccion]] and [[A_seccion]] do not vary along the axis. Variable-section beams require numerical methods or the WKB approximation.
...
For beams with internal damping, the model extends by replacing the real [[E_young]] with a complex modulus, introducing frequency-dependent attenuation in addition to dispersion.
...
| Validity | k·r_g less than 0.3 | Full frequency range |
