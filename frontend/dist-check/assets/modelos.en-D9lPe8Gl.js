...
Under these conditions, the problem has a closed analytical solution: the coefficients [[R_amp]] and [[T_amp]] are expressed algebraically as a function of the impedance ratio. There is no mode conversion, no dispersion, no dissipation.
...
Amplitude coefficients satisfy: −1 <= [[R_amp]] <= 1 and 0 <= [[T_amp]] <= 2. Energy coefficients satisfy: 0 <= [[R_E]] <= 1 and 0 <= [[T_E]] <= 1, with [[R_E]] + [[T_E]] exactly equal to 1.
...
|---|---|---|
| Input variables | [[Z_1]], [[Z_2]] | [[Z_1]], [[Z_2]], P and S velocities, angle |
