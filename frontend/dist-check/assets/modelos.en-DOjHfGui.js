...
The ideal model treats the Earth (or the region of interest) as an **isotropic, homogeneous, infinite elastic medium**. In this framework, P and S waves propagate in straight lines at constant velocities determined by [[K_bulk]], [[G_shear]], and [[rho_medio]]. There is no refraction, reflection, dispersion, or attenuation.
...
The **radial PREM model** (Preliminary Reference Earth Model) describes the variation of [[K_bulk]], [[G_shear]], and [[rho_medio]] with depth in concentric layers. It allows computing curved travel-time curves and shadow zones.
