...
- **Charge inconsistency**: If the net flux [[flux_E]] does not correspond to the internal charge variation, the model is omitting the displacement current necessary in dynamic regimes.
- **Non-zero magnetic flux**: A [[flux_B]] result other than zero indicates a structural failure in the Gauss surface definition or the presence of unobserved magnetic monopoles.
