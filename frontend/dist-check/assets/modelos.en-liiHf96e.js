...
- **Normal incidence**: the beam is perpendicular to the defect interface. If the defect is inclined relative to the beam, the reflected wave does not return to the transducer and the calculated [[R_ac]] overestimates the received signal.
