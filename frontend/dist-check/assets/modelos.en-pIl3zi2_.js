const e=`\uFEFF# Pipe Flow - Model and Validity
...
While the Darcy-Weisbach model is the gold standard for the design of industrial and civil long-distance networks, Navier-Stokes (CFD) models are mandatory when designing high-precision components such as fuel injectors or artificial heart valves, where local velocity profile detail is critical for safety and performance.\r
`;export{e as default};
