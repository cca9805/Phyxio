...
\r
El objeto puede ser una razon trigonometrica, una proyeccion, una conversion entre coordenadas, una longitud de arco, una semejanza o una aplicacion de Pitagoras. En este leaf la herramienta principal es usar Pitagoras, semejanza, escala y angulos para construir la geometria que necesita un problema fisico.\r
\r
...
\r
No sustituyas numeros hasta tener la relacion simbolica. Para este leaf, una forma guia es \`a^2 + b^2 = c^2, razones iguales en triangulos semejantes\`. Despues adapta signos y unidades al sistema fisico.\r
\r
