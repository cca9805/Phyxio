...
\r
El objeto puede ser una razon trigonometrica, una proyeccion, una conversion entre coordenadas, una longitud de arco, una semejanza o una aplicacion de Pitagoras. En este leaf la herramienta principal es orientar una magnitud en el plano, fijar referencia angular, elegir sentido positivo y leer signos por cuadrante.\r
\r
...
\r
No sustituyas numeros hasta tener la relacion simbolica. Para este leaf, una forma guia es \`x = r cos(theta), y = r sin(theta)\`. Despues adapta signos y unidades al sistema fisico.\r
\r
