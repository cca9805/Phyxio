...
\r
El objeto puede ser una razon trigonometrica, una proyeccion, una conversion entre coordenadas, una longitud de arco, una semejanza o una aplicacion de Pitagoras. En este leaf la herramienta principal es describir posicion mediante radio y angulo cuando la simetria circular simplifica el problema.\r
\r
...
\r
No sustituyas numeros hasta tener la relacion simbolica. Para este leaf, una forma guia es \`x = r cos(theta), y = r sin(theta), r = sqrt(x^2+y^2)\`. Despues adapta signos y unidades al sistema fisico.\r
\r
