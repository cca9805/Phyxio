...
\r
El objeto puede ser una razon trigonometrica, una proyeccion, una conversion entre coordenadas, una longitud de arco, una semejanza o una aplicacion de Pitagoras. En este leaf la herramienta principal es usar seno, coseno y tangente como razones entre catetos, hipotenusa, angulo y proyeccion.\r
\r
...
\r
No sustituyas numeros hasta tener la relacion simbolica. Para este leaf, una forma guia es \`sin(theta)=opuesto/hipotenusa, cos(theta)=adyacente/hipotenusa, tan(theta)=opuesto/adyacente\`. Despues adapta signos y unidades al sistema fisico.\r
\r
