...
\r
The object may be a trigonometric ratio, a projection, a coordinate conversion, an arc length, a similarity relation, or Pythagoras. In this leaf the main tool is to orient a quantity in the plane, set angular reference, choose positive sense, and read quadrant signs.\r
\r
...
\r
Do not substitute numbers until the symbolic relation is clear. For this leaf, a guide form is \`x = r cos(theta), y = r sin(theta)\`. Then adapt signs and units to the physical system.\r
\r
