...
\r
The object may be a trigonometric ratio, a projection, a coordinate conversion, an arc length, a similarity relation, or Pythagoras. In this leaf the main tool is to understand the radian as arc divided by radius and use it in rotation, oscillations, and circular motion.\r
\r
...
\r
Do not substitute numbers until the symbolic relation is clear. For this leaf, a guide form is \`theta = s/r, s = r theta, omega = Delta theta / Delta t\`. Then adapt signs and units to the physical system.\r
\r
