...
\r
The object may be a trigonometric ratio, a projection, a coordinate conversion, an arc length, a similarity relation, or Pythagoras. In this leaf the main tool is to convert a directed quantity into components along axes and reconstruct it without losing sign, magnitude, or unit.\r
\r
...
\r
Do not substitute numbers until the symbolic relation is clear. For this leaf, a guide form is \`A_x = A cos(theta), A_y = A sin(theta), A = sqrt(A_x^2 + A_y^2)\`. Then adapt signs and units to the physical system.\r
\r
