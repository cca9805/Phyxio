...
\r
The object may be a trigonometric ratio, a projection, a coordinate conversion, an arc length, a similarity relation, or Pythagoras. In this leaf the main tool is to describe position with radius and angle when circular symmetry simplifies the problem.\r
\r
...
\r
Do not substitute numbers until the symbolic relation is clear. For this leaf, a guide form is \`x = r cos(theta), y = r sin(theta), r = sqrt(x^2+y^2)\`. Then adapt signs and units to the physical system.\r
\r
