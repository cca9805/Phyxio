...
\r
The object may be a trigonometric ratio, a projection, a coordinate conversion, an arc length, a similarity relation, or Pythagoras. In this leaf the main tool is to use sine, cosine, and tangent as ratios between legs, hypotenuse, angle, and projection.\r
\r
...
\r
Do not substitute numbers until the symbolic relation is clear. For this leaf, a guide form is \`sin(theta)=opuesto/hipotenusa, cos(theta)=adyacente/hipotenusa, tan(theta)=opuesto/adyacente\`. Then adapt signs and units to the physical system.\r
\r
