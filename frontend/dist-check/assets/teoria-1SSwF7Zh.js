...
-   **Cuerpo humano**: En agua dulce, una persona con los pulmones llenos de aire tiene una densidad promedio de unos \\( 980\\text{ kg/m}^3 \\). Esto permite que el \\( 2\\% \\) del volumen corporal (suficiente para la nariz y boca) quede fuera del agua sin esfuerzo. Sin embargo, al exhalar el aire, la densidad puede subir a \\( 1020\\text{ kg/m}^3 \\), provocando el hundimiento si no se realiza un trabajo mecánico adicional.\r
-   **Mar Muerto**: Debido a su extrema concentración de sales, su densidad alcanza los \\( 1240\\text{ kg/m}^3 \\). Un bañista humano flota con una fracción sumergida de apenas \\( 0.80 \\), lo que resulta en una flotabilidad tan alta que es prácticamente imposible hundirse por completo de forma pasiva.\r
\r
## Método de resolución personalizado\r
1.  **Identificar las Densidades**: Obtén el valor de la densidad del objeto [[rho_obj]] y del fluido [[rho_f]] en unidades coherentes (usualmente \\( \\text{kg/m}^3 \\)).\r
2.  **Calcular la Fracción Teórica**: Aplica la relación de densidades para determinar el porcentaje de volumen que quedará bajo la superficie.\r
3.  **Verificar la Condición de Flotación**: Si la fracción calculada es menor o igual a \\( 1 \\), el objeto flotará. Si es mayor a \\( 1 \\), el objeto se hundirá y la estática de flotación ya no es aplicable.\r
4.  **Determinar Volúmenes Reales**: Utiliza el volumen total [[Vtot]] para hallar el volumen de carena [[Vsum]] multiplicando por la fracción sumergida.\r
5.  **Análisis de Estabilidad**: Evalúa si el centro de gravedad está lo suficientemente bajo (añadiendo lastre si es necesario) para garantizar que el equilibrio sea estable frente a inclinaciones.\r
\r
## Casos especiales y ejemplo extendido\r
**El densímetro industrial**: Este instrumento es una aplicación magistral de la flotación. Consiste en un cilindro de vidrio hueco con un peso calibrado en su base. Al introducirlo en un líquido de densidad desconocida, el instrumento se hunde hasta que el empuje iguala su peso. Dado que el peso y el volumen total del densímetro son constantes, la profundidad a la que se detiene depende exclusivamente de la densidad del líquido. Una escala graduada en el cuello del instrumento permite leer directamente la densidad o el grado alcohólico, convirtiendo un fenómeno de flotación en una medición analítica de alta precisión.\r
\r
## Preguntas reales del alumno\r
-   **¿Por qué floto mejor en el mar que en una piscina?** Porque el agua salada es más densa que el agua dulce. Al ser [[rho_f]] mayor, la fracción sumergida [[frac_sum]] necesaria para equilibrar tu peso es menor, por lo que sobresales más de la superficie.\r
-   **¿Qué pasa si el objeto es hueco pero tiene una fuga?** Su densidad promedio aumenta a medida que el agua reemplaza al aire. Cuando la densidad media supera la del fluido exterior, el empuje máximo ya no puede compensar el peso y el objeto se hunde.\r
-   **¿Puede algo flotar en el aire?** Sí, los globos de helio o de aire caliente flotan siguiendo exactamente las mismas leyes. Mientras la densidad del conjunto (globo + gas + carga) sea menor que la densidad del aire circundante, existirá una fracción de flotación positiva.\r
\r
## Conexiones transversales y rutas de estudio\r
-   **Oceanografía**: Estudio de las corrientes marinas impulsadas por variaciones de densidad (circulación termohalina).\r
-   **Zoología**: Mecanismos de flotabilidad neutra en cefalópodos mediante cámaras de gas controladas.\r
-   **Ingeniería Aeroespacial**: Comportamiento de combustibles en depósitos de satélites bajo condiciones de microgravedad.\r
\r
## Síntesis final\r
