const e=`# Rozamiento y disipacion\r
\r
## Contexto conceptual\r
\r
El rozamiento es una interaccion de contacto que se opone al deslizamiento relativo. En problemas de trabajo y energia importa porque no almacena energia mecanica recuperable como un muelle o un campo conservativo: transforma parte de esa energia en calentamiento, sonido, desgaste y deformaciones microscopicas.\r
\r
La idea clave es separar tres cantidades que el alumno suele mezclar: el trabajo del rozamiento [[Wr]], que tiene signo; la energia disipada [[Edis]], que se toma positiva; y la variacion de energia mecanica [[dEm]], que indica si el sistema conserva o pierde energia mecanica util.\r
\r
## 🟢 Nivel esencial
...
## 🔴 Nivel estructural\r
\r
El modelo presupone contacto seco o ligeramente lubricado, [[mu]] aproximadamente constante, deslizamiento real y una normal [[N]] bien definida. Si hay rodadura pura, lubricacion hidrodinamica, desgaste severo, calentamiento fuerte o arrastre de un fluido dominante, el modelo deja de ser el principal.\r
\r
El criterio fisico no es memorizar que el rozamiento "quita energia", sino decidir que sistema se analiza. Si el sistema incluye solo el bloque, [[Wr]] suele ser negativo. Si el sistema incluye bloque, mesa y entorno termico, la energia total se conserva, pero cambia de forma.\r
\r
Un analisis estructural tambien pregunta que variable controla el resultado. Si se duplica la distancia de deslizamiento, se duplica el modulo de [[Wr]] en el modelo de fuerza constante. Si se duplica la normal, se duplica [[fr]] y tambien la disipacion por metro. Si se reduce el tiempo manteniendo la misma energia convertida, no cambia [[Edis]], pero si aumenta [[Pdis]]. Estas tres sensibilidades separan geometria, contacto y riesgo termico.\r
\r
## Interpretacion fisica profunda\r
\r
El rozamiento conecta dinamica y energia: [[N]] y [[mu]] determinan la escala de fuerza, [[d]] determina cuanto trabajo negativo se acumula y [[t]] permite saber si la disipacion es suave o peligrosa por potencia [[Pdis]].\r
\r
Por eso dos problemas con la misma [[Edis]] pueden ser fisicamente distintos: disipar 1000 J en una hora apenas calienta un sistema, mientras que disiparlos en una decima de segundo puede destruir un freno, una herramienta o una superficie de contacto.\r
\r
La lectura experta evita dos extremos. El primer extremo es tratar el rozamiento como una simple resta en una formula de energia. El segundo es abandonar el modelo por ser microscopicamente incompleto. En el rango adecuado, el modelo con [[mu]] y [[N]] es potente porque condensa la complejidad del contacto en una prediccion energetica verificable.\r
\r
\r
## Orden de magnitud\r
\r
Un rozamiento de unas decenas de newton actuando durante unos metros produce centenares de julios. Esa escala es visible en un bloque que se calienta poco, pero tambien en una frenada suave de bicicleta. En un vehiculo, las masas y velocidades elevan la energia a decenas o cientos de kilojulios, por lo que el problema deja de ser solo de distancia y pasa a ser tambien de gestion termica.\r
\r
...
\r
1. Delimita el sistema: cuerpo solo, conjunto con superficie o sistema mas entorno.\r
2. Decide si hay deslizamiento y si el modelo de Coulomb es valido.\r
3. Calcula [[N]] antes de usar [[fr]]; no sustituyas [[m]][[g]] si el plano no es horizontal o hay otras fuerzas verticales.\r
4. Usa [[Wr]] con signo y [[Edis]] como cantidad positiva.\r
5. Cierra con el balance entre [[Emi]], [[Emf]] y [[dEm]].\r
6. Si hay tiempo de proceso, calcula [[Pdis]] para valorar calentamiento y riesgo real.\r
\r
## Casos especiales y ejemplo extendido\r
\r
En superficie horizontal, el caso [[N]] = [[m]][[g]] permite pasar directamente a trabajo de rozamiento horizontal. En plano inclinado hay que recalcular la normal. En frenadas, embragues y cojinetes, la potencia disipada suele ser mas importante que la energia total porque controla temperatura y dano.\r
\r
Ejemplo guia: un bloque se detiene por rozamiento. La energia cinetica inicial forma parte de [[Emi]], la energia mecanica final [[Emf]] puede ser cero si termina en reposo al mismo nivel, y entonces [[Wr]] coincide con [[dEm]]. La energia disipada [[Edis]] tiene el mismo modulo que la perdida mecanica, pero signo positivo.\r
\r
## Preguntas reales del alumno\r
\r
- **Por que el trabajo del rozamiento es negativo y la energia disipada positiva?**  \r
  Porque [[Wr]] describe transferencia mecanica sobre el sistema con signo, mientras [[Edis]] mide cuanto se ha convertido en calor, sonido o deformacion y se informa como cantidad acumulada.\r
\r
- **Puedo usar siempre [[fr]] = [[mu]][[N]]?**  \r
  No. Solo si el contacto seco y el regimen de deslizamiento justifican un coeficiente [[mu]] aproximadamente constante.\r
\r
- **Que reviso si el resultado no tiene sentido?**  \r
  Revisa primero [[N]], despues el signo de [[Wr]], y por ultimo si el sistema elegido permite comparar correctamente [[Emi]] y [[Emf]].\r
\r
## Conexiones transversales y rutas de estudio\r
\r
Este leaf se apoya en trabajo mecanico, energia cinetica y conservacion de energia. Tambien conecta con rozamiento en dinamica, porque la misma fuerza [[fr]] puede aparecer en una ecuacion de Newton o en un balance energetico.\r
\r
La continuacion natural es \`trabajo-de-fuerzas-no-conservativas\`, donde el rozamiento se generaliza a cualquier fuerza que cambie la energia mecanica del sistema.\r
\r
Tambien conecta con dinamica traslacional: el mismo [[fr]] que aqui produce [[Wr]] puede producir desaceleracion en una ecuacion de Newton. La diferencia es el punto de vista. La dinamica pregunta por aceleraciones instante a instante; este leaf pregunta por energia transferida a lo largo de un recorrido.\r
\r
## Sintesis final\r
\r
