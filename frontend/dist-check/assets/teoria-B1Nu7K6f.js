const e=`# Sistemas de ecuaciones para fisica\r
\r
## Que es\r
\r
Un sistema aparece cuando una sola ecuacion no contiene toda la informacion necesaria. En fisica se usa para leer una relacion antes de sustituir numeros. La pregunta central no es solo cuanto vale una cantidad, sino que cambia cuando se modifica una condicion del problema.\r
\r
...
\r
La idea visual es esta: imagina varias restricciones actuando a la vez sobre el mismo problema: cada ecuacion recorta las soluciones posibles. Esa imagen evita tratar todas las formulas como listas de simbolos equivalentes.\r
\r
...
\r
En simbolos, dos incognitas requieren normalmente dos ecuaciones independientes; si las ecuaciones repiten la misma informacion, el sistema no determina una respuesta unica. Lo importante es leer la operacion como relacion entre magnitudes y no como decoracion algebraica.\r
\r
...
\r
<!-- algebra-depth-v2 -->\r
## Capa de profundidad: sistemas de ecuaciones para fisica\r
\r
Este leaf no debe funcionar como una lista corta de reglas, sino como una herramienta para pensar problemas fisicos. El objetivo es traducir varias restricciones fisicas en un conjunto coherente de ecuaciones. Un alumno basico necesita reconocer la magnitud buscada y la unidad esperada; un alumno intermedio debe justificar la operacion elegida; un alumno avanzado debe anticipar limites, dependencias y casos donde el modelo deja de servir.\r
\r
Un sistema no nace porque haya muchas letras, sino porque una sola relacion no contiene toda la informacion.\r
\r
| Senal en el problema | Traduccion |\r
|---|---|\r
| dos cuerpos unidos | ecuaciones acopladas por tension o aceleracion comun |\r
| conservacion total | suma antes = suma despues |\r
| mismo punto de encuentro | posiciones iguales en el mismo tiempo |\r
| restricciones geometricas | relaciones entre desplazamientos o velocidades |\r
\r
