...
La descripción matemática del transporte energético ondulatorio comienza con la densidad de energía. Para una onda transversal en una cuerda, la densidad de energía instantánea [[u_energia]] en un punto depende de las propiedades del medio y de la perturbación:

{{f:densidad_energia_cuerda}}

Esta expresión muestra que la densidad de energía varía armónicamente con la posición y el tiempo, siendo máxima donde el seno cuadrado alcanza su valor unitario. El factor [[mu]] representa la inercia lineal del medio, [[omega]] la rapidez de oscilación y [[A]] la magnitud de la perturbación.
...
La tasa de transferencia de energía, es decir, la **potencia** transportada [[P_onda]] por la onda, se obtiene multiplicando la energía por unidad de longitud por la velocidad de propagación:

{{f:potencia_onda_cuerda}}

Esta expresión es válida para ondas progresivas unidireccionales. Para ondas en medios tridimensionales, la generalización introduce la sección transversal [[S]] por la que fluye la energía:

{{f:potencia_onda_general}}

Esta formulación unificada aplica a ondas mecánicas, electromagnéticas y acústicas, destacando la universalidad del transporte energético ondulatorio. La potencia [[P_onda]] representa la energía que atraviesa una sección del medio por unidad de tiempo, siendo la magnitud clave para diseñar sistemas de captación de energía undimotriz.
...
La dependencia cuadrática con [[omega]] refleja que la velocidad transversal de los elementos del medio escala linealmente con la frecuencia para una amplitud dada (v_max = [[omega]]·[[A]]). Como la energía cinética depende del cuadrado de la velocidad, aparece el [[omega]]². Físicamente, esto significa que ondas de alta frecuencia son intrínsecamente más "intensas" energéticamente que ondas de baja frecuencia con la misma amplitud.

El concepto de **densidad de energía** [[u_energia]] introduce una localización espacial del energía que no es posible en mecánica de partículas puntuales. En el límite continuo, podemos hablar de energía contenida en un elemento infinitesimal de volumen, permitiendo análisis de flujos locales y balances energéticos diferenciales.
...
Para detectar errores de cálculo, verificar que la energía total [[E_onda]] nunca exceda (1/2)·[[mu]]·[[lambda]]³·[[omega]]², que sería la energía cinética de traslación de toda la masa de un ciclo moviéndose a velocidad [[omega]]·[[A]]. Valores superiores indican violación del régimen lineal o error en los parámetros.
...
2. **Caracterizar el medio**: densidad lineal [[mu]], sección transversal [[S]], módulos elásticos relevantes. Para ondas electromagnéticas, la permitividad y permeabilidad del medio.

3. **Determinar parámetros cinemáticos**: amplitud [[A]], frecuencia [[omega]], longitud de onda [[lambda]], velocidad de propagación v.
...
Tanto la energía cinética como la potencial de un oscilador armónico dependen del cuadrado de las variables de estado (velocidad y desplazamiento respectivamente). Como la velocidad máxima es proporcional a la amplitud multiplicada por la frecuencia, ambas contribuciones energéticas escalan cuadráticamente con [[A]].
