...
La descripción matemática del transformador ideal parte de la ley de Faraday de la inducción electromagnética. La tensión alterna aplicada al primario de [[N_1]] espiras genera un flujo magnético alterno en el núcleo. La relación entre las tensiones primaria [[V_1]] y secundaria [[V_2]] es directamente proporcional a la relación entre el número de espiras:

{{f:relacion_transformacion}}

Esta ecuación revela que la transformación de tensión es puramente geométrica, dependiendo solo de la relación de espiras [[N_1]]/[[N_2]]. Un transformador elevador tiene [[N_2]] > [[N_1]], mientras que uno reductor tiene [[N_2]] < [[N_1]].
...
La potencia aparente [[S]], producto de [[V_1]] por [[I_1]], representa la capacidad de transferencia del transformador. Este parámetro nominal limita las corrientes máximas admisibles en ambos devanados:

{{f:potencia_aparente}}

En un transformador real, las pérdidas energéticas reducen ligeramente la eficiencia. El rendimiento [[eta]] compara la potencia activa de salida [[P_2]] con la potencia activa de entrada [[P_1]], cuantificando la fracción de potencia útil transferida:

{{f:rendimiento_transformador}}

Las pérdidas totales [[P_p]] se componen de las pérdidas en los devanados de cobre por efecto Joule [[P_Cu]] y las pérdidas en el núcleo de hierro por histéresis y corrientes parásitas [[P_Fe]]:

{{f:perdidas_totales}}

## 🔴 Nivel estructural

Las cinco ecuaciones anteriores forman un sistema coherente que describe completamente el funcionamiento del transformador en régimen estacionario. La tensión primaria [[V_1]] y la relación de espiras [[N_1]]/[[N_2]] determinan la tensión secundaria disponible [[V_2]]. La carga conectada al secundario demanda una corriente [[I_2]] que, por conservación de potencia, impone una corriente primaria [[I_1]] ajustada por la misma relación de espiras pero de forma inversa.

Esta cadena de dependencias revela un principio fundamental: el transformador es un dispositivo pasivo que se adapta automáticamente a la carga. Si la impedancia del secundario disminuye, aumenta [[I_2]] y consecuentemente [[I_1]], manteniendo el balance energético. El primario solo consume la corriente necesaria para suministrar la potencia demandada por el secundario más las pérdidas.

La potencia aparente nominal [[S]] es el parámetro de diseño que limita la capacidad máxima de transferencia. Para cualquier punto de operación, las corrientes deben satisfacer [[V_1]] × [[I_1]] ≤ [[S]] y [[V_2]] × [[I_2]] ≤ [[S]]. Exceder estos límites causa sobrecalentamiento por pérdidas excesivas en los conductores.
...
Para resolver problemas de transformadores, seguir el siguiente orden. Primero identificar los datos conocidos: [[N_1]], [[N_2]], [[V_1]], [[V_2]], [[I_1]], [[I_2]], [[S]], o [[eta]]. Segundo, determinar la relación de transformación [[N_1]]/[[N_2]]. Tercero, calcular la magnitud desconocida usando la relación directa para tensiones o la inversa para corrientes. Cuarto, verificar la conservación de la potencia aparente. Quinto, si hay datos de pérdidas o rendimiento, aplicar el balance energético correspondiente.

Recordar que en el transformador ideal el cociente entre tensiones sigue el cociente entre espiras, mientras que el cociente entre corrientes sigue la relación inversa. Si se conoce [[S]], cada corriente nominal se obtiene dividiendo esa potencia aparente por la tensión del devanado correspondiente.

## Casos especiales y ejemplo extendido

El transformador en vacío es el caso donde no hay carga conectada al secundario. La corriente [[I_2]] es cero, y el primario solo consume la pequeña corriente de magnetización necesaria para establecer el flujo en el núcleo. Este ensayo permite medir las pérdidas en el hierro [[P_Fe]].

El cortocircuito es el caso límite donde el secundario está directamente cortado. La corriente teórica sería infinita, pero la impedancia interna del transformador la limita a un valor finito pero muy elevado. El ensayo de cortocircuito permite determinar las pérdidas en cobre [[P_Cu]] a plena carga.

Ejemplo extendido: un transformador con mil espiras en el primario y cincuenta en el secundario tiene una relación de transformación de veinte a uno. Con [[V_1]] de 230 V, la tensión secundaria resulta de 11.5 V. Si la carga conectada demanda [[I_2]] de 4 A, la potencia de salida es aproximadamente 46 W. La corriente primaria queda alrededor de 0.2 A, porque la corriente se reduce en el primario en la misma proporción inversa. Con un rendimiento del 95%, las pérdidas son aproximadamente 2.4 W y la potencia de entrada aproximadamente 48.4 W. Estas magnitudes son típicas de un transformador de pequeña potencia para aplicaciones electrónicas.
