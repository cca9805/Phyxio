const e=`# Magnitudes alternas

## Contexto conceptual
Magnitudes alternas es el leaf donde la corriente alterna deja de verse como una señal que solo "sube y baja" y empieza a leerse como un sistema cuantitativo con significado energético. En AC no basta saber el valor instantáneo [[v_t]]. Hace falta distinguir amplitud [[Vmax]], valor eficaz [[Vrms]], frecuencia [[f]], frecuencia angular [[omega]], período [[T]], desfase [[phi]] y potencia activa [[P]]. Cada una de esas magnitudes responde a una pregunta distinta y operativa.
...
Este tema es puente entre lenguaje temporal y lenguaje energético. El dominio temporal usa [[t]], [[v_t]], [[omega]] y [[phi]] para describir forma de onda. El dominio energético usa [[Vrms]], [[Irms]] y [[P]] para cuantificar transferencia media. Una lectura rigurosa necesita ambos: forma de señal y consecuencia física.
...
Este bloque formal exige coherencia de unidades y de contexto. [[f]] en Hz no puede sustituirse por [[omega]] en rad/s sin factor de conversión. [[Vrms]] e [[Irms]] deben pertenecer al mismo estado estacionario. Y la expresión de [[P]] no es completa sin [[phi]], porque el desfase codifica cuánto de la demanda eléctrica se transforma en transferencia media neta.
...
## 🔴 Nivel estructural
En nivel estructural interesa cómo se organizan las magnitudes entre sí. [[v_t]] vive en el dominio instantáneo y oscila de signo. [[Vrms]] e [[Irms]] viven en el dominio energético y se reportan como magnitudes no negativas. [[f]] y [[T]] forman una pareja recíproca que fija la escala temporal del problema. [[omega]] traduce esa escala al lenguaje angular. [[phi]] conecta geometría temporal con transferencia de potencia.

Esa estructura explica por qué dos señales con igual [[Vmax]] pueden no ser equivalentes en uso real. Si cambia la forma de onda, el vínculo simple entre [[Vmax]] y [[Vrms]] puede romperse. Si cambia [[phi]], la potencia activa [[P]] cambia aunque [[Vrms]] e [[Irms]] se mantengan. Si cambia [[f]], cambia [[T]] y cambia el comportamiento de sistemas acoplados que dependen del ritmo de excitación.
...
La lectura profunda de magnitudes alternas aparece cuando dejas de verlas como definiciones aisladas y las interpretas como un sistema de compresión física. Una señal temporal tiene infinitos puntos. Sin embargo, con [[Vmax]], [[Vrms]], [[f]], [[omega]], [[T]] y [[phi]] puedes resumir su comportamiento esencial para diseño y operación.

[[Vrms]] es especialmente importante porque traduce AC a criterio energético comparable con DC. [[phi]] es igualmente decisiva porque cuantifica desalineación temporal entre variables conjugadas, lo que afecta la porción realmente útil de transferencia. Por eso potencia activa [[P]] no depende solo de cuánta tensión o corriente hay, sino de cómo se relacionan en fase.

Otra lectura física clave es distinguir descripción y causa. [[v_t]] describe el estado instantáneo. [[f]] y [[omega]] describen el ritmo. [[phi]] describe relación temporal. [[P]] describe consecuencia energética media. Mezclar niveles de descripción conduce a errores de diseño, de diagnóstico y de interpretación experimental.

## Orden de magnitud
En red eléctrica doméstica o de laboratorio, [[Vrms]] suele estar en decenas o centenas de voltios. [[f]] suele estar en decenas de hertz, y [[omega]] en centenas de radianes por segundo. [[T]] suele estar en milisegundos para frecuencia de red. Estas escalas sirven para detectar errores inmediatos de unidad.

Si obtienes [[omega]] del orden de 50 rad/s para una red de 50 Hz, hay error de factor 2π. Si obtienes [[T]] de segundos enteros para red estándar, algo falla en la conversión. Si [[P]] sale incompatible con [[Vrms]] e [[Irms]] reportadas, probablemente se omitió [[phi]] o se mezclaron valores pico y eficaces.
...
Primero, etiqueta cada dato: instantáneo, pico, eficaz, frecuencia, período o fase. Segundo, unifica unidades SI y decide si trabajarás en Hz o rad/s, manteniendo conversión explícita. Tercero, escribe la señal temporal y comprueba que el argumento trigonométrico sea coherente con [[omega]] y [[t]].

Cuarto, convierte amplitud a RMS solo si la forma es sinusoidal pura. Quinto, calcula potencia activa usando [[Vrms]], [[Irms]] y [[phi]] del mismo estado operativo. Sexto, cierra con una validación rápida: reciprocidad entre [[f]] y [[T]], consistencia entre [[Vmax]] y [[Vrms]], y razonabilidad de [[P]] frente a magnitudes de entrada.
...
Considera una señal sinusoidal en la que conoces amplitud, frecuencia y fase relativa de trabajo. El objetivo no es solo obtener números, sino construir trazabilidad entre descripción temporal y consecuencia energética. Inicia con la forma temporal para ubicar el papel de [[v_t]] y [[t]], luego pasa a [[omega]], [[f]] y [[T]], y finalmente traduce a [[Vrms]] y [[P]].

En este tipo de casos, un error frecuente es saltar directamente a potencia sin comprobar coherencia temporal. Si [[omega]] está mal, toda la interpretación de ciclo queda comprometida. Si [[Vrms]] se deduce mal de [[Vmax]], [[P]] heredará el error. Si [[phi]] se ignora, la estimación de transferencia útil se sobrestima.

Otro caso especial importante es la señal no sinusoidal. Allí la conversión simple entre [[Vmax]] y [[Vrms]] deja de ser exacta. El leaf enseña a reconocer ese límite y a justificar cuándo pasar de modelo básico a análisis más rico. El objetivo pedagógico no es negar la complejidad, sino saber cuándo aparece.
...
2. ¿Qué cambia primero cuando aumenta [[f]]? Cambia [[T]] en forma inversa y cambia la rapidez de variación de fase asociada a [[omega]].

3. ¿Puede haber potencia activa con desfase grande? Sí, pero disminuye con el factor coseno asociado a [[phi]].
...
Este leaf conecta de forma directa con reactancia inductiva y capacitiva, porque la conversión entre [[f]] y [[omega]] fija magnitudes de respuesta en esos temas. También conecta con potencia en AC, donde [[Vrms]], [[Irms]] y [[phi]] determinan lectura energética útil.
