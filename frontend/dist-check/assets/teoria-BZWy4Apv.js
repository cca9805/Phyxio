...
Dividiendo [[F_C]] entre la carga de prueba se obtiene el **campo eléctrico** [[E_C]] creado por [[q1]] en ese punto del espacio:

{{f:campo_electrico_coulomb}}

Esta segunda relación es la puerta de entrada al concepto de campo eléctrico: [[E_C]] no depende de qué carga se coloque en el punto sino solo de [[q1]] y [[r12]].
...
- **Dependencia inversa cuadrática con la distancia**: [[r12]] aparece al cuadrado en el denominador. Doblar [[r12]] reduce [[F_C]] a una cuarta parte; triplicarla la reduce a un noveno.
...
- Dos electrones separados 1 Å (décima de nanómetro): [[F_C]] del orden de 10⁻⁸ N. Pequeña pero enorme para la masa del electrón.
- Dos esferas de laboratorio con 1 μC a 10 cm: [[F_C]] del orden de 0.9 N. Detectable con una balanza de precisión.
- Dos cargas de 1 C a 1 m: [[F_C]] del orden de 9×10⁹ N. Catastrófico en cualquier sistema real —razón por la que 1 C de carga concentrada no existe en la práctica.

Si un resultado de [[F_C]] supera los kiloNewtons para cargas de microcoulombios a distancias de centímetros, hay casi con certeza un error de conversión de unidades (usar centímetros en vez de metros en [[r12]]).
...
2. **Elegir qué se calcula**: si se pide [[F_C]], usar la fórmula directamente. Si se pide [[r12]] o una carga, despejar antes algebraicamente.
...
**Caso límite — distancia tendiendo a cero**: cuando [[r12]] se aproxima a cero, [[F_C]] diverge. En la práctica, esto nunca ocurre porque los objetos tienen extensión finita; el modelo de carga puntual deja de ser válido antes de que la distancia sea comparable al tamaño de los objetos. Este límite señala la frontera del modelo.

**Caso de carga nula**: si [[q1]] o [[q2]] es cero, [[F_C]] es exactamente cero sin importar la distancia. Una carga nula no interactúa electrostáticamente. Este resultado, aunque obvio, tiene implicaciones importantes: la carga de prueba infinitesimal usada para definir el campo eléctrico es una idealización precisamente porque no debe perturbar el campo de la carga fuente.
...
La tercera ley de Newton es universal: el módulo de [[F_C]] entre las dos cargas es único. Lo que varía es la aceleración según la masa de cada objeto.

**Si separo las cargas al doble, ¿la fuerza se reduce a la mitad?**
No. [[r12]] está al cuadrado en el denominador: duplicar la distancia reduce [[F_C]] a una cuarta parte.

**¿Qué diferencia hay entre [[F_C]] y [[E_C]]?**
[[F_C]] depende de las dos cargas [[q1]] y [[q2]]. [[E_C]] es [[F_C]] dividido entre la carga de prueba: solo depende de [[q1]] y de la posición. El campo es una propiedad del espacio; la fuerza es lo que una carga concreta siente en él.

## Conexiones transversales y rutas de estudio

La ley de Coulomb es el punto de entrada a tres ramas:

- **Campo eléctrico [[E_C]]**: dividir [[F_C]] entre la carga de prueba define [[E_C]]. Lleva al leaf de campo eléctrico puntual y, por superposición, al campo de distribuciones.
