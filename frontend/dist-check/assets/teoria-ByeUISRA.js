const e=`# Marco rotante general

## Contexto conceptual

Marco rotante general responde a una pregunta fisica precisa: ¿Como se descompone la aceleracion absoluta cuando el observador pertenece a un marco rotante general? El tema no se introduce para sumar una formula mas, sino para dar al alumno una herramienta de lectura cuando los modelos elementales ya no separan bien causa, escala y dominio.

Un marco rotante general separa aceleracion relativa, aceleracion del origen y terminos aparentes. La lectura importante es distinguir que fuerzas aparecen por interaccion real y cuales aparecen porque el observador rota. Por eso las magnitudes nucleares, [[a_abs]], [[a_rel]], [[a_O]], [[Omega]], [[alpha]], [[r]], [[v_rel]], [[F_E]], [[m]], no son una lista decorativa. Cada una marca una parte de la estructura: una escala, una frontera, una variable dinamica, una condicion de validez o una cantidad conservada.

## 🟢 Nivel esencial

La idea esencial es que un marco rotante general separa aceleracion relativa, aceleracion del origen y terminos aparentes. Antes de calcular, el estudiante debe poder decir que mecanismo fisico se esta aislando y que aspecto del sistema queda deliberadamente fuera. Si esa lectura no existe, la formula puede producir un numero correcto para una pregunta equivocada.

En este nivel, [[a_abs]] actua como magnitud dominante porque concentra la decision didactica del leaf. No basta nombrarla: hay que explicar si aumenta, disminuye, cambia de signo, se anula o deja de tener sentido cuando cambia el regimen. Esa lectura verbal prepara el paso formal.
...
Para aplicarlas, [[a_abs]], [[a_rel]], [[a_O]], [[Omega]], [[alpha]], [[r]], [[v_rel]], [[F_E]], [[m]] deben pertenecer al mismo sistema. Tambien hay que revisar signo, unidades y dominio. La pregunta central sigue siendo: ¿Como se descompone la aceleracion absoluta cuando el observador pertenece a un marco rotante general? Si un despeje cambia esa pregunta, el procedimiento ha dejado de ser fisica y se ha convertido en manipulacion simbolica.
...
La estructura profunda aparece al comparar el modelo con sus limites. Un marco rotante general separa aceleracion relativa, aceleracion del origen y terminos aparentes. La lectura importante es distinguir que fuerzas aparecen por interaccion real y cuales aparecen porque el observador rota. Esta frase debe funcionar como criterio de control: permite decidir si el tema se esta usando en su dominio natural o si se esta forzando fuera de rango.
...
La interpretacion profunda empieza preguntando que representa [[a_abs]] dentro de la cadena causal. Si [[a_abs]] se modifica, puede cambiar el regimen, desplazar una condicion critica o revelar que una hipotesis secundaria ya no es secundaria.
...
Esta comprobacion evita conclusiones artificiales. Las unidades de [[a_abs]], [[a_rel]], [[a_O]], [[Omega]], [[alpha]], [[r]], [[v_rel]], [[F_E]], [[m]] deben sostener la misma dimension fisica y la misma escala experimental.

## Método de resolución personalizado

Primero se delimita el sistema y se nombran las hipotesis. Segundo se identifica [[a_abs]] y se decide que formula responde a la pregunta central. Tercero se calcula simbolicamente antes de sustituir numeros.
...
Al terminar, el alumno debe explicar que un marco rotante general separa aceleracion relativa, aceleracion del origen y terminos aparentes, aplicar las formulas en su dominio y justificar que significa fisicamente el resultado. La competencia final es decidir si el modelo responde a la pregunta del sistema real, no solo obtener una expresion algebraica.
