...
Dos partículas con [[q1]] y [[q2]] no nulas se atraen o se repelen mutuamente. Si ambas tienen el mismo tipo de carga, la fuerza [[F_C]] las separa; si tienen tipos contrarios, la fuerza las acerca. Este comportamiento es universal y no requiere contacto entre las partículas: actúa a distancia.

La intensidad de esa acción depende de cuánto valen [[q1]] y [[q2]], y de cuán lejos estén. Lo más importante a nivel intuitivo es que **duplicar la distancia no reduce la fuerza a la mitad, sino a una cuarta parte**: la dependencia con [[r]] es cuadrática.
...
La relación matemática entre [[F_C]], [[q1]], [[q2]] y [[r]] es la **ley de Coulomb**:

{{f:fuerza_coulomb}}

donde [[k_e]] es la constante de Coulomb, cuyo valor en el vacío es aproximadamente 8.988×10⁹ N·m²·C⁻². La fórmula muestra que [[F_C]] es **proporcional al producto de las cargas** y **proporcional a la inversa del cuadrado de la distancia**.

El signo de [[F_C]] sigue directamente del producto \\(q_1 \\cdot q_2\\): si ambas cargas son positivas o ambas negativas, el producto es positivo y la fuerza es repulsiva; si tienen signos contrarios, el producto es negativo y la fuerza es atractiva.

De la ley de Coulomb se deduce directamente el **campo eléctrico** creado por [[q1]] en cualquier punto del espacio. En el punto donde se encuentra [[q2]], a distancia [[r]], ese campo vale:

{{f:campo_electrico_coulomb}}

La diferencia conceptual entre [[F_C]] y [[E_C]] es fundamental: [[E_C]] es una propiedad del espacio creada por [[q1]] que existe aunque no haya [[q2]]. La fuerza [[F_C]] requiere la presencia de ambas cargas; el campo [[E_C]] solo requiere [[q1]].
...
Para el sistema electrón-protón en el átomo de hidrógeno, con cargas de ±1.6×10⁻¹⁹ C y distancia de 0.53×10⁻¹⁰ m, [[F_C]] es del orden de 8×10⁻⁸ N, lo que equivale a una aceleración del electrón de casi 10²² m/s². Cualquier resultado en un problema de cargas atómicas inferior a 10⁻¹⁰ N o superior a 10⁻⁶ N debe hacer saltar una señal de alerta.

Para detectar un resultado absurdo: si [[F_C]] supera el peso de un objeto macroscópico con cargas de laboratorio habituales (microculombios), algo está mal. Las cargas de laboratorio raramente superan 10 µC.
...
2. **Medir [[r]] en metros**. No en centímetros ni en angstroms.
...
Si el problema pide el campo [[E_C]] en lugar de [[F_C]], usar la segunda fórmula del leaf y recordar que [[E_C]] no depende de [[q2]].

## Casos especiales y ejemplo extendido

**Carga nula**: si [[q1]] o [[q2]] es cero, [[F_C]] es exactamente cero. No hay interacción aunque las cargas estén en contacto.
...
La dependencia cuadrática no es arbitraria: refleja que la interacción se "diluye" en el espacio tridimensional. El "flujo" de la fuerza se reparte sobre una superficie esférica que crece con [[r]]², por eso la densidad de fuerza cae con [[r]]². Esta misma lógica explica la gravitación y la intensidad de la luz.
...
**¿Cómo sé si usar [[F_C]] o [[E_C]] para resolver un problema?**

Si el enunciado pregunta la fuerza sobre una carga específica, usa [[F_C]]. Si pregunta qué aceleración o fuerza experimentaría cualquier carga (sin especificarla), la respuesta correcta es [[E_C]], que no depende de la carga de prueba. Si el enunciado da [[E_C]] y pide [[F_C]], basta multiplicar por [[q2]].
