...
La descripción matemática parte de la fuerza de Laplace sobre un conductor. Un conductor de longitud [[L_c]] con corriente [[I]] dentro de campo [[B]] experimenta fuerza proporcional al producto de estas magnitudes y al seno del ángulo. Con [[N_c]] conductores activos, la fuerza total es:
...
Las cinco fórmulas anteriores forman un sistema encadenado donde cada variable se determina secuencialmente a partir de las anteriores. La corriente de armadura [[I]], impuesta por la diferencia entre la tensión de alimentación y la fem contraelectromotriz, determina la fuerza de Laplace [[F_L]] sobre cada conductor activo. Esta fuerza, distribuida entre los [[N_c]] conductores del bobinado, genera una acción mecánica colectiva.
...
El par motor y la velocidad angular combinados determinan la potencia mecánica [[P_mec]] transferida al eje. Comparando esta potencia útil con la potencia eléctrica total consumida [[P_elec]] se obtiene el rendimiento [[eta]], que cuantifica la calidad de la conversión energética. Las pérdidas, representadas por la diferencia entre potencia entrante y útil, se disipan principalmente como calor en el bobinado.
...
Para resolver cualquier problema de motor eléctrico, el orden recomendado es el siguiente. Primero identificar los datos conocidos entre [[N_c]], [[I]], [[L_c]], [[B]], [[r_a]], [[sin_theta]] y [[omega]]. Segundo, calcular [[F_L]] con la primera fórmula y verificar la dimensión. Tercero, obtener [[tau_m]] multiplicando [[F_L]] por [[r_a]]. Cuarto, si se conoce [[omega]], calcular [[epsilon_c]] y [[P_mec]]. Quinto, con [[P_elec]] y [[P_mec]], obtener [[eta]]. En cada paso, verificar que el resultado tiene el orden de magnitud esperado antes de avanzar al siguiente.
...
Ejemplo extendido: un motor de CC con 300 conductores activos, [[L_c]] de 0.08 m, [[B]] de 1.0 T, [[r_a]] de 0.05 m y [[I]] de 5 A opera a [[omega]] de 100 rad/s con [[sin_theta]] igual a 1. La fuerza por conductor es [[I]] por [[L_c]] por [[B]], es decir 0.4 N. La fuerza total sobre los [[N_c]] conductores es 120 N. El par es 120 por 0.05, igual a 6 N·m. La potencia mecánica es 6 por 100, igual a 600 W. La fem contraelectromotriz es 300 por 0.08 por 1.0 por 0.05 por 100, igual a 120 V. Con una tensión de alimentación de 130 V y la fem contraelectromotriz de 120 V, la corriente de régimen es aproximadamente (130 - 120) dividido entre la resistencia interna del bobinado. Con 2 Ω de resistencia, la corriente es 5 A, lo que verifica la coherencia del sistema.
...
¿Por qué invertir la polaridad de la alimentación invierte el giro? Porque invierte la dirección de [[I]], lo que invierte la dirección de la fuerza de Laplace según la regla de la mano derecha.
