const e=`# Ligaduras no holonomas

## Contexto conceptual

Ligaduras no holonomas responde a una pregunta fisica precisa: ¿Como se formulan las ligaduras no holonomas cuando restringen velocidades y no solo configuraciones? El tema no se introduce para sumar una formula mas, sino para dar al alumno una herramienta de lectura cuando los modelos elementales ya no separan bien causa, escala y dominio.

Una ligadura no holonoma restringe velocidades admisibles y no puede integrarse siempre como restriccion de posicion. El punto didactico es entender que no toda condicion diferencial reduce simplemente el numero de coordenadas. Por eso las magnitudes nucleares, [[Aai]], [[qdot_i]], [[aa]], [[lambda_a]], [[Lagr]], [[Qi]], [[dqi]], no son una lista decorativa. Cada una marca una parte de la estructura: una escala, una frontera, una variable dinamica, una condicion de validez o una cantidad conservada.

## 🟢 Nivel esencial

La idea esencial es que una ligadura no holonoma restringe velocidades admisibles y no puede integrarse siempre como restriccion de posicion. Antes de calcular, el estudiante debe poder decir que mecanismo fisico se esta aislando y que aspecto del sistema queda deliberadamente fuera. Si esa lectura no existe, la formula puede producir un numero correcto para una pregunta equivocada.

En este nivel, [[Aai]] actua como magnitud dominante porque concentra la decision didactica del leaf. No basta nombrarla: hay que explicar si aumenta, disminuye, cambia de signo, se anula o deja de tener sentido cuando cambia el regimen. Esa lectura verbal prepara el paso formal.
...
Para aplicarlas, [[Aai]], [[qdot_i]], [[aa]], [[lambda_a]], [[Lagr]], [[Qi]], [[dqi]] deben pertenecer al mismo sistema. Tambien hay que revisar signo, unidades y dominio. La pregunta central sigue siendo: ¿Como se formulan las ligaduras no holonomas cuando restringen velocidades y no solo configuraciones? Si un despeje cambia esa pregunta, el procedimiento ha dejado de ser fisica y se ha convertido en manipulacion simbolica.
...
La estructura profunda aparece al comparar el modelo con sus limites. Una ligadura no holonoma restringe velocidades admisibles y no puede integrarse siempre como restriccion de posicion. El punto didactico es entender que no toda condicion diferencial reduce simplemente el numero de coordenadas. Esta frase debe funcionar como criterio de control: permite decidir si el tema se esta usando en su dominio natural o si se esta forzando fuera de rango.
...
La interpretacion profunda empieza preguntando que representa [[Aai]] dentro de la cadena causal. Si [[Aai]] se modifica, puede cambiar el regimen, desplazar una condicion critica o revelar que una hipotesis secundaria ya no es secundaria.
...
Esta comprobacion evita conclusiones artificiales. Las unidades de [[Aai]], [[qdot_i]], [[aa]], [[lambda_a]], [[Lagr]], [[Qi]], [[dqi]] deben sostener la misma dimension fisica y la misma escala experimental.

## Método de resolución personalizado

Primero se delimita el sistema y se nombran las hipotesis. Segundo se identifica [[Aai]] y se decide que formula responde a la pregunta central. Tercero se calcula simbolicamente antes de sustituir numeros.
...
Al terminar, el alumno debe explicar que una ligadura no holonoma restringe velocidades admisibles y no puede integrarse siempre como restriccion de posicion, aplicar las formulas en su dominio y justificar que significa fisicamente el resultado. La competencia final es decidir si el modelo responde a la pregunta del sistema real, no solo obtener una expresion algebraica.
