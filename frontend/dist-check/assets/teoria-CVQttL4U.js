...
La relacion cuantitativa entre la [[I]] y el angulo [[theta_p]] entre la direccion de polarizacion de la onda y el eje del polarizador viene dada por la ley de Malus:

{{f:ley_malus}}

Donde [[I_0]] es la intensidad de la luz polarizada que llega al analizador y [[theta_p]] es el angulo entre el eje de polarizacion de la onda y el eje de transmision del filtro. La dependencia cuadratica con el coseno indica que la intensidad no decrece linealmente sino que se mantiene alta para angulos pequenos y cae rapidamente a medida que el angulo se acerca a 90 grados. Para [[theta_p]] igual a cero, [[I]] coincide con [[I_0]]; para [[theta_p]] igual a 90 grados, [[I]] se anula (polarizadores cruzados).

> [!NOTE]
> Si la fuente emite luz natural no polarizada, el primer polarizador transmite exactamente la mitad de la intensidad original. La ley de Malus se aplica entonces tomando esa mitad como [[I_0]] para el segundo polarizador.
...
Para una interfase aire-vidrio comun ([[n_1]] cercano a 1.00 y [[n_2]] cercano a 1.50), [[theta_B]] es aproximadamente 56 grados. Para agua ([[n_2]] cercano a 1.33) baja a unos 53 grados. Intensidades tipicas de laboratorio varian entre 10 y 1000 W/m². Un resultado de [[I]] muy superior a [[I_0]] o un angulo de Brewster fuera del rango de 40 a 70 grados para materiales comunes deberia despertar sospecha inmediata de error en los datos.
...
3. **Aplicar la ley de Malus**: calcular [[I]] a partir de [[I_0]] y [[theta_p]].
4. **Si hay reflexion**: identificar los medios, obtener [[n_1]] y [[n_2]], y calcular [[theta_B]] con la ley de Brewster.
5. **Verificar coherencia**: comprobar que [[I]] no supera [[I_0]] y que [[theta_B]] esta en un rango razonable para los materiales dados.

## Casos especiales y ejemplo extendido

- **Polarizadores cruzados con lamina intermedia**: si se inserta un tercer polarizador entre dos cruzados con su eje a 45 grados de ambos, la luz vuelve a transmitirse parcialmente. La intensidad final resulta ser un cuarto de [[I_0]] multiplicado por el seno cuadrado del doble del angulo intermedio, lo que demuestra que la polarizacion no es simplemente un filtro de "todo o nada".

- **Reflexion en agua a [[theta_B]]**: al observar un lago bajo el angulo de Brewster, la luz reflejada esta casi completamente polarizada horizontalmente. Por eso las gafas de sol polarizadas con eje vertical eliminan el deslumbramiento del agua mientras transmiten la luz util.
