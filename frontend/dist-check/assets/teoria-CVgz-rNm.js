...
La condición de contorno para una cuerda con extremos fijos exige nodos en ambos puntos de su longitud vibrante. La solución de onda estacionaria que satisface esta restricción impone que [[L]] contenga exactamente [[n]] medias longitudes de onda:

{{f:longitud_onda_armonica}}

Donde [[n]] es el número de armónico (entero positivo) y [[lambda_n]] la longitud de onda correspondiente. Resolviendo para la longitud de onda, obtenemos el conjunto discreto de valores permitidos.

La relación general entre frecuencia, velocidad de propagación y longitud de onda indica que [[v]] equivale al producto de [[f_n]] por [[lambda_n]], permitiendo derivar las frecuencias armónicas. Sustituyendo la expresión anterior:

{{f:frecuencia_armonica}}

Esta ecuación revela que las frecuencias son múltiplos enteros de una frecuencia base. El caso particular en el que [[n]] vale 1 define la **frecuencia fundamental**:
...
> [!WARNING]
> La velocidad [[v]] en estas fórmulas es la velocidad de propagación de la perturbación a lo largo de la cuerda, no la velocidad transversal de oscilación de los puntos de la misma. Estas magnitudes están relacionadas pero son conceptualmente distintas.
...
> [!NOTE]
> El carácter lineal del espectro armónico, donde [[f_n]] escala con [[n]] y con [[f_1]], es consecuencia directa de la unidimensionalidad del sistema y la homogeneidad de la cuerda. Sistemas de mayor dimensionalidad exhiben espectros más complejos.
...
4. **Derive las frecuencias**: obtenga [[f_n]] combinando [[n]], [[v]], [[L]] y [[lambda_n]] mediante las fórmulas del nivel formal.
