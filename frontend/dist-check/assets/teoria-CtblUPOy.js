const e=`# Interferencia de la luz
...
El tratamiento matemático de la interferencia en doble rendija parte de la geometría del experimento. Consideremos dos rendijas separadas una distancia [[d]] que actúan como fuentes secundarias coherentes. Un punto en la pantalla, situado a ángulo [[theta]] respecto a la dirección central, recibe contribuciones de ambas rendijas. La diferencia de camino óptico entre ambos haces es:
...
Donde [[m]] es un número entero que identifica el orden del máximo. Valores positivos y negativos de [[m]] corresponden a franjas a ambos lados del centro. El orden cero corresponde al máximo central donde ambos caminos son iguales.

Para interferencia destructiva (mínimos de intensidad), las ondas deben llegar en contrafase:

{{f:condicion_minimos}}

En este caso, [[m]] sigue siendo entero, pero el desplazamiento de medio entero introduce el desfase de π radianes necesario para la anulación.

La posición lineal [[y_m]] de cada franja en la pantalla, a distancia [[L]] de las rendijas, se obtiene mediante la aproximación de ángulos pequeños:

{{f:posicion_franja}}

Esta fórmula resulta de combinar la condición de máximo con la aproximación de ángulos pequeños, válida cuando [[y_m]] es mucho menor que [[L]]. La separación entre franjas consecutivas es constante:
...
Las cuatro ecuaciones anteriores forman un sistema encadenado que describe completamente el patrón de interferencia en régimen de ángulos pequeños. La diferencia de camino [[delta]] depende directamente de la separación [[d]] y del ángulo [[theta]]. La condición de máximo o mínimo establece valores discretos de [[delta]] para cada orden [[m]]. La posición [[y_m]] traduce estas condiciones angulares en posiciones lineales medibles sobre la pantalla.
...
El patrón de interferencia establece una dualidad fundamental: a mayor separación entre rendijas [[d]], más comprimido es el patrón, con franjas más cercanas entre sí. Esta relación de reciprocidad espacial es análoga a la relación tiempo-frecuencia en el análisis de Fourier. Aumentar [[d]] equivale a aumentar la resolución angular del sistema, permitiendo resolver fuentes con separación angular menor. Este principio es la base de la interferometría astronómica de línea de base larga.
...
Las escalas típicas en experimentos de interferencia de doble rendija son las siguientes. La separación entre rendijas [[d]] es del orden de 0.1 mm a 0.5 mm. La distancia a la pantalla [[L]] es del orden de 1 m a 2 m. La longitud de onda visible [[lambda]] está entre 400 nm y 700 nm. La separación entre franjas resultante [[Delta_y]] es típicamente de 1 mm a 10 mm.

El factor adimensional [[lambda]]/[[d]], del orden de 5 × 10⁻³, determina la apertura angular del patrón. Un patrón típico contiene entre 10 y 20 franjas brillantes visibles antes de que la difracción por el ancho finito de las rendijas atenúe la intensidad. El número máximo observable de órdenes limita la precisión con la que puede medirse [[lambda]] a partir del patrón.

## Método de resolución personalizado

Para resolver problemas de interferencia de doble rendija, seguir este procedimiento. Primero, identificar los valores de [[d]], [[L]] y [[lambda]], verificando que todas las unidades sean consistentes en metros. Segundo, calcular la diferencia de camino para la posición o ángulo dado. Tercero, aplicar la condición de interferencia constructiva o destructiva según se busquen máximos o mínimos. Cuarto, despejar la incógnita: [[y_m]], [[m]], [[lambda]], [[d]] o [[L]]. Quinto, verificar la consistencia física: el orden [[m]] debe ser entero, la posición [[y_m]] debe ser razonable y la separación entre franjas debe estar en el rango de milímetros para parámetros típicos. Sexto, validar calculando la separación entre franjas consecutivas como [[lambda]] × [[L]] / [[d]] y verificar coherencia con los resultados parciales.

## Casos especiales y ejemplo extendido

El caso [[m]] = 0 corresponde al máximo central, donde la diferencia de camino es nula y las ondas siempre llegan en fase independientemente de [[lambda]]. Este máximo es blanco cuando se usa luz policromatica.

Ejemplo extendido: un experimento usa un láser de helio-neón con [[lambda]] de 632.8 nm, separación entre rendijas [[d]] de 0.20 mm y distancia a pantalla [[L]] de 2.0 m. Sustituyendo en la fórmula de separación entre franjas se obtiene aproximadamente 6.3 mm. La posición del tercer máximo lateral resulta aproximadamente 18.9 mm. Si [[d]] se duplica, las franjas se acercan a la mitad. Si [[lambda]] aumenta un 10%, las franjas se separan un 10%. Este análisis demuestra que el patrón permite medir [[lambda]] con precisión del 0.1% conociendo los parámetros geométricos.
...
¿Se puede usar la fórmula de ángulos pequeños para cualquier orden? No. La aproximación es válida solo cuando [[y_m]] es mucho menor que [[L]]. Para órdenes altos donde el ángulo supera 0.1 radianes, debe usarse la expresión exacta con arcoseno.
