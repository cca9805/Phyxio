...
\r
La magnitud central del leaf es [[tau]], el torque o momento de fuerza. El efecto rotacional depende de la fuerza [[F]] aplicada, de la distancia [[r]] desde el eje al punto de aplicación, y del ángulo [[theta]] entre [[r]] y [[F]]. El brazo de palanca [[b]] es la distancia perpendicular efectiva desde el eje a la línea de acción de [[F]], y es la clave de la geometría del problema: cuanto mayor es [[b]], mayor es el torque para la misma [[F]].\r
\r
## 🔵 Nivel formal\r
\r
La traducción matemática reúne esa intuición en relaciones precisas. Las fórmulas que organizan el análisis son la forma angular, la forma de brazo de palanca, la forma plana por componentes y la segunda ley rotacional. En este leaf, la primera relación operativa es el torque por ángulo entre [[r]] y [[F]]:\r
\r
...
\r
Con frecuencia aparece además una segunda relación de cierre, torque por brazo de palanca, que ayuda a completar la estructura del problema:\r
\r
{{f:torque_brazo}}\r
\r
...
\r
Cuando se conocen las componentes [[F_x]] y [[F_y]] de la fuerza y las coordenadas [[x]] y [[y]] del punto de aplicación, se usa:\r
\r
{{f:torque_plano}}\r
\r
Si además se busca la respuesta dinámica del sistema, se usa:\r
\r
{{f:segunda_ley_rotacional}}\r
\r
La segunda ley rotacional conecta [[tau]] con la aceleración angular [[alpha]] a través del momento de inercia [[I]] del cuerpo.\r
\r
...
\r
Un caso especial interesante aparece cuando la relación principal sigue siendo válida, pero una hipótesis lateral cambia el modo de interpretar el resultado. En Definición de Torque, eso puede ocurrir si el sistema pasa de ideal a disipativo, de rígido a deformable, o de un solo cuerpo a un conjunto acoplado. El mismo formalismo deja entonces de responder con la misma transparencia y pide una lectura más cuidadosa del dominio de validez.\r
\r
...
\r
Definición de Torque conversa de forma natural con varios bloques cercanos del mapa:\r
\r
