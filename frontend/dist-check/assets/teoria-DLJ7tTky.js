const e=`# Sistemas con ligaduras y Dirac

## Contexto conceptual

Sistemas con ligaduras y Dirac responde a una pregunta fisica precisa: ¿Como organiza el formalismo de Dirac un sistema hamiltoniano con ligaduras en el espacio de fases? El tema no se introduce para sumar una formula mas, sino para dar al alumno una herramienta de lectura cuando los modelos elementales ya no separan bien causa, escala y dominio.

El formalismo de Dirac organiza ligaduras hamiltonianas en el espacio de fases y modifica los corchetes cuando las restricciones deben preservarse. Es un puente avanzado entre mecanica clasica y teorias con simetria gauge. Por eso las magnitudes nucleares, [[HT]], [[Hc]], [[phi_a]], [[lambda_a]], [[Cab]], [[Fobs]], [[DB]], no son una lista decorativa. Cada una marca una parte de la estructura: una escala, una frontera, una variable dinamica, una condicion de validez o una cantidad conservada.

## 🟢 Nivel esencial

La idea esencial es que el formalismo de dirac organiza ligaduras hamiltonianas en el espacio de fases y modifica los corchetes cuando las restricciones deben preservarse. Antes de calcular, el estudiante debe poder decir que mecanismo fisico se esta aislando y que aspecto del sistema queda deliberadamente fuera. Si esa lectura no existe, la formula puede producir un numero correcto para una pregunta equivocada.

En este nivel, [[HT]] actua como magnitud dominante porque concentra la decision didactica del leaf. No basta nombrarla: hay que explicar si aumenta, disminuye, cambia de signo, se anula o deja de tener sentido cuando cambia el regimen. Esa lectura verbal prepara el paso formal.
...
Para aplicarlas, [[HT]], [[Hc]], [[phi_a]], [[lambda_a]], [[Cab]], [[Fobs]], [[DB]] deben pertenecer al mismo sistema. Tambien hay que revisar signo, unidades y dominio. La pregunta central sigue siendo: ¿Como organiza el formalismo de Dirac un sistema hamiltoniano con ligaduras en el espacio de fases? Si un despeje cambia esa pregunta, el procedimiento ha dejado de ser fisica y se ha convertido en manipulacion simbolica.
...
La estructura profunda aparece al comparar el modelo con sus limites. El formalismo de Dirac organiza ligaduras hamiltonianas en el espacio de fases y modifica los corchetes cuando las restricciones deben preservarse. Es un puente avanzado entre mecanica clasica y teorias con simetria gauge. Esta frase debe funcionar como criterio de control: permite decidir si el tema se esta usando en su dominio natural o si se esta forzando fuera de rango.
...
La interpretacion profunda empieza preguntando que representa [[HT]] dentro de la cadena causal. Si [[HT]] se modifica, puede cambiar el regimen, desplazar una condicion critica o revelar que una hipotesis secundaria ya no es secundaria.
...
Esta comprobacion evita conclusiones artificiales. Las unidades de [[HT]], [[Hc]], [[phi_a]], [[lambda_a]], [[Cab]], [[Fobs]], [[DB]] deben sostener la misma dimension fisica y la misma escala experimental.

## Método de resolución personalizado

Primero se delimita el sistema y se nombran las hipotesis. Segundo se identifica [[HT]] y se decide que formula responde a la pregunta central. Tercero se calcula simbolicamente antes de sustituir numeros.
...
Al terminar, el alumno debe explicar que el formalismo de dirac organiza ligaduras hamiltonianas en el espacio de fases y modifica los corchetes cuando las restricciones deben preservarse, aplicar las formulas en su dominio y justificar que significa fisicamente el resultado. La competencia final es decidir si el modelo responde a la pregunta del sistema real, no solo obtener una expresion algebraica.
