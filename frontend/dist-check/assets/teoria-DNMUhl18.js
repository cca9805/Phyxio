...
\r
1. **Ley de Gauss para la electricidad**: Establece que el flujo eléctrico [[flux_E]] a través de cualquier superficie cerrada es proporcional a la carga eléctrica [[q_enc]] encerrada, dividida por la permitividad del vacío [[epsilon0]].\r
\r
{{f:gauss_e}}\r
\r
2. **Ley de Gauss para el magnetismo**: Dictamina que el flujo magnético [[flux_B]] total a través de una superficie cerrada es siempre cero, reflejando la inexistencia de cargas magnéticas aisladas.\r
\r
{{f:gauss_b}}\r
\r
3. **Ley de Faraday-Lenz**: Relaciona la fuerza electromotriz [[emf]] (circulación del campo eléctrico) inducida en un camino cerrado con la rapidez de cambio del flujo magnético [[dPhiB_dt]] que lo atraviesa.\r
\r
{{f:faraday}}\r
\r
4. **Ley de Ampère-Maxwell**: Describe la circulación del campo magnético [[cirB]] como resultado de la corriente eléctrica [[I_enc]] que atraviesa la superficie y la variación temporal del flujo eléctrico [[dPhiE_dt]].\r
\r
{{f:ampere_maxwell}}\r
\r
...
- Resultados de flujo neto magnético [[flux_B]] distinto de cero indican una rotura de la topología o la presencia (teórica) de un monopolo.\r
- Inconsistencias en el balance de carga [[q_enc]] sugieren que no se ha tenido en cuenta la corriente de desplazamiento [[dPhiE_dt]].\r
- Fallos en la inducción si la frecuencia es tan alta que los efectos cuánticos de los fotones dominan sobre el campo medio.\r
\r
## Interpretación física profunda\r
La descripción integral nos enseña que el campo no es solo una flecha en un punto, sino una entidad que "llena" el espacio y cuya presencia se manifiesta en la suma total sobre áreas y caminos. Esto elimina la idea de "acción a distancia": la carga no afecta a otra carga lejana instantáneamente, sino que crea un flujo [[flux_E]] que se propaga y es detectado por la superficie que rodea a la segunda carga. La existencia del término de desplazamiento en la ley de Ampère-Maxwell es quizá la conclusión más profunda: nos dice que el propio espacio vacío puede comportarse como un conductor de "corrientes invisibles" de campo eléctrico, permitiendo que las perturbaciones se auto-sostengan y viajen como ondas. Sin esta visión global, la luz no sería más que un misterio sin explicación mecánica.\r
\r
## Orden de magnitud\r
En aplicaciones cotidianas, como un transformador doméstico, las variaciones de flujo magnético [[dPhiB_dt]] pueden ser del orden de decenas de webers por segundo, generando fuerzas electromotrices [[emf]] de cientos de voltios. A escala planetaria, el flujo magnético [[flux_B]] de la Tierra es inmenso debido a la gran superficie que ocupa, aunque el campo local sea débil (aprox. 5e-5 T). En la microelectrónica, las corrientes [[I_enc]] son minúsculas (nanoamperios), pero al estar confinadas en áreas tan pequeñas, generan densidades y circulaciones que deben ser gestionadas con precisión extrema para evitar interferencias.\r
\r
## Método de resolución personalizado\r
1. **Identificar la simetría**: Observar si la distribución de carga [[q_enc]] o corriente [[I_enc]] permite elegir una superficie de Gauss o un camino de Ampère donde el campo sea constante en magnitud.\r
2. **Elegir el dominio de integración**: Seleccionar una superficie cerrada (para Gauss) o un contorno (para Faraday/Ampère) que aproveche la simetría detectada.\r
3. **Calcular el término de fuente**: Sumar las cargas encerradas [[q_enc]], las corrientes [[I_enc]] o evaluar las derivadas temporales de flujo [[dPhiB_dt]] y [[dPhiE_dt]].\r
4. **Despejar el campo**: Utilizar la relación geométrica para extraer la intensidad del campo de la integral y obtener la solución final.\r
\r
## Casos especiales y ejemplo extendido\r
Un caso clásico es el cálculo del campo eléctrico de una esfera cargada. Al elegir una superficie esférica concéntrica, el flujo eléctrico [[flux_E]] se simplifica al producto del campo por el área. La ley de Gauss nos dice que este flujo es proporcional a [[q_enc]], permitiendo deducir la ley de Coulomb de forma inmediata. Otro caso es el solenoide ideal, donde la simetría cilíndrica y la ley de Ampère permiten calcular la circulación magnética [[cirB]] y demostrar que el campo es uniforme en su interior y nulo en el exterior, una aproximación fundamental para la creación de campos magnéticos controlados en medicina e investigación.\r
\r
## Preguntas reales del alumno\r
1. **¿Por qué hay dos leyes de Gauss?** Porque el universo tiene cargas eléctricas aisladas (fuentes de flujo eléctrico [[flux_E]]), pero no tiene cargas magnéticas aisladas; el magnetismo siempre fluye en bucles.\r
2. **¿Qué es la "fuerza" en la fuerza electromotriz [[emf]]?** Históricamente se llamó así, pero no es una fuerza en Newtons; es un potencial (voltios) que impulsa a las cargas a lo largo de un camino.\r
3. **¿La corriente de desplazamiento es corriente real?** No, es un cambio en el campo eléctrico [[dPhiE_dt]] que produce el mismo efecto magnético que una corriente de electrones.\r
4. **¿Puedo usar la forma integral en cualquier problema?** Sí, pero solo es fácil de resolver a mano si existe mucha simetría. Si no, se usan métodos numéricos.\r
\r
## Conexiones transversales y rutas de estudio\r
- **fundamentos/conceptos-estructurales/conservacion**: Las leyes integrales son expresiones directas de la conservación de la carga y el flujo.\r
- **fisica-clasica/electromagnetismo/induccion-electromagnetica**: Faraday es el pilar de toda la tecnología eléctrica moderna.\r
- **matematicas/calculo-vectorial/teoremas-de-integracion**: Los teoremas de Gauss y Stokes son el puente matemático entre esta forma y la diferencial.\r
\r
## Síntesis final\r
La formulación integral de Maxwell es el mapa que conecta las fuentes con sus efectos globales. Al dominar el concepto de flujo y circulación sobre regiones finitas, pasamos de entender "qué pasa en un punto" a comprender "cómo funciona un sistema", permitiéndonos manipular la energía electromagnética para construir el mundo moderno.\r
`;export{e as default};
