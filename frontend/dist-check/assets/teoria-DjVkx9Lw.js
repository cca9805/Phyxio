const e=`# Analisis dimensional\r
\r
## Que es\r
\r
El analisis dimensional estudia que tipo fisico tiene cada cantidad, no solo que unidad se ha escrito. En fisica se usa para leer una relacion antes de sustituir numeros. La pregunta central no es solo cuanto vale una cantidad, sino que cambia cuando se modifica una condicion del problema.\r
\r
...
\r
La idea visual es esta: imagina cada magnitud como una etiqueta de naturaleza: longitud, masa, tiempo, corriente o combinaciones que no se pueden sumar si son distintas. Esa imagen evita tratar todas las formulas como listas de simbolos equivalentes.\r
\r
...
\r
En simbolos, una velocidad tiene dimension L/T, una fuerza M L/T^2 y una energia M L^2/T^2; una igualdad solo puede ser valida si ambos lados tienen la misma dimension. Lo importante es leer la operacion como relacion entre magnitudes y no como decoracion algebraica.\r
\r
...
\r
<!-- algebra-depth-v2 -->\r
## Capa de profundidad: analisis dimensional\r
\r
...
\r
Una formula dimensionalmente imposible esta mal; una formula dimensionalmente posible aun necesita modelo fisico.\r
\r
| Magnitud | Dimension | Lectura |\r
|---|---|---|\r
| velocidad | \`L T^-1\` | longitud por tiempo |\r
| aceleracion | \`L T^-2\` | cambio de velocidad por tiempo |\r
| fuerza | \`M L T^-2\` | masa por aceleracion |\r
| energia | \`M L^2 T^-2\` | fuerza por distancia |\r
| presion | \`M L^-1 T^-2\` | fuerza por area |\r
\r
