const e=`# Ecuacion de Euler de fluidos

## Contexto conceptual

Ecuacion de Euler de fluidos responde a una pregunta fisica precisa: ¿Como expresa la ecuacion de Euler el movimiento de un fluido ideal sin viscosidad? El tema no se introduce para sumar una formula mas, sino para dar al alumno una herramienta de lectura cuando los modelos elementales ya no separan bien causa, escala y dominio.

La ecuacion de Euler de fluidos expresa el balance entre inercia material, presion y fuerzas de volumen cuando la viscosidad se desprecia. Su valor didactico es mostrar donde empieza y donde acaba el fluido ideal. Por eso las magnitudes nucleares, [[rho]], [[v]], [[p]], [[g]], [[DvDt]], [[t]], [[Phi]], no son una lista decorativa. Cada una marca una parte de la estructura: una escala, una frontera, una variable dinamica, una condicion de validez o una cantidad conservada.

## 🟢 Nivel esencial

La idea esencial es que la ecuacion de euler de fluidos expresa el balance entre inercia material, presion y fuerzas de volumen cuando la viscosidad se desprecia. Antes de calcular, el estudiante debe poder decir que mecanismo fisico se esta aislando y que aspecto del sistema queda deliberadamente fuera. Si esa lectura no existe, la formula puede producir un numero correcto para una pregunta equivocada.

En este nivel, [[DvDt]] actua como magnitud dominante porque concentra la decision didactica del leaf. No basta nombrarla: hay que explicar si aumenta, disminuye, cambia de signo, se anula o deja de tener sentido cuando cambia el regimen. Esa lectura verbal prepara el paso formal.
...
Para aplicarlas, [[rho]], [[v]], [[p]], [[g]], [[DvDt]], [[t]], [[Phi]] deben pertenecer al mismo sistema. Tambien hay que revisar signo, unidades y dominio. La pregunta central sigue siendo: ¿Como expresa la ecuacion de Euler el movimiento de un fluido ideal sin viscosidad? Si un despeje cambia esa pregunta, el procedimiento ha dejado de ser fisica y se ha convertido en manipulacion simbolica.
...
La estructura profunda aparece al comparar el modelo con sus limites. La ecuacion de Euler de fluidos expresa el balance entre inercia material, presion y fuerzas de volumen cuando la viscosidad se desprecia. Su valor didactico es mostrar donde empieza y donde acaba el fluido ideal. Esta frase debe funcionar como criterio de control: permite decidir si el tema se esta usando en su dominio natural o si se esta forzando fuera de rango.
...
La interpretacion profunda empieza preguntando que representa [[DvDt]] dentro de la cadena causal. Si [[DvDt]] se modifica, puede cambiar el regimen, desplazar una condicion critica o revelar que una hipotesis secundaria ya no es secundaria.
...
Esta comprobacion evita conclusiones artificiales. Las unidades de [[rho]], [[v]], [[p]], [[g]], [[DvDt]], [[t]], [[Phi]] deben sostener la misma dimension fisica y la misma escala experimental.

## Método de resolución personalizado

Primero se delimita el sistema y se nombran las hipotesis. Segundo se identifica [[DvDt]] y se decide que formula responde a la pregunta central. Tercero se calcula simbolicamente antes de sustituir numeros.
...
Al terminar, el alumno debe explicar que la ecuacion de euler de fluidos expresa el balance entre inercia material, presion y fuerzas de volumen cuando la viscosidad se desprecia, aplicar las formulas en su dominio y justificar que significa fisicamente el resultado. La competencia final es decidir si el modelo responde a la pregunta del sistema real, no solo obtener una expresion algebraica.
