...
Un **generador eléctrico** pertenece a las aplicaciones directas de la inducción electromagnética. Su función física no es “crear electricidad” desde la nada, sino transformar **trabajo mecánico** en energía eléctrica mediante una variación controlada de [[Phi_B]]. Por eso este leaf conecta la ley de Faraday con máquinas reales: turbinas, alternadores, dinamos, generadores de emergencia y montajes de laboratorio.

Pensar en generadores sirve para unir tres lecturas que suelen estudiarse separadas: la geometría de la bobina, la rapidez del movimiento y la potencia útil entregada. La pregunta central es qué debe cambiar para que aparezca [[epsilon_0]], y qué parte de esa conversión llega finalmente como [[P_elec]] cuando el sistema real tiene pérdidas.
...
La idea intuitiva es simple: cuanto más campo atraviesa la bobina, cuanta más área queda enlazada y cuanto más rápido se produce el cambio, mayor será la tensión inducida. [[N]] actúa como multiplicador porque cada espira añade una contribución al enlace de flujo.

> [!WARNING]
> No confundas [[epsilon_0]] con [[P_elec]]. La primera describe tensión inducida; la segunda describe ritmo de entrega de energía al circuito.

En un generador ideal no se pierde energía en rozamientos, calentamiento ni resistencia interna. En un generador real, parte de la energía mecánica entra como [[P_mec]] y solo una fracción aparece como potencia eléctrica útil. Esa fracción se resume con [[eta]].

## 🔵 Nivel formal

La descripción formal separa primero la **cantidad de flujo disponible** y después la rapidez con que cambia. En una bobina ideal de [[N]] espiras, con campo medio [[B]] y área efectiva [[A]], el flujo máximo enlazado queda determinado por la geometría y el campo:
...
La ley de Faraday también puede leerse en forma media cuando se conoce un cambio de flujo [[DeltaPhi_B]] durante un intervalo [[Delta_t]]. Esta lectura es útil para conmutaciones, vueltas parciales o estimaciones sin señal sinusoidal completa:

{{f:fem_media_generador}}

Para conectar inducción con energía, se introduce el rendimiento. Un generador real recibe [[P_mec]] y entrega una potencia útil menor o igual, porque existen pérdidas mecánicas, térmicas, magnéticas y eléctricas:
...
En una bobina educativa con [[N]] de unas cien espiras, [[B]] cercano a unas décimas de tesla, [[A]] del orden de centésimas de metro cuadrado y [[omega]] de cien radianes por segundo, [[epsilon_0]] puede estar en el orden de decenas de voltios. Un micrófono dinámico trabaja con señales mucho menores, de milivoltios, mientras un alternador de red puede manejar cientos de voltios. Un resultado de millones de voltios para una bobina manual pequeña es físicamente absurdo salvo que los datos sean extremos.

## Método de resolución personalizado

Primero identifica qué pide el problema: [[Phi_B]], [[epsilon]], [[epsilon_0]], [[eta]] o [[P_elec]]. Después separa los datos geométricos de los datos temporales. Convierte [[omega]] si aparece en revoluciones por minuto, revisa que [[A]] esté en metros cuadrados y confirma si [[N]] multiplica el flujo de una sola espira.

Luego decide si el problema usa giro sinusoidal o cambio medio de flujo. Para un generador rotatorio ideal, usa la amplitud; para una variación dada durante un intervalo, usa la fem media. Finalmente, si se pregunta por energía útil, no mezcles tensión con potencia: incorpora [[P_mec]] y [[eta]].
...
Otro caso límite aparece con circuito abierto. Puede existir [[epsilon_0]] medible en bornes, pero [[P_elec]] entregada a una carga externa será nula porque no circula corriente útil. En cambio, con una carga muy baja, la corriente puede ser grande, las pérdidas internas aumentan y la tensión terminal cae.
...
**¿Por qué aparece tensión si no hay una pila química?** Porque el trabajo mecánico cambia el enlace de [[Phi_B]] y separa cargas mediante inducción. La fuente energética es el movimiento suministrado al eje.

**¿Más espiras siempre significa mejor generador?** Aumentar [[N]] eleva el enlace de flujo, pero también puede aumentar resistencia, tamaño, masa e inductancia. El diseño real equilibra fem, pérdidas y calentamiento.
...
**¿Por qué un generador se frena al conectar una carga?** Porque al entregar [[P_elec]] aparece una reacción electromagnética que exige más [[P_mec]] para mantener la misma velocidad. No es rozamiento “misterioso”; es conversión de energía.
