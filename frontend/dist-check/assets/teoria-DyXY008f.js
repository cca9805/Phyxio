...
## 🔵 Nivel formal\r
\r
Una vez fijada la escena, la notación ordena la intuición. En este leaf [[frame_sigma]] nombra el marco desde el que se describe el problema; [[O]] fija el cero espacial de ese marco; [[r_vec]] representa la posición del móvil respecto a ese origen; [[v_frame]] mide la velocidad con la que un marco se desplaza respecto a otro; y [[t_global]] recuerda que, en mecánica clásica, ambos observadores comparten el mismo parámetro temporal. Si alguno de esos elementos falta, la ecuación puede parecer correcta y seguir siendo inútil.\r
\r
La relación central del tema es la **transformación galileana de posición**. Escrita con la notación del leaf, expresa que la posición medida en un marco se obtiene sumando la posición medida en el otro marco y el desplazamiento acumulado por el propio marco móvil:\r
\r
{{f:trans_galileo_pos}}\r
\r
Esta ecuación no se usa para decorar una deducción, sino para responder una pregunta concreta: cómo se traduce una misma trayectoria cuando se cambia el observador. Si el estudiante sabe que [[r_vec]] pertenece al marco elegido y que [[v_frame]] pertenece a la relación entre marcos, deja de sumar velocidades y posiciones sin criterio.\r
\r
La velocidad se interpreta con la misma lógica. Si un pasajero camina dentro del vagón, el observador del vagón mide [[v_prime]] y el observador del andén mide [[v]] . La transformación de velocidad suma a la lectura interna la velocidad del vagón [[v_frame]] . Lo importante no es memorizar la suma, sino distinguir dos niveles: el movimiento interno del móvil dentro del marco y el movimiento del marco entero respecto a otro:\r
\r
{{f:trans_galileo_vel}}\r
\r
Hay además dos invariancias clásicas que ordenan la interpretación. La primera dice que dos marcos galileanos comparan la misma **separación espacial** [[r_vec]] cuando miden simultáneamente el mismo segmento:\r
\r
{{f:invarianza_distancia}}\r
\r
La segunda afirma que ambos comparten el mismo [[t_global]] . Estas invariancias no son adornos filosóficos: son el motivo por el que el problema puede cerrarse con una única cronología común:\r
\r
{{f:invarianza_tiempo}}\r
\r
El uso correcto de las expresiones formales exige una disciplina de lectura. Primero se elige el marco. Después se declara dónde está [[O]] . Luego se escribe [[r_vec]] con el signo adecuado. Solo al final se decide cómo entra [[v_frame]] . Ese orden evita la confusión típica de poner un número en una ecuación antes de saber a quién pertenece. El álgebra no corrige un marco mal elegido; solo propaga el error con más precisión.\r
\r
---\r
\r
## 🔴 Nivel estructural\r
\r
El modelo galileano funciona porque simplifica el mundo de una manera muy específica. Supone marcos inerciales o casi inerciales, ejes paralelos, velocidades relativas constantes y un tiempo común para todos los observadores del problema. Mientras esas hipótesis se mantengan, cambiar de [[frame_sigma]] reordena la descripción sin romper la coherencia física. El resultado puede cambiar de signo, de valor o incluso pasar de reposo a movimiento, pero no deja de referirse al mismo evento.\r
\r
...
\r
El indicador más fiable de fallo es cualitativo. Si una maleta en reposo dentro del tren sale con velocidad cero para el andén, o si una cámara móvil y una fija producen descripciones que no pueden reconciliarse con un mismo [[t_global]] , el problema no necesita más cuentas: necesita revisar el marco. La competencia avanzada del tema consiste en detectar ese fallo antes de cerrar el resultado.\r
\r
---\r
\r
## Interpretación física profunda\r
\r
La ganancia intelectual del leaf es aprender a separar realidad física y descripción. El evento no depende del observador, pero el valor de [[r_vec]] sí; el objeto no cambia de naturaleza, pero la lectura de su velocidad depende del [[frame_sigma]] elegido; el choque, el encuentro o el reposo siguen ocurriendo, aunque cada observador los exprese con coordenadas distintas. Esta separación es profunda porque enseña a no confundir la herramienta de medida con el fenómeno medido.\r
\r
Leída así, la referencia deja de ser un trámite administrativo. Elegir bien el marco es decidir qué información se vuelve simple, qué magnitudes se comparan directamente y dónde está el error conceptual dominante. Un marco que acompaña al móvil puede revelar una geometría sencilla; un marco fijo al suelo puede ser mejor para interpretar tiempos de llegada. Ninguno es "el verdadero" por sí solo: es verdadero para la pregunta concreta que se quiere responder.\r
\r
---\r
\r
## Orden de magnitud\r
\r
Los números razonables de [[v_frame]] suelen estar en escalas muy familiares: una cinta de aeropuerto puede moverse del orden de 10^{-1} a 10^{0} m/s, un tren urbano en el entorno de 10^1 m/s y un vehículo de laboratorio incluso menos. Estas escalas son útiles porque permiten detectar absurdos rápido. Si un ejercicio escolar hace que una persona caminando dentro de un vagón aparezca con velocidad de cientos de metros por segundo, no hace falta una demostración larga para sospechar del marco o del signo.\r
\r
También conviene revisar el orden de magnitud de [[r_vec]] . En un laboratorio, unos pocos metros suelen ser razonables; en un problema de pista o carretera, decenas o centenares de metros; en una animación de gráfica temporal, desplazamientos enormes en tiempos mínimos suelen delatar que el origen o el reloj se mezclaron. El orden de magnitud no resuelve el problema, pero evita aceptar una traducción entre marcos que ya nace físicamente desajustada.\r
\r
---\r
\r
## Método de resolución personalizado\r
\r
1. Nombrar explícitamente el [[frame_sigma]] de cada observador y decidir cuál de ellos simplifica la pregunta física.\r
2. Fijar el origen [[O]] y el signo positivo en cada descripción.\r
3. Escribir [[r_vec]] y, si hace falta, la velocidad propia del móvil dentro del marco acompasado.\r
4. Introducir [[v_frame]] como velocidad del marco móvil respecto al marco fijo.\r
5. Comprobar al final si el cambio de observador altera solo la descripción y no el evento.\r
\r
Este método importa porque ataca el error más frecuente del tema: comparar magnitudes legítimas, pero pertenecientes a observadores distintos. Cuando cada símbolo queda asignado a su marco antes de sustituir datos, la resolución se vuelve mucho más corta y defendible.\r
\r
---\r
\r
## Casos especiales y ejemplo extendido\r
\r
### El reposo aparente\r
Un objeto puede tener [[r_vec]] constante en un marco y, al mismo tiempo, desplazarse uniformemente en otro. Ese escenario no es una excepción: es el corazón del tema. Si el alumno lo entiende, comprende por qué una maleta apoyada en el tren no contradice que el tren avance respecto al andén.\r
\r
### Orígenes desplazados\r
Otro caso útil es el de dos observadores que comparten [[t_global]] pero no origen espacial. No basta con decir "está en una coordenada de 5 m": hace falta decir respecto a qué [[O]] .\r
\r
---\r
\r
## Preguntas reales del alumno\r
\r
- **¿Si el movimiento es el mismo, por qué sale otra velocidad?** No ha cambiado el movimiento físico, sino la partición entre movimiento propio y movimiento del marco.\r
- **¿Cómo sé cuál es el mejor marco?** Elige el que haga más simple la relación dominante. Si quieres saber cómo se mueve un pasajero dentro del tren, el marco del vagón aclara primero; para un poste, el marco del suelo.\r
\r
---\r
\r
...
\r
Dominar sistemas de referencia significa elegir un [[frame_sigma]] , fijar un origen [[O]] e interpretar [[r_vec]] sin ambigüedad. Cambiar de observador cambia la descripción del movimiento, no el hecho físico descrito.\r
\r
Recuerda:\r
1. El marco [[frame_sigma]] es la herramienta, no el fenómeno.\r
2. La [[v_frame]] es la "velocidad de traducción" entre descripciones.\r
3. El tiempo [[t_global]] es el único hilo conductor que comparten todos los observadores galileanos.\r
4. Un resultado sin marco declarado es físicamente incompleto.\r
`;export{e as default};
