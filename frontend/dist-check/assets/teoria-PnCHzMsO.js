const a=`# Ondas longitudinales en barras
...
- Materiales rigidos (alto [[E_young]]) transmiten rapido porque los "resortes internos" son duros.
...
La **impedancia mecanica** [[Z_barra]] es la magnitud que controla que ocurre cuando la onda encuentra un cambio: otra barra, un extremo libre, un empotramiento o una union. Se calcula como el producto de densidad, area de seccion y velocidad de onda.
...
La solucion de esta ecuacion de onda tiene velocidad de propagacion [[v_barra]] igual a la raiz cuadrada de [[E_young]] entre [[rho_vol]].
...
- **Uniones entre barras:** cuando una onda alcanza la union entre dos barras de impedancias [[Z_barra]] distintas (Z1 y Z2), se refleja parcialmente. El coeficiente de reflexion en fuerza es (Z2 - Z1)/(Z2 + Z1). Si Z2 es mayor que Z1, la onda reflejada tiene el mismo signo que la incidente; si Z2 es menor, se invierte.
...
La impedancia [[Z_barra]] representa la "resistencia al flujo de energia ondulatoria". Dos barras con la misma impedancia se comportan como un medio continuo: la onda pasa sin reflexion. Cualquier cambio de impedancia (material, seccion o ambos) genera reflexion.

## Orden de magnitud

Para una barra de acero:
- [[E_young]] es 210 GPa (210 × 10⁹ Pa)
...
- [[E_young]] es 70 GPa, [[rho_vol]] es 2700 kg/m³
...
1. Obtener [[E_young]] del material en Pa. Si viene en GPa, multiplicar por 10⁹.
...
5. Si se necesita impedancia: obtener [[A_seccion]] en m² y calcular [[Z_barra]] como rho·A·[[v_barra]].
