const e=`\uFEFF# Magnitudes angulares\r
\r
...
\r
La velocidad angular cuantifica con qué rapidez cambia la posición angular; el periodo mide el tiempo que tarda el cuerpo en dar una vuelta completa; y la frecuencia cuenta cuántas vueltas completas ocurren por segundo. Las tres describen el mismo ritmo de giro desde perspectivas complementarias y ninguna de ellas es redundante: los instrumentos reportan habitualmente una sola, y saber distinguirlas —sin mezclar periodo con frecuencia ni grados con radianes— es la habilidad clave antes de escribir ningún cálculo.\r
\r
## 🔵 Nivel formal\r
\r
La base geométrica del leaf es la definición del radián, que convierte arco y radio en ángulo:\r
\r
{{f:definicion_radian}}\r
\r
Esta relación es la única que conecta las magnitudes lineales [[s]] y [[R]] con el ángulo [[theta]]. Para movimiento circular uniforme, la velocidad angular [[omega]] se conecta con el tiempo por vuelta y con las vueltas por segundo mediante:\r
\r
...
\r
El indicador más rápido de fallo es la incoherencia dimensional: si la expresión final mezcla radianes y metros sin una relación explícita de \`R\`, el modelo está mal planteado y conviene revisar el sistema desde la geometría antes de continuar con la aritmética.\r
\r
## Interpretación física profunda\r
\r
Más allá del cálculo, magnitudes angulares enseña a leer una relación entre descripción y observador. El número final solo tiene sentido si recupera el mecanismo que lo produjo: estas magnitudes no son adornos notacionales: son la forma mínima de describir la orientación y su cambio en el tiempo. Esa exigencia de lectura física es la que separa una solución reutilizable de una cuenta correcta pero muda.\r
\r
## Orden de magnitud\r
\r
Los órdenes de magnitud razonables dependen del contexto, pero siempre conviene compararlos con escenas reconocibles: relojes con periodos de horas, ruedas con frecuencias de unos pocos hercios y turbinas que alcanzan miles de revoluciones por minuto. Esa comprobación rápida atrapa signos imposibles, tiempos absurdos y magnitudes incompatibles con la escala real del fenómeno antes de que el error se esconda detrás de una aritmética impecable.\r
\r
...
\r
Las dudas auténticas suelen girar alrededor de dos confusiones: "¿qué magnitud hay que igualar o comparar?" y "¿qué cambia si otro observador, otra escala o otra condición inicial entra en juego?". La respuesta operativa para este leaf es que antes de calcular conviene decidir si el dato describe orientación, ritmo de giro o cambio del ritmo; esa clasificación evita mezclar fórmulas. Cuando esa idea queda clara, muchas cuentas largas se reducen a una elección correcta de variables y signos.\r
\r
## Conexiones transversales y rutas de estudio\r
\r
Este leaf conversa de forma natural con otros nodos de cinemática y con la dinámica posterior. La razón es que sirve de base para MCU, MCUA, relación lineal-angular, rodadura y dinámica rotacional, porque todas esas ramas usan este vocabulario como punto de partida. Por eso conviene enlazarlo con movimiento rectilíneo, análisis gráfico, movimiento en dos dimensiones o rotación según el caso: no como lista de temas vecinos, sino como una cadena de modelos que reutilizan estructura con distinto nivel de complejidad.\r
\r
## Síntesis final\r
\r
