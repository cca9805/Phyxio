...
Este leaf conecta el espectro electromagnetico con la optica real. En el vacio basta usar [[c]] como referencia; en un vidrio, agua, plastico o fibra optica aparece el indice [[n]], que resume cuanto se modifica la propagacion. Pensar en medios permite entender refraccion, retardo, guiado, dispersion y perdida sin confundirlos con un cambio de naturaleza de la onda.
...
Cuando una onda electromagnetica entra en un medio ordinario, suele propagarse mas despacio que en el vacio. El indice [[n]] mide precisamente ese efecto: cuanto mayor es el indice, menor es la velocidad de propagacion [[v_m]] y mas corta queda la longitud de onda dentro del material.
...
El alumno debe distinguir tres lecturas: [[c]] es la referencia de vacio, [[v_m]] es la rapidez dentro del medio, y [[lambda_m]] es la escala espacial dentro del medio. Mezclarlas produce resultados incoherentes.
...
El primer modelo formal usa el indice efectivo para corregir la velocidad de fase. Si el medio es lineal, homogeneo e isotropo como primera aproximacion, [[v_m]] se obtiene comparando [[c]] con [[n]].

{{f:velocidad_en_medio}}

Esta relacion expresa una idea fisica directa: [[n]] no tiene unidades y actua como factor de reduccion. Un medio con indice mayor produce una velocidad de fase menor. En materiales ordinarios transparentes, esta lectura describe la propagacion de ondas planas y permite estimar tiempos de retardo.
...
En aire, [[n]] esta muy cerca de uno y [[v_m]] casi coincide con [[c]]. En agua visible, un indice alrededor de 1.33 reduce la velocidad a unas tres cuartas partes de la referencia de vacio. En vidrio comun, indices alrededor de 1.5 reducen mas la velocidad y acortan la longitud de onda en la misma proporcion.

Un resultado absurdo aparece si un vidrio ordinario da una velocidad mayor que [[c]], si un indice positivo produce una longitud de onda negativa, o si se usa una longitud de onda de vacio como si fuera la longitud real dentro de una fibra.

## Método de resolución personalizado

Primero identifica que magnitud pertenece al vacio y cual pertenece al medio. Si el dato es [[lambda0]], no lo trates como [[lambda_m]] sin aplicar el indice. Si el dato es [[n]], calcula primero [[v_m]] o [[lambda_m]] segun la pregunta.
...
**¿Por que no uso siempre [[c]]?** Porque [[c]] describe la propagacion en vacio. En un medio, el campo interactua con la respuesta electrica y magnetica del material, y la velocidad efectiva cambia.
...
La propagacion en medios explica como un material modifica la velocidad y la longitud de onda de una radiacion electromagnetica mediante [[n]], [[epsilon_r]] y [[mu_r]]. La frecuencia queda fijada por la fuente, mientras [[v_m]] y [[lambda_m]] describen la nueva escala fisica dentro del medio.
`;export{e as default};
