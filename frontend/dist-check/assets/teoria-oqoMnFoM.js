const e=`# Pequenas oscilaciones y modos normales\r
\r
...
## Sintesis final\r
\r
Como cierre operativo, este tema debe dejar claro que linealizar no es ignorar la complejidad, sino elegir la escala donde la complejidad se organiza en modos. El alumno que domina el leaf puede justificar el equilibrio, construir el problema modal, interpretar frecuencias y reconocer que forma colectiva se activa.\r
\r
\r
Despues de este leaf, el alumno debe poder usar Pequenas oscilaciones y modos normales como criterio fisico. La competencia final no es memorizar ecuaciones, sino decidir cuando la descripcion avanzada es legitima, que conserva y que tipo de pregunta mecanica puede responder.\r
\r
Esta competencia permite revisar soluciones de otros temas: si una frecuencia aparece sin modo, sin equilibrio o sin escala pequena, el resultado no describe una vibracion fisica. El leaf funciona como criterio de estabilidad local.\r
`;export{e as default};
