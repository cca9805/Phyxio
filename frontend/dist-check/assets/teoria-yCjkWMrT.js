const e=`# Cálculo del Torque\r
\r
## Contexto conceptual\r
\r
Este leaf no se centra en decir que es el torque, sino en decidir como obtenerlo de forma fiable cuando el problema ya esta planteado. Esa diferencia parece pequeña, pero didacticamente es grande. Un alumno puede saber que el torque mide capacidad de giro y [[y]], aun asi, equivocarse al calcularlo porque no sabe elegir entre distancia radial, brazo de palanca [[b]], componentes cartesianas o signo algebraico. Aqui el centro del trabajo es el procedimiento.\r
\r
El problema tipico de este leaf no pregunta por una idea general, sino por una ruta de calculo. A veces el enunciado da fuerza [[F]] y angulo. Otras veces da fuerza y brazo perpendicular. En otros casos da coordenadas y componentes de fuerza. Lo importante es reconocer que cada dato pide una ruta distinta. Resolver bien significa escoger la representacion que hace mas visible la geometria efectiva del giro.\r
\r
Por eso este leaf no trata solo de interpretar una escena, sino de traducirla a una cuenta robusta. El estudiante debe aprender a mirar el esquema y preguntarse: donde esta el eje, que linea de accion tiene la fuerza, que distancia es realmente perpendicular, y en que sentido debe contarse el giro. Cuando esas cuatro preguntas quedan respondidas, el torque deja de ser una formula memorizada y se vuelve una magnitud calculable con criterio.\r
\r
## 🟢 Nivel esencial\r
\r
La intuicion esencial de este leaf puede resumirse asi: calcular torque no es multiplicar por una distancia cualquiera, sino extraer la parte de la fuerza que realmente hace girar al sistema o, de forma equivalente, extraer la distancia que realmente actua como brazo de palanca. La palabra realmente importa. Muchas confusiones nacen de usar la distancia equivocada o la componente equivocada.\r
\r
En una escena sencilla, esto se entiende sin algebra. Si empujas una puerta justo en la bisagra, el efecto de giro es casi nulo aunque la fuerza sea grande. Si empujas lejos de la bisagra y de forma perpendicular, el efecto de giro crece mucho. El calculo del torque consiste en formalizar esa intuicion cotidiana con el dato geometrico correcto. El alumno debe aprender a ver que no toda fuerza gira igual y que no toda distancia cuenta igual.\r
\r
El nivel esencial tambien introduce una disciplina visual. Antes de tocar numeros conviene dibujar mentalmente o en papel la posicion del punto de aplicacion, la direccion de la fuerza y el eje de referencia. En ese dibujo ya aparece la pista de calculo: tal vez el angulo entre [r] y [F] esta claro; tal vez lo claro es el brazo [b]; tal vez conviene descomponer la fuerza en [[F_x]] y [[F_y]]. La cuenta correcta suele nacer de ese diagnostico visual previo.\r
\r
Otra idea esencial es que el signo no es un detalle de final de pagina. Forma parte del calculo mismo. Si la fuerza intenta girar en sentido horario, el torque no tiene el mismo signo que si intenta girar en sentido antihorario. No es un adorno algebraico: es la forma de conservar la orientacion fisica del problema. Un calculo de torque sin convenio de signos es un calculo incompleto.\r
\r
## 🔵 Nivel formal\r
\r
Formalmente, este leaf organiza varias rutas equivalentes para obtener la misma magnitud. La primera es la forma angular:\r
\r
...
\r
La segunda ruta usa el brazo de palanca:\r
\r
{{f:torque_brazo}}\r
\r
...
\r
La tercera ruta usa la forma en componentes para problemas bidimensionales:\r
\r
{{f:torque_plano}}\r
\r
...
\r
El calculo del torque tambien conversa con la dinamica rotacional:\r
\r
...
\r
Otra lectura profunda es que una buena cuenta de torque ya contiene una interpretacion del sistema. Si el torque sale pequeño, tal vez no falta fuerza: tal vez la linea de accion pasa demasiado cerca del eje. Si el torque sale grande, tal vez no es porque la fuerza sea extraordinaria: tal vez el brazo de palanca esta bien aprovechado. El calculo, bien leido, se convierte en diagnostico fisico.\r
\r
## Orden de magnitud\r
\r
...
\r
Una rutina simple es la siguiente. Primero, estimar el tamaño de [[r]] y de [[F]]. Segundo, preguntarse si el angulo hace grande o pequeña la componente perpendicular. Tercero, revisar si el signo esperado coincide con el sentido de giro intuitivo. Estas tres comprobaciones suelen bastar para rechazar resultados absurdos.\r
\r
## Método de resolución personalizado\r
\r
Una secuencia robusta para este leaf puede resumirse asi:\r
\r
1. Declarar eje de referencia y sentido positivo de giro.\r
2. Dibujar o leer la linea de accion de la fuerza.\r
3. Decidir si la forma mas natural es por angulo, por brazo o por componentes.\r
4. Calcular el torque parcial de cada fuerza con el signo correcto.\r
5. Si hay varias fuerzas, sumar algebraicamente.\r
6. Cerrar comparando el valor obtenido con la geometria del problema.\r
\r
Este metodo tiene una ventaja clara: separa decision de herramienta y ejecucion algebraica. El alumno deja de buscar una formula universal y empieza a elegir una ruta de calculo. Esa es exactamente la competencia que diferencia este leaf del de definicion.\r
\r
...
\r
Otro caso interesante aparece cuando el punto de aplicacion se desplaza sobre un mismo objeto mientras la fuerza conserva modulo. El torque cambia sin que cambie la fuerza. Este tipo de escena es muy valioso porque enseña que el calculo del torque no es un problema de intensidad pura, sino de intensidad mas geometria.\r
\r
## Preguntas reales del alumno\r
\r
**¿Qué fórmula uso primero?**  \r
La que mejor coincide con los datos que realmente te da el problema: angulo, brazo o componentes.\r
\r
**¿Por qué no sirve siempre multiplicar por la distancia al eje [[r]]?**  \r
Porque la distancia que importa no es siempre la radial, sino la perpendicular a la linea de accion de la fuerza.\r
\r
**¿Cuándo conviene descomponer en componentes?**  \r
Cuando la geometria angular es confusa o cuando el problema ya esta planteado en coordenadas cartesianas.\r
\r
## Conexiones transversales y rutas de estudio\r
\r
Este leaf conecta con definicion de torque, producto vectorial, equilibrio rotacional y segunda ley rotacional. Tambien prepara problemas con varias fuerzas, balances de momentos y lectura de mecanismos donde la seleccion de la ruta de calculo es tan importante como el valor final.\r
\r
## Síntesis final\r
\r
Dominar Cálculo del Torque significa saber elegir la ruta correcta para construir [[tau]] a partir de la geometria y de la fuerza disponible. No es solo saber que el torque existe. Es saber cuando usar angulo, cuando usar brazo, cuando usar componentes y como conservar el signo fisico del giro durante toda la cuenta.`;export{e as default};
