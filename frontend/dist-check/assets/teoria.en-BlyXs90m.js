const e=`# Flexural Waves in Beams
...
- The **bending stiffness** of the beam, combining the material's Young's modulus ([[E_young]]) with the cross-section shape (second moment of area [[I_seccion]]). A stiffer beam propagates waves faster.
...
The product [[E_young]]·[[I_seccion]] (bending stiffness EI) plays a dual role: it controls both the magnitude of resonance frequencies and the speed of perturbation propagation. For vibration design, the ratio EI/[[rho_lin]] is the master parameter: materials with high E and low density (aluminium, titanium, composites) produce beams with higher phase velocities per kg of structure.

## Order of magnitude

For a rectangular steel bar with a 5 mm × 20 mm section:
- [[E_young]] is 210 GPa (in SI: 210 × 10⁹ Pa)
- [[I_seccion]] is 20 × 5³ / 12 × 10⁻¹² m⁴, giving 2.08 × 10⁻¹⁰ m⁴
...
If [[v_fase_flex]] exceeds 5000 m/s for a steel beam at audible frequency, there is a unit error: most likely [[I_seccion]] is in cm⁴ without conversion.

## Personalized resolution method

To calculate flexural phase velocity in a beam:

1. Obtain [[E_young]] of the material in Pa (if in GPa, multiply by 10⁹).
2. Calculate [[I_seccion]] of the section in m⁴. For a rectangular section of width b and height h in the bending direction: b·h³/12.
3. Calculate [[rho_lin]] as [[rho_vol]] × [[A_seccion]], where [[A_seccion]] is b·h for rectangular section.
...
**Circular beam:** for a circular section of radius r, [[I_seccion]] is π·r⁴/4 and [[A_seccion]] is π·r². The radius of gyration is r/2. Circular bars are common in mechanical engineering and flexural dispersion determines the free vibration frequency of rotating shafts.
