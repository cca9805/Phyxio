const e=`# Binet Equation and Orbits

## Conceptual context

Binet Equation and Orbits answers a precise physical question: How does Binet equation transform a central force into the geometric shape of the orbit? The topic is not introduced to add one more equation, but to give the student a reading tool when elementary models no longer separate cause, scale, and domain clearly.

Binet equation replaces the radial variable with inverse radius and lets the orbital shape be read from the central force law. The didactic focus is not solving an arbitrary curve, but recognizing that a force leaves a geometric signature. For that reason the core quantities, [[u]], [[theta]], [[r]], [[F]], [[L]], [[m]], [[U]], are not decorative labels. Each one marks part of the structure: a scale, a boundary, a dynamic variable, a validity condition, or a conserved quantity.

## 🟢 Essential level

The essential idea is that binet equation replaces the radial variable with inverse radius and lets the orbital shape be read from the central force law. Before calculating, the student must state which physical mechanism is being isolated and which part of the system is deliberately left outside the model. Without that reading, an equation may produce the right number for the wrong question.

At this level, [[u]] acts as the dominant quantity because it concentrates the didactic decision of the leaf. It is not enough to name it: the student must explain whether it increases, decreases, changes sign, vanishes, or loses meaning when the regime changes.
...
It is also useful to separate description from decision. Description lists quantities; decision explains which of them controls the observed change. In this leaf, that decision is supported by [[u]] and by the comparison between dominant term, correction, and limiting case. This distinction prevents the student from confusing a long solution with a deep solution.
...
To apply them, [[u]], [[theta]], [[r]], [[F]], [[L]], [[m]], [[U]] must belong to the same system. Sign, units, and domain must also be checked. The central question remains: How does Binet equation transform a central force into the geometric shape of the orbit? If an algebraic rearrangement changes that question, the procedure has stopped being physics and has become symbolic manipulation.
...
In formal calculation, it is useful to observe trajectory curvature before integrating. Orbital shape reveals the central law: a conic, a precession, or an angular deviation speaks about the force. That reading separates this leaf from radial energy analysis.

## 🔴 Structural level

The deeper structure appears when the model is compared with its limits. Binet equation replaces the radial variable with inverse radius and lets the orbital shape be read from the central force law. The didactic focus is not solving an arbitrary curve, but recognizing that a force leaves a geometric signature. This sentence must work as a control criterion: it decides whether the topic is being used in its natural domain or forced outside its range.
...
The specific reading of Binet relies on curvature and inverse radius. An inverse-square force produces conics, a perturbation produces precession, and a force reconstructed from the orbit diagnoses the central field. This vocabulary does not belong to effective potential: here the student thinks with orbital shape and force law.

## Deep physical interpretation

Deep interpretation starts by asking what [[u]] represents in the causal chain. If [[u]] is modified, the regime may change, a critical condition may move, or a secondary assumption may stop being secondary.
...
This check prevents artificial conclusions. The units of [[u]], [[theta]], [[r]], [[F]], [[L]], [[m]], [[U]] must support the same physical dimension and the same experimental scale.

## Personalized resolution method

First, delimit the system and state the assumptions. Second, identify [[u]] and decide which relation answers the central question. Third, calculate symbolically before substituting numbers.
...
In Binet's method, the specific feature is that central force becomes orbital curvature. The inverse radial variable turns the dynamic question into a geometric equation; therefore the student must interpret precession, conics, and deviations as signatures of the force law.

## Final synthesis

At the end, the student should explain that binet equation replaces the radial variable with inverse radius and lets the orbital shape be read from the central force law, apply the formulas in their domain, and justify the physical meaning of the result. The final competence is deciding whether the model answers the question of the real system, not merely obtaining an algebraic expression.
...
In this leaf, even the error vocabulary is specific: confusing inverse radius with physical radius, reading precession as a numerical failure, or reconstructing a central force without checking angular dependence. These errors do not appear in the same form in effective potential.
`;export{e as default};
