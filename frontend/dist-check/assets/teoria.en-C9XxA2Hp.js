const e=`# Voltage and Power at Home

## Conceptual context

This leaf translates abstract electrical magnitudes —voltage [[V]], current [[I]], resistance [[R]], power [[P]]— into concrete technical decisions for domestic use. In the domestic grid, voltage is fixed at 230 V, but each connected appliance "decides" how much current it demands based on its internal resistance. This interaction determines the actual electrical flow and, with it, cable heating, energy consumption, and potential risks.
...
In domestic electricity, four magnitudes govern practical decisions. **Voltage** [[V]] is the electrical "push" provided by the grid —at home it is always 230 V— and constitutes the available potential to make appliances work. **Current** [[I]], also called intensity, represents the electrical flow through cables; it is measured in amperes and is the magnitude that cables must transport without excessive heating.

**Resistance** [[R]] is the opposition to current flow presented by each appliance. Here lies a critical safety point: if resistance is very low, current can grow enormously and exceed cable capacity. Finally, **power** [[P]] indicates the rate at which an appliance consumes energy; it is the magnitude on appliance labels that determines both the bill cost and current flow.
...
This relationship allows calculating any of the three magnitudes knowing the other two: [[V]], [[I]] and [[P]]. When we know the nominal power of an appliance —the watts on its label— we can determine [[I]] it will demand from the grid by dividing [[P]] by domestic [[V]]:

{{f:corriente_por_resistencia}}

The resistive model offers an alternative perspective. The same [[P]] can be expressed as a function of [[R]], which is especially useful when we don't directly know [[I]] but know the appliance's construction characteristics:

{{f:potencia_resistiva}}

The electrical energy accumulated [[E_kWh]] during a period of time [[t_h]] is obtained by multiplying power by operating time. This magnitude —typically measured in kilowatt-hours (kWh)— is what really counts for the electricity bill:

{{f:energia}}

The [[E_kWh]] accumulated over a period [[t_h]] connects directly to the electricity bill and is essential for comparing the economic impact of appliances with different [[P]].
...
The nominal power on a label —"2000 W"— doesn't tell the whole story. That number indicates consumption rate, but not accumulated energy. A 2000 W oven operating 10 minutes consumes less [[E_kWh]] than a 150 W refrigerator operating 24 [[t_h]].

## Order of magnitude

Typical values provide useful references for detecting anomalous situations. Voltage [[V]] is standardized at 230 V in Europe, with typical tolerances of ±10% that equipment must withstand without damage. Currents below 0.1 A are common in standby equipment or very light loads; between 0.5 A and 5 A we find most normal domestic appliances; between 5 A and 16 A are higher consumption equipment like ovens, washing machines, and electric water heaters; values above 16 A require special circuits and appropriate protections.

Resistance [[R]] of operating equipment varies enormously: from thousands of ohms in LED lamps to fractions of an ohm in heating elements. A load resistance less than 10 Ω should already attract attention and require verification of resulting current. Typical domestic powers range from a few watts for small loads to 3-4 kW for the most demanding equipment. Simultaneous configurations adding more than 5 kW on a single circuit generally require review of cable capacity.

## Personalized resolution method

The domestic electrical analysis protocol follows a systematic sequence. First, identify which data we know from the appliance: usually the nominal power [[P]] on its label, or in some cases the internal resistance [[R]]. Second, apply the corresponding equation to obtain current: if we know [[P]], use [[I]] = [[P]]/[[V]]; if we know [[R]], use [[I]] = [[V]]/[[R]].
...
In domestic use they are synonyms: both represent magnitude [[I]] in amperes. "Intensity" is more formal, "current" more colloquial, but both designate the same phenomenon: flow of electrical charge per unit time.
...
No. Power [[P]] is a rate —watts— indicating consumption speed. Energy [[E_kWh]] is accumulation —watt-hours— depending on power multiplied by time [[t_h]]. A high-power oven operating briefly may consume less energy than a low-power refrigerator operating continuously.
