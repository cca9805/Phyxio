const e=`# Systems of equations for physics\r
\r
## What it is\r
\r
A system appears when one equation does not contain all the necessary information. In physics it is used to read a relation before substituting numbers. The central question is not only how large a quantity is, but what changes when one condition changes.\r
\r
...
\r
The visual idea is this: imagine several constraints acting on the same problem: each equation cuts down the possible solutions. That image prevents treating every formula as a flat list of equivalent symbols.\r
\r
...
\r
Symbolically, two unknowns normally require two independent equations; if equations repeat the same information, the system does not determine a unique answer. The important point is to read the operation as a relation between quantities, not as algebraic decoration.\r
\r
...
\r
<!-- algebra-depth-v2 -->\r
## Depth layer: systems of equations for physics\r
\r
...
\r
A system does not appear just because there are many letters, but because one relation does not contain all the information.\r
\r
| Cue in problem | Translation |\r
|---|---|\r
| two connected bodies | equations coupled by tension or common acceleration |\r
| total conservation | sum before = sum after |\r
| same meeting point | equal positions at the same time |\r
| geometric constraints | relations between displacements or velocities |\r
\r
