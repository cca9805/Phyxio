const e=`# Isochoric Process\r
\r
## Conceptual context\r
\r
The **isochoric process** is one of the four fundamental ideal thermodynamic processes, alongside the isobaric, isothermal and adiabatic processes. Its name derives from the Greek *isos* (equal) and *khoros* (space or volume), describing any gas transformation occurring at **strictly constant volume**.\r
\r
The prototypical physical situation is a gas enclosed in a perfectly rigid container, such as a sealed pressure cooker or a steel cylinder. When that container is heated or cooled, the gas changes temperature and pressure but cannot expand or compress. This geometric constraint has an immediate thermodynamic consequence: **no mechanical work is performed**.\r
\r
Understanding the isochoric process is not merely about solving secondary-school exercises. It is about grasping why steam boilers have safety valves, why combustion engines can rupture if coolant stops circulating, and why pressure cookers prepare food faster. Constant volume makes this process the purest case of the first law of thermodynamics: all exchanged heat goes directly to modifying the internal energy of the gas.\r
\r
## 🟢 Essential level\r
\r
Imagine a tightly sealed, perfectly rigid metal container full of gas. Place it over a flame and the gas cannot expand because the walls do not yield. Pressure rises, temperature rises, but volume does not change at all. That is the isochoric process: **heat enters or leaves with volume fixed**.\r
\r
The most important consequence is that there is no **mechanical work** [[W]]. Without expansion or compression, the gas does not push or displace any boundary. All the heat the gas absorbs goes entirely into its **internal energy** [[DeltaU]]. The first law of thermodynamics simplifies to its maximum: heat absorbed and change in internal energy are exactly equal.\r
\r
...
## 🔵 Formal level\r
\r
The mathematical description of the isochoric process starts from the first law of thermodynamics. The thermodynamic work in a constant-volume process is zero by definition, since expansion-compression work depends on volume change. This is expressed by the isochoric work formula:\r
\r
{{f:trabajo_isocorico}}\r
\r
With [[W]] zero, the first law reduces to the identity between absorbed heat and the change in internal energy. The **change in internal energy** of the gas is determined by:\r
\r
{{f:energia_interna_isocorica}}\r
\r
This formula shows that [[DeltaU]] depends linearly on three factors: the number of moles [[n]], the molar heat capacity at constant volume [[Cv]], and the temperature change [[DeltaT]]. The exchanged heat follows the same expression:\r
\r
{{f:calor_isocorico}}\r
\r
The equality between [[Q]] and [[DeltaU]] is the defining identity of the isochoric process. Note that [[Cv]] is the parameter that depends on the type of gas: for an ideal monatomic gas it is approximately 12.5 joules per mole and kelvin, for a diatomic gas about 20.8, and for triatomic about 24.9. These differences reflect the molecular degrees of freedom that participate in energy storage.\r
\r
The temperature change is obtained as:\r
\r
...
\r
In the pressure-temperature (pT) diagram, the isochoric process appears as a **straight line segment passing through the coordinate origin**. This expresses Gay-Lussac's law at constant volume: pressure and absolute temperature are proportional. The slope of that line depends on the number of moles and the enclosed volume. Different containers with the same gas but different volumes give lines of different slopes, all passing through the origin.\r
\r
The internal energy of an ideal gas depends exclusively on temperature, not on volume or pressure. This property, demonstrated by Joule in his free expansion experiment, is why [[DeltaU]] can be computed with the expression above for any process of an ideal gas, not only isochoric ones. The advantage of the isochoric process is that, since [[W]] is zero, the absorbed heat is directly computable without knowing the path of the process.\r
\r
...
\r
The sign of [[DeltaU]] and [[Q]] is the most important reading variable. Positive heat means the surroundings are hotter than the gas and transfer energy to it; negative heat means the gas is hotter than the surroundings and releases energy. This asymmetry is key for understanding safety phenomena: a sealed hot-gas container that cools undergoes an isochoric process with negative [[DeltaU]] and negative [[DeltaT]], so its pressure drops. Conversely, a container that heats up experiences a pressure increase that can exceed the rupture limit if there is no relief valve.\r
\r
## Order of magnitude\r
\r
For one mole of diatomic gas (for example, nitrogen with [[Cv]] of 20.8 J per mol and kelvin) with a temperature increase of 100 K, the change in internal energy is approximately 2080 J, about 2 kJ. For 10 moles the result is 20 kJ. In industrial applications with 100 moles and [[DeltaT]] of 500 K, [[DeltaU]] reaches approximately 1 MJ.\r
\r
If the result of [[DeltaU]] is of the order of joules for several moles and hundreds of kelvin, there is an error; the unit of [[Cv]] was probably confused, or the specific heat per unit mass was used instead of the molar value. A negative [[DeltaU]] result when heat is supplied is an immediate sign of an error in the sign of [[DeltaT]].\r
\r
## Personalized resolution method\r
\r
To solve any isochoric problem systematically, follow this sequence:\r
\r
1. **Confirm the isochoric condition**: verify that volume is constant. If so, [[W]] is immediately zero and the first law reduces to [[Q]] equal to [[DeltaU]].\r
2. **Convert temperatures to kelvins**: add 273.15 to each Celsius temperature. This step is mandatory for any ratio or absolute formula.\r
3. **Identify the type of gas and [[Cv]]**: monatomic (12.5 J per mol and kelvin), diatomic (20.8), or triatomic (24.9).\r
4. **Calculate [[DeltaT]]**: subtract the initial temperature from the final. The sign determines whether the process is heating or cooling.\r
5. **Calculate [[DeltaU]] and [[Q]]**: multiply [[n]] by [[Cv]] by [[DeltaT]].\r
6. **Verify coherence**: the ratio of final to initial pressure must equal the ratio of [[T2]] to [[T1]].\r
\r
## Special cases and extended example\r
\r
**Isochoric cooling**: If the rigid container is placed in a cold bath, [[DeltaT]] is negative, [[DeltaU]] is negative and [[p]] drops. In an autoclave that cools rapidly without being opened, [[p]] can fall below atmospheric.\r
\r
**Otto engine**: The combustion phase of the idealised Otto cycle is modelled as an isochoric process: combustion sharply raises [[T]] and [[p]] while the piston barely moves.\r
\r
## Real student questions\r
\r
**Why use [[Cv]] instead of Cp?** Because [[Cv]] is the heat capacity at constant [[V]]. Cp includes expansion work that does not exist in the isochoric process.\r
\r
**Why kelvins instead of Celsius in Gay-Lussac's law?** The proportionality between [[p]] and [[T]] only holds on the absolute scale. For [[DeltaT]] in the [[DeltaU]] formula, the difference is the same in both scales, but in ratios only kelvins are valid.\r
\r
## Cross-cutting connections and study paths\r
\r
The isochoric process connects with the **isobaric process** (constant [[p]]), where [[Cv]] is replaced by Cp and expansion work is non-zero. Recommended study path: first law → isochoric → isobaric → isothermal → Carnot cycle.\r
\r
The isochoric process links to Gay-Lussac's law and kinetic theory through the microscopic meaning of [[Cv]] and molecular degrees of freedom.\r
\r
## Final synthesis\r
\r
The isochoric process concentrates the entire essence of the first law of thermodynamics in its cleanest form: with constant volume, mechanical work is zero and all absorbed heat converts entirely into the change in internal energy of the gas. Mastering this process means understanding what [[DeltaU]] is, how it relates to temperature and to the type of gas through [[Cv]], and why the Kelvin scale is indispensable for pressure-to-temperature proportionality calculations.\r
`;export{e as default};
