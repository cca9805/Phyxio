...
Snell's law states that the product of the refractive index of a medium and the sine of the angle between the ray and the surface normal remains constant when crossing the interface. The refractive index [[n1]] of the medium where the incident ray travels and the index [[n2]] of the medium where the refracted ray travels determine, together with the angle of incidence [[theta_1]], the angle of refraction [[theta_2]]. If light enters an optically denser medium (higher index), the ray bends toward the normal and [[theta_2]] is smaller than [[theta_1]]; if it enters a less dense one, it bends away from the normal and [[theta_2]] is larger.
...
When the interface is not flat, Snell's law still applies **locally** using the local normal, enabling ray tracing through curved lenses. In the regime of grazing angles, reflectivity increases rapidly according to the Fresnel equations; Snell's law predicts the direction but not the transmitted energy.
...
Snell's law connects directly to the [refractive index](leaf:fisica-clasica/electromagnetismo/optica/optica-geometrica/refraccion/indice-de-refraccion), which defines the quantities [[n1]] and [[n2]] in terms of the speed of light in each medium. Conceptually it links to **Fermat's principle** (stationary optical path), which unifies reflection and refraction under a single variational principle.
