...
This formula has three immediate implications: the force is maximum when [[v]] is perpendicular to [[B]], zero when [[v]] is parallel or antiparallel to [[B]], and always perpendicular to the plane formed by [[v]] and [[B]]. It also explains why a magnetic field can bend a trajectory without increasing the kinetic energy of the particle.
