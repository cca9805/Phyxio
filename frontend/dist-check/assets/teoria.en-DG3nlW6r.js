...
The mathematical description begins with the Laplace force on a conductor. A conductor of length [[L_c]] carrying current [[I]] inside a field [[B]] experiences a force proportional to the product of these magnitudes and the sine of the angle. With [[N_c]] active conductors, the total force is:
...
The five formulas above form a chained system where each variable is determined sequentially from the previous ones. The armature current [[I]], imposed by the difference between supply voltage and back-EMF, determines the Laplace force [[F_L]] on each active conductor. This force, distributed among the [[N_c]] winding conductors, generates a collective mechanical action.
...
To solve any electric motor problem, the recommended order is as follows. First identify the known data among [[N_c]], [[I]], [[L_c]], [[B]], [[r_a]], [[sin_theta]] and [[omega]]. Second, calculate [[F_L]] using the first formula and check the dimension. Third, obtain [[tau_m]] by multiplying [[F_L]] by [[r_a]]. Fourth, if [[omega]] is known, calculate [[epsilon_c]] and [[P_mec]]. Fifth, with [[P_elec]] and [[P_mec]], obtain [[eta]]. At each step, verify that the result has the expected order of magnitude before proceeding to the next.
...
Extended example: a DC motor with 300 active conductors, [[L_c]] of 0.08 m, [[B]] of 1.0 T, [[r_a]] of 0.05 m and [[I]] of 5 A operates at [[omega]] of 100 rad/s with [[sin_theta]] equal to 1. The force per conductor is [[I]] times [[L_c]] times [[B]], that is 0.4 N. The total force on [[N_c]] conductors is 120 N. Torque is 120 times 0.05, equal to 6 N·m. Mechanical power is 6 times 100, equal to 600 W. Back-EMF is 300 times 0.08 times 1.0 times 0.05 times 100, equal to 120 V. With a supply voltage of 130 V and back-EMF of 120 V, the steady-state current is approximately (130 minus 120) divided by the internal winding resistance. With 2 Ω resistance, current is 5 A, which verifies the consistency of the system.
...
Why does reversing the supply polarity reverse the direction of rotation? Because it reverses the direction of [[I]], which reverses the direction of the Laplace force according to the right-hand rule.
...
The electric motor converts electrical energy into mechanical torque through the force that the stator field exerts on the rotor current. Torque is proportional to current, field and the motor's constructive parameters. Back-EMF, generated by the same rotor as it rotates, limits current at steady state and is the mechanism by which energy is transferred to the shaft. Efficiency measures the quality of that conversion and is always less than one due to unavoidable losses. The motor's operating point is the intersection of its torque-speed curve and the resistive torque curve of the load.
`;export{e as default};
