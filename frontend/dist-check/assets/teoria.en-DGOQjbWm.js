const e=`# Definition of Torque\r
\r
...
\r
The central magnitude of the leaf is [[tau]], the torque or moment of force. The rotational effect depends on the applied force [[F]], the distance [[r]] from the axis to the application point, and the angle [[theta]] between [[r]] and [[F]]. The lever arm [[b]] is the effective perpendicular distance from the axis to the line of action of [[F]], and it is the key to the problem geometry: the larger [[b]] is, the greater the torque for the same [[F]].\r
\r
## 🔵 Formal level\r
\r
The mathematical layer organizes that intuition into explicit relations. The formulas that structure the analysis are the angle-based form, the lever-arm form, the planar component form, and rotational second law. In this leaf, the first operational relation is torque from the angle between [[r]] and [[F]]:\r
\r
...
\r
Very often a second relation is needed to close the model, namely Torque from lever arm:\r
\r
{{f:torque_brazo}}\r
\r
...
\r
When force components [[F_x]] and [[F_y]] are known along with application-point coordinates [[x]] and [[y]], use:\r
\r
{{f:torque_plano}}\r
\r
When dynamic response is also required, use:\r
\r
{{f:segunda_ley_rotacional}}\r
\r
Rotational second law connects [[tau]] with angular acceleration [[alpha]] through the moment of inertia [[I]] of the body.\r
\r
Unit checks and dimensional logic also belong here. An expression may be dimensionally acceptable and still be physically misused if rigidity, contact regime, linearity, or validity conditions have been ignored. Dimensions are necessary, but they never replace modeling judgment.\r
\r
## 🔴 Structural level\r
\r
...
\r
Definition of Torque naturally connects with several nearby blocks:\r
\r
