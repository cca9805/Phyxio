...
[[C]] measures the energy per kelvin needed to change the temperature of a specific body. [[Q]] and [[DeltaT]] describe the process; [[C]] describes the body's thermal response. The relation is linear only while no phase change occurs and while heat capacity is approximately constant.\r
`;export{e as default};
