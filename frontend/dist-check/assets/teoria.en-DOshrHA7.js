...
The quantitative relationship between [[I]] and the angle [[theta_p]] between the wave's polarisation direction and the polariser axis is given by Malus's law:

{{f:ley_malus}}

Here [[I_0]] is the intensity of the polarised light reaching the analyser and [[theta_p]] is the angle between the wave's polarisation direction and the filter's transmission axis. The squared-cosine dependence means that intensity does not fall linearly but stays high at small angles and drops rapidly as the angle approaches 90 degrees. When [[theta_p]] equals zero, [[I]] equals [[I_0]]; when [[theta_p]] equals 90 degrees, [[I]] vanishes (crossed polarisers).

> [!NOTE]
> If the source emits unpolarised natural light, the first polariser transmits exactly half the original intensity. Malus's law then applies taking that half as [[I_0]] for the second polariser.
...
For a common air–glass interface ([[n_1]] close to 1.00 and [[n_2]] close to 1.50), [[theta_B]] is approximately 56 degrees. For water ([[n_2]] close to 1.33) it falls to about 53 degrees. Typical laboratory intensities range from 10 to 1000 W/m². A result of [[I]] much larger than [[I_0]], or a Brewster angle outside the 40-to-70-degree range for ordinary materials, should immediately raise suspicion of a data error.
...
3. **Apply Malus's law**: compute [[I]] from [[I_0]] and [[theta_p]].
4. **If reflection is involved**: identify the two media, obtain [[n_1]] and [[n_2]], and calculate [[theta_B]] with Brewster's law.
5. **Check coherence**: verify that [[I]] does not exceed [[I_0]] and that [[theta_B]] falls within a reasonable range for the given materials.

## Special cases and extended example

- **Crossed polarisers with an intermediate sheet**: inserting a third polariser between two crossed ones with its axis at 45 degrees to both allows light to pass again. The final intensity is one quarter of [[I_0]] multiplied by the squared sine of twice the intermediate angle, demonstrating that polarization is not simply an all-or-nothing filter.

- **Reflection off water at [[theta_B]]**: observing a lake at the Brewster angle shows that reflected light is almost completely horizontally polarised. This is why polarised sunglasses with a vertical transmission axis eliminate glare from the water surface while transmitting useful light.
