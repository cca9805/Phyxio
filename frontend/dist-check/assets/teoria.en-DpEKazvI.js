const e=`# Small Oscillations and Normal Modes\r
\r
...
\r
Modal structure separates collective motion, not isolated particles. A normal mode can move many coordinates at once with fixed proportions; another mode can do so with another shape and frequency. This decomposition explains why a complex structure vibrates with recognizable signatures and why resonance can attack only some patterns.\r
\r
...
## Final synthesis\r
\r
As an operational closure, this topic must make clear that linearizing is not ignoring complexity, but choosing the scale where complexity organizes into modes. A student who masters the leaf can justify equilibrium, build the modal problem, interpret frequencies, and recognize which collective shape is activated.\r
\r
\r
After this leaf, the student should be able to use Small Oscillations and Normal Modes as a physical criterion. The final competence is not memorizing equations, but deciding when the advanced description is legitimate, what it preserves, and what kind of mechanical question it can answer.\r
\r
This competence also reviews solutions in other topics: if a frequency appears without a mode, equilibrium, or small scale, the result does not describe a physical vibration. The leaf works as a local stability criterion.\r
`;export{e as default};
