...
\r
## 🔴 Structural level\r
From a structural and mechanical perspective, this principle is not an isolated empirical law, but a direct and necessary consequence of Newton's Second Law applied to an infinitesimal fluid element in static equilibrium. For an infinitesimal portion of fluid to remain at absolute rest, the sum of all external forces (pressure forces on its faces and volumetric weight force) must be exactly zero.\r
\r
...
To solve any problem based on this principle, it is recommended to follow this systematic protocol:\r
1.  **Coordinate definition:** Always establish a Z-axis positive upwards to avoid confusion with elevation signs for [[z1]] and [[z2]].\r
2.  **Point identification:** Clearly mark your reference and destination elevations.\r
3.  **Unit consistency:** Ensure density [[rho]] is expressed in kg/m^3 and not in g/cm^3.\r
4.  **Formula application:** Substitute into the equilibrium equation and verify that the result is coherent: pressure must be higher at the lowest point.\r
5.  **Differential calculation:** If you only need the change, use the pressure jump [[dp]] multiplied by the elevation increment [[dz]].\r
\r
## Special cases and extended example\r
A very common special case is that of stratified fluids (immiscible liquids of different densities stacked). In this scenario, the total pressure at the bottom is calculated by sequentially adding the hydrostatic jumps of each individual layer. Another case of interest is that of accelerated tanks, where an effective gravity appears that modifies the value of [[g]], but the linear structure of the fundamental principle remains unchanged with respect to that new resulting acceleration. It is also relevant to consider inclined tanks where pressure still depends only on pure vertical elevation.\r
\r
## Real student questions\r
"Why doesn't the pressure depend on the shape of the container?" This is the famous hydrostatic paradox. The answer lies in the fact that the side walls of the container exert forces that exactly compensate for any weight component that is not vertical. Therefore, the pressure at a point only "feels" the vertical column of fluid directly above it, regardless of whether the container widens or narrows above that level. "If there's an air bubble, does the pressure change?" Yes, because the fluid's continuity is broken and air, having a much lower [[rho]], generates a negligible pressure jump compared to the liquid. "What happens if the fluid moves?" Then we must abandon hydrostatics and move to hydrodynamics (Bernoulli).\r
\r
