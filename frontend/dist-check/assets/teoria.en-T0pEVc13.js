const e=`# Canonical Transformations\r
\r
...
\r
The deep structure is symplectic. A change can shorten an expression and still destroy oriented phase areas or canonical relations. When the transformation is legitimate, the system keeps its dynamical identity even though the descriptive variables change. This is the basis of action-angle variables and many perturbation methods.\r
\r
...
## Final synthesis\r
\r
As an operational closure, this topic must make clear that changing variables is not the same as changing physics. A student who masters the leaf can propose a generator, obtain new variables, check the canonical condition, and explain whether the new Hamiltonian keeps the same dynamics or introduces a necessary time correction.\r
\r
\r
After this leaf, the student should be able to use Canonical Transformations as a physical criterion. The final competence is not memorizing equations, but deciding when the advanced description is legitimate, what it preserves, and what kind of mechanical question it can answer.\r
\r
This competence also reviews solutions in other topics: if a variable change simplifies but does not preserve structure, the result is no longer equivalent Hamiltonian mechanics. The leaf works as a legitimacy filter.\r
`;export{e as default};
