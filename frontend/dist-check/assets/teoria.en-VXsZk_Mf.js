const e=`# Basic polar coordinates\r
\r
## What it is\r
\r
...
\r
![Basic polar coordinates](/graphs/matematicas/trigonometria-y-geometria/coordenadas-polares.svg)\r
\r
...
\r
| Coordinate | Meaning | Cartesian conversion |\r
|---|---|---|\r
| r | distance from origin | sqrt(x^2+y^2) |\r
| theta | angular direction | atan(y/x) with quadrant |\r
| x | horizontal projection | r cos(theta) |\r
| y | vertical projection | r sin(theta) |\r
\r
