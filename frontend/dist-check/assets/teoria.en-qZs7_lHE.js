const e=`# Projections and components\r
\r
## What it is\r
\r
...
\r
![Projections and components](/graphs/matematicas/trigonometria-y-geometria/proyecciones-componentes.svg)\r
\r
...
\r
| Known data | Parallel component | Perpendicular component | Check |\r
|---|---|---|---|\r
| magnitude and angle from x | A cos(theta) | A sin(theta) | same magnitude when rebuilt |\r
| magnitude and angle from y | A sin(theta) | A cos(theta) | chosen function changes |\r
| component and angle | divide by sin/cos | solve magnitude | check domain |\r
\r
