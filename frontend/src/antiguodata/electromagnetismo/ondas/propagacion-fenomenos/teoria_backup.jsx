    ...
    <>
      ...
      <div className="theory-anecdotes-section">
        ...
        <div className="concepto-fundamental">
          ...
          <p>
            Una fibra óptica típica tiene solo 125 micrómetros de diámetro (más delgada que un cabello humano) pero puede transmitir datos a 100 Gbpry;heonosTenomegacionFropafault Pt de
