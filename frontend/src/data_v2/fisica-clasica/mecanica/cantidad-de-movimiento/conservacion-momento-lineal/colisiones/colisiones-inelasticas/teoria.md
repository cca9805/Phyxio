...
## Idea clave
Colisiones inelásticas permite choques reales con p conservado y K decreciente.

## 1- Qué estudia este subtema y por qué es fundamental
Este subtema desarrolla cómo plantear, calcular e interpretar colisiones inelásticas con criterio físico.

## 2- Cómo funciona físicamente
e entre 0 y 1 mide rebote parcial.
...
- usar p + restitución para velocidades finales.

## 9- Aplicaciones reales
- accidentología,materiales,barreras.

## 10- Síntesis final
Dominar Colisiones inelásticas implica justificar: hipótesis -> ecuación -> cálculo -> interpretación -> decisión.
