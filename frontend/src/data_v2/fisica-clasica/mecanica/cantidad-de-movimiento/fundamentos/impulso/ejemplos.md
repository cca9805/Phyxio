...
## Ejemplo 1- Caso base de Impulso
**Enunciado:** F=150N,dt=0.2s -> J=30 N s.

**Pasos de resolución**
1. Identifica variable objetivo y datos.
2. Aplica la relación principal: $J = F\Delta t$.
3. Verifica unidades y lectura física.

## Ejemplo 2- Variación de condición en Impulso
**Enunciado:** m=0.25kg,vi=10,vf=-6 -> J=-4 N s.
