...
Confundir velocidad inicial, ángulo o sentido de la gravedad.

## 2- Error de interpretación física
Olvidar que el proyectil parte con velocidad en dos dimensiones.

## 3- Error de dominio de validez
Aplicar el modelo cuando hay resistencia del aire o velocidad inicial solo en $x$ o $y$.
