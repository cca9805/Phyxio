...
## Idea clave
La tension superficial surge por cohesion molecular y domina fenomenos de interface.
...
- $\gamma$: tension superficial
- F: fuerza
- L: longitud contacto
- \Delta p: salto presion
- r: radio curvatura
...
- Objetivo central del tema: equilibrio de interfaces y capilaridad.
