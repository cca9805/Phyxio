...
## Idea clave
Las ondas en fluidos transportan energia e informacion mediante oscilaciones del medio.
...
- v: velocidad onda
- $\lambda$: longitud onda
- f: frecuencia
- T: periodo
- B: modulo compresibilidad
- $\rho$: densidad
...
- Objetivo central del tema: propagacion ondulatoria y bases del sonido.
