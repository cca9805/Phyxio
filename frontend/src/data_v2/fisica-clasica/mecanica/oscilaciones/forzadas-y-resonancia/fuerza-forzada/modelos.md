...
Este subtema modela respuesta estacionaria y transitoria de un oscilador excitado externamente. Se usa un marco clásico, determinista y con parámetros efectivos constantes en el intervalo de análisis.
...
- Amplitud estacionaria en función de frecuencia de excitación.
- Desfase entre fuerza aplicada y respuesta.
- Separación entre transitorio y régimen permanente.
