...
Este subtema modela la oscilación de un cuerpo rígido alrededor de un eje, gobernada por su inercia rotacional. Se usa un marco clásico, determinista y con parámetros efectivos constantes en el intervalo de análisis.
...
- Periodo natural desde geometría e inercia.
- Influencia de d e I en la rapidez de oscilación.
- Comparación entre péndulo simple equivalente y péndulo físico real.
