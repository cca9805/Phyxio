...
## 1. Diagnóstico de calidad de energía en instalaciones

En auditorías de red, magnitudes alternas permite distinguir si una anomalía proviene de amplitud, ritmo temporal o [[phi]] operativo. Esta distinción evita diagnósticos vagos del tipo "hay mala tensión" y obliga a identificar qué magnitud está fuera de rango y qué consecuencia física produce.

Variable dominante: [[tension_eficaz]].
...
Variable dominante: [[potencia_activa]].

Límite de validez: exige que [[tension_eficaz]], [[corriente_eficaz]] y [[phi]] provengan del mismo punto de operación para mantener coherencia.
