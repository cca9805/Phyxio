...
El modelo ideal de este leaf asume señal sinusoidal pura, [[frecuencia]] estable y magnitudes bien definidas en régimen estacionario. Bajo ese marco, [[v_t]] puede describirse con amplitud [[amplitud_de_tension]], ritmo [[omega]] o [[frecuencia]], escala temporal [[periodo]] y [[phi]] [[phi]], mientras la lectura energética se resume con [[tension_eficaz]], [[corriente_eficaz]] y [[potencia_activa]].
...
Además, se asume consistencia metrológica: [[tension_eficaz]] e [[corriente_eficaz]] provienen del mismo estado de operación, [[frecuencia]] y [[omega]] se convierten con trazabilidad explícita y [[phi]] mantiene una convención definida de referencia temporal.
...
También conviene exigir estabilidad de amplitud: variación relativa de [[amplitud_de_tension]] menor o igual al 5 por ciento en la ventana analizada. Si estas condiciones no se cumplen, la interpretación puramente sinusoidal deja de ser suficiente y el valor eficaz debe evaluarse con definición general, no solo con fórmula de senoide pura.

## Señales de fallo del modelo

Una primera señal de fallo aparece cuando las conversiones básicas dan resultados incompatibles entre sí, por ejemplo cuando [[periodo]] no coincide con 1/[[frecuencia]] dentro del error instrumental esperado. Otra señal clara es obtener [[potencia_activa]] físicamente inverosímil respecto de [[tension_eficaz]] e [[corriente_eficaz]] reportadas.
...
Cuando el modelo ideal no basta, el paso natural es introducir análisis armónico y definición integral de RMS sobre la forma real de onda. Ese modelo extendido conserva el papel de [[frecuencia]], [[omega]] y [[phi]], pero distribuye la energía entre componentes espectrales y evita sobrerrepresentar la fundamental.
