...
El caso se resuelve con una [[capacitancia]] [[capacitancia]] de cuarenta y siete microfaradios, [[frecuencia]] [[frecuencia]] de sesenta hertz y tensión eficaz [[tension_eficaz]] de doscientos treinta voltios. El ejercicio asume comportamiento lineal del capacitor en el rango de operación y régimen sinusoidal estacionario.

## Definición del sistema

El sistema es una rama capacitiva única conectada a fuente ideal de [[frecuencia]] fija. El interés no está en transitorio de carga inicial, sino en respuesta periódica estable. La magnitud de oposición es [[reactancia_capacitiva]], la de corriente eficaz es [[corriente_capacitiva_eficaz]] y la de intercambio reactivo es [[potencia_reactiva_capacitiva]].
...
Primero se expresa [[capacitancia]] en faradios. Con [[frecuencia]] de sesenta hertz, la conversión entrega un valor de [[omega]] en centenas de radianes por segundo. Esa escala conduce a [[reactancia_capacitiva]] del orden de decenas de ohmios, coherente con una rama capacitiva de microfaradios a [[frecuencia]] industrial moderada.

Con [[tension_eficaz]] eficaz de doscientos treinta voltios y la reactancia obtenida, la corriente [[corriente_capacitiva_eficaz]] resulta del orden de amperios. Luego, al combinar [[tension_eficaz]] e [[corriente_capacitiva_eficaz]], la magnitud [[potencia_reactiva_capacitiva]] queda en el rango de centenas a miles de var según redondeo y convención de reporte. El punto pedagógico no es el último decimal, sino la consistencia causal entre entradas, oposición y respuesta.

## Validación dimensional

La validación dimensional confirma coherencia en toda la cadena: [[omega]] en radianes por segundo, [[reactancia_capacitiva]] en ohmios, [[corriente_capacitiva_eficaz]] en amperios y [[potencia_reactiva_capacitiva]] en var. También se verifica tendencia física: al usar una [[capacitancia]] de microfaradios en [[frecuencia]] de decenas de hertz, la reactancia no debe quedar ni extremadamente baja ni astronómicamente alta.
...
Esto implica que el valor calculado solo adquiere significado completo cuando se conecta con decisión operativa. Por tanto, no basta con reportar [[reactancia_capacitiva]], [[corriente_capacitiva_eficaz]] y [[potencia_reactiva_capacitiva]]; hay que justificar qué variable gobernó el resultado y cómo cambiaría el diagnóstico ante una variación de [[frecuencia]] o [[capacitancia]].
...
El equipo recopila [[capacitancia]] efectiva por etapa, [[frecuencia]] de operación real, tensión eficaz y corrientes de rama medidas. Primero verifica conversión de unidades de [[capacitancia]] y consistencia entre [[frecuencia]] y [[omega]]. Luego recalcula [[reactancia_capacitiva]] para cada etapa y compara con la corriente [[corriente_capacitiva_eficaz]] medida en campo.

La estimación muestra que en ciertos periodos la [[frecuencia]] efectiva y la distribución de etapas activas reducen la oposición total más de lo previsto en diseño inicial. Como consecuencia, la corriente de rama crece y aproxima límites térmicos de elementos de protección. Además, la magnitud [[potencia_reactiva_capacitiva]] mejora el balance global, pero introduce exigencia local que no había sido priorizada en la puesta en marcha.
...
La decisión técnica resultante incluye escalonar etapas, ajustar lógica de conexión y revisar margen térmico de protecciones en condiciones reales de carga. Esta salida es más robusta que una sustitución impulsiva, porque nace de causalidad física explícita entre [[capacitancia]], [[frecuencia]], [[reactancia_capacitiva]], [[corriente_capacitiva_eficaz]] y [[potencia_reactiva_capacitiva]].
