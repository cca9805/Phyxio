...
El modelo ideal trata a la bobina como elemento puramente reactivo, con comportamiento lineal y sin perdidas dominantes. En ese marco, la oposicion [[reactancia_inductiva]] se explica con [[omega]] y [[inductancia]], la corriente [[corriente_inductiva_eficaz]] se determina con la tension eficaz [[tension_eficaz]], y [[potencia_reactiva_inductiva]] resume magnitud de intercambio reactivo en regimen sinusoidal estacionario.
...
Cuarta hipotesis metrologica: [[tension_eficaz]] e [[corriente_inductiva_eficaz]] son magnitudes RMS coherentes y obtenidas en condiciones comparables. Quinta hipotesis operativa: [[frecuencia]], [[omega]] y [[inductancia]] estan expresadas con unidades correctas y trazables.

## Dominio de validez cuantitativo

Como criterio operativo, el modelo minimo es confiable cuando THD <= 5%, cuando la [[frecuencia]] se mantiene dentro de 0.98 <= f_medida/f_nominal <= 1.02 y cuando la perdida relativa se mantiene baja, por ejemplo R_equivalente/[[reactancia_inductiva]] <= 0.10 en la banda principal.
...
Una senal de fallo temprana es la incoherencia entre tendencia esperada y medicion. Si aumenta [[frecuencia]] y la rama no muestra el incremento de oposicion previsto, puede haber saturacion, perdidas o fuerte distorsion fuera del modelo ideal.
...
La transicion explicita es esta: cuando conviene cambiar a modelo alternativo ocurre si R_equivalente/[[reactancia_inductiva]] > 0.10, si THD supera 5%, o si la deriva de [[frecuencia]] sale del intervalo operativo definido. En esos casos, mantener el modelo ideal como unico soporte de decision puede producir diagnostico incompleto.
