...
**Por qué es incorrecto**: Tienen significados físicos y geométricos opuestos. La [[divergencia_de_e]] mide cuánto "sale" o "entra" el campo de un punto infinitesimal (fuentes de carga), mientras que el [[rotacional_de_e]] mide cuánto "gira" o circula localmente el campo alrededor de ese punto. Una divergencia alta no implica un rotacional alto, y viceversa.
...
**Por qué parece correcto**: En el aprendizaje inicial, es tentador insertar la carga total en la ley de Gauss diferencial en lugar de la densidad volumétrica de carga [[rho]], o la corriente total en lugar de la densidad [[densidad_de_corriente]].
...
**Por qué parece correcto**: Se intenta calcular el [[divergencia_de_e]] o el [[rotacional_de_b]] justo en la frontera o superficie de separación entre dos materiales (como aire y metal) para ver cómo cambia el campo al "cruzar".
