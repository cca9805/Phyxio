...
El modelo ideal de la formulación diferencial de Maxwell describe el comportamiento de los campos eléctrico [[campo_electrico]] y magnético [[campo_magnetico]] en el vacío absoluto, asumiendo que el espacio es un continuo matemático sin estructura atómica y que los campos son funciones infinitamente derivables. En este modelo, las interacciones ocurren de forma local y la velocidad de la luz [[velocidad_de_la_luz]] es una constante universal insuperable.
...
1. **Divergencias infinitas**: Si al calcular el [[divergencia_de_e]] el resultado tiende a infinito en un punto, indica que la aproximación de carga puntual ha fallado y se requiere un modelo de distribución espacial o cuántico.
...
3. **Pérdida de conservación de energía**: Si en un cálculo dinámico no se incluye la corriente de desplazamiento proporcional a [[variacion_temporal_de_e]], el sistema resultante viola la conservación de la carga, una señal crítica de fallo del modelo incompleto.
