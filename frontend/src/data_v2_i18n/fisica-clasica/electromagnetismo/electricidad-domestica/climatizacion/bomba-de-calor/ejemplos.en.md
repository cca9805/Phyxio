...
A single-family home located in a climate zone with moderate winters has an estimated average daily [[thermal demand|q_demanda]] of 180 MJ. To meet this demand, the owner has installed an aerothermal heat pump that, according to design conditions, operates with an [[average seasonal coefficient of performance|cop]] of 3.5. If the current [[electricity price|precio_kwh]] is 0.22 euros for each billed kWh, you are requested to determine:
1. The total electrical energy in MJ that the compressor must consume in a day.
...
- Daily [[thermal demand|q_demanda]]: 180 MJ.
- [[Coefficient of performance|cop]]: 3.5.
- [[Electric energy price|precio_kwh]]: 0.22 euros per kWh.
- Unit conversion factor: 1 kWh is equivalent to 3.6 MJ.
...
The physical model considers fundamental system quantities such as [[ahorro]], [[cop]], [[coste]].
...
To satisfy a [[delivered heat|q_calor]] delivery of 180 MJ with a [[COP|cop]] of 3.5:
Electrical energy: 180 MJ divided by 3.5, which results in 51.43 MJ.
This is the value of the daily [[electric work|w_elec]] expressed in MJ.
...
We first convert energy from MJ to commercial kWh:
Consumption: 51.43 MJ divided by 3.6, which results in 14.29 kWh.
We multiply by the [[electricity price|precio_kwh]] of 0.22 euros per kWh:
[[daily expenditure|coste]]: 14.29 kWh multiplied by 0.22 euros per kWh, which results in 3.14 euros.

4. **Extracted ambient heat ([[ambient heat|q_ambiente]])**:
Subtracting the [[electric work|w_elec]] from the [[delivered heat|q_calor]]:
[[ambient heat|q_ambiente]]: 180 MJ minus 51.43 MJ, which results in 128.57 MJ.
...
- For [[cost|coste]]: The product of an energy M L2 T-2 (in the form of kWh) by a unit price [[electricity price|precio_kwh]] per each kWh cancels the energy dimensions and leaves the monetary unit. Coherent.

## Physical interpretation

The obtained result reveals the powerful "thermal leverage" mechanism that characterizes this technology. To satisfy a demand of 180 MJ, the user has only had to buy 51.4 MJ of [[total electric consumption|e_elec]]. This does not mean that energy is being created out of thin air (which would violate the first law), but that the compressor is performing [[electric work|w_elec]] to "force" 128.6 MJ of thermal [[ambient heat|q_ambiente]] dispersed in the outdoor air (a low-temperature source) to concentrate and enter the home.
...
For a pool that requires an energy input of the order of 1,000,000 MJ annually to compensate for evaporation and radiation losses:
- With the current combustion system, the hotel must buy and burn fuel equivalent to that million MJ.
- With a heat pump with a [[COP|cop]] of 4.8, the hotel will only pay for 208,333 MJ of electrical [[electric work|w_elec]].
- The remaining 791,667 MJ of [[delivered heat|q_calor]] will be captured for free from the mountain air.

If the [[electricity price|precio_kwh]] is 0.20 euros per kWh, the hotel would go from paying about 55,555 euros annually (estimated in equivalent energy) to paying only about 11,574 euros, achieving an economic [[saving|ahorro]] of almost 44,000 euros per year.
