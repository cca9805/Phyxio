...
Una vivienda unifamiliar situada en una zona climática de inviernos moderados tiene una [[demanda térmica|q_demanda]] media diaria estimada de 180 MJ. Para cubrir esta demanda, el propietario ha instalado una bomba de calor aerotérmica que, según las condiciones de diseño, opera con un [[coeficiente de rendimiento|cop]] medio estacional de 3.5. Si el [[precio de la electricidad|precio_kwh]] actual es de 0.22 euros por cada kWh facturado, se solicita determinar:
1. La energía eléctrica total en [[megajulio]] que el compresor debe consumir en un día.
...
- [[Demanda térmica|q_demanda]] diaria: 180 [[megajulio]].
- [[Coeficiente de rendimiento|cop]]: 3.5.
- [[Precio de la energía eléctrica|precio_kwh]]: 0.22 euros por cada kWh.
- Factor de conversión de unidades: 1 kWh equivale a 3.6 MJ.
...
Para satisfacer una entrega de [[calor entregado|q_calor]] de 180 MJ con un [[COP|cop]] de 3.5:
Energía eléctrica: 180 MJ dividido por 3.5, lo que resulta en 51.43 MJ.
Este es el valor del [[trabajo eléctrico|w_elec]] diario expresado en MJ.
...
Convertimos primero la energía de MJ a kWh comerciales:
Consumo: 51.43 MJ dividido por 3.6, lo que resulta en 14.29 kWh.
Multiplicamos por el [[precio de la energía|precio_kwh]] de 0.22 euros por kWh:
[[coste]]: 14.29 kWh multiplicado por 0.22 euros por kWh, lo que resulta en 3.14 euros.

4. **[[calor ambiental|q_ambiente]] extraído**:
Restando el [[trabajo eléctrico|w_elec]] al [[calor entregado|q_calor]]:
[[calor ambiental|q_ambiente]]: 180 MJ menos 51.43 MJ, lo que resulta en 128.57 MJ.
...
- Para el [[coste]]: El producto de una energía M L² T⁻² (en forma de kWh) por un precio unitario Moneda por cada M L² T⁻² cancela las dimensiones de energía y deja la unidad monetaria. Coherente.

## Interpretación física

El resultado obtenido revela el potente mecanismo de "apalancamiento térmico" que caracteriza a esta tecnología. Para satisfacer una demanda de 180 MJ, el usuario solo ha tenido que comprar 51.4 MJ de energía eléctrica. Esto no significa que se esté creando energía de la nada (lo cual violaría la primera ley), sino que el compresor está realizando un [[trabajo eléctrico|w_elec]] para "obligar" a 128.6 MJ de [[calor ambiental|q_ambiente]] dispersa en el aire exterior (un foco de baja temperatura) a concentrarse y entrar en la vivienda.
...
Para una piscina que requiere un aporte energético del orden de 1.000.000 MJ anuales para compensar las pérdidas por evaporación y radiación:
- Con el sistema actual de combustión, el hotel debe comprar y quemar combustible equivalente a ese millón de MJ.
- Con una bomba de calor con [[COP|cop]] de 4.8, el hotel solo pagará por 208.333 MJ de [[trabajo eléctrico|w_elec]].
- Los restantes 791.667 MJ de [[calor entregado|q_calor]] serán capturados gratuitamente del aire de la montaña.

Si el [[precio de la electricidad|precio_kwh]] es de 0.20 euros por kWh, el hotel pasaría de pagar unos 55.555 euros anuales (estimados en energía equivalente) a pagar tan solo unos 11.574 euros, logrando un [[ahorro]] económico de casi 44.000 euros al año.
