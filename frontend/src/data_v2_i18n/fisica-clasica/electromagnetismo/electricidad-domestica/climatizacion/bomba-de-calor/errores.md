...
**Por qué parece correcto**
La confusión de magnitudes entre [[kilovatio]] y kWh es el error matemático más persistente. El alumno utiliza la potencia en [[kilovatio]] del compresor directamente en fórmulas que requieren energía total, debido a una falta de atención a la dimensión temporal del proceso.
...
**Corrección conceptual**
Recuerda que los [[kilovatio]] son como la velocidad de un coche (km/h), mientras que los [[kilovatio_hora]] son la distancia recorrida (km). Para saber cuánta energía has gastado, debes multiplicar cuánto de rápido iba el flujo por cuánto tiempo ha estado encendido.
...
3. Asegúrate de que los MJ y los kWh estén bien convertidos: un [[kilovatio_hora]] equivale a 3.6 [[megajulio]]. Si no has usado este factor, tu [[coste]] económico estará equivocado por un factor de casi 4 veces.