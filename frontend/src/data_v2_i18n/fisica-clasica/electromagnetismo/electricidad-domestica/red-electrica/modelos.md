...
- **Cargas moderadas**: Corriente total [[corriente_total_de_linea]] menor que el 80 % del calibre del magnetotérmico [[corriente_maxima_del_circuito]]. Por encima de este umbral, el calor en los cables comienza a ser apreciable y la resistencia del cobre aumenta ligeramente.
...
- **Calentamiento anormal de cables**: Si los conductores se calientan visiblemente sin que [[corriente_total_de_linea]] alcance [[corriente_maxima_del_circuito]], la resistencia del cable ha aumentado por envejecimiento o sección insuficiente.
...
- Se calcula que [[corriente_maxima_del_circuito]] produciría una caída de tensión superior a 10 V en la línea
- Se trabaja con receptores inductivos o capacitivos significativos (motores, transformadores)

El modelo extendido también contempla la **potencia aparente**, distinta de la potencia activa [[potencia_total_conectada]] cuando el factor de potencia es menor que 1. En este caso, la corriente total resulta mayor que la predicha por el modelo ideal, explicando por qué este subestima la corriente real.
...
| **Variables necesarias** | [[potencia_total_conectada]], [[tension_de_red]] | [[potencia_total_conectada]], [[tension_de_red]], factor de potencia, datos del cable |
...
4. **Verificar el margen de seguridad**: Comprobar que la corriente calculada con el modelo extendido mantiene un margen de uso seguro respecto a [[corriente_maxima_del_circuito]].