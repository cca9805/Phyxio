...
Esta ecuación establece que la **corriente total** [[corriente_total_de_linea]] que demanda la instalación es directamente proporcional a la **potencia total conectada** [[potencia_total_conectada]] e inversamente proporcional a la **tensión de red** [[tension_de_red]], que permanece constante a 230 V en el estándar europeo.
...
Donde [[corriente_maxima_del_circuito]] representa el **calibre nominal** del magnetotérmico (16 A, 20 A, 25 A, etc.). Cuando [[margen_uso]] alcanza o supera el valor 1, el circuito está en sobrecarga y la protección debe actuar.
...
El **magnetotérmico** actúa como un **fusible reusable sensible a la corriente**. Cuando la corriente total [[corriente_total_de_linea]] supera el límite [[corriente_maxima_del_circuito]] durante un tiempo suficiente, el calor generado por el efecto Joule en un elemento bimetálico provoca la apertura mecánica del circuito. El parámetro [[margen_uso]], obtenido al dividir [[corriente_total_de_linea]] entre [[corriente_maxima_del_circuito]], es un indicador directo del **riesgo térmico** del cableado.
...
1. **Inventario de potencias**: Suma las potencias nominales [[potencia_total_conectada]] de todos los receptores que podrían funcionar simultáneamente en el circuito.

2. **Cálculo de corriente**: Aplica la fórmula de corriente usando [[tension_de_red]] fija en 230 V. Obtienes la corriente máxima teórica.
...
4. **Selección de calibre**: Elige un magnetotérmico con [[corriente_maxima_del_circuito]] superior a la corriente calculada, seleccionando el valor comercial inmediatamente superior (16, 20, 25 A).

5. **Verificación del margen**: Calcula el margen dividiendo la corriente total entre [[corriente_maxima_del_circuito]]. Si es mayor que 0,8, distribuye la carga o aumenta el calibre si el cableado lo permite.

6. **Verificación de la sección de cable**: Consulta la normativa eléctrica para confirmar que el cable soporta el [[corriente_maxima_del_circuito]] seleccionado.
...
La potencia total máxima [[potencia_total_conectada]] alcanza 5200 W.
...
R: Los motores tienen corriente de arranque 5-7 veces superior a la nominal durante segundos. Si el circuito está cargado, ese pico supera [[corriente_maxima_del_circuito]] momentáneamente.
