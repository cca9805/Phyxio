...
- Contact voltage: [[tension_de_contacto]] = 230 V AC
- Body resistance (wet conditions, IEC 60479 standard): [[resistencia_electrica_del_cuerpo_humano]] = 1,000 Ω
- Installed differential threshold: [[corriente_de_disparo_del_diferencial]] of 30 mA (0.030 A)
- Alternative differential threshold: [[corriente_de_disparo_del_diferencial]] of 10 mA (0.010 A)
- Ventricular fibrillation threshold: [[corriente_de_seguridad_maxima]] = 30 mA
...
The ideal resistive model of electrical safety is applied, which treats the human body as a constant pure resistance [[resistencia_electrica_del_cuerpo_humano]] during contact. The fundamental relationship is Ohm's Law applied to the contact circuit:
...
Body current is [[tension_de_contacto]] divided by [[resistencia_electrica_del_cuerpo_humano]].

For the protection margin:

{{f:margen_proteccion}}

The margin with the 30 mA differential is [[corriente_de_disparo_del_diferencial]] (0.030 A) divided by [[corriente_a_traves_del_cuerpo]]. With the 10 mA differential the numerator changes to 0.010 A.

To evaluate direct physiological risk quantitatively, we use the safety ratio:

{{f:ratio_seguridad}}

The ratio is calculated by dividing [[corriente_a_traves_del_cuerpo]] by [[corriente_de_seguridad_maxima]].

## Numerical substitution

**Part a — Body current:**

Dividing contact voltage (230 V) by body resistance (1000 Ω) gives the current. The result is 0.230 A. Therefore [[corriente_a_traves_del_cuerpo]] ≈ 230 mA.
...
In the bathroom, with [[resistencia_electrica_del_cuerpo_humano]] estimated at 800 Ω (wet skin after showering), direct contact with a 230 V phase would produce [[corriente_a_traves_del_cuerpo]] = 230/800 ≈ 288 mA. This value massively exceeds the 30 mA threshold, and the current already exceeds the residual 15 mA margin available, so the differential would trip at any additional leakage above 15 mA, including body contact itself.
