...
La tensión no interactúa con los tejidos; lo hace la corriente. La tensión solo determina cuánta corriente fluirá dado el camino eléctrico disponible. Un generador de 10 000 V con resistencia interna de 100 MΩ produce 0.1 mA —imperceptible. La red doméstica a 230 V con [[resistencia_electrica_del_cuerpo_humano]] = 1000 Ω produce 230 mA —mortal. La magnitud de daño es [[corriente_a_traves_del_cuerpo]], no [[tension_de_contacto]] directamente.
...
La peligrosidad de un contacto eléctrico se evalúa siempre calculando la corriente resultante: [[corriente_a_traves_del_cuerpo]] = [[tension_de_contacto]] / [[resistencia_electrica_del_cuerpo_humano]]. La tensión es el factor de entrada, no el agente de daño. Una tensión alta con alta impedancia puede ser menos peligrosa que una tensión moderada con baja impedancia.

**Mini-ejemplo de contraste**

Incorrecto: "El cerca eléctrico de 5000 V para ganado es más peligroso que la red doméstica de 230 V." Correcto: el cerca eléctrico libera pulsos de alta tensión pero con energía muy limitada (baja corriente por alta impedancia interna). Una persona sana que lo toca siente un impacto doloroso pero no experimenta fibrilación. La red doméstica a 230 V con [[resistencia_electrica_del_cuerpo_humano]] = 1000 Ω produce 230 mA, 7 veces el umbral de fibrilación.
...
El alumno conoce que el cuerpo humano tiene resistencia eléctrica y que valores más altos limitan la corriente. Si la resistencia "siempre es alta", el peligro siempre sería bajo. Esta lógica es correcta pero ignora cómo varía [[resistencia_electrica_del_cuerpo_humano]] con las condiciones.

**Por qué es incorrecto**

La resistencia corporal no es una constante física: varía por un factor de 100 o más según la condición de la piel. Piel seca puede tener 50 000–100 000 Ω; piel mojada, 500–2 000 Ω. Un alumno que trabaja en el jardín mojado por la lluvia, toca un cable pelado a 230 V y tiene [[resistencia_electrica_del_cuerpo_humano]] = 800 Ω recibirá 287 mA —mortal. El mismo contacto con las manos completamente secas y [[resistencia_electrica_del_cuerpo_humano]] = 80 000 Ω produciría 2.9 mA —apenas perceptible.
...
Para evaluar el riesgo real, siempre usar el valor de [[resistencia_electrica_del_cuerpo_humano]] correspondiente a las condiciones del escenario: 1000 Ω para zonas húmedas (valor normativo IEC 60479 para diseño de protecciones), 5 000 Ω para condiciones normales de trabajo, 50 000 Ω o más solo en condiciones controladas de laboratorio con piel seca.

**Mini-ejemplo de contraste**

Incorrecto: "Con 230 V y resistencia corporal de 50 000 Ω, la corriente es 4.6 mA, completamente segura, no necesito diferencial." Correcto: ese cálculo usa piel seca de laboratorio. En la misma situación con las manos sudadas ([[resistencia_electrica_del_cuerpo_humano]] = 5 000 Ω) la corriente sube a 46 mA, zona de fibrilación posible. El diferencial sí es necesario.
...
El alumno supone que la presencia de un diferencial en el cuadro garantiza que cualquier contacto accidental será inofensivo, sin calcular [[corriente_a_traves_del_cuerpo]] ni el [[margen]] de protección.

**Corrección conceptual**

El diferencial proporciona protección efectiva cuando: (a) su umbral [[corriente_de_disparo_del_diferencial]] supera la corriente de fuga calculada, (b) su tiempo de respuesta es inferior a 30 ms, y (c) el circuito de tierra está en buen estado. El [[margen]] de protección (cociente entre [[corriente_de_disparo_del_diferencial]] e [[corriente_a_traves_del_cuerpo]]) debe ser mayor que 1 para el escenario analizado.

**Mini-ejemplo de contraste**

Incorrecto: "La instalación tiene diferencial de 30 mA, así que un contacto en el baño con la ducha encendida es seguro." Correcto: en el baño con piel mojada [[resistencia_electrica_del_cuerpo_humano]] ≈ 500 Ω y [[tension_de_contacto]] = 230 V, [[corriente_a_traves_del_cuerpo]] = 460 mA. El diferencial de 30 mA dispararía (460 mA > 30 mA), pero la corriente es tan alta que el tiempo de exposición antes del disparo puede ser suficiente para fibrilación. Por eso se requieren diferenciales de 10 mA con tiempo de respuesta < 10 ms en zonas mojadas.
...
La potencia y la corriente están relacionadas por la tensión (la potencia siendo el producto de la tensión por la intensidad de corriente), pero la potencia no mide el riesgo de contacto directo con el conductor. Lo que produce el daño fisiológico es [[corriente_a_traves_del_cuerpo]], que depende de [[tension_de_contacto]] y [[resistencia_electrica_del_cuerpo_humano]], no de la potencia del aparato. Un horno de 2000 W a 230 V consume 8.7 A por su circuito, pero si alguien toca un conductor pelado de ese circuito, la corriente corporal [[corriente_a_traves_del_cuerpo]] se calcula como el cociente entre [[tension_de_contacto]] y [[resistencia_electrica_del_cuerpo_humano]], resultando en 230 mA para una tensión de 230 V y una resistencia de 1000 Ω, valor completamente independiente de los 8.7 A de carga del horno.
...
Para evaluar el riesgo de contacto eléctrico, ignorar la potencia del aparato y calcular siempre [[corriente_a_traves_del_cuerpo]] = [[tension_de_contacto]] / [[resistencia_electrica_del_cuerpo_humano]]. La potencia del aparato determina el calibre del circuito y del magnetotérmico, pero no el riesgo de electrocución en caso de contacto.

**Mini-ejemplo de contraste**

Incorrecto: "El calentador de 50 W a 12 V (corriente 4.2 A) es más peligroso que el calentador de 23 W a 230 V (corriente 0.1 A) porque circula más corriente." Correcto: si alguien toca la fase del calentador de 230 V, [[corriente_a_traves_del_cuerpo]] = 230/1000 = 230 mA (peligroso). Si toca la fase del calentador de 12 V, [[corriente_a_traves_del_cuerpo]] = 12/1000 = 12 mA (molesto pero generalmente no mortal). La tensión de contacto, no la corriente de carga, determina el riesgo.
...
1. **¿Se calculó [[corriente_a_traves_del_cuerpo]] con [[resistencia_electrica_del_cuerpo_humano]] adecuado a las condiciones?** Usar 1000 Ω para zonas húmedas, no el valor de piel seca.
2. **¿Es [[corriente_a_traves_del_cuerpo]] < [[corriente_de_disparo_del_diferencial]] instalado?** Si no, el diferencial no protege en ese escenario.
