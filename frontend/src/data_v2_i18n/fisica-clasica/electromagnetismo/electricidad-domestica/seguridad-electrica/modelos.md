...
En este modelo, las magnitudes conservadas son [[tension_de_contacto]], [[resistencia_electrica_del_cuerpo_humano]] e [[corriente_a_traves_del_cuerpo]], relacionadas por la Ley de Ohm. Las magnitudes ignoradas incluyen la variación temporal de [[resistencia_electrica_del_cuerpo_humano]] durante el contacto, la reactancia inductiva y capacitiva del cuerpo, la resistencia de los zapatos y el suelo, y la impedancia interna de la red. Esta simplificación permite calcular directamente la corriente máxima de peligro usando solo dos parámetros conocidos.

El significado físico de la simplificación central es conservador por diseño: al asumir [[resistencia_electrica_del_cuerpo_humano]] = 1000 Ω (el peor caso normativo) se sobreestima el riesgo. Las protecciones diseñadas con esta hipótesis son válidas para todos los casos reales, incluso aquellos con resistencia más alta.

## Hipótesis

- **Resistencia corporal constante durante el contacto**: [[resistencia_electrica_del_cuerpo_humano]] no varía con el tiempo ni con la corriente. Si se viola, las quemaduras destruyen la piel resistiva y [[resistencia_electrica_del_cuerpo_humano]] disminuye progresivamente, aumentando [[corriente_a_traves_del_cuerpo]] durante la exposición —el modelo subestima el riesgo en contactos prolongados.

- **Tensión de contacto igual a la tensión de red (230 V)**: se asume contacto directo fase-tierra sin caída en impedancias intermedias. Si se viola —contacto indirecto a través de masa con resistencia de tierra— [[tension_de_contacto]] puede ser inferior a 230 V, pero el modelo sigue siendo válido como cota superior de riesgo.
...
- **[[resistencia_electrica_del_cuerpo_humano]] ≥ 500 Ω**: por debajo de este valor (heridas abiertas extensas, mucosas) la hipótesis de resistencia constante deja de ser conservadora y el modelo puede subestimar el riesgo real.
- **[[tension_de_contacto]] entre 50 V y 230 V**: por debajo de 50 V el riesgo es bajo y el modelo sobreestima el peligro de forma segura; por encima de 230 V (sobretensiones transitorias) se requiere modelo extendido.
- **Frecuencia de red 50–60 Hz**: los umbrales IEC 60479 son específicos para esta banda.
- **Tiempo de exposición < 1 s**: el modelo estático es válido. Para exposiciones más largas, la variación de [[resistencia_electrica_del_cuerpo_humano]] con quemaduras y el calentamiento de tejidos requieren modelo dinámico.

La desigualdad de seguridad fundamental es: [[corriente_a_traves_del_cuerpo]] < [[corriente_de_seguridad_maxima]], con [[corriente_de_seguridad_maxima]] = 30 mA para uso doméstico general.

## Señales de fallo del modelo

- **Corriente calculada muy superior a 230 mA**: con 230 V y [[resistencia_electrica_del_cuerpo_humano]] ≥ 1000 Ω, el máximo teórico es 230 mA. Si el cálculo supera este valor, los datos de entrada son inconsistentes con el modelo doméstico estándar.
...
|---|---|---|
| **Parámetro corporal** | [[resistencia_electrica_del_cuerpo_humano]] constante (1000 Ω) | Impedancia variable con frecuencia |
