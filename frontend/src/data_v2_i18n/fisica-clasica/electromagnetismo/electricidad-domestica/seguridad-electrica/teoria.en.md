...
where [[corriente_a_traves_del_cuerpo]] is the current flowing through the body (in amperes), [[tension_de_contacto]] is the contact voltage (in volts), and [[resistencia_electrica_del_cuerpo_humano]] is the electrical resistance of the body (in ohms).

The normative reference value for [[resistencia_electrica_del_cuerpo_humano]] is 1000 Ω (according to international standard IEC 60479), representing the worst case with wet skin. With 230 V and this resistance, the theoretical body current would reach 230 mA, massively exceeding the fibrillation threshold.

The evaluation of the installed differential's protection level is quantified by the margin:

{{f:margen_proteccion}}

where [[corriente_de_disparo_del_diferencial]] is the threshold of the installed differential device. The [[margen]] is a dimensionless quantity; a value greater than 1 indicates effective protection, while less than 1 indicates an unmitigated risk.

To evaluate direct biological risk on the organism against the tolerable limit, the physiological safety ratio is used:

{{f:ratio_seguridad}}

where [[ratio_seguridad]] is the safety ratio and [[corriente_de_seguridad_maxima]] is the safe limit current (30 mA). If [[ratio_seguridad]] exceeds unity, the body current surpasses the physiological safety threshold for ventricular protection.

The physiological thresholds of [[corriente_de_seguridad_maxima]] established by standard IEC 60479 are:
...
**Temporal dependence of resistance.** Body resistance decreases with exposure time. Electrical burns progressively destroy the skin's resistive layer, reducing [[resistencia_electrica_del_cuerpo_humano]] during contact. This creates a dangerous positive feedback: longer contact time leads to lower resistance and higher body current. The fast RCD response (under 30 ms) stops this lethal cycle before it develops.

**Anatomical path and cardiac risk.** Fibrillation risk depends on the fraction of [[corriente_a_traves_del_cuerpo]] crossing the heart. The left hand-to-feet path is the most dangerous because it crosses the cardiac muscle directly. Paths like hand-to-hand are also critical, while right hand-to-feet presents a slightly lower but still lethal cardiac risk.
...
Any calculation producing [[corriente_a_traves_del_cuerpo]] above 300 mA with domestic voltage indicates an [[resistencia_electrica_del_cuerpo_humano]] below 770 Ω, which is physically and physiologically implausible except in the presence of open wounds or direct mucous contact.

## Personalized resolution method

To evaluate electrical risk in a contact scenario:

1. **Identify contact voltage** [[tension_de_contacto]]: determine if it is direct phase contact (230 V) or indirect contact through a faulty enclosure.
2. **Estimate body resistance** [[resistencia_electrica_del_cuerpo_humano]]: classify the environment as dry (above 10,000 Ω), wet (1000 to 5000 Ω), or damp (below 1000 Ω).
3. **Calculate body current** [[corriente_a_traves_del_cuerpo]] as the ratio between [[tension_de_contacto]] and [[resistencia_electrica_del_cuerpo_humano]].
4. **Evaluate danger level** by comparing [[corriente_a_traves_del_cuerpo]] with IEC 60479 standard thresholds.
5. **Calculate the safety ratio** [[ratio_seguridad]] by dividing [[corriente_a_traves_del_cuerpo]] by [[corriente_de_seguridad_maxima]] (30 mA) and the protection [[margen]] by dividing [[corriente_de_disparo_del_diferencial]] by [[corriente_a_traves_del_cuerpo]].
