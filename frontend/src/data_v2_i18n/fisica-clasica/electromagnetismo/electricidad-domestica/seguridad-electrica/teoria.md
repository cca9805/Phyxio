...
donde [[corriente_a_traves_del_cuerpo]] es la corriente que circula por el cuerpo (en amperios), [[tension_de_contacto]] es la tensión de contacto (en voltios) y [[resistencia_electrica_del_cuerpo_humano]] es la resistencia eléctrica del cuerpo (en ohmios).

El valor normativo de referencia para [[resistencia_electrica_del_cuerpo_humano]] es de 1000 Ω (según la norma IEC 60479), que representa el peor caso con piel húmeda. Con 230 V y esta resistencia, la corriente corporal teórica alcanzaría los 230 mA, superando masivamente el umbral de fibrilación.

La evaluación del nivel de protección del diferencial instalado se cuantifica mediante el [[margen]]:

{{f:margen_proteccion}}

donde [[corriente_de_disparo_del_diferencial]] es el umbral de disparo del interruptor diferencial instalado. El [[margen]] es una cantidad adimensional; un valor mayor que 1 indica protección efectiva, mientras que menor que 1 señala un riesgo no mitigado.
...
donde [[ratio_seguridad]] es el cociente de seguridad y [[corriente_de_seguridad_maxima]] es la corriente límite segura (30 mA). Si [[ratio_seguridad]] supera la unidad, la corriente corporal rebasa el umbral fisiológico de seguridad ventricular.

Los umbrales fisiológicos de [[corriente_de_seguridad_maxima]] establecidos por la norma IEC 60479 son:
...
Cualquier cálculo que produzca [[corriente_a_traves_del_cuerpo]] por encima de 300 mA con tensión doméstica indica una [[resistencia_electrica_del_cuerpo_humano]] inferior a 770 Ω, algo física y fisiológicamente inverosímil salvo en presencia de heridas abiertas o contacto directo con mucosas.

## Método de resolución personalizado

Para evaluar el riesgo eléctrico en un escenario de contacto:

1. **Identificar la tensión de contacto** [[tension_de_contacto]]: determinar si es contacto directo de fase (230 V) o indirecto a través de una masa defectuosa.
2. **Estimar la resistencia corporal** [[resistencia_electrica_del_cuerpo_humano]]: clasificar el entorno en seco (mayor a 10 000 Ω), húmedo (1000 a 5000 Ω) o mojado (menor a 1000 Ω).
3. **Calcular la corriente corporal** [[corriente_a_traves_del_cuerpo]] como cociente entre [[tension_de_contacto]] y [[resistencia_electrica_del_cuerpo_humano]].
4. **Evaluar el nivel de peligro** comparando [[corriente_a_traves_del_cuerpo]] con los umbrales de la norma IEC 60479.
5. **Calcular el cociente de seguridad** [[ratio_seguridad]] dividiendo [[corriente_a_traves_del_cuerpo]] entre [[corriente_de_seguridad_maxima]] (30 mA) y el [[margen]] de protección dividiendo [[corriente_de_disparo_del_diferencial]] entre [[corriente_a_traves_del_cuerpo]].
