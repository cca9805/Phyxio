...
The analysis is based on the fundamental relationship between [[potencia_electrica]], [[tension_electrica]] and [[intensidad_de_corriente]], where total simultaneous power determines whether the contracted limit is exceeded. For a home with multiple high-power appliances (oven 2000 W, washing machine 1500 W, water heater 1200 W), the arithmetic sum 4700 W would typically exceed contracted power of 3450 W (15 A).
...
Energy education exploits human optimization capacity when complete information is provided. Instantaneous power [[potencia_electrica]] is the temporal derivative of energy; integrated over usage time [[t_h]] it produces the consumed energy [[energia_consumida]]. Multiplying by unit tariff yields the direct monetary cost of the consumption act.
...
- Real-time energy monitors showing instantaneous [[potencia_electrica]] and accumulated daily [[energia_consumida]].
...
2. Calculate individual current for each appliance by dividing its [[potencia_electrica]] by 230 V. Result in amperes.
3. Estimate realistic simultaneity (e.g., kitchen: oven + ceramic hob + microwave never 100% simultaneous).
4. Calculate maximum simultaneous [[intensidad_de_corriente]] per circuit.
5. Compare against [[intensidad_de_corriente]] nominal of circuit breaker and cable cross-section (1.5 mm² → ~16 A, 2.5 mm² → ~25 A).
