...
In domestic electrical installations, the physical relationship is inverted: resistance limits current according to Ohm's law [[intensidad_de_corriente]] = [[tension_electrica]]/[[resistencia_electrica]]. At a fixed voltage of 230 V, a resistance of 1000 Ω limits current to 0.23 A (safe and insignificant), while a resistance of 5 Ω allows 46 A (extremely dangerous for standard 16 A circuits). Dissipated power also follows [[potencia_electrica]] = [[tension_electrica]]²/[[resistencia_electrica]], being inversely proportional to resistance.
...
In domestic electricity, "low resistance" is the danger, not "high resistance." Always calculate [[intensidad_de_corriente]] = 230/[[resistencia_electrica]] immediately when evaluating a resistance. Interpret the result: I < 0.5 A is safe, I > 10 A requires verification, I > 20 A is dangerous for standard installations.
...
Electrical safety depends on current [[intensidad_de_corriente]], not directly on power [[potencia_electrica]]. A power of 2000 W at 230 V implies 8.7 A (safe for a 16 A circuit), but the same power at 12 V implies 167 A (dangerous even for thick cables). Additionally, instantaneous power ignores duty cycles: a refrigerator labeled "150 W" has a 300 W compressor operating at 50% duty cycle.
...
Power is a consequence, not a direct cause of safety. Always calculate [[intensidad_de_corriente]] by dividing [[potencia_electrica]] by [[tension_electrica]] and compare with the circuit limit (10 A, 16 A, etc.). For energy, obtain [[energia_consumida]] by multiplying [[potencia_en_kilovatios]] by [[t_h]].
...
For inductive loads (motors > 100 W, transformers, industrial luminaires), size by apparent current: divide [[potencia_electrica]] by the power factor cos φ. Check the power factor on the equipment nameplate (typically 0.7-0.9 for domestic motors). Apply correction when reactive power is significant (> 20% of active).
...
The relationship between [[potencia_electrica]], [[tension_electrica]] and [[intensidad_de_corriente]] requires [[potencia_electrica]] in W, [[tension_electrica]] in V, [[intensidad_de_corriente]] in A for consistency. Mixing kW with V produces kA (1000× error). Using W with h for energy produces Wh (correct) but expressing it as kWh requires division by 1000. Omitted conversions generate catastrophic magnitude errors.
...
Power [[potencia_electrica]] is an instantaneous rate (watts, equivalent to joules per second). Energy [[energia_consumida]] is the temporal integral of power (Wh means watts multiplied by hours). Multiplying power by time gives energy, but comparing P directly with E is comparing speed with distance traveled. This produces cost estimates incorrect by factor 10-100.
...
Power is "consumption rate" (W). Energy is "accumulated consumption" (Wh or kWh). For costs, always use energy: obtain [[energia_consumida]] by multiplying [[potencia_en_kilovatios]] by [[t_h]]. Verify that resulting units are of energy, not power.
...
Theoretical calculations typically use the appliance load resistance ([[resistencia_electrica]]), ignoring the resistance of connection cables. This simplification seems valid because installation cables (1.5-2.5 mm² copper) have apparently insignificant resistance compared to loads of 10-100 Ω.
...
1. **SI Conversion:** Verify that [[potencia_electrica]] is in W (not kW), [[tension_electrica]] in V, [[resistencia_electrica]] in Ω. Convert if necessary.

2. **Current Calculation:** Divide [[potencia_electrica]] by [[tension_electrica]] (if power is known), or divide [[tension_electrica]] by [[resistencia_electrica]] (if resistance is known). Result in amperes.
...
4. **Safety Comparison:** Is calculated [[intensidad_de_corriente]] < 80% of rating? If not, requires different circuit or simultaneity management.

5. **Resistance Check:** If starting from [[resistencia_electrica]], is [[resistencia_electrica]] > 10 Ω? If [[resistencia_electrica]] < 10 Ω, explicitly verify it is not a short circuit or defective load.
...
- ⚠️ [[intensidad_de_corriente]] > 100% of circuit rating → Immediate danger, connection prohibited
- ⚠️ [[intensidad_de_corriente]] > 80% of rating → Caution, requires additional verification
- ⚠️ [[resistencia_electrica]] < 10 Ω without explicit manufacturer certification → Potential short circuit
