...
### Error 1: Creer que la capacidad [[capacidad_electrica]] cambia cuando cambia la tensión [[diferencia_de_potencial]]

**Por qué parece correcto**

El alumno observa que al aumentar la tensión, también aumenta la carga [[carga_almacenada]] almacenada. Por analogía con la ley de Ohm (donde la corriente cambia con la tensión y con la resistencia), concluye que la capacidad también debe cambiar, porque "algo tiene que cambiar en el condensador" para almacenar más carga.

**Por qué es incorrecto**

La capacidad [[capacidad_electrica]] es una propiedad geométrica y material del condensador: depende del área de las armaduras, de la separación y de la permitividad del dieléctrico. Ninguno de esos factores cambia al variar la tensión aplicada (en el modelo ideal). Lo único que cambia es [[carga_almacenada]], que aumenta proporcionalmente con [[diferencia_de_potencial]] para [[capacidad_electrica]] constante.

**Señal de detección**

El alumno calcula el cociente [[carga_almacenada]]/[[diferencia_de_potencial]] para dos tensiones diferentes y obtiene valores distintos, luego afirma que [[capacidad_electrica]] del condensador cambió. Si los valores obtenidos son idénticos (como deben ser), el error ya no está presente.

**Corrección conceptual**

La capacidad [[capacidad_electrica]] es constante para un condensador dado en régimen lineal. La relación entre [[carga_almacenada]], [[capacidad_electrica]] y [[diferencia_de_potencial]] es lineal: [[carga_almacenada]] varía con [[diferencia_de_potencial]], pero el coeficiente de proporcionalidad [[capacidad_electrica]] es fijo. Solo cambia [[capacidad_electrica]] si se modifica físicamente el condensador (área, separación, dieléctrico).
...
La definición de [[capacidad_electrica]] usa [[carga_almacenada]] como un valor positivo. El alumno interpreta que "el condensador tiene carga Q" en toda su estructura, sin distinguir entre las dos armaduras. Además, la batería "mete" carga en el circuito, lo que sugiere que toda la carga va al condensador de forma uniforme.
...
Antes de aplicar la fórmula de [[capacidad_geometrica_del_condensador_plano]] con [[epsilon]], el área y la separación, verificar que d es al menos 10–20 veces menor que la dimensión lateral menor de la placa. Si no se cumple, la fórmula subestima la capacidad real y debe emplearse un modelo con corrección de borde o una simulación numérica.
...
El factor 1/2 en [[energia_almacenada_en_el_condensador]] no es opcional: surge de integrar el trabajo de carga desde tensión cero hasta el valor final. Durante la carga, la tensión va creciendo progresivamente y el trabajo en cada instante depende de la carga acumulada dividida por [[capacidad_electrica]]; la integral total da [[carga_almacenada]]²/(2·[[capacidad_electrica]]). Omitir el 1/2 dobla la energía calculada respecto a la real.
...
La fórmula correcta de [[energia_almacenada_en_el_condensador]] incluye el factor 1/2 multiplicando el producto de [[capacidad_electrica]] por [[diferencia_de_potencial]]². Existen tres expresiones equivalentes: con [[capacidad_electrica]] y [[diferencia_de_potencial]], con [[carga_almacenada]] y [[diferencia_de_potencial]], o con [[carga_almacenada]] y [[capacidad_electrica]]. El factor 1/2 refleja que la tensión promedio durante la carga es la mitad del valor final.
...
1. **Factor 1/2 en energía**: ¿La fórmula de [[energia_almacenada_en_el_condensador]] incluye el factor 1/2 multiplicando [[capacidad_electrica]] por [[diferencia_de_potencial]]² o [[carga_almacenada]] por [[diferencia_de_potencial]]? Si falta el factor 1/2, hay un error seguro.
...
3. **Consistencia entre [[carga_almacenada]], [[capacidad_electrica]] y [[diferencia_de_potencial]]**: ¿el producto de [[capacidad_electrica]] por [[diferencia_de_potencial]] coincide con [[carga_almacenada]]? Si no, alguno de los tres está mal calculado o mal introducido.
