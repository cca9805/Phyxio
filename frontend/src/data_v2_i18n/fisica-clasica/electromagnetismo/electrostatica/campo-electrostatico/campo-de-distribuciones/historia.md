...
El obstáculo intelectual fundamental era la ausencia de una noción operativa de **densidad de carga continua**. La electricidad se concebía como un fluido que habitaba en los cuerpos, sin que existiera una descripción matemática precisa de cómo se repartía. Sin la noción de [[lambda]], [[sigma]] o [[rho_vol]] como funciones del espacio, no era posible formular el integrando de [[contribucion_diferencial_de_campo]].
...
Siméon Denis Poisson fue el primero en formular, entre 1812 y 1813, la teoría matemática completa del potencial de distribuciones continuas. Introdujo explícitamente la densidad volumétrica [[rho_vol]] como función del espacio, estableció la ecuación diferencial que lleva su nombre — que conecta la distribución de carga con el potencial eléctrico — y demostró que la integración de [[contribucion_diferencial_de_campo]] sobre toda la distribución producía el campo resultante [[campo_electrico_resultante]] por superposición. Este avance transformó el cálculo del campo eléctrico de un problema físico vago en un procedimiento matemático sistemático.

Carl Friedrich Gauss complementó este avance en 1835 con su ley del flujo: el flujo de [[campo_electrico_resultante]] a través de cualquier superficie cerrada es proporcional a la carga total encerrada. Esta formulación es matemáticamente equivalente a la integración directa de [[contribucion_diferencial_de_campo]], pero aprovecha la simetría geométrica de forma mucho más eficiente para hilo infinito, plano infinito y esfera.
...
James Clerk Maxwell unificó este resultado en 1865: la primera de sus ecuaciones en forma diferencial, que conecta la divergencia de [[campo_electrico_resultante]] con [[rho_vol]] dividida entre ε₀, es la forma local de la ley de Gauss. Esta ecuación no es solo un resultado de electrostática: es el punto de partida de toda la teoría clásica del electromagnetismo y de la óptica electromagnética.
...
En física de plasmas y astrofísica, las distribuciones de carga continua modeladas con [[rho_vol]] describen desde el interior de una estrella de neutrones hasta la ionosfera terrestre. La misma integral de [[contribucion_diferencial_de_campo]] que Poisson formuló para barras de laboratorio sigue siendo la base del cálculo de campos en entornos de cientos de miles de grados kelvin y densidades de millones de coulombios por metro cúbico.