...
Estos valores pequeños de [[diferencia_de_potencial]] son suficientes para activar los canales iónicos de la membrana, que permiten el flujo de iones Na⁺ y K⁺. La membrana celular tiene un espesor de unos 7 nm, de modo que el campo eléctrico dentro de ella alcanza el orden de 10⁷ N/C, un valor extraordinariamente intenso a escala molecular aunque [[diferencia_de_potencial]] sea mínima. Esta relación entre [[diferencia_de_potencial]] y [[distancia_entre_puntos]] revela por qué la biología opera con voltajes bajos pero campos muy altos.
...
La relación entre [[trabajo_electrico]], [[carga_de_prueba]] y [[diferencia_de_potencial]] convierte directamente la diferencia de potencial en energía de la partícula: una diferencia de potencial de 1 kV aplicada a un electrón le confiere 1 keV de energía cinética, equivalente a 1.6×10⁻¹⁶ J. Los aceleradores modernos encadenan múltiples etapas de aceleración, cada una contribuyendo con su [[diferencia_de_potencial]] a la energía total. La velocidad final crece como la raíz cuadrada de [[diferencia_de_potencial]], lo que explica la necesidad de megavoltios para alcanzar velocidades relativistas.
...
Límite de validez: el modelo clásico de aceleración mediante [[diferencia_de_potencial]] es válido para energías inferiores a 511 keV; por encima, la relatividad especial corrige significativamente la relación entre [[diferencia_de_potencial]] y la velocidad adquirida.

## 4. Sensores de efecto Hall

El efecto Hall genera una diferencia de potencial transversal [[diferencia_de_potencial]] cuando una corriente eléctrica fluye por un conductor o semiconductor en presencia de un campo magnético perpendicular. Esta diferencia de potencial, llamada voltaje Hall, es proporcional al campo magnético y a la corriente, e inversamente proporcional a la densidad de portadores de carga del material.

Los sensores Hall miden campos magnéticos con alta precisión midiendo [[diferencia_de_potencial]] en el material semiconductor. Se usan en codificadores de posición angular en motores y robótica, en detectores de velocidad de ruedas en sistemas ABS de automóviles, y en instrumentos de medida de corriente continua sin interrumpir el circuito. La ventaja clave es que [[diferencia_de_potencial]] Hall puede medirse con precisión submilimétrica sin contacto mecánico con el objeto en movimiento.
...
Límite de validez: el modelo lineal de [[diferencia_de_potencial]] Hall es válido para campos magnéticos por debajo de la saturación magnética del material y temperaturas de operación en las que la densidad de portadores no varía significativamente.

## 5. Condensadores y almacenamiento de energía pulsada

Los condensadores son los dispositivos más directamente asociados con la diferencia de potencial en ingeniería eléctrica. La energía almacenada en un condensador crece con el cuadrado de [[diferencia_de_potencial]] entre sus armaduras, lo que hace que duplicar la diferencia de potencial cuadruplique la energía almacenada. El campo eléctrico entre las placas se obtiene dividiendo [[diferencia_de_potencial]] entre la separación [[distancia_entre_puntos]].
