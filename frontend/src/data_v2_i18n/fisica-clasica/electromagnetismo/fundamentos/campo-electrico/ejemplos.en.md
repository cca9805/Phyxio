...
The system consists of a fixed point charge [[q_fuente]] at the origin and an evaluation point located at distance [[distancia_a_la_carga_fuente]] from the origin. The test charge [[q_0]] is small enough not to disturb the source charge distribution. Magnetic effects are not considered (pure electrostatics), nor are conductors or dielectrics in the environment. The field direction follows the line connecting the source charge to the evaluation point.

## Physical model

The point-charge model in vacuum is applied: the field [[campo_electrico]] at any point in space depends only on [[q_fuente]], [[k_e]], and [[distancia_a_la_carga_fuente]] via Coulomb's law. The force [[fuerza_electrica]] on the test charge [[q_0]] is obtained from [[campo_electrico]] by applying the operational definition of the field. The superposition principle is not needed because there is only one source charge.
...
The magnitude of the electric field at the point at distance [[distancia_a_la_carga_fuente]] from [[q_fuente]] is obtained by applying:

{{f:campo_electrico_coulomb}}

Once the field [[campo_electrico]] is computed, the force on the test charge [[q_0]] placed at that point is obtained by rearranging the definition:

{{f:campo_electrico_definicion}}

from which the force is the product of [[campo_electrico]] and [[q_0]]. For the sensitivity analysis: if [[distancia_a_la_carga_fuente]] is doubled, the denominator of Coulomb's formula increases by a factor of four, so [[campo_electrico]] decreases to one quarter of its original value.

## Numerical substitution

To compute the field magnitude, [[k_e]] of 8.988×10⁹ N·m²·C⁻², [[q_fuente]] of 5×10⁻⁶ C, and [[distancia_a_la_carga_fuente]] of 0.30 m are entered. The numerator is the product of 8.988×10⁹ and 5×10⁻⁶, giving 44 940 N·m²/C. The denominator is the square of 0.30 m, i.e. 0.09 m². Dividing both, [[campo_electrico]] is approximately 499 333 N/C, rounded to three significant figures approximately 499 000 N/C.

For the force on [[q_0]]: multiplying the field of 499 000 N/C by the test charge of 2×10⁻⁹ C, [[fuerza_electrica]] is approximately 9.98×10⁻⁴ N, i.e. approximately 1 mN.
...
The sensitivity analysis reveals the most important consequence of the inverse-square law: doubling the distance does not halve [[campo_electrico]] but reduces it to one quarter. This means the field of a point charge is concentrated near the source and decays rapidly. Therefore, an engineer designing an ion trap or a particle accelerator must account for this nonlinearity: moving slightly away from the source drastically reduces the field influence. If the distance were tripled, the field would fall to one ninth of its original value.
...
Consider the tip of a lightning rod as a point charge [[q_fuente]] of typical value 10 nC concentrated within an effective radius of 1 mm. At a distance [[distancia_a_la_carga_fuente]] of 1 mm from the tip, the field is estimated using Coulomb's formula. With [[k_e]] of 8.988×10⁹ N·m²·C⁻² and [[q_fuente]] of 10⁻⁸ C, the numerator is 8.988×10⁹ times 10⁻⁸, giving 89.88 N·m²/C. The denominator is the square of 10⁻³ m, i.e. 10⁻⁶ m². The resulting field [[campo_electrico]] is approximately 89 880 000 N/C, i.e. on the order of 90 MN/C.
