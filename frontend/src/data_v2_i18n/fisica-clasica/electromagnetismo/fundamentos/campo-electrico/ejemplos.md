...
El sistema consiste en una carga puntual [[q_fuente]] fija en el origen y un punto de evaluación situado a distancia [[distancia_a_la_carga_fuente]] del origen. La carga de prueba [[q_0]] es suficientemente pequeña para no perturbar la distribución de carga fuente. No se consideran efectos magnéticos (electrostática pura), ni la presencia de conductores o dieléctricos en el entorno. La dirección del campo sigue la línea que une la carga fuente con el punto de evaluación.

## Modelo físico

Se aplica el modelo de carga puntual en vacío: el campo [[campo_electrico]] en cualquier punto del espacio depende únicamente de [[q_fuente]], de [[k_e]] y de [[distancia_a_la_carga_fuente]] mediante la ley de Coulomb. La fuerza [[fuerza_electrica]] sobre la carga de prueba [[q_0]] se obtiene a partir de [[campo_electrico]] aplicando la definición operativa del campo. El principio de superposición no es necesario porque solo hay una carga fuente.
...
El módulo del campo eléctrico en el punto a distancia [[distancia_a_la_carga_fuente]] de [[q_fuente]] se obtiene aplicando:

{{f:campo_electrico_coulomb}}

Una vez calculado el campo [[campo_electrico]], la fuerza sobre la carga de prueba [[q_0]] colocada en ese punto se obtiene despejando de la definición:

{{f:campo_electrico_definicion}}

de donde la fuerza es el producto de [[campo_electrico]] por [[q_0]]. Para el análisis de sensibilidad: si [[distancia_a_la_carga_fuente]] se duplica, el denominador de la fórmula de Coulomb aumenta un factor de cuatro, por lo que [[campo_electrico]] disminuye a una cuarta parte de su valor original.

## Sustitución numérica

Para calcular el módulo del campo, se introduce [[k_e]] de 8.988×10⁹ N·m²·C⁻², [[q_fuente]] de 5×10⁻⁶ C y [[distancia_a_la_carga_fuente]] de 0.30 m. El numerador es el producto de 8.988×10⁹ por 5×10⁻⁶, que da 44 940 N·m²/C. El denominador es el cuadrado de 0.30 m, es decir, 0.09 m². Dividiendo ambos, [[campo_electrico]] resulta aproximadamente 499 333 N/C, que redondeando a tres cifras significativas es aproximadamente 499 000 N/C.

Para la fuerza sobre [[q_0]]: multiplicando el campo de 499 000 N/C por la carga de prueba de 2×10⁻⁹ C, [[fuerza_electrica]] resulta aproximadamente 9.98×10⁻⁴ N, es decir, aproximadamente 1 mN.

Para el caso de [[distancia_a_la_carga_fuente]] duplicado a 60 cm: el denominador pasa a ser el cuadrado de 0.60 m, es decir, 0.36 m². El nuevo campo resulta aproximadamente 124 833 N/C, que es exactamente una cuarta parte del valor original, confirmando la dependencia cuadrática inversa.
...
Considérese la punta de un pararrayos como una carga puntual [[q_fuente]] de valor típico 10 nC acumulada en un radio efectivo de 1 mm. A una distancia [[distancia_a_la_carga_fuente]] de 1 mm de la punta, el campo se estima aplicando la fórmula de Coulomb. Con [[k_e]] de 8.988×10⁹ N·m²·C⁻² y [[q_fuente]] de 10⁻⁸ C, el numerador es 8.988×10⁹ por 10⁻⁸, que da 89.88 N·m²/C. El denominador es el cuadrado de 10⁻³ m, es decir, 10⁻⁶ m². El campo resultante [[campo_electrico]] es aproximadamente 89 880 000 N/C, es decir, del orden de 90 MN/C.
