...
- **Carga puntual**: el tamaño físico de la carga fuente es despreciable frente a la distancia [[distancia_a_la_carga_fuente]] de evaluación. Si se viola esta hipótesis (objeto extendido a distancia comparable a su tamaño), el campo real diverge del modelo puntual y hay que integrar contribuciones elementales.
...
- El campo calculado crece al reducir [[distancia_a_la_carga_fuente]] sin límite: el modelo puntual predice un campo infinito en [[distancia_a_la_carga_fuente]] tendiendo a cero, lo que en la práctica indica que la escala de evaluación ha alcanzado el tamaño real del objeto cargado.
