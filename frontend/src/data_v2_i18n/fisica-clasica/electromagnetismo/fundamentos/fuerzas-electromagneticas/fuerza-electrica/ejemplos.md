...
La primera esfera actúa como [[q1]] (carga fuente) y la segunda como [[q2]] (carga receptora). La distancia [[distancia_entre_cargas]] es la separación entre centros.

## Modelo físico

El modelo aplicable es la **ley de Coulomb para cargas puntuales** en el vacío. Las magnitudes núcleo son [[q1]], [[q2]] y [[distancia_entre_cargas]], y la magnitud resultado es [[fuerza_electrica_de_coulomb]]. El campo eléctrico [[campo_electrico_de_carga_puntual]] creado por [[q1]] en el punto de [[q2]] se calcula a partir de la segunda fórmula del leaf.
...
Aplicando la ley de Coulomb para obtener [[fuerza_electrica_de_coulomb]]:
...
En este cálculo [[q1]] es la carga fuente y [[distancia_entre_cargas]] es la misma distancia de separación. El resultado [[campo_electrico_de_carga_puntual]] es positivo porque [[q1]] es positiva (el campo apunta hacia fuera de [[q1]]).
...
Dividiendo: [[fuerza_electrica_de_coulomb]] es aproximadamente −215.7×10⁻³ / 0.0144, lo que da [[fuerza_electrica_de_coulomb]] ≈ −15.0 N.

Para el campo eléctrico: el numerador es 8.988×10⁹ × 4.0×10⁻⁶, que da aproximadamente 35952 N·m²/C. Dividiendo entre (0.12)² da [[campo_electrico_de_carga_puntual]] ≈ 35952 / 0.0144 ≈ 2496 kN/C, es decir, [[campo_electrico_de_carga_puntual]] ≈ 2.50×10⁶ N/C.

## Validación dimensional

Para [[fuerza_electrica_de_coulomb]]: la constante [[k_e]] tiene unidades `[M L³ T⁻⁴ I⁻²]`, las cargas tienen unidades `[I T]` cada una, y la distancia al cuadrado tiene unidades `[L²]`. El cociente resulta en `[M L³ T⁻⁴ I⁻²] · [I T]² / [L²]`, que se reduce a `[M L T⁻²]`, es decir, newtons. ✓

Para [[campo_electrico_de_carga_puntual]]: el cociente da unidades `[M L T⁻⁴ I⁻²] · [I T] / [L²]`, que se reduce a `[M L T⁻³ I⁻¹]`, es decir, N/C. ✓

## Interpretación física

El resultado [[fuerza_electrica_de_coulomb]] ≈ −15.0 N indica que la fuerza es **atractiva**: la segunda esfera es atraída hacia la primera con una intensidad de 15 N. Este valor es considerable: equivale a sostener un peso de aproximadamente 1.5 kg. Para cargas de solo unas pocas microcoulombios a 12 cm de distancia, este resultado ilustra la enorme intensidad de la fuerza eléctrica comparada con la gravitatoria a escala de laboratorio.
...
El campo eléctrico [[campo_electrico_de_carga_puntual]] ≈ 2.50×10⁶ N/C es una propiedad de la primera esfera en ese punto del espacio, independiente de la segunda. Si [[q2]] fuera el doble (−12 µC en lugar de −6 µC), [[fuerza_electrica_de_coulomb]] también sería el doble (≈ −30.0 N), pero [[campo_electrico_de_carga_puntual]] no cambiaría porque solo depende de [[q1]] y de [[distancia_entre_cargas]]. Esta diferencia entre [[fuerza_electrica_de_coulomb]] y [[campo_electrico_de_carga_puntual]] es el núcleo conceptual del leaf.
...
Convirtiendo: [[q1]] del electrodo equivale a 2.0×10⁻⁴ C; [[q2]] de la partícula equivale a −5.0×10⁻¹⁰ C; [[distancia_entre_cargas]] de 5 cm equivale a 0.05 m.

Aplicando la ley de Coulomb: el numerador es 8.988×10⁹ × 2.0×10⁻⁴ × (−5.0×10⁻¹⁰), que da aproximadamente −8.988×10⁻⁴ N·m². El denominador es (0.05)², es decir, 2.5×10⁻³ m². La fuerza [[fuerza_electrica_de_coulomb]] es del orden de −8.988×10⁻⁴ / 2.5×10⁻³, lo que da [[fuerza_electrica_de_coulomb]] ≈ −0.36 N.
...
Si la distancia [[distancia_entre_cargas]] se redujera a la mitad (2.5 cm), [[fuerza_electrica_de_coulomb]] se cuadruplicaría (≈ 1.44 N), aumentando la aceleración en el mismo factor. Este comportamiento cuadrático **describe** cómo los electrodos cónicos o con geometría convergente concentran la fuerza en la zona de captura.