...
Two particles with non-zero [[q1]] and [[q2]] attract or repel each other. If both carry the same type of charge, the force [[fuerza_electrica_de_coulomb]] pushes them apart; if they carry opposite types, the force pulls them together. This behaviour is universal and requires no contact between the particles: it acts at a distance.

The strength of that action depends on how large [[q1]] and [[q2]] are, and on how far apart they sit. The most important intuitive point is that **doubling the distance does not halve the force — it reduces it to one quarter**: the dependence on [[distancia_entre_cargas]] is quadratic.
...
The mathematical relation between [[fuerza_electrica_de_coulomb]], [[q1]], [[q2]] and [[distancia_entre_cargas]] is **Coulomb's law**:

{{f:fuerza_coulomb}}

where [[k_e]] is the Coulomb constant, whose value in vacuum is approximately 8.988×10⁹ N·m²·C⁻². The formula shows that [[fuerza_electrica_de_coulomb]] is **proportional to the product of the charges** and **proportional to the inverse square of the distance**.

The sign of [[fuerza_electrica_de_coulomb]] follows directly from the product \([[q1]] \cdot [[q2]]\): if both charges are positive or both are negative, the product is positive and the force is repulsive; if they have opposite signs, the product is negative and the force is attractive.

From Coulomb's law one derives directly the **electric field** created by [[q1]] at any point in space. At the point where [[q2]] sits, at distance [[distancia_entre_cargas]], that field equals:

{{f:campo_electrico_coulomb}}

The conceptual difference between [[fuerza_electrica_de_coulomb]] and [[campo_electrico_de_carga_puntual]] is fundamental: [[campo_electrico_de_carga_puntual]] is a property of space created by [[q1]] that exists even without [[q2]]. The force [[fuerza_electrica_de_coulomb]] requires both charges; the field [[campo_electrico_de_carga_puntual]] requires only [[q1]].
...
The field structure created by a point charge is **radially symmetric**: [[campo_electrico_de_carga_puntual]] has the same magnitude at all points at the same distance [[distancia_entre_cargas]], and points radially outward (for positive [[q1]]) or inward (for negative [[q1]]). This symmetry is what allows Gauss's law to be applied simply for spherical, cylindrical, or planar distributions with high symmetry.

The most relevant limiting behaviour is the **electric potential energy** associated with the Coulomb force. Because the force is conservative (its work depends only on the initial and final positions, not on the path), there exists a potential energy function proportional to the product of [[q1]] by [[q2]] divided by [[distancia_entre_cargas]] and scaled by [[k_e]]. This energy function is the foundation of electric potential and connects Coulomb's law to all of electrostatic potential theory.

## Deep physical interpretation

The sign of [[fuerza_electrica_de_coulomb]] is not just an algebraic convention: it is direct physical information. When substituting into the formula gives a negative result, the system is **energetically favourable** for approaching: the force does positive work as [[distancia_entre_cargas]] decreases, which translates into a reduction in potential energy. When the result is positive, separating the charges requires external work.
...
For the electron–proton system in the hydrogen atom, with charges of ±1.6×10⁻¹⁹ C and distance 0.53×10⁻¹⁰ m, [[fuerza_electrica_de_coulomb]] is of order 8×10⁻⁸ N, corresponding to an electron acceleration of nearly 10²² m/s². Any result in a problem with atomic charges below 10⁻¹⁰ N or above 10⁻⁶ N should raise an alert.

To detect an absurd result: if [[fuerza_electrica_de_coulomb]] exceeds the weight of a macroscopic object with typical laboratory charges (microcoulombs), something is wrong. Laboratory charges rarely exceed 10 µC.
...
2. **Measure [[distancia_entre_cargas]] in metres**. Not in centimetres or angstroms.
...
If the problem asks for the field [[campo_electrico_de_carga_puntual]] rather than [[fuerza_electrica_de_coulomb]], use the second formula of the leaf and remember that [[campo_electrico_de_carga_puntual]] does not depend on [[q2]].

## Special cases and extended example

**Zero charge**: if [[q1]] or [[q2]] is zero, [[fuerza_electrica_de_coulomb]] is exactly zero. There is no interaction even if the charges are in contact.
...
The quadratic dependence is not arbitrary: it reflects how the interaction "dilutes" in three-dimensional space. The "flux" of the force spreads over a spherical surface that grows with [[distancia_entre_cargas]]², so the force density falls with [[distancia_entre_cargas]]². This same logic explains gravitation and the intensity of light.
...
**How do I know whether to use [[fuerza_electrica_de_coulomb]] or [[campo_electrico_de_carga_puntual]] to solve a problem?**

If the problem asks for the force on a specific charge, use [[fuerza_electrica_de_coulomb]]. If it asks what acceleration or force any charge would experience (without specifying it), the correct answer involves [[campo_electrico_de_carga_puntual]], which does not depend on the test charge. If the problem gives [[campo_electrico_de_carga_puntual]] and asks for [[fuerza_electrica_de_coulomb]], simply multiply by [[q2]].
...
Coulomb's law is the quantitative relation governing the force between point charges: proportional to the product of [[q1]] and [[q2]], and inversely proportional to the square of [[distancia_entre_cargas]]. Its inverse-square structure is the same as gravity, but the presence of signs in [[q1]] and [[q2]] adds the possibility of repulsion, which gravitation lacks. This simple formula is the starting point of all classical electrostatics.