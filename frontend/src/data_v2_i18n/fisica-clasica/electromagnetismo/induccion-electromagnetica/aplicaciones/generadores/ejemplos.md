...
El sistema es la bobina giratoria y su eje mecánico. La interacción física relevante es la variación de [[flujo_magnetico_maximo_enlazado]] al rotar en el campo. La salida eléctrica se interpreta primero como [[epsilon_0]] ideal y después como [[potencia_electrica_util]] útil cuando se incluyen pérdidas mediante [[eta]].

## Modelo físico

Usamos un generador sinusoidal ideal para la fem máxima y una lectura media de Faraday para la prueba de cambio de flujo. El modelo incluye [[numero_de_espiras]], [[campo_magnetico]], [[area_de_la_espira]], [[omega]], [[cambio_de_flujo_magnetico]], [[intervalo_temporal]], [[potencia_mecanica_de_entrada]] y [[eta]]. La potencia útil se calcula después de la inducción, porque tensión inducida y potencia entregada no son la misma magnitud.
...
Multiplicar 200 espiras por 0.25 T y por 0.015 m² da 0.75 Wb. Por tanto [[flujo_magnetico_maximo_enlazado]] ≈ 0.75 Wb.
...
El rendimiento del 78 % se usa como fracción 0.78. Multiplicar 0.78 por 85 W da 66.3 W. Por tanto [[potencia_electrica_util]] ≈ 66.3 W.

## Validación dimensional

El producto de espiras, tesla y metro cuadrado produce weber, con dimensión `[M L² T⁻² I⁻¹]`, coherente con [[flujo_magnetico_maximo_enlazado]].
...
La potencia útil de 66.3 W indica que parte de los 85 W mecánicos se pierden. Físicamente, esas pérdidas pueden corresponder a rozamiento, calentamiento del bobinado y pérdidas magnéticas. Si [[eta]] bajara, [[potencia_electrica_util]] caería aunque la fem ideal de la bobina no cambiara.
