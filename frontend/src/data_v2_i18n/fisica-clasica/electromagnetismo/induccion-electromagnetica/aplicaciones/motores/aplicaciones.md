...
La magnitud crítica en el servomotor es la constante de par, que agrupa los factores [[numero_de_conductores_activos]], [[longitud_activa_del_conductor]], [[campo_magnetico_del_estator]] y [[r_a]]. Una constante de par alta permite obtener el par deseado con poca corriente, lo que reduce el calentamiento del bobinado y mejora la precisión. Por eso los servomotores modernos usan imanes permanentes de tierras raras, que generan campos [[campo_magnetico_del_estator]] de hasta 1.2 T en un volumen compacto.
...
El diseño de estos motores maximiza el producto [[numero_de_conductores_activos]] por [[longitud_activa_del_conductor]] por [[campo_magnetico_del_estator]] por [[r_a]] para obtener una fem contraelectromotriz elevada a bajas corrientes, reduciendo las pérdidas Joule. El análisis de eficiencia es central: [[eta]] elevado reduce el calor generado y prolonga la vida del sistema, que en un disco duro puede operar durante años ininterrumpidamente.
