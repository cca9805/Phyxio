...
El alumno aplica la misma relación de espiras a las corrientes que a las tensiones, calculando [[corriente_secundaria]] como [[corriente_primaria]] multiplicado por [[numero_de_espiras_secundario]]/[[numero_de_espiras_primario]], siguiendo la lógica directa de proporcionalidad.

**Por qué es incorrecto**

La conservación de la potencia exige que el producto tensión-corriente se mantenga constante. Si la tensión aumenta en la relación [[numero_de_espiras_secundario]]/[[numero_de_espiras_primario]], la corriente debe disminuir en esa misma proporción para conservar la potencia. La relación correcta entre corrientes sigue el cociente [[numero_de_espiras_secundario]]/[[numero_de_espiras_primario]], es decir, la inversa de la relación de tensiones.
...
Sin carga conectada, el alumno razona que no hay corriente en el secundario y por tanto la corriente primaria debe ser cero. El modelo ideal predice exactamente eso: corriente primaria nula cuando [[corriente_secundaria]] es cero.
