...
Even when full electromagnetic simulators are used, the parameter [[inductancia_propia]] remains the operational summary that connects geometry and field to circuit decisions.