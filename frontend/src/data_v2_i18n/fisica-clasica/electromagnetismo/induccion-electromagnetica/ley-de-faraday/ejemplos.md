...
- Numero de espiras [[numero_de_espiras]]: 200.
- Flujo inicial [[flujo_magnetico]]: 0.0030 Wb por espira.
- Flujo final: 0.00050 Wb por espira.
- Intervalo [[intervalo_de_tiempo]]: 0.020 s.
...
Se usa la forma media de la ley de Faraday. El flujo disminuye, por lo que [[cambio_de_flujo_magnetico]] es negativo con la normal elegida. El signo final de la fem debe reflejar oposicion al descenso de flujo.
...
La bobina tiene muchas vueltas, por lo que [[numero_de_espiras]] multiplica la respuesta si cada vuelta enlaza el mismo cambio de flujo. El resultado seria distinto si el dato de flujo ya fuera enlace total de toda la bobina.
...
El flujo final es menor que el inicial, asi que [[cambio_de_flujo_magnetico]] es un descenso de 0.0025 Wb. Dividir ese cambio por 0.020 s da una rapidez media de cambio con modulo 0.125 Wb/s.
...
Si se hubiera olvidado convertir el tiempo o multiplicar por [[numero_de_espiras]], el resultado cambiaria por factores grandes. Por eso la lectura numerica debe ir acompañada de control de unidades y de interpretacion del signo.

## Validación dimensional

Weber dividido por segundo produce voltio, por lo que [[rapidez_media_de_cambio_de_flujo]] tiene la dimension adecuada para generar fem. El numero de espiras [[numero_de_espiras]] no añade unidad; solo multiplica la respuesta.
...
El valor de 25 V es razonable para una bobina con muchas espiras, aunque el cambio por espira parezca pequeño. La acumulacion por [[numero_de_espiras]] convierte una variacion moderada de flujo en una tension medible.
...
La estimacion tambien muestra el papel de la geometria. Una bobina con mayor [[area_enlazada]] o mejor orientada respecto a [[campo_magnetico_perpendicular_efectivo]] puede enlazar mas flujo; si ese flujo cambia durante el giro, la respuesta electrica crece.
...
El diseño correcto mira [[flujo_magnetico]], [[cambio_de_flujo_magnetico]], [[intervalo_de_tiempo]] y [[numero_de_espiras]] juntos. Si se ignora cualquiera de esas magnitudes, se pierde la causa fisica de la tension inducida o se estima mal su escala.
