...
El estudiante sabe que el campo magnético [[campo_magnetico]] existe en todo punto del espacio y que ejerce fuerzas. La generalización errónea es que esas fuerzas actúan sobre cualquier carga, en movimiento o en reposo, igual que el campo eléctrico.

**Por qué es incorrecto**

La fuerza de Lorentz magnética es proporcional a la velocidad [[velocidad_de_la_carga]] de la carga. Si [[velocidad_de_la_carga]] es cero, la fuerza es exactamente nula, independientemente de cuánto valga [[campo_magnetico]]. El campo magnético no actúa sobre cargas estáticas; esa es la diferencia fundamental con el campo eléctrico.
...
La condición necesaria para que exista fuerza magnética es que la carga tenga velocidad no nula con una componente perpendicular a [[campo_magnetico]]. Si la carga está en reposo o se mueve paralela a [[campo_magnetico]], la fuerza es nula.
...
Para el hilo recto: duplicar [[distancia_al_hilo_conductor]] divide [[campo_magnetico]] entre dos. Para el campo eléctrico de carga puntual: duplicar r divide el campo entre cuatro. El origen de la diferencia es la geometría de la distribución de fuente: puntual (esférica) frente a lineal (cilíndrica).
...
Antes de aplicar la fórmula del hilo recto, verificar que la longitud del conductor sea al menos diez veces mayor que la distancia de evaluación [[distancia_al_hilo_conductor]]. Para conductores de longitud comparable a [[distancia_al_hilo_conductor]], usar la ley de Biot-Savart.
...
La estructura de la fórmula tiene varios factores numéricos: [[mu_0]], la corriente [[intensidad_de_corriente]] y la distancia [[distancia_al_hilo_conductor]]. El factor 2π en el denominador es fácil de omitir si el alumno memoriza la fórmula de forma incompleta.
...
La energía cinética depende del cuadrado de la **rapidez** (módulo de la velocidad), no de su dirección. La fuerza magnética [[fuerza_magnetica]] es siempre perpendicular a [[velocidad_de_la_carga]], por lo que no cambia el módulo de [[velocidad_de_la_carga]]. La rapidez permanece constante; solo cambia la dirección. El trabajo neto de [[fuerza_magnetica]] sobre cualquier trayectoria es siempre cero.
...
Un protón que entra en un campo [[campo_magnetico]] uniforme a 10⁶ m/s describe un círculo perfecto y sale con exactamente la misma rapidez de 10⁶ m/s. Su energía cinética antes y después del campo es idéntica. Si el campo hubiera cambiado su energía, sería un motor de movimiento perpetuo, lo que viola la conservación de la energía.
...
4. ¿El módulo de [[campo_magnetico]] es positivo?
