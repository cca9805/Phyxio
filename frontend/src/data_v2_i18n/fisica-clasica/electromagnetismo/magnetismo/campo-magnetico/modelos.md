...
El **modelo de hilo recto infinito** es la idealización central de este leaf para el cálculo de campo magnético. En él, toda la corriente [[intensidad_de_corriente]] fluye por un conductor rectilíneo de longitud infinita y sección despreciable, y el espacio circundante es vacío con permeabilidad constante. Bajo estas hipótesis, el campo magnético [[campo_magnetico]] en cualquier punto queda completamente determinado por [[mu_0]], [[intensidad_de_corriente]] y la distancia perpendicular [[distancia_al_hilo_conductor]].

Para la interacción carga-campo se usa el **modelo de Lorentz**: la carga [[carga_electrica]] es puntual, su movimiento es no relativista, y el campo [[campo_magnetico]] en la región donde se mueve es uniforme o varía lentamente en comparación con la escala de la trayectoria.

## Hipótesis

- **Hilo recto de longitud infinita**: la longitud del conductor es mucho mayor que la distancia de evaluación [[distancia_al_hilo_conductor]]. Si se viola esta hipótesis (hilo finito), el campo real es menor que el predicho por el modelo, especialmente cerca de los extremos.
...
- **Velocidad no relativista**: para la fuerza de Lorentz, la rapidez [[velocidad_de_la_carga]] de la carga debe ser mucho menor que la velocidad de la luz. Por encima del 10% de c los efectos relativistas superan el 1%.
...
El modelo de hilo recto infinito es aplicable cuando la distancia de evaluación [[distancia_al_hilo_conductor]] cumple: r > radio del conductor y r < longitud del conductor dividida entre diez. Para un cable doméstico de 2 m de longitud, el modelo es válido para r menor de 20 cm.

Para la fuerza de Lorentz, el modelo clásico es fiable cuando la rapidez [[velocidad_de_la_carga]] es menor del 10% de la velocidad de la luz, es decir, v < 3×10⁷ m/s. La energía cinética clásica difiere menos del 1% de la relativista en ese régimen.
