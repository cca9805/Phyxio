...
En un motor, los conductores de una bobina transportan [[intensidad_de_corriente]] dentro de un [[campo_magnetico]] creado por imanes o electroimanes. Las fuerzas sobre lados opuestos de la bobina pueden formar un par que produce giro.

Variable dominante: [[fuerza_magnetica_sobre_el_conductor]] como fuerza mecanica total sobre cada tramo activo.
...
En el diseño real tambien se controla cuanta longitud activa queda dentro del campo. Mas vueltas de bobina aumentan el numero de tramos que contribuyen, pero tambien elevan resistencia y calentamiento. La fuerza util nace de equilibrar [[intensidad_de_corriente]], [[longitud_efectiva]], [[campo_magnetico]] y refrigeracion.

La lectura de este leaf ayuda a separar decisiones. Aumentar [[campo_magnetico]] exige mejores imanes o nucleos, aumentar [[intensidad_de_corriente]] exige fuente y disipacion adecuadas, y aumentar [[longitud_efectiva]] exige mas cobre dentro de la zona util. Un motor eficiente no maximiza una variable aislada, sino el conjunto completo.

## 2. Altavoces dinamicos

Un altavoz usa una bobina situada en el entrehierro de un iman permanente. La senal electrica cambia [[intensidad_de_corriente]], y la fuerza magnetica mueve el diafragma hacia delante o hacia atras.

Variable dominante: [[intensidad_de_corriente]] como control temporal de la fuerza.
Límite de validez: a grandes amplitudes, la bobina puede salir de la zona de campo uniforme.

La fuerza debe seguir la senal sin deformarse demasiado. Por eso importa que [[campo_magnetico]] sea estable, que la longitud efectiva de bobina sea conocida y que el calentamiento no altere la corriente.

La lectura de [[fuerza_magnetica_por_unidad_de_longitud]] es util para comparar imanes y bobinas antes de fijar el numero de vueltas. Si dos diseños dan la misma fuerza por metro, el de mayor longitud activa empujara mas, pero puede ser mas pesado o disipar mas calor.
...
Variable dominante: [[longitud_efectiva]] como tramo efectivo calibrado.
Límite de validez: el conductor debe permanecer recto y con orientacion estable.

Esta aplicacion es pedagogica porque convierte una magnitud electrica invisible en una lectura de peso o desplazamiento. Si la fuerza no cambia linealmente con [[intensidad_de_corriente]], el montaje revela un fallo de alineacion o de uniformidad.

Tambien permite calibrar campos. Si se conoce [[intensidad_de_corriente]] y [[longitud_efectiva]], medir la fuerza ayuda a estimar [[campo_magnetico]]. La orientacion debe quedar bloqueada, porque un pequeno giro modifica [[s_theta]] y cambia la lectura aunque el campo no haya variado.
...
Variable dominante: [[fuerza_magnetica_por_unidad_de_longitud]] como fuerza disponible por metro activo.
...
La fuerza por longitud permite estimar esfuerzos antes de construir el dispositivo completo. Si [[fuerza_magnetica_por_unidad_de_longitud]] supera lo que el soporte puede tolerar, el problema no se resuelve solo bajando masa: hay que rediseñar campo, corriente o recorrido.
...
Variable dominante: [[campo_magnetico]] como intensidad del entorno magnetico.
