...
Esta aplicacion muestra que "material magnetico" no significa siempre "mayor campo posible". En una fuente conmutada interesa almacenar y transferir energia de forma controlada, mantener el nucleo frio y evitar que [[campo_magnetico_total]] entre en una zona donde el control electronico pierda margen.
...
Un blindaje magnetico de material de alta permeabilidad no bloquea el campo como una pared opaca. Redirige lineas de campo por una ruta de menor reluctancia, de modo que la region protegida queda con menor [[campo_magnetico_total]]. La clave es que el material concentre el campo en si mismo sin saturarse.
...
Algunos sensores usan piezas ferromagneticas para concentrar el campo externo en una region sensible. El material aumenta [[campo_magnetico_total]] local para que una sonda Hall, magnetorresistiva o inductiva trabaje con mejor señal. La lectura correcta separa el campo ambiental de la amplificacion geometrica y material.
