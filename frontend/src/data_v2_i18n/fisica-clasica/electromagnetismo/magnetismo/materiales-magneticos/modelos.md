...
El modelo ideal de materiales magneticos usa un medio lineal, isotropo, homogeneo y reversible. En ese marco, [[intensidad_magnetica]] actua como excitacion aplicada, [[magnetizacion]] como respuesta interna proporcional y [[campo_magnetico_total]] como campo total resultante. La complejidad microscopica de dominios, espines y corrientes ligadas queda resumida por [[mu]], [[mu_r]] y [[chi_m]].
...
- La respuesta es reversible: si se viola, aparece memoria magnetica y [[magnetizacion]] depende de la historia previa.
- El medio se trata como isotropo: si se viola, la direccion de [[campo_magnetico_total]] puede no coincidir con la de [[intensidad_magnetica]].
...
El modelo es razonable cuando el tramo usado de la curva [[campo_magnetico_total]] frente a [[intensidad_magnetica]] conserva pendiente casi constante. Como regla de trabajo, un error inferior al 5 % en la pendiente experimental permite tratar [[mu]] como efectiva para calculos introductorios.
...
Una primera señal de fallo es que la grafica [[campo_magnetico_total]] frente a [[intensidad_magnetica]] se curva de forma visible. Si al duplicar la excitacion el campo total aumenta mucho menos de lo esperado, la pendiente efectiva ya no es constante.

Otra señal es la remanencia: al retirar la excitacion, [[magnetizacion]] no vuelve al estado inicial. Tambien son sospechosos el calentamiento por perdidas magneticas, la dependencia con la frecuencia, la diferencia entre ciclos de subida y bajada, o una respuesta distinta al girar la muestra.
...
| Lectura fisica | Distingue [[intensidad_magnetica]], [[magnetizacion]] y [[campo_magnetico_total]] con claridad | Añade remanencia, coercitividad y perdidas |
