...
Los hornos microondas calientan los alimentos emitiendo ondas electromagnéticas a una [[frecuencia]] fija de 2,45 GHz dentro de una cavidad metálica sellada. El campo eléctrico [[amplitud_del_campo_electrico]] oscilante ejerce un par de torsión continuo sobre los dipolos eléctricos de las moléculas de agua contenidas en la comida, forzándolas a rotar miles de millones de veces por segundo y generando calor por fricción molecular instantánea.
...
Variable dominante: amplitud del campo eléctrico [[amplitud_del_campo_electrico]]
