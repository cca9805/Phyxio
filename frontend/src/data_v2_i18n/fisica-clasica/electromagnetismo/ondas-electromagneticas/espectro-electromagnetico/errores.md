...
La enseñanza escolar presenta radio, visible y rayos X como etiquetas. Esa memorizacion oculta que todas las regiones se ordenan por [[frecuencia]], [[lambda]] y [[energia_de_un_foton]].
...
Ordena siempre con una magnitud. Si sube [[frecuencia]], sube [[energia_de_un_foton]] y baja la longitud de onda en el vacio.
...
La relacion entre [[frecuencia]] y longitud de onda se memoriza con [[velocidad_de_la_luz_en_el_vacio]], y el alumno la aplica en cualquier material sin revisar el contexto.
...
En el vacio, [[lambda]] y [[frecuencia]] varian de forma inversa. La energia de un foton aumenta con [[frecuencia]], no con una longitud de onda mayor.
...
Para energia por foton, mira [[frecuencia]] o [[energia_de_un_foton]]. Para escala espacial, mira [[lambda]]. No intercambies esas lecturas.
...
[[energia_de_un_foton]] mide energia individual. La intensidad total depende de cuantos fotones llegan por segundo y de como se reparte la radiacion.
...
Un puntero visible puede ser menos potente que un calefactor infrarrojo, aunque sus fotones individuales tengan energia diferente. La potencia total no sale de [[energia_de_un_foton]] sola.

## Regla de autocontrol rápido

Antes de cerrar un ejercicio, responde tres preguntas: que region predice [[frecuencia]], que escala espacial predice [[lambda]], y que interaccion individual sugiere [[energia_de_un_foton]]. Si una respuesta contradice otra, revisa la conversion.
