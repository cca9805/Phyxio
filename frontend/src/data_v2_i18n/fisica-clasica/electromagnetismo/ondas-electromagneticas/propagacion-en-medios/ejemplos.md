...
El sistema es una onda electromagnetica monocromatica que pasa de vacio a vidrio. Las magnitudes de referencia son [[velocidad_de_la_luz_en_el_vacio]] y [[lambda0]]. Las magnitudes que describen el material son [[indice_de_refraccion_efectivo]], [[epsilon_r]] y [[mu_r]]. Las magnitudes que se quieren leer dentro del vidrio son [[v_m]] y [[lambda_m]].
...
Se usa el modelo de propagacion en medio lineal, homogeneo e isotropo. En este modelo [[indice_de_refraccion_efectivo]] resume la respuesta electromagnetica efectiva y permite calcular [[v_m]] a partir de [[velocidad_de_la_luz_en_el_vacio]]. Tambien permite convertir [[lambda0]] en [[lambda_m]].
...
Para la velocidad de fase dentro del medio se usa la relacion entre [[velocidad_de_la_luz_en_el_vacio]], [[indice_de_refraccion_efectivo]] y [[v_m]]:
...
Para la longitud de onda dentro del vidrio se relacionan [[lambda0]], [[indice_de_refraccion_efectivo]] y [[lambda_m]]:

{{f:longitud_onda_en_medio}}

El orden fisico esperado es claro antes de sustituir: con un indice mayor que uno, [[v_m]] debe ser menor que [[velocidad_de_la_luz_en_el_vacio]] y [[lambda_m]] debe ser menor que [[lambda0]].
...
En la lectura material, [[epsilon_r]], [[mu_r]] y [[indice_de_refraccion_efectivo]] son adimensionales. La operacion combina respuestas relativas del medio y produce otro numero sin unidad.
...
Para una longitud de onda de vacio de 1550 nm y un indice de nucleo cercano a 1.45, la longitud de onda dentro del nucleo es del orden de 1070 nm. La velocidad de fase queda del orden de 2.1×10⁸ m/s, claramente menor que [[velocidad_de_la_luz_en_el_vacio]] pero aun enorme en escala humana.
