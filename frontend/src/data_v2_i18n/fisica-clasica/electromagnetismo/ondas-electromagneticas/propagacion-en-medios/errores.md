...
**Corrección conceptual**: Mantener la frecuencia como puente entre medios y ajustar la escala espacial mediante [[indice_de_refraccion_efectivo]].
...
**Por qué parece correcto**: [[velocidad_de_la_luz_en_el_vacio]] aparece en muchas formulas de ondas electromagneticas y se memoriza como velocidad de la luz.

**Por qué es incorrecto**: [[velocidad_de_la_luz_en_el_vacio]] es la velocidad de referencia en vacio. Dentro de un medio ordinario se usa [[v_m]], determinada por el indice [[indice_de_refraccion_efectivo]].

**Señal de detección**: El calculo da la misma velocidad en aire, agua y vidrio sin justificar que los indices sean iguales.

**Corrección conceptual**: Usar [[velocidad_de_la_luz_en_el_vacio]] solo como referencia y aplicar el indice del medio cuando haya material.
...
**Por qué es incorrecto**: [[indice_de_refraccion_efectivo]] puede depender de frecuencia, temperatura, polarizacion o direccion. Un valor tabulado solo vale bajo condiciones concretas.
...
**Por qué parece correcto**: Dividir o multiplicar por [[indice_de_refraccion_efectivo]] puede parecer simetrico si no se interpreta el resultado.
...
**Señal de detección**: Un indice mayor produce una velocidad mayor que [[velocidad_de_la_luz_en_el_vacio]] o una longitud de onda mas grande que [[lambda0]].
...
Si al cambiar de medio cambiaste frecuencia sin una fuente nueva, revisa el razonamiento. En una frontera estacionaria ordinaria, el medio modifica [[v_m]] y [[lambda_m]] mediante [[indice_de_refraccion_efectivo]], mientras la frecuencia conserva la identidad temporal de la radiacion.