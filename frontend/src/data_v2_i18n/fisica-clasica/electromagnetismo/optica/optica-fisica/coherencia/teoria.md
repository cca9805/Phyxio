...
La magnitud [[longitud_de_coherencia]] resume una distancia util de estabilidad. Si el desajuste de caminos [[diferencia_de_camino_optico]] es pequeno frente a esa escala, la interferencia puede verse con buen contraste. Si el desajuste se vuelve demasiado grande, la fuente ya no mantiene memoria de fase entre los dos caminos.

La visibilidad [[visibilidad_de_franjas]] mide el contraste real entre franjas brillantes y oscuras. Una visibilidad alta no significa necesariamente mas luz total; significa mejor diferencia relativa entre maximos y minimos. Esa distincion es fundamental para leer experimentos.
...
La primera relacion convierte el tiempo de coherencia [[tau_c]] en una longitud de coherencia [[longitud_de_coherencia]]. El tiempo de coherencia mide durante cuanto tiempo la fase permanece correlacionada de forma util; multiplicarlo por la velocidad de propagacion da una escala espacial comparable con caminos opticos.

{{f:longitud_coherencia}}

Esta longitud no es el tamano de la fuente ni la distancia maxima que viaja la luz. En aire o vacio, [[velocidad_de_la_luz]] actua como velocidad de conversion entre la memoria temporal de fase y la distancia comparable con el montaje. Es una escala de comparacion: si dos recorridos difieren mucho mas que [[longitud_de_coherencia]], las fases relativas cambian demasiado para sostener franjas estables.

Para representar de forma simple como cae la coherencia al aumentar la diferencia de camino se usa una magnitud adimensional [[coherencia_relativa]]. El modelo no pretende sustituir una funcion de correlacion completa; sirve para leer monotonicamente la perdida de coherencia al crecer [[diferencia_de_camino_optico]].
...
La visibilidad experimental se obtiene comparando la intensidad maxima [[intensidad_maxima]] con la intensidad minima [[intensidad_minima]] del patron. Esta relacion mide contraste normalizado y elimina la dependencia directa de la potencia total de la fuente.
...
La coherencia no es todo o nada. En la practica, las franjas se degradan gradualmente. Por eso conviene trabajar con indicadores como [[coherencia_relativa]] o [[visibilidad_de_franjas]] en lugar de decidir solo si la interferencia existe. Un patron con contraste bajo puede contener informacion util si el detector y el ruido lo permiten.

La estructura tambien obliga a distinguir prediccion y diagnostico. [[coherencia_relativa]] predice una perdida esperada por camino; [[visibilidad_de_franjas]] diagnostica lo que realmente se midio. Si ambas lecturas no coinciden, el montaje esta aportando otro mecanismo fisico o instrumental.
...
La lectura fisica fina consiste en separar contraste y energia. [[visibilidad_de_franjas]] no dice cuanta potencia llega, sino cuan distinguibles son maximos y minimos. Una imagen con poca luz puede tener alta visibilidad si el detector es sensible; una imagen brillante puede tener baja visibilidad si las fases se mezclan.
...
Una lampara de espectro ancho puede tener [[longitud_de_coherencia]] de micrometros, mientras un laser estabilizado puede alcanzar metros o mas. Esta diferencia de muchos ordenes de magnitud explica por que una doble rendija simple puede funcionar con luz filtrada, pero un interferometro de brazos largos suele requerir una fuente mucho mas coherente.

Un resultado absurdo aparece si una lampara blanca ordinaria se usa con diferencias de camino de centimetros y se espera alto contraste, o si una visibilidad casi nula se interpreta como ausencia total de luz. La pregunta correcta es comparar [[diferencia_de_camino_optico]] con [[longitud_de_coherencia]] y despues leer [[visibilidad_de_franjas]].

## Método de resolución personalizado

Primero identifica que se esta evaluando: escala temporal de la fuente, diferencia de caminos o contraste medido. Si conoces [[tau_c]], calcula [[longitud_de_coherencia]]. Si conoces el montaje, compara [[diferencia_de_camino_optico]] con esa escala. Si tienes una imagen de franjas, usa [[intensidad_maxima]] e [[intensidad_minima]] para estimar [[visibilidad_de_franjas]].

Despues decide si el problema es de fuente o de montaje. Si [[diferencia_de_camino_optico]] supera mucho [[longitud_de_coherencia]], falta coherencia temporal. Si [[visibilidad_de_franjas]] es baja aunque los caminos esten bien emparejados, revisa intensidades, alineacion, fondo o coherencia espacial.
...
La coherencia mide si una fuente y un montaje conservan fase suficiente para producir franjas observables. [[longitud_de_coherencia]], [[diferencia_de_camino_optico]], [[coherencia_relativa]] y [[visibilidad_de_franjas]] permiten traducir esa idea en una lectura fisica: estabilidad temporal, desajuste de caminos y contraste experimental.