...
- Ancho de rendija [[ancho_de_la_rendija]]: 0.15 mm, equivalente a 1.5 · 10⁻⁴ m
- Distancia a la pantalla [[distancia_a_la_pantalla]]: 2.0 m
- Aceleración angular o angularidad: paraxial

## Definición del sistema

El sistema está constituido por un emisor láser coherente de longitud de onda fija de 633 nm que incide ortogonalmente sobre una rendija de difracción simple uniforme con ancho [[ancho_de_la_rendija]] de 0.15 mm. La luz se propaga en campo lejano hasta incidir sobre una pantalla de proyección paralela plana colocada a una distancia longitudinal [[distancia_a_la_pantalla]] de 2.0 m.

## Modelo físico

Se aplica el modelo de difracción de Fraunhofer en rendija simple rectangular bajo aproximación paraxial. Las magnitudes que definen este leaf de estudio son el ancho de la rendija [[ancho_de_la_rendija]], la longitud de onda [[lambda]], la desviación angular [[theta]], la distancia a la pantalla [[distancia_a_la_pantalla]] y el ancho lineal total del máximo central [[ancho_del_maximo_central]]. El modelo requiere que el ancho de la rendija sea significativamente mayor que la longitud de onda y que el ángulo del primer mínimo sea pequeño (menor a una décima de radián).
...
Apartado (b): El ancho lineal total del máximo central brillante [[ancho_del_maximo_central]] proyectado sobre la pantalla de observación lateral se deduce combinando el ángulo de desviación angular bilateral con la amplificación de la distancia longitudinal geométrica [[distancia_a_la_pantalla]]:
...
Apartado (b): Multiplicando dos por la longitud de onda de 6.33 · 10⁻⁷ m, por la distancia a la pantalla de 2.0 m, y dividiendo por el ancho de la rendija de 1.5 · 10⁻⁴ m, se obtiene un ancho lineal [[ancho_del_maximo_central]] de aproximadamente 0.0169 metros, equivalente a 16.9 milímetros. Por tanto [[ancho_del_maximo_central]] ≈ 16.9 mm.
...
De acuerdo con el principio de Babinet en física ondulatoria, un obstáculo opaco delgado (el cabello) difracta la luz de forma exactamente idéntica a como lo haría una abertura rectangular complementaria del mismo ancho. Por lo tanto, el cabello actúa físicamente como una rendija difractora simple de ancho [[ancho_de_la_rendija]], donde [[ancho_de_la_rendija]] representa el diámetro transversal del cabello.

Al proyectar el haz verde sobre la pantalla a una distancia [[distancia_a_la_pantalla]] de 2.5 m, el biofísico mide con una regla digital que el ancho total del máximo brillante central verde sobre la pantalla tiene [[ancho_del_maximo_central]] de 3.6 cm, equivalente a 0.036 m.

Para estimar el diámetro del cabello, el biofísico despeja el parámetro [[ancho_de_la_rendija]] de la expresión del máximo central brillante declarada en el leaf:

{{f:ancho_maximo_central}}

Introduciendo los valores experimentales: la longitud de onda es de 5.32 · 10⁻⁷ m, la distancia a la pantalla es de 2.5 m, y el ancho medido es de 0.036 m. Multiplicando dos por la longitud de onda y por la distancia se obtiene 2.66 · 10⁻⁶ m², y al dividir entre el ancho de 0.036 m resulta un ancho de rendija [[ancho_de_la_rendija]] aproximado de 7.39 · 10⁻⁵ m, es decir, unos 74 micrómetros.
...
La magnitud física del diámetro del cabello [[ancho_de_la_rendija]] actúa como el elemento de escala dominante. Este método de calibración óptica demuestra cómo un fenómeno físico puramente ondulatorio permite realizar mediciones indirectas extremadamente precisas de dimensiones microscópicas utilizando únicamente un láser, una cinta métrica y una regla de laboratorio. El carácter no invasivo y la alta sensibilidad del patrón difractado a pequeños cambios en el espesor lo convierten en una técnica industrial y científica sumamente robusta para la metrología de fibras finas, cables y capilares biológicos.

Variable dominante: [[ancho_de_la_rendija]], el diámetro físico del obstáculo (cabello), que controla inversamente la escala del patrón espacial proyectado en la pantalla.
