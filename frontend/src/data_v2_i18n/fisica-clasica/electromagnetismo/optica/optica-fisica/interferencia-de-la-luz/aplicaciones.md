...
## 1. Medida de longitud de onda con doble rendija

Una de las aplicaciones más directas de la interferencia es la determinación experimental de la longitud de onda de una fuente luminosa desconocida. El procedimiento consiste en iluminar dos rendijas separadas una distancia [[separacion_entre_rendijas]] conocida y medir la separación entre franjas [[separacion_entre_franjas_consecutivas]] sobre una pantalla situada a distancia [[distancia_a_la_pantalla]]. A partir de la relación entre estas tres magnitudes geométricas se obtiene [[lambda]] con precisión del orden del uno por ciento en montajes de laboratorio estándar.

Este método es fundamental en espectroscopia de baja resolución y en la calibración de fuentes luminosas educativas. La precisión alcanzable depende de la calidad de la medida de [[separacion_entre_franjas_consecutivas]], de la estabilidad del patrón y de la monocromaticidad de la fuente. En la práctica, un microscopio de medida sobre la pantalla permite determinar [[separacion_entre_franjas_consecutivas]] con error inferior a una décima de milímetro.

Variable dominante: la separación entre franjas [[separacion_entre_franjas_consecutivas]], directamente proporcional a la longitud de onda buscada y al cociente geométrico entre distancia a pantalla y separación entre rendijas.
...
Variable dominante: el orden de difracción [[orden_de_la_franja]] y el número total de rendijas iluminadas, que conjuntamente determinan el poder de resolución espectral del dispositivo.
