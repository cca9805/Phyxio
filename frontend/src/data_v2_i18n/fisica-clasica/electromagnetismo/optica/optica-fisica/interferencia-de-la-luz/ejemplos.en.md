...
In a Young's double-slit experiment, light from a helium-neon laser with wavelength [[lambda]] equal to 632.8 nm illuminates two slits. The separation between slits is [[separacion_entre_rendijas]] equal to 0.25 mm and the distance from slits to observation screen is [[distancia_a_la_pantalla]] equal to 1.80 m. Calculate the position of the third lateral maximum and the separation between consecutive fringes.

## Data

- [[lambda]] is 632.8 nm equal to 6.328 × 10⁻⁷ m
- [[separacion_entre_rendijas]] is 0.25 mm equal to 2.5 × 10⁻⁴ m
- [[distancia_a_la_pantalla]] is 1.80 m
- Requested order: [[orden_de_la_franja]] equal to 3

## System definition

The system consists of two narrow slits separated by distance [[separacion_entre_rendijas]] acting as coherent secondary sources. Light from both slits superposes on the screen, creating an interference pattern with alternating fringes of maximum and minimum intensity. The output variable is the linear position [[y_m]] of the maxima on the screen.

## Physical model

The double-slit interference model in the small-angle approximation is applied. The position of each maximum depends linearly on order [[orden_de_la_franja]], wavelength [[lambda]], screen distance [[distancia_a_la_pantalla]] and slit separation [[separacion_entre_rendijas]]. The separation between consecutive fringes is constant.

## Model justification

The laser provides highly coherent and monochromatic light. The slit separation is much larger than the wavelength, allowing multiple fringes to be observed. The distance to the screen is sufficiently large for the small-angle approximation to be valid for the first orders. The observation angle [[theta]] of the third maximum will be approximately 0.008 radians, well below the 0.1 radian limit of the approximation.
...
Combining the maximum condition with the small-angle approximation, the position of the maximum of order [[orden_de_la_franja]] on the screen is:
...
Fringe separation is [[separacion_entre_franjas_consecutivas]] equal to 6.328 × 10⁻⁷ m multiplied by 1.80 m divided by 2.5 × 10⁻⁴ m equal to 4.56 × 10⁻³ m, approximately 4.6 mm.
...
For [[separacion_entre_franjas_consecutivas]]: m × m / m gives m. Correct.

Order of magnitude check: 13.7 mm at 1.80 m distance implies an observation angle [[theta]] of approximately 0.008 radians, validating the small-angle approximation.
