...
En un experimento de doble rendija de Young, se ilumina con un láser de helio-neón cuya longitud de onda es [[lambda]] igual a 632.8 nm. La separación entre las dos rendijas es [[separacion_entre_rendijas]] igual a 0.25 mm y la distancia desde las rendijas hasta la pantalla de observación es [[distancia_a_la_pantalla]] igual a 1.80 m. Calcular la posición del tercer máximo lateral y la separación entre franjas consecutivas.

## Datos

- [[lambda]] es 632.8 nm igual a 6.328 × 10⁻⁷ m
- [[separacion_entre_rendijas]] es 0.25 mm igual a 2.5 × 10⁻⁴ m
- [[distancia_a_la_pantalla]] es 1.80 m
- Orden solicitado: [[orden_de_la_franja]] igual a 3
...
Se aplica el modelo de interferencia de doble rendija en aproximación de ángulos pequeños. La posición de cada máximo depende linealmente del orden [[orden_de_la_franja]], de la longitud de onda [[lambda]], de la distancia a la pantalla [[distancia_a_la_pantalla]] y de la separación entre rendijas [[separacion_entre_rendijas]]. La separación entre franjas consecutivas es constante.

## Justificación del modelo

El láser proporciona luz altamente coherente y monocromática. La separación entre rendijas es mucho mayor que la longitud de onda, permitiendo observar múltiples franjas. La distancia a la pantalla es suficientemente grande para que la aproximación de ángulos pequeños sea válida para los primeros órdenes. El ángulo de observacion [[theta]] para el tercer máximo será aproximadamente 0.008 radianes, muy inferior al límite de 0.1 radianes de la aproximación.
...
Combinando la condición de máximos con la aproximación de ángulos pequeños, la posición del máximo de orden [[orden_de_la_franja]] en la pantalla es:
...
La separación entre franjas es [[separacion_entre_franjas_consecutivas]] igual a 6.328 × 10⁻⁷ m multiplicado por 1.80 m dividido por 2.5 × 10⁻⁴ m igual a 4.56 × 10⁻³ m, aproximadamente 4.6 mm.
...
Para [[separacion_entre_franjas_consecutivas]]: m por m dividido por m da m. Correcto.

Verificación de orden de magnitud: 13.7 mm a 1.80 m de distancia implica un ángulo de observacion [[theta]] de aproximadamente 0.008 radianes, validando la aproximación de ángulos pequeños.
