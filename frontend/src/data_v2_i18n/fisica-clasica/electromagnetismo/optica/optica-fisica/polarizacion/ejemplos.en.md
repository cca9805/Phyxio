...
The system consists of a laser source emitting linearly polarised light and a single analyser polariser. The incident intensity [[intensidad_incidente]] corresponds directly to the laser output, with no prior reduction. The control variable is the angle [[theta_p]] between the beam's polarisation direction and the analyser's transmission axis.

## Physical model

The phenomenon is described by **Malus's law**, which relates [[intensidad_transmitida]] to [[intensidad_incidente]] and [[theta_p]]. This model is valid because the source is a coherent, monochromatic and completely polarised laser, and the polariser is considered ideal with a high extinction ratio.
...
We substitute [[intensidad_incidente]] and [[theta_p]] to obtain [[intensidad_transmitida]].

For the second part, we need the angle [[theta_p]] that makes [[intensidad_transmitida]] equal to one quarter of [[intensidad_incidente]]. Rearranging Malus's law, the squared cosine of [[theta_p]] must equal one quarter, so the cosine of [[theta_p]] is one half, which corresponds to 60 degrees.

## Numerical substitution

For the transmitted intensity at 35 degrees: multiply 500 W/m² by the squared cosine of 35 degrees. The cosine of 35 degrees is approximately 0.8192; squaring it gives 0.6710. Multiplying by 500 yields approximately 335.5 W/m². Therefore [[intensidad_transmitida]] ≈ 335.5 W/m².

For the angle giving one quarter of the intensity: the squared cosine of [[theta_p]] must equal 0.25; the square root of 0.25 is 0.5; the arccosine of 0.5 is 60 degrees. Therefore [[theta_p]] ≈ 60 degrees (equivalent to 1.047 rad). Note that this angle is different from [[angulo_de_brewster]], which depends on the refractive indices and not on the squared cosine of intensity.
...
The result shows that at 35 degrees approximately 67 per cent of the incident intensity is transmitted. Physically, this means the drop is gentle at moderate angles because [[intensidad_transmitida]] depends on the squared cosine rather than on the cosine itself. As [[theta_p]] increases, [[intensidad_transmitida]] decreases more and more steeply, making the attenuation far less severe at small angles than one might expect from a linear relationship.
...
If [[intensidad_incidente]] were increased while keeping the same angle, [[intensidad_transmitida]] would grow proportionally, confirming linearity with respect to incident intensity. Conversely, if [[theta_p]] varied while [[intensidad_incidente]] remained fixed, the response would be quadratic, which is key for designing precise optical attenuators.
...
Substituting [[n_1]] equal to 1.00 (air) and [[n_2]] equal to 1.33 (water) into Brewster's law, the arctangent of 1.33 divided by 1.00 gives approximately 53.1 degrees. Therefore [[angulo_de_brewster]] ≈ 53.1 degrees.
