...
En un espejo convexo, [[distancia_focal_del_espejo]] es negativo. La ecuacion del espejo siempre da [[d_i]] negativo para [[d_o]] positivo y [[distancia_focal_del_espejo]] negativo. La imagen se forma detras del espejo.

**Mini-ejemplo de contraste**
Con [[distancia_focal_del_espejo]] igual a menos 0.10 m y [[d_o]] igual a 0.20 m, la ecuacion del espejo da [[d_i]] igual a menos 0.067 m. El signo negativo confirma imagen virtual, no real.
...
**Correccion conceptual**
Un espejo plano equivale a [[radio_de_curvatura_del_espejo]] infinito, [[distancia_focal_del_espejo]] infinito. La ecuacion del espejo da [[d_i]] igual a menos [[d_o]]: la imagen esta tan lejos detras del espejo como el objeto delante.
...
**Por que es incorrecto**
La distancia focal es exactamente la mitad del radio de curvatura. Usar [[radio_de_curvatura_del_espejo]] donde deberia ir [[distancia_focal_del_espejo]] duplica el error en la posicion de la imagen.
...
**Correccion conceptual**
Siempre verificar que [[distancia_focal_del_espejo]] es igual a [[radio_de_curvatura_del_espejo]] dividido por 2 antes de sustituir en la ecuacion del espejo. No usar [[radio_de_curvatura_del_espejo]] directamente en la ecuacion del espejo.

**Mini-ejemplo de contraste**
Con [[radio_de_curvatura_del_espejo]] igual a 0.40 m: la focal correcta es 0.20 m. Si se usa 0.40 m como focal, el resultado de [[d_i]] se desvía por un factor de 2 respecto al valor correcto.
...
**Por que parece correcto**
El alumno asocia "negativo" con "menos" o "reduccion" y concluye que [[aumento_lateral]] negativo implica imagen reducida.

**Por que es incorrecto**
El signo de [[aumento_lateral]] indica la orientacion, no el tamano. [[aumento_lateral]] negativo significa imagen **invertida**; el tamano lo da el valor absoluto. Un aumento de menos 3 significa una imagen invertida y tres veces mayor que el objeto.

**Senal de deteccion**
El alumno calcula [[aumento_lateral]] igual a menos 2 y afirma que la imagen es "la mitad del objeto" o que esta "reducida".

**Correccion conceptual**
El modulo de [[aumento_lateral]] da el factor de escala: mayor que uno indica imagen aumentada, menor que uno indica imagen reducida. El signo solo indica orientacion: negativo es invertida, positivo es derecha.

**Mini-ejemplo de contraste**
[[aumento_lateral]] igual a menos 3: la imagen es tres veces mayor que el objeto y esta invertida. [[aumento_lateral]] igual a 0.5: la imagen es la mitad del objeto y esta derecha. El signo y el modulo transmiten informacion distinta.

## Regla de autocontrol rápido

Antes de dar por bueno un resultado de espejos, verificar tres puntos clave:

1. **Signo de [[distancia_focal_del_espejo]]**: concavo positivo, convexo negativo. Si el signo no coincide con el tipo de espejo, hay error.
...
3. **Signo y modulo de [[aumento_lateral]]**: negativo indica invertida, positivo indica derecha. El modulo indica el tamano relativo. No confundir orientacion con tamano.