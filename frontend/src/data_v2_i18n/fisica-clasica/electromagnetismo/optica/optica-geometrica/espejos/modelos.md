...
El modelo ideal de espejos supone que la superficie reflectante es **perfectamente esferica**, que todos los rayos incidentes son **paraxiales** (forman angulos pequenos con el eje optico) y que la reflexion es **especular** sin scattering ni absorcion. En este marco, la ecuacion del espejo relaciona [[d_o]], [[d_i]] y [[distancia_focal_del_espejo]] de forma exacta, y el aumento lateral [[aumento_lateral]] describe la relacion de tamano y orientacion entre imagen y objeto.

Las magnitudes que se conservan son [[d_o]] como parametro de entrada, [[distancia_focal_del_espejo]] y [[radio_de_curvatura_del_espejo]] como parametros del sistema y [[d_i]] junto con [[aumento_lateral]] como salidas principales. La relacion entre focal y radio permanece exacta dentro de la aproximacion paraxial.
