...
Focal length [[distancia_focal]] of 15 cm (positive, converging lens). Object distance [[d_o]] of 25 cm. Object height of 4 cm.
...
The thin lens model in the paraxial approximation is applied. Image formation is governed by the thin lens equation relating [[distancia_focal]], [[d_o]] and [[d_i]]. The lateral magnification [[aumento_lateral]] is obtained as the signed ratio of distances.
...
[[d_i]] is obtained as the product of [[distancia_focal]] and [[d_o]] divided by the difference between [[d_o]] and [[distancia_focal]].

The lateral magnification:

{{f:aumento_lateral}}

The image height is the product of the magnitude of [[aumento_lateral]] and the object height, with the sign of [[aumento_lateral]] indicating orientation.
...
For [[aumento_lateral]]: minus 37.5 divided by 25 gives minus 1.5.

Image height: magnitude 1.5 times 4 cm gives 6 cm. The negative sign of [[aumento_lateral]] indicates the image is inverted.

## Dimensional validation

The distance [[d_i]] is expressed in centimetres, consistent with the input units. The magnification [[aumento_lateral]] is dimensionless (ratio of two lengths). The image height is in centimetres, consistent with the object height.

## Physical interpretation

The image forms 37.5 cm on the far side of the lens. It is real because [[d_i]] is positive: it can be projected onto a screen placed at that distance. It is inverted because [[aumento_lateral]] is negative, meaning the rays cross as they pass through the lens and the image appears flipped relative to the object. It is magnified because the magnitude of [[aumento_lateral]] is 1.5, greater than one: each centimetre of the object maps to 1.5 cm in the image.

Physically, this result arises because the object lies between one and two focal lengths from the lens, the zone where real images are magnified. Moving the object closer to the focus would cause [[d_i]] to grow without bound and the image to enlarge enormously, a situation exploited in projectors. Moving it beyond two focal lengths would reduce the magnitude of [[aumento_lateral]] below one and shrink the image, as occurs in the human eye when viewing distant objects.

Sign coherence confirms the validity of the result: positive [[d_i]] with negative [[aumento_lateral]] corresponds to the real-inverted image pair, exactly what ray tracing predicts. Had we obtained positive [[d_i]] with positive [[aumento_lateral]], that combination would violate the sign convention and signal an algebraic error. This kind of self-check is essential in geometrical optics problems.
...
Refining: [[d_o]] works out to approximately 82 mm (slightly above [[distancia_focal]]). The magnification [[aumento_lateral]] is of the order of minus 37 (inverted image, which the projector corrects by placing the slide upside down). The screen image measures roughly 89 cm, a reasonable value for classroom projection.

The thin lens model is applicable because the projector lens has an 80 mm focal length and its typical thickness is of the order of 8 mm (one tenth of the focal length), within the validity limit. The lens is manufactured from glass with refractive index [[indice_de_refraccion_de_la_lente]] of approximately 1.5 and a front surface radius [[radio_de_curvatura_de_la_primera_superficie]] of the order of 60 mm, parameters that the lensmaker's equation connects to the resulting focal length.

## Interpretation

The result confirms that a short focal-length lens can produce highly magnified images when the object is barely above the focal distance. Sensitivity is high: moving the slide by 1 mm changes [[d_i]] significantly, which explains why projectors incorporate fine-focus mechanisms. The relationship between [[d_o]] and [[distancia_focal]] operates in a regime of high sensitivity because [[d_o]] is only slightly larger than [[distancia_focal]], placing the system near the divergence point of the thin lens equation.
