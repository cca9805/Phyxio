...
The **thin lens** model treats the lens as a two-dimensional interface that bends rays without introducing additional optical path through its thickness. The focal length [[distancia_focal]], the distances [[d_o]] and [[d_i]], and the magnification [[aumento_lateral]] are preserved. The real glass thickness, spherical aberrations, chromatic aberration and surface-reflection losses are ignored.
...
- The lens thickness is negligible compared to [[d_o]], [[d_i]] and [[distancia_focal]].
...
For optical frequencies, BK7 glass chromatic dispersion produces variations in [[indice_de_refraccion_de_la_lente]] on the order of 0.008 between 400 nm and 700 nm, equivalent to a focal shift of roughly 1 % of [[distancia_focal]].

## Model failure signals

- The screen image appears blurry at the edges but sharp at the centre: spherical aberration.
- The measured image size does not match the prediction from [[aumento_lateral]] for extended objects: the model fails for marginal rays.
