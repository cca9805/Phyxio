...
El modelo de **lente delgada** trata la lente como una interfaz bidimensional que desvía los rayos sin introducir recorrido optico adicional por su espesor. Se conservan la distancia focal [[distancia_focal]], las posiciones [[d_o]] y [[d_i]], y el aumento [[aumento_lateral]]. Se ignoran el espesor real del vidrio, las aberraciones esfericas, la aberracion cromatica y las perdidas por reflexion en las superficies.
...
- El espesor de la lente es despreciable frente a [[d_o]], [[d_i]] y [[distancia_focal]].
...
Para frecuencias opticas, la dispersion cromatica de vidrio BK7 produce variaciones de [[indice_de_refraccion_de_la_lente]] del orden de 0.008 entre 400 nm y 700 nm, equivalente a un desplazamiento focal de aproximadamente el 1 % de [[distancia_focal]].

## Señales de fallo del modelo

- La imagen observada en pantalla aparece borrosa en los bordes pero nitida en el centro: aberracion esferica.
- El tamano de imagen medido no coincide con el predicho por [[aumento_lateral]] para objetos extensos: el modelo falla para rayos marginales.
