# Pulleys - Common errors and misunderstandings
...
3. **Visual count**: Draw the tackle and count only the rope segments passing directly over the moving pulley or load. That number must match the value of [[n]] used in the formula.
