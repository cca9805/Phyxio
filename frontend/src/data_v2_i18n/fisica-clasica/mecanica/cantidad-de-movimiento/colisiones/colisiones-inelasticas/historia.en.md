...
The change came when mechanics began to demand clearly defined systems, consistent diagrams, and testable quantitative relations. That transition turned the study of inelastic collisions into a problem that could be argued with data rather than with craft intuition alone. The move from qualitative description to quantitative validation was decisive.
