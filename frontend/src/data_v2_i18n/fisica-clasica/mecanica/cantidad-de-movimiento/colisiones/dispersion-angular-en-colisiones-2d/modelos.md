# Modelos fisicos: dispersion angular en colisiones 2d

## Modelo ideal

El modelo ideal de dispersion angular en colisiones 2d supone que basta con interpretar como se reparte el momento entre direcciones tras un choque oblicuo. Se conserva solo la estructura imprescindible para que la relacion principal describa el mecanismo dominante y para que la lectura del diagrama siga siendo limpia. En este nivel se eliminan detalles secundarios del material, del fluido o del contacto porque todavia no cambian la conclusion esencial. Esa simplificacion es valiosa siempre que el alumno pueda explicar que fenomeno se ha descartado y por que su ausencia no altera la interpretacion principal.
