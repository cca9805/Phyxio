# Modelos fisicos: impulso externo y ruptura de la conservacion

## Modelo ideal

El modelo ideal de impulso externo y ruptura de la conservacion supone que basta con medir como un impulso externo rompe o corrige la conservacion ideal. Se conserva solo la estructura imprescindible para que la relacion principal describa el mecanismo dominante y para que la lectura del diagrama siga siendo limpia. En este nivel se eliminan detalles secundarios del material, del fluido o del contacto porque todavia no cambian la conclusion esencial. Esa simplificacion es valiosa siempre que el alumno pueda explicar que fenomeno se ha descartado y por que su ausencia no altera la interpretacion principal.


## Hipótesis

Las hipótesis fundamentales de este modelo son: cuerpos puntuales o rígidos, ausencia de fuerzas externas netas durante la interacción, y marco de referencia inercial. Cualquier violación de estas condiciones exige revisar si el modelo sigue siendo aplicable o si se requiere una extensión.
