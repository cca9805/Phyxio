...
The key change was recognizing that internal forces between parts of the system always sum to zero (Third Law), so the condition of isolation refers exclusively to interaction with the external environment. This reformulation turned the conservation principle into a precise and operational tool.
