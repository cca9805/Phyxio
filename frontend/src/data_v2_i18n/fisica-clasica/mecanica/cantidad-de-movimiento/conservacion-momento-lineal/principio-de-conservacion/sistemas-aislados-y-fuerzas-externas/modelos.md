# Modelos fisicos: sistemas aislados y fuerzas externas

## Modelo ideal

El modelo ideal de sistemas aislados y fuerzas externas supone que basta con comparar el balance interno del sistema con la accion de fuerzas externas. Se conserva solo la estructura imprescindible para que la relacion principal describa el mecanismo dominante y para que la lectura del diagrama siga siendo limpia. En este nivel se eliminan detalles secundarios del material, del fluido o del contacto porque todavia no cambian la conclusion esencial. Esa simplificacion es valiosa siempre que el alumno pueda explicar que fenomeno se ha descartado y por que su ausencia no altera la interpretacion principal.
