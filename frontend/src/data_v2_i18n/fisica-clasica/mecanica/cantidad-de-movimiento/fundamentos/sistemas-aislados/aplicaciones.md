...
Variable dominante: comparar el impulso externo esperado con el intercambio interno del choque.

Limite de validez: la hipotesis cae si el rozamiento residual, la pendiente o el empuje del aire dejan de ser pequenos.

## 2. Explosion de puck sobre hielo
...
Variable dominante: vigilar si [[pTotI]] y [[pTotF]] se mantienen coherentes mientras [[Jext]] sigue siendo despreciable.

Limite de validez: la aplicacion deja de servir si el objeto roza bordes, recibe un empuje externo o cambia de plano.

## 3. Separacion de nave y modulo
...
Variable dominante: estimar cuanto pesa [[Jext]] frente al momento intercambiado entre las dos partes.

Limite de validez: hay que cambiar de modelo si los propulsores siguen activos o si la separacion dura demasiado.

## 4. Auditoria de perturbaciones

En una revision experimental para saber que fuerzas externas se estaban ignorando, sistemas aislados deja de ser abstracto porque permite determinar si una discrepancia nace del sensor o de un mal supuesto de aislamiento. El problema practico no consiste solo en obtener un numero, sino en decidir si la simplificacion elegida sigue siendo defendible cuando aparecen tiempos finitos de contacto, rotaciones, apoyos o distribuciones reales de masa. Para responder bien hay que conectar el modelo con una escena medible y con una consecuencia tangible: aprobar un ensayo, corregir un diseno, interpretar un video o rechazar una conclusion precipitada.
...
Variable dominante: usar [[DeltaPtot]] como prueba de fuego para detectar cuando el entorno si esta mandando.

Limite de validez: la lectura se vuelve ambigua si el intervalo temporal del analisis no coincide con el evento fisico.

## 5. Comparacion de fronteras del sistema
...
Variable dominante: seguir como cambian [[pTotI]], [[pTotF]] y [[Jext]] cuando la frontera se mueve.

Limite de validez: no sirve redefinir el sistema si con ello desaparece la magnitud que se queria interpretar.
