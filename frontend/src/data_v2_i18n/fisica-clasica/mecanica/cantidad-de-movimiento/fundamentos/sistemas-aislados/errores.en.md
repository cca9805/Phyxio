# Common mistakes: isolated systems

## Conceptual errors

### Error 1: Confusing the formal definition of isolated systems with everyday intuition

**Why it seems correct:**
Everyday intuition about isolated systems works in simple contexts, so it seems always correct.

**Why it is wrong:**
The physics definition of isolated systems includes restrictions (vector nature, sign, reference frame) that intuition ignores.
...
A student applies isolated systems without considering the vector sign and gets a positive result where it should be negative; the magnitude is correct but the direction is not.

## Model errors

### Error 2: Applying the ideal model of isolated systems outside its validity domain
...
**Mini contrast example:**
Applying the ideal formula for isolated systems at relativistic speeds gives >5 % error when the speed exceeds 10% of the speed of light.

## Mathematical errors

### Error 3: Sign error when projecting vectors in the calculation of isolated systems
...
**Mini contrast example:**
A particle moves leftward along the x-axis. If a positive velocity is assumed instead of a negative one, the computed momentum points the wrong way.
...
**Mini contrast example:**
The student obtains a momentum of -12 kg·m/s and writes only "12". The negative sign indicates the opposite direction to the chosen axis, which is lost information.
