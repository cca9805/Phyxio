# Errores comunes: sistemas aislados

## Errores conceptuales

### Error 1: Confundir la definición formal de sistemas aislados con la intuición cotidiana

**Por qué parece correcto:**
La intuición cotidiana sobre sistemas aislados funciona en contextos simples, así que parece correcta siempre.

**Por qué es incorrecto:**
La definición física de sistemas aislados incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.
...
Un alumno aplica sistemas aislados sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.

## Errores de modelo

### Error 2: Aplicar el modelo ideal de sistemas aislados fuera de su dominio de validez
...
**Mini-ejemplo de contraste:**
Aplicar la fórmula ideal de sistemas aislados a velocidades relativistas da un error >5 % cuando la velocidad supera el 10% de la velocidad de la luz.

## Errores matemáticos

### Error 3: Error de signo al proyectar vectores en el cálculo de sistemas aislados
...
**Mini-ejemplo de contraste:**
Una partícula se mueve hacia la izquierda respecto al eje x. Si se asume una velocidad positiva en vez de negativa, el momento calculado apunta al lado equivocado.
...
**Mini-ejemplo de contraste:**
El alumno obtiene un momento de -12 kg·m/s y escribe solo "12". El signo negativo indica dirección opuesta al eje elegido, información que se pierde.
