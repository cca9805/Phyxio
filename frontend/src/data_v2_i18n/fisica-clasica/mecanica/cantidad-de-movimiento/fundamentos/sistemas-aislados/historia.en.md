...
What was poorly understood was which conditions make the isolation approximation legitimate. In many contexts, quantities that we now distinguish carefully were treated as equivalent, or visual impression alone was assumed to be enough to identify the cause of motion or equilibrium. That old confusion still reappears in common school mistakes.

## What changed

The change came when mechanics began to demand clearly defined systems, consistent diagrams, and testable quantitative relations. That transition turned the study of isolated systems into a problem that could be argued with data rather than with craft intuition alone. The move from qualitative description to quantitative validation was decisive.
