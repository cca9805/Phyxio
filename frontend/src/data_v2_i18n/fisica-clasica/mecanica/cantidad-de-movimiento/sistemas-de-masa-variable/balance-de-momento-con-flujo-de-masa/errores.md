# Errores comunes: balance de momento con flujo de masa

## Errores conceptuales

### Error 1: Confundir la definición formal de balance de momento con flujo de masa con la intuición cotidiana

**Por qué parece correcto:**
La intuición cotidiana sobre balance de momento con flujo de masa funciona en contextos simples, así que parece correcta siempre.

**Por qué es incorrecto:**
La definición física de balance de momento con flujo de masa incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.
...
Un alumno aplica balance de momento con flujo de masa sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.

## Errores de modelo

### Error 2: Aplicar el modelo ideal de balance de momento con flujo de masa fuera de su dominio de validez
...
**Mini-ejemplo de contraste:**
Aplicar la fórmula ideal de balance de momento con flujo de masa a velocidades relativistas da un error >5 % cuando v > 0.1c.

## Errores matemáticos

### Error 3: Error de signo al proyectar vectores en el cálculo de balance de momento con flujo de masa
...
**Mini-ejemplo de contraste:**
Una partícula se mueve hacia la izquierda respecto al eje \(x\). Si se pone \(v > 0\) en vez de \(v < 0\), el momento calculado apunta al lado equivocado.
...
**Mini-ejemplo de contraste:**
El alumno calcula un momento lineal [[P]] con signo negativo y anota solo el módulo. El signo negativo indica dirección opuesta al eje elegido, información que se pierde.
