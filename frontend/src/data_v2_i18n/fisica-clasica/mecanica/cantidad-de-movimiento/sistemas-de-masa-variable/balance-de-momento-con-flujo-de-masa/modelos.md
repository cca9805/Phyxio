# Modelos fisicos: balance de momento con flujo de masa

## Modelo ideal

El modelo ideal de balance de momento con flujo de masa supone que basta con extender el balance de momento a sistemas abiertos con entrada o salida de masa. Se conserva solo la estructura imprescindible para que la relacion principal describa el mecanismo dominante y para que la lectura del diagrama siga siendo limpia. En este nivel se eliminan detalles secundarios del material, del fluido o del contacto porque todavia no cambian la conclusion esencial. Esa simplificacion es valiosa siempre que el alumno pueda explicar que fenomeno se ha descartado y por que su ausencia no altera la interpretacion principal.
