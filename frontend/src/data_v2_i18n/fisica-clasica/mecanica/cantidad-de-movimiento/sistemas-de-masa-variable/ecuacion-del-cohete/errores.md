# Errores comunes: ecuación del cohete

## Errores conceptuales

### Error 1: Confundir la definición formal de ecuación del cohete con la intuición cotidiana

**Por qué parece correcto:**
La intuición cotidiana sobre ecuación del cohete funciona en contextos simples, así que parece correcta siempre.

**Por qué es incorrecto:**
La definición física de ecuación del cohete incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.
...
Un alumno aplica ecuación del cohete sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.

## Errores de modelo

### Error 2: Aplicar el modelo ideal de ecuación del cohete fuera de su dominio de validez
...
**Mini-ejemplo de contraste:**
Aplicar la fórmula ideal de ecuación del cohete a velocidades relativistas da un error >5 % cuando v > 0.1c.

## Errores matemáticos

### Error 3: Error de signo al proyectar vectores en el cálculo de ecuación del cohete
...
**Mini-ejemplo de contraste:**
Una partícula se mueve hacia la izquierda respecto al eje x. Si se usa una velocidad positiva en vez de negativa, el momento calculado apunta al lado equivocado.
...
**Mini-ejemplo de contraste:**
El alumno calcula un momento lineal negativo y escribe solo el módulo, descartando la información de signo. El signo negativo indica dirección opuesta al eje elegido, información que se pierde.
