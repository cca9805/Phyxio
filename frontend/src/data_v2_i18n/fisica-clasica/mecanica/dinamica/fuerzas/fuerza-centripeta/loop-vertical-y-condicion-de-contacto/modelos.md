# Modelos físicos: Loop vertical y condicion de contacto
...
**Para Ecuacion radial general:**
- r > 0

**Para Ecuacion radial en el punto alto:**
- r > 0
...
### Transición explícita a modelo alternativo

Cambia de modelo cuando la diferencia entre predicción ideal y medición real sea sistemática y operacionalmente relevante, o cuando el cálculo ideal exija condiciones físicamente no sostenibles (por ejemplo, contacto límite repetido sin margen en escenarios reales).

Transicion explicita: cuando conviene cambiar de modelo, se abandona el esquema ideal y se adopta un modelo alternativo con disipacion, flexibilidad o dinamica acoplada segun el mecanismo dominante observado.

### Cuándo conviene cambiar de modelo

Si la decisión de seguridad, diseño o mantenimiento depende de efectos que el modelo ideal ignora, la transición al modelo extendido deja de ser opcional y pasa a ser obligatoria.
