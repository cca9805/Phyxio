# Errores frecuentes: Tension en cuerdas y cables
...
Antes de cerrar un ejercicio, verifica cinco puntos: modelo elegido, ejes y signos consistentes, uso correcto de [[T]] frente a [[Tx]] y [[Ty]], coherencia dimensional de resultados incluyendo [[dT_dy]], e interpretacion final ligada a validez fisica. Si falla uno, el resultado no esta listo para decision tecnica.
