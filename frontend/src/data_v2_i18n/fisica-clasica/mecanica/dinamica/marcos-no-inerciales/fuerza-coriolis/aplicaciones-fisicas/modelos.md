# Modelos físicos: Aplicaciones fisicas
...
Estrategia recomendada: usar primero el ideal para detectar relevancia, luego escalar solo si los indicadores lo exigen.
