...
## 🔵 Formal level
The mathematical expression defining this behavior is based on the equality of pressures in a closed system in equilibrium. If we apply an input force [[F1]] on an area [[A1]], we generate a pressure [[p]] that is transmitted to the output area [[A2]], producing a force [[F2]]. The fundamental relationship is:
