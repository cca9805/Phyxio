...
En esta ecuación, el término ([[z1]] - [[z2]]) representa la diferencia de cotas verticales [[dz]]. Si el punto final está a mayor profundidad, [[z2]] será un valor más negativo que [[z1]], haciendo que la resta sea positiva y, por tanto, que la presión [[p2]] aumente respecto a [[p1]].

## Sustitución numérica
Introducimos los valores proporcionados en el enunciado, asegurando la coherencia total de las unidades dentro del Sistema Internacional (SI):
