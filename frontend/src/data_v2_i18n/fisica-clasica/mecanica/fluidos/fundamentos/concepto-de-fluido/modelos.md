# Modelos físicos: concepto de fluido
...
La comparación con modelos alternativos sirve para decidir si conviene una descripción macroscópica o microscópica. El modelo de medio continuo es extremadamente potente y eficiente para casi todas las aplicaciones de ingeniería terrestre, desde la hidráulica hasta el diseño de barcos, mientras que los modelos moleculares se reservan para condiciones extremas de escala o presión.
