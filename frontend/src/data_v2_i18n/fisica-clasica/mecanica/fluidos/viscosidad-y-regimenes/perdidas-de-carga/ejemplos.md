...
1.  **Número de Reynolds**: se calcula con [[rho]], [[v]], [[D]] y la viscosidad dinámica para identificar el régimen de flujo.
2.  **Rugosidad relativa**: se obtiene como el cociente entre rugosidad absoluta y [[D]].
3.  **Factor [[f]]**: se estima con una correlación explícita para régimen turbulento, como Haaland.
4.  **Pérdida de carga**:
    {{f:darcy_weisbach}}
5.  **Caída de presión**:
    {{f:conversion_presion}}
...
1.  **Reynolds [[Re]]**:
- Con los datos del problema, [[Re]] resulta aproximadamente 199201, por lo que el flujo es turbulento.
2.  **Factor f**:
- Con rugosidad relativa de 0.00045, [[f]] resulta aproximadamente 0.0189.
3.  **Pérdida de carga [[hf]]**:
- Al aplicar Darcy-Weisbach se obtiene [[hf]] aproximadamente igual a 5.78 metros.
4.  **Presión [[dp]]**:
- Al convertir con densidad y gravedad, [[dp]] resulta aproximadamente 56.6 kilopascales.

## Validación dimensional
- Pérdida de carga: la combinación adimensional del factor de fricción y términos geométricos entrega una magnitud de longitud, coherente con metros.
- Presión: al multiplicar densidad, gravedad y altura de carga se obtiene una magnitud de fuerza por unidad de área, coherente con pascales.

## Interpretación física
El resultado obtenido **indica** que el agua pierde energía equivalente a una columna de 5.78 metros solo por fricción. Esto **significa** que si la tubería fuera horizontal, la presión final sería 56.6 kilopascales menor. El valor es plenamente **coherente** para una instalación industrial de estas dimensiones. La potencia disipada de 890 vatios es la **resultante** del trabajo realizado por las fuerzas viscosas sobre el fluido, transformándose irreversiblemente en calor.
