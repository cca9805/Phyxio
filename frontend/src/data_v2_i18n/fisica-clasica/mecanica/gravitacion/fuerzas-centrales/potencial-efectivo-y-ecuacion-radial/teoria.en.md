...
Effective Potential and Radial Equation answers a precise physical question: How does effective potential turn a central orbit into a radial energy problem? The topic is not introduced to add one more equation, but to give the student a reading tool when elementary models no longer separate cause, scale, and domain clearly.

Effective potential converts the geometry of a central orbit into a radial energy reading. The angular barrier is not a new force: it summarizes the geometric resistance to falling toward the center when angular momentum is conserved. For that reason the core quantities, [[Ueff]], [[U]], [[L]], [[m]], [[r]], [[E]], [[rdot]], are not decorative labels. Each one marks part of the structure: a scale, a boundary, a dynamic variable, a validity condition, or a conserved quantity.

## 🟢 Essential level

The essential idea is that effective potential converts the geometry of a central orbit into a radial energy reading. Before calculating, the student must state which physical mechanism is being isolated and which part of the system is deliberately left outside the model. Without that reading, an equation may produce the right number for the wrong question.

At this level, [[Ueff]] acts as the dominant quantity because it concentrates the didactic decision of the leaf. It is not enough to name it: the student must explain whether it increases, decreases, changes sign, vanishes, or loses meaning when the regime changes.
...
It is also useful to separate description from decision. Description lists quantities; decision explains which of them controls the observed change. In this leaf, that decision is supported by [[Ueff]] and by the comparison between dominant term, correction, and limiting case. This distinction prevents the student from confusing a long solution with a deep solution.
...
To apply them, [[Ueff]], [[U]], [[L]], [[m]], [[r]], [[E]], [[rdot]] must belong to the same system. Sign, units, and domain must also be checked. The central question remains: How does effective potential turn a central orbit into a radial energy problem? If an algebraic rearrangement changes that question, the procedure has stopped being physics and has become symbolic manipulation.
...
In formal calculation, it is useful to imagine the radial function before solving. Allowed radii, stability of a minimum, and the angular barrier are read as features of effective energy. That reading separates this leaf from any purely geometric method.

## 🔴 Structural level

The deeper structure appears when the model is compared with its limits. Effective potential converts the geometry of a central orbit into a radial energy reading. The angular barrier is not a new force: it summarizes the geometric resistance to falling toward the center when angular momentum is conserved. This sentence must work as a control criterion: it decides whether the topic is being used in its natural domain or forced outside its range.
...
The specific reading of effective potential relies on the shape of a radial function. A well indicates confinement, a barrier prevents access to small radii, and a turning point appears where available energy is exhausted. This vocabulary does not belong to Binet: here the student thinks with energy, stability, and radial accessibility.

## Deep physical interpretation

Deep interpretation starts by asking what [[Ueff]] represents in the causal chain. If [[Ueff]] is modified, the regime may change, a critical condition may move, or a secondary assumption may stop being secondary.
...
This check prevents artificial conclusions. The units of [[Ueff]], [[U]], [[L]], [[m]], [[r]], [[E]], [[rdot]] must support the same physical dimension and the same experimental scale.

## Personalized resolution method

First, delimit the system and state the assumptions. Second, identify [[Ueff]] and decide which relation answers the central question. Third, calculate symbolically before substituting numbers.
...
For central orbits, the specific feature of this leaf is reading turning points, wells, and barriers without integrating the whole trajectory. The student learns to read an effective-energy curve: minima as stable orbits, maxima as unstable equilibrium, and intersections with energy as allowed radii.

## Final synthesis

At the end, the student should explain that effective potential converts the geometry of a central orbit into a radial energy reading, apply the formulas in their domain, and justify the physical meaning of the result. The final competence is deciding whether the model answers the question of the real system, not merely obtaining an algebraic expression.
...
In this leaf, even the error vocabulary is specific: confusing an effective-potential maximum with stability, forgetting that the angular barrier depends on L, or interpreting a forbidden radius as if it were a possible trajectory. These errors do not appear in the same form in Binet.
