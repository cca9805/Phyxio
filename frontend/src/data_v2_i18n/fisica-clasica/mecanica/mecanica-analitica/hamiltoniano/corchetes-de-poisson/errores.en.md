# Frequent errors in Poisson Brackets

## Conceptual errors

### Error 1: Treating notation as physics

Why it seems correct: the symbols of Poisson Brackets look powerful and compact.

Why it is incorrect: [[PB]] only has physical meaning when the domain assumptions are satisfied.
...
Why it is incorrect: the interpretation is organized around [[PB]], because it determines the physical reading of the leaf.

Detection signal: the final answer contains formulas but no statement about what [[PB]] means.

Conceptual correction: end every solution with a sentence about the physical role of [[PB]].
