# Modelos para Corchetes de Poisson

## Modelo ideal

El modelo ideal es un sistema clasico regular en el que algebra de observables, flujo hamiltoniano, involucion, generadores infinitesimales y conservacion en espacio de fases puede describirse con variables suaves [[A]], [[B]], [[PB]], [[qi]], [[pi]], [[H]], [[dA_dt]]. El modelo asume que la estructura analitica es el objeto que se pone a prueba, no una decoracion opcional.
...
- La magnitud dominante [[PB]] tiene el papel fisico declarado en magnitudes.yaml.
