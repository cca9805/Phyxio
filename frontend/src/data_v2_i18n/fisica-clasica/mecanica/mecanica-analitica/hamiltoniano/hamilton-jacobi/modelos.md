# Modelos para Hamilton-Jacobi

## Modelo ideal

El modelo ideal es un sistema clasico regular en el que funcion principal de accion, ecuacion diferencial parcial, separacion de variables, integrabilidad e interpretacion de frentes de accion puede describirse con variables suaves [[S]], [[W]], [[H]], [[E]], [[qi]], [[pi]], [[t]]. El modelo asume que la estructura analitica es el objeto que se pone a prueba, no una decoracion opcional.
...
- La magnitud dominante [[S]] tiene el papel fisico declarado en magnitudes.yaml.
