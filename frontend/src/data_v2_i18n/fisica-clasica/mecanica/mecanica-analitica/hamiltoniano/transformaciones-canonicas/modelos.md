# Modelos para Transformaciones canonicas

## Modelo ideal

El modelo ideal es un sistema clasico regular en el que cambios de carta, preservacion simplectica, funciones generatrices, variables nuevas y equivalencia de descripciones hamiltonianas puede describirse con variables suaves [[q]], [[p]], [[Q]], [[P]], [[K]], [[Fgen]], [[C]]. El modelo asume que la estructura analitica es el objeto que se pone a prueba, no una decoracion opcional.
...
- La magnitud dominante [[C]] tiene el papel fisico declarado en magnitudes.yaml.
