...
Operativamente, el modelo ideal es excelente para enseñar estructura, detectar papeles físicos y acelerar el diagnóstico conceptual. El modelo extendido es mejor cuando la geometría del problema manda o cuando el cálculo del torque no puede separarse de la distribución espacial de fuerzas. La comparación entre ambos modelos no se decide por elegancia algebraica, sino por capacidad para conservar significado físico sin simplificar de más.