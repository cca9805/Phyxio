# Errores Frecuentes en Calculo del Torque
...
**Por qué es incorrecto:** I depende del eje de giro. Pensar que cualquier valor de I es intercambiable lleva a una aceleracion angular [[alpha]] incorrecta, aunque la aritmetica sea perfecta.
**Señal de detección:** El valor de [[alpha]] no es plausible para la escala del sistema o no coincide con estimacion cualitativa.
**Corrección conceptual:** Verificar que el eje para el que se calcula I coincide exactamente con el eje de giro declarado en el problema. La relacion correcta es
...
. El error es del 16%, que puede cambiar el diagnostico en un diseño ajustado.
...
**Por qué es incorrecto:** Un signo erroneo en [[F_x]] o [[F_y]] invierte el sentido de giro de [[tau_z]]. El numero puede ser correcto en modulo pero equivocado en signo.
