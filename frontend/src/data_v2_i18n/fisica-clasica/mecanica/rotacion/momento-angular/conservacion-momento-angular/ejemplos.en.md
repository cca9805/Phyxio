...
The system is chosen so that the internal reorganization of mass stays inside the balance while the surrounding torques are clearly identified. That choice must be compatible with the axis of rotation and with the question of the leaf: are we allowed to compare [[Li]] and [[Lf]] directly, or is an external torque large enough to break conservation?
