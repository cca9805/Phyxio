# Common mistakes: conservation of angular momentum

## Conceptual errors

### Error 1: Confusing the formal definition of conservation of angular momentum with everyday intuition

**Why it seems correct:**
Everyday intuition about conservation of angular momentum works in simple contexts, so it seems always correct.

**Why it is wrong:**
The physics definition of conservation of angular momentum includes restrictions (vector nature, sign, reference frame) that intuition ignores.
...
A student applies conservation of angular momentum without considering the vector sign and gets a positive result where it should be negative; the magnitude is correct but the direction is not.

## Model errors

### Error 2: Applying the ideal model of conservation of angular momentum outside its validity domain
...
**Mini contrast example:**
Applying the ideal formula for conservation of angular momentum at relativistic speeds gives >5 % error when
...
### Error 3: Sign error when projecting vectors in the calculation of conservation of angular momentum
...
**Mini contrast example:**
A particle moves leftward along the x-axis. When
...
, the computed momentum points the wrong way.
...
kg·m/s and writes only "12". The negative sign indicates the opposite direction to the chosen axis, which is lost information.
