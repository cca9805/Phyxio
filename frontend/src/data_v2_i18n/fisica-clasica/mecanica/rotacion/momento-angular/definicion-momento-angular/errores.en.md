# Common mistakes: definition of angular momentum

## Conceptual errors

### Error 1: Confusing the formal definition of definition of angular momentum with everyday intuition

**Why it seems correct:**
Everyday intuition about definition of angular momentum works in simple contexts, so it seems always correct.

**Why it is wrong:**
The physics definition of definition of angular momentum includes restrictions (vector nature, sign, reference frame) that intuition ignores.
...
A student applies definition of angular momentum without considering the vector sign and gets a positive result where it should be negative; the magnitude is correct but the direction is not.

## Model errors

### Error 2: Applying the ideal model of definition of angular momentum outside its validity domain
...
**Mini contrast example:**
Applying the ideal formula for definition of angular momentum at relativistic speeds gives >5 % error when
...
### Error 3: Sign error when projecting vectors in the calculation of definition of angular momentum
...
**Mini contrast example:**
A particle moves leftward along the x-axis. If
