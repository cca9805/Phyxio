# Errores comunes: definición del momento angular

## Errores conceptuales

### Error 1: Confundir la definición formal de definición del momento angular con la intuición cotidiana

**Por qué parece correcto:**
La intuición cotidiana sobre definición del momento angular funciona en contextos simples, así que parece correcta siempre.

**Por qué es incorrecto:**
La definición física de definición del momento angular incluye restricciones (vectorialidad, signo, marco de referencia) que la intuición ignora.
...
Un alumno aplica definición del momento angular sin considerar el signo vectorial y obtiene un resultado positivo donde debería ser negativo; la magnitud es correcta pero la dirección no.

## Errores de modelo

### Error 2: Aplicar el modelo ideal de definición del momento angular fuera de su dominio de validez
...
**Mini-ejemplo de contraste:**
Aplicar la fórmula ideal de definición del momento angular a velocidades relativistas da un error >5 % cuando
...
### Error 3: Error de signo al proyectar vectores en el cálculo de definición del momento angular
