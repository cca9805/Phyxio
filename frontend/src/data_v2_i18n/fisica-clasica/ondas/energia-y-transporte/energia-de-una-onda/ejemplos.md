...
(a) Calcular la velocidad de propagación [[velocidad_de_propagacion]] de la onda y la longitud de onda correspondiente.
...
Las magnitudes fundamentales son la densidad de energía [[u_energia]] que varía espacial y temporalmente, la energía total por ciclo [[energia_de_la_onda]], y la potencia transportada [[potencia_de_la_onda]]. La relación entre ellas está gobernada por las fórmulas de transporte energético ondulatorio.
...
(a) La velocidad de propagación [[velocidad_de_propagacion]] en una cuerda bajo tensión se obtiene de la tensión dividida por la densidad lineal, en raíz cuadrada. La longitud de onda resulta de dividir [[velocidad_de_propagacion]] por la frecuencia, o equivalentemente multiplicar [[velocidad_de_propagacion]] por el período angular característico.
...
Alternativamente, puede obtenerse como [[energia_de_la_onda]]·v/[[lambda]], que es equivalente.
...
(a) Velocidad de propagación [[velocidad_de_propagacion]] calculada desde la tensión y la densidad lineal: la raíz cuadrada del cociente entre 800 N y 5.0 milésimos de kg/m da como resultado aproximadamente 400 m/s. La longitud de onda resulta del cociente entre [[velocidad_de_propagacion]] y la frecuencia de 440 Hz, obteniendo aproximadamente 0.91 m.

(b) Energía total en un ciclo:

Para aplicar la fórmula, primero evaluamos los factores individuales. El cuadrado de la frecuencia angular resulta aproximadamente 7.645 × 10⁶ rad²/s². El cuadrado de la [[amplitud]] da 9.0 × 10⁻⁶ m². Multiplicando la densidad lineal por estos factores se obtiene aproximadamente 0.344 J/m. Finalmente, aplicando la fórmula de energía total con el factor medio y la longitud de onda, el resultado es aproximadamente 0.156 J.
...
Los factores son los mismos hasta el cuadrado de la [[amplitud]], pero ahora multiplicamos por [[velocidad_de_propagacion]] en lugar de la longitud de onda. Esto da aproximadamente 138 W antes del factor medio. Aplicando el factor 1/2, la potencia resulta aproximadamente 69 W. La verificación alternativa usando la energía total multiplicada por la velocidad y dividida por la longitud de onda confirma este resultado numérico.
...
La energía de 0.156 J en un solo ciclo de la onda es apreciable para una cuerda, pero no macroscópicamente enorme. Esta energía viaja a lo largo de la cuerda a 400 m/s, pasando por un punto dado en aproximadamente 2.3 ms (el período de oscilación).

La potencia de 69 W es alta para una onda ideal sostenida en una cuerda musical, pero ya está en un orden de magnitud físicamente razonable para un pulso intenso y breve. En la práctica, la cuerda solo mantiene esta [[amplitud]] durante un tiempo corto tras la excitación inicial, y la potencia promedio temporal en una interpretación musical es mucho menor debido al decaimiento natural.

Si la [[amplitud]] se redujera a 1 mm (un tercio), la energía y potencia caerían a un noveno (factor 1/3² = 1/9), resultando en aproximadamente 0.017 J y 7.7 W respectivamente. Esta dependencia cuadrática explica por qué tocar "más fuerte" (mayor [[amplitud]]) aumenta drásticamente el volumen percibido.
