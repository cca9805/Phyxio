...
El diseño óptimo requiere maximizar el flujo [[densidad_de_flujo_de_energia]] manteniendo la integridad mecánica. Esto se logra seleccionando materiales con alta densidad lineal [[mu]] y tensiones que proporcionen velocidades [[velocidad_de_propagacion]] elevadas sin riesgo de ruptura. La [[amplitud]] se controla mediante la excitación inicial, recordando que el flujo depende cuadráticamente de ella.
