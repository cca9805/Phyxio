...
Energy density [[u_energia]] is the energy per unit volume stored in the medium, while flux [[densidad_de_flujo_de_energia]] is the power per unit area crossing a perpendicular surface. A standing wave can have high energy density at its antinodes but zero net flux because energy does not displace netly in any direction. Flux requires propagation; energy density can exist in static media.
