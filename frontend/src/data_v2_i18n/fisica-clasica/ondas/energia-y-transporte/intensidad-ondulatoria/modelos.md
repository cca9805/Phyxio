...
En este modelo simplificado, la intensidad [[intensidad_ondulatoria]] sigue estrictamente la ley del inverso del cuadrado de la distancia: decrece proporcionalmente a 1/r² desde la fuente. La potencia total [[potencia_de_la_fuente]] se conserva en todo el espacio, redistribuyéndose sobre áreas esféricas cada vez mayores sin pérdidas por disipación.
...
- **Fuente puntual isotrópica**: Emite potencia [[potencia_de_la_fuente]] uniformemente en todas direcciones, sin preferencia angular.
