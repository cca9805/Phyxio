...
La **intensidad ondulatoria** mide esa concentración energética: potencia transportada por unidad de área perpendicular a la propagación. El flujo de energía describe el transporte local; la intensidad [[intensidad_ondulatoria]] resume cuánta potencia atraviesa una superficie de medida.
...
Para una fuente puntual que emite potencia [[potencia_de_la_fuente]] de manera isótropa en tres dimensiones, la intensidad a distancia [[r_distancia]] se obtiene dividiendo la potencia total entre el área de la esfera centrada en la fuente:

{{f:intensidad_desde_potencia}}

El área de reparto [[area_de_la_onda_esferica]] se calcula con la geometría esférica:
...
La intensidad [[intensidad_ondulatoria]] es positiva y escalar, mientras que el flujo energético conserva información direccional. Si solo interesa la potencia que cruza una superficie, basta la intensidad. Si interesa hacia dónde viaja la energía, conviene usar el flujo vectorial.
...
2. **Determinar la potencia emitida**: usar [[potencia_de_la_fuente]] en vatios y comprobar si corresponde a potencia total, potencia útil o potencia emitida en una dirección concreta.
