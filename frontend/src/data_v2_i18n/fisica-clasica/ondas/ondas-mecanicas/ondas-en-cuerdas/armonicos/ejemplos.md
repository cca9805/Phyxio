...
Para el caso particular del primer armónico, [[numero_de_armonico]] vale 1 y aparece la fundamental:
...
Para obtener la frecuencia fundamental [[f_1]], dividir la velocidad [[velocidad_de_propagacion]] (312 m/s) entre el doble de la longitud [[longitud_de_la_cuerda]] (1.30 m), usando el primer armónico [[numero_de_armonico]] igual a 1

**Apartado b) Quinto armónico**

Para el quinto armónico, [[numero_de_armonico]] vale 5. Usando la relación general:
...
Donde el número de armónico [[numero_de_armonico]] multiplica la fundamental [[f_1]] para dar la frecuencia del armónico deseado
...
La longitud de onda del quinto armónico [[lambda_n]] resulta de dividir el doble de la longitud de cuerda [[longitud_de_la_cuerda]] entre el número de armónico [[numero_de_armonico]] (cinco)
...
La nueva frecuencia fundamental [[f_1]] se calcula con la nueva longitud [[longitud_de_la_cuerda]] en el denominador, manteniendo constante la velocidad [[velocidad_de_propagacion]] y el número de armónico [[numero_de_armonico]] igual a 1
...
Para el quinto armónico, multiplicar 5 por la frecuencia fundamental. Con [[f_1]] ≈ 240 Hz, la magnitud general [[f_n]] toma aproximadamente 1200 Hz cuando [[numero_de_armonico]] vale cinco.

{{f:longitud_onda_armonica}}

Para la longitud de onda, dividir el doble de la longitud (1.30 m) entre 5, dando aproximadamente 0.26 m.

Para [[numero_de_armonico]] igual a cinco, [[lambda_n]] ≈ 0.26 m (26 cm).
...
Si la tensión de la cuerda se incrementara (girando la clavija), la velocidad [[velocidad_de_propagacion]] aumentaría elevando todas las frecuencias proporcionalmente, permitiendo afinar el instrumento.
