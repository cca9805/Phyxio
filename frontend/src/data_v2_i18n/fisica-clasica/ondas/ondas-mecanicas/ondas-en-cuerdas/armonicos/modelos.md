...
- **Frecuencias no exactamente múltiplos enteros**: Si el cociente entre [[f_n]] y [[f_1]] difiere significativamente de [[numero_de_armonico]], aparece **inarmonicidad** por rigidez de la cuerda.
...
El **modelo de cuerda rígida** (Rayleigh, 1877) incorpora el momento de flexión de la cuerda. En esa lectura, [[f_n]] queda por encima del valor ideal mediante un factor corrector que aumenta con el cuadrado de [[numero_de_armonico]].

El parámetro de rigidez controla cuánto se separan los armónicos altos de la serie ideal. Este modelo predice inarmonicidad creciente con [[numero_de_armonico]].
