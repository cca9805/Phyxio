...
Variable dominante: [[lambda]], que determina [[rapidez_de_propagacion_de_ondas_superficiales]] y, por tanto, el tiempo de llegada de cada componente espectral. Las olas más largas llegan primero porque su [[rapidez_de_propagacion_de_ondas_superficiales]] es mayor. La separación temporal entre la llegada de diferentes [[lambda]] permite estimar la distancia de la fuente.

**Interpretación física**: cada componente armónico de [[lambda]] viaja a [[rapidez_de_propagacion_de_ondas_superficiales]] proporcional a la raíz de [[lambda]]. Un paquete de ondas se dispersa: las componentes largas llegan días antes que las cortas. Los surfistas experimentados reconocen la llegada de "swells" regulares (largas, suaves) antes que las olas caóticas cortas.
...
Variable dominante: [[sigma]], que fija directamente [[rapidez_de_propagacion_de_ondas_superficiales]] en el régimen capilar dado [[numero_de_onda]] y [[rho]] conocidos. Midiendo [[rapidez_de_propagacion_de_ondas_superficiales]] y [[numero_de_onda]] experimentalmente, [[sigma]] se obtiene despejando de la fórmula capilar.

**Interpretación física**: la fórmula capilar actúa como una ecuación inversa que conecta la observable experimental ([[rapidez_de_propagacion_de_ondas_superficiales]] y [[numero_de_onda]]) con la propiedad material deseada ([[sigma]]). Surfactantes, proteínas o contaminantes en la interfaz modifican [[sigma]] de manera detectable con precisión del 1%.
...
**Contexto físico real**: los ingenieros costeros diseñan diques y rompeolas para proteger puertos y playas de la erosión por olas. El dimensionado de estas estructuras requiere conocer [[rapidez_de_propagacion_de_ondas_superficiales]], la longitud de onda de las olas de diseño y la profundidad local, todo ello derivado de la relación de dispersión.
...
**Interpretación física**: las olas de mayor [[lambda]] tienen [[rapidez_de_propagacion_de_ondas_superficiales]] más alta y transportan más energía por unidad de tiempo. El diseño de protección apunta a reducir la [[rapidez_de_propagacion_de_ondas_superficiales]] de las olas que alcanzan la costa disipando energía por reflexión, difracción y disipación viscosa en el material de la estructura.
...
Variable dominante: [[sigma]], que controla la [[rapidez_de_propagacion_de_ondas_superficiales]] de los anillos capilares de pequeño radio. Mayor [[sigma]] produce anillos que se expanden más rápido y son más estables frente al amortiguamiento viscoso.
...
**Contexto físico real**: la presencia de residuos de petróleo, aceites o surfactantes en la superficie del agua reduce [[sigma]] de forma medible. Sensores ópticos y acústicos miden la [[rapidez_de_propagacion_de_ondas_superficiales]] de ondas capilares generadas artificialmente para estimar el grado de contaminación superficial en tiempo real.
...
Variable dominante: [[sigma]], cuya reducción por contaminantes disminuye [[rapidez_de_propagacion_de_ondas_superficiales]] capilar. La sensibilidad es máxima en el régimen capilar puro: [[rapidez_de_propagacion_de_ondas_superficiales]] es proporcional a la raíz cuadrada de [[sigma]], por lo que una reducción del 50% en [[sigma]] produce una reducción del 29% en [[rapidez_de_propagacion_de_ondas_superficiales]], detectable con precisión acústica.

**Interpretación física**: el sensor emite una onda capilar de [[numero_de_onda]] conocido y mide el tiempo de llegada al receptor. La [[rapidez_de_propagacion_de_ondas_superficiales]] medida se invierte en la fórmula capilar para obtener [[sigma]] efectivo de la superficie. Cualquier contaminante que reduzca [[sigma]] se manifiesta como una disminución de [[rapidez_de_propagacion_de_ondas_superficiales]] medida.
