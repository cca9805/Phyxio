...
El resultado central es la relación de dispersión que conecta [[rapidez_de_propagacion_de_ondas_superficiales]], [[aceleracion_gravitatoria]], [[sigma]], [[rho]] y [[numero_de_onda]]: la rapidez de fase de cada componente armónica depende únicamente de [[numero_de_onda]], y la superposición de componentes de distinto [[numero_de_onda]] produce dispersión. La energía total de la onda se reparte por igual entre energía cinética del fluido y energía potencial (gravitatoria más superficial).
...
- La ola se curva hacia adelante y rompe. El punto de ruptura requiere que la velocidad de las partículas en la cresta iguale a [[rapidez_de_propagacion_de_ondas_superficiales]], condición que excede con creces la hipótesis de amplitud pequeña.
...
**Teoría de agua somera**: cuando la profundidad es menor que un quinto de [[lambda]], la relación de dispersión se modifica por una función tangente hiperbólica del producto de [[numero_de_onda]] y la profundidad. En el límite de agua muy somera, [[rapidez_de_propagacion_de_ondas_superficiales]] depende únicamente de la profundidad y de [[aceleracion_gravitatoria]], no de [[numero_de_onda]]; la onda no es dispersiva en ese límite extremo. Este modelo explica el ralentizamiento y la deformación de tsunamis al aproximarse a la costa.

**Ondas viscosas**: incluyen la disipación por viscosidad, importante para capilares en líquidos de alta viscosidad (aceites, polímeros). La amplitud decae exponencialmente con el tiempo; la tasa de decaimiento es proporcional a la viscosidad cinemática multiplicada por el cuadrado de [[numero_de_onda]].
...
La viscosidad es irrelevante para [[lambda]] mayor de 1 cm en agua a temperatura ambiente, pero se convierte en el factor dominante de amortiguamiento para capilares de décimas de milímetro. En ese límite, el cociente entre la longitud de amortiguamiento y [[lambda]] disminuye con [[numero_de_onda]] al cuadrado.

La transición entre régimen gravitatorio y capilar no requiere cambiar el modelo sino simplemente reconocer qué término de la relación de dispersión domina para el [[numero_de_onda]] en cuestión. Usar la fórmula combinada siempre que no haya certeza sobre el régimen elimina esta ambigüedad.