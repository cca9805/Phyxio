...
## 1. Inspección de soldaduras en tuberías de centrales nucleares
...
El contraste acústico entre un adhesivo bien adherido ([[impedancia_acustica]] de 2–3 MRayl) y el aire de un despegue ([[impedancia_acustica]] de 400 Rayl) produce [[coeficiente_de_reflexion_acustica]] próximo a 1 en la zona de despegue, frente a un [[coeficiente_de_reflexion_acustica]] de aproximadamente 0.3 en la zona de adhesión correcta. La presencia de la reflexión intensa en [[t_vuelo]] correspondiente a la interfaz adhesivo-composite señala un despegue. La amplitud del eco de la segunda interfaz (interior del panel) desaparece en zonas de despegue porque la energía es casi completamente reflejada en la primera interfaz.

Variable dominante: [[coeficiente_de_reflexion_acustica]] en la interfaz adhesivo-substrate, que determina si el eco de primer interfaz es alto (despegue, [[coeficiente_de_reflexion_acustica]] próximo a 1) o bajo (adhesión correcta, [[coeficiente_de_reflexion_acustica]] bajo).
...
Las ondas guiadas de baja frecuencia (entre 20 y 100 kHz) se propagan a lo largo del tubo con [[v_us]] dependiente del modo y del diámetro, recorriendo distancias de hasta 50 metros desde el transductor. Una reducción localizada del espesor de pared actúa como reflector que modifica [[t_vuelo]] y [[coeficiente_de_reflexion_acustica]] del eco recibido. El análisis de la señal permite estimar [[d_defecto]] axial (la distancia al punto corroído a lo largo del tubo) con una precisión de aproximadamente el 1 % de la distancia recorrida.
