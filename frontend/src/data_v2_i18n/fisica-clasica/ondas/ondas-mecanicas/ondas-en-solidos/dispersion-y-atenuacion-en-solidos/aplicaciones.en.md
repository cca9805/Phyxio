...
## 1. Non-destructive testing in aerospace industries
...
Validity limit: thicknesses below 3×[[longitud_de_atenuacion]] with signal-to-noise ratio above 10 dB; not valid in regions with property gradients without complete directional analysis
...
In healthy cortical bone, [[longitud_de_atenuacion]] ≈ 2-5 mm; in osteoporotic bone it can increase to 10 mm. In muscular tissue, [[longitud_de_atenuacion]] ≈ 50-100 mm; in adipose tissue, [[longitud_de_atenuacion]] ≈ 150-200 mm. [[frecuencia]] variation follows a power law with exponent [[exponente_de_frecuencia]] ≈ 1.1-1.3.

Dominant variable: attenuation length [[longitud_de_atenuacion]], directly correlating with bone mineral density and tissue elasticity
...
In aqueous liquids, typical [[perdida_en_decibelios]] values are 1-10 dB/cm; in meat products, 15-30 dB/cm; in baked products, 25-50 dB/cm. Temperature dependence follows a thermal coefficient of -0.2 to -0.5%/°C depending on food type.

Dominant variable: loss in decibels [[perdida_en_decibelios]] per unit thickness, correlating with food composition and texture
...
Seismic attenuation, expressed through the quality factor Q (inversely proportional to [[alpha]]), allows inferring petrophysical rock properties, detecting presence of hydrocarbons, water, and gas, and characterizing subsurface stratigraphic structure. Seismic dispersion causes different components of [[frecuencia]] to travel at different velocities, affecting seismic image resolution and requiring corrections for precise interpretation.
...
Dominant variable: quality factor Q, correlating with [[alpha]] through Q , where [[frecuencia]] is frequency and v is propagation velocity
