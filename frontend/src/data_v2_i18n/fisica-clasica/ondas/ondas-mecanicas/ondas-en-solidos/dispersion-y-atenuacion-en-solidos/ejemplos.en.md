...
For the attenuation length, calculate the inverse of 61.1 Np/m, which gives approximately 0.0164 m or 16.4 mm. Thus [[longitud_de_atenuacion]] has a value of about 16.4 mm.

For the loss in decibels, calculate 20 × log10(2.0/0.8). The ratio 2.0/0.8 is 2.5, whose base-10 logarithm is approximately 0.398. Multiplying by 20 gives approximately 7.96 dB. Therefore [[perdida_en_decibelios]] has a value of about 7.96 dB.
...
Units of [[longitud_de_atenuacion]]: inverse of Np/m results in meters, dimension `[L]`.

Units of [[perdida_en_decibelios]]: base-10 logarithm is dimensionless, multiplied by 20 maintains dimensionlessness with dB reference.

Dimensional breakdown: the exponential argument [[alpha]]·[[distancia_de_propagacion]] must be dimensionless, result of `[L⁻¹]` times `[L]` equals `[1]`.

The ratio [[amplitud_a_distancia_x]]/[[amplitud_inicial]] is dimensionless by nature, consistent with model expectations.
...
For titanium at elevated temperature, the reference attenuation coefficient [[alpha_0]] is approximately 15 Np/m at the reference frequency [[f_0]] of 2.5 MHz and follows a power law with frequency exponent [[exponente_de_frecuencia]] of about 1.2. Using the frequency dependence relationship:

{{f:dependencia_frecuencia}}

At 10 MHz, [[alpha]] would be approximately 15 multiplied by (10/2.5) raised to the power of 1.2 (with [[alpha_0]] = 15 Np/m and [[f_0]] = 2.5 MHz), which gives about 94.5 Np/m.
