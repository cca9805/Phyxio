...
**Por qué es incorrecto**
La atenuación sigue una ley exponencial, no lineal. La aproximación lineal solo es válida para distancias mucho menores que la longitud de atenuación [[longitud_de_atenuacion]].
...
**Corrección conceptual**
La relación correcta es exponencial. Solo en el límite de pequeñas distancias ([[distancia_de_propagacion]] << [[longitud_de_atenuacion]]) la aproximación lineal es válida con pendiente proporcional a [[alpha]].
...
**Señal de detección**
Si el gráfico ln([[amplitud_a_distancia_x]]/[[amplitud_inicial]]) vs distancia no es una línea recta sino una curva, o si diferentes regiones de la misma pieza dan valores distintos de [[alpha]].
...
**Corrección conceptual**
Para extraer [[alpha]] de mediciones de amplitud usar ln([[amplitud_a_distancia_x]]/[[amplitud_inicial]]), para cálculos en dB usar 20·log10([[amplitud_a_distancia_x]]/[[amplitud_inicial]]). No intercambiar las fórmulas.
...
**Por qué parece correcto**
El estudiante asume que [[longitud_de_atenuacion]] es la distancia máxima a la cual puede realizarse el ensayo, tomando el límite físico como límite práctico.

**Por qué es incorrecto**
[[longitud_de_atenuacion]] es la distancia donde la amplitud se reduce a 37%, no donde se vuelve indetectable. La profundidad útil depende del umbral del equipo, típicamente 3-5 veces [[longitud_de_atenuacion]].

**Señal de detección**
Si se concluye que un material no puede inspeccionarse más allá de [[longitud_de_atenuacion]] cuando en la práctica se obtienen ecos a distancias mayores.

**Corrección conceptual**
[[longitud_de_atenuacion]] es una escala característica, no un límite absoluto. La profundidad máxima de detección depende del umbral de ruido del equipo y es generalmente varias veces [[longitud_de_atenuacion]].

**Mini-ejemplo de contraste**
Para [[longitud_de_atenuacion]] de 2 cm, el estudiante concluye que no puede inspeccionar más allá de 2 cm. En realidad, con equipo sensible puede detectar ecos hasta 6-10 cm, aunque con amplitud muy reducida.
...
Primero, confirme que la relación entre amplitud y distancia es exponencial graficando ln([[amplitud_a_distancia_x]]/[[amplitud_inicial]]) vs [[distancia_de_propagacion]]; debe obtener una línea recta. Segundo, verifique que el [[alpha]] calculado sea positivo y constante en todo el rango. Tercero, asegúrese de haber compensado la dispersión geométrica antes de atribuir pérdidas al material. Cuarto, compruebe que está usando logaritmo natural para cálculos de [[alpha]] y logaritmo base 10 para decibelios. Finalmente, verifique que la profundidad de detección estimada sea varias veces [[longitud_de_atenuacion]], no igual a [[longitud_de_atenuacion]].
