...
This idealization conserves total system energy (energy lost by the wave converts to heat) but ignores real microstructural complexity. The quantities maintained are frequency [[frecuencia]] and propagation velocity, while geometric dispersion effects, grain scattering, and frequency dependence of [[alpha]] are neglected.
...
The exponential model is valid when propagation distance is greater than 10 times the wavelength but less than 3 times the attenuation length [[longitud_de_atenuacion]]. For typical industrial testing frequencies (0.5-20 MHz), this corresponds to distances between 1 mm and 100 mm depending on the material.
...
- **Deviation from linearity in logarithmic scale**: If the ln([[amplitud_a_distancia_x]]/[[amplitud_inicial]]) vs [[distancia_de_propagacion]] graph is not a straight line, the exponential model fails. This indicates [[alpha]] variation with distance or uncompensated geometric dispersion effects.
...
| **Required parameters** | [[alpha]], [[distancia_de_propagacion]], [[amplitud_inicial]] | [[alpha]]([[frecuencia]]), beam geometry, anisotropy |
