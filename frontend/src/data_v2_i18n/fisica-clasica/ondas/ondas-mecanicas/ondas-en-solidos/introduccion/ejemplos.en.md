...
- [[modulo_de_young]] (aluminium) = 69 × 10⁹ Pa
- [[rho]] (aluminium) = 2700 kg/m³
- Bar length: 3 m
- Diameter: 10 mm (0.010 m)
- Dominant impact [[frecuencia]]: 5000 Hz
...
The longitudinal wave speed model for thin bars is applied: [[v_fase]] depends on [[modulo_de_young]] and [[rho]]. The thin bar condition holds because the diameter (10 mm) is much smaller than the expected wavelength. Transit time is obtained by dividing length by velocity. [[lambda]] is obtained from the fundamental dispersion relation.
...
[[lambda]] from the dispersion relation:

{{f:relacion_dispersion}}

## Numerical substitution

(a) Calculating the longitudinal velocity:

[[v_fase]] = √([[modulo_de_young]] / [[rho]]) = √(69 × 10⁹ / 2700) = √(25.56 × 10⁶) ≈ 5055 m/s

(b) Calculating the transit time:

Time = length / [[v_fase]] = 3 / 5055 ≈ 5.93 × 10⁻⁴ s ≈ 0.593 ms

(c) Calculating the wavelength:

[[lambda]] = [[v_fase]] / [[frecuencia]] = 5055 / 5000 ≈ 1.011 m
...
If one wished to work with transverse waves in the same aluminium, [[modulo_de_cizalladura]] (about 26 GPa) would be used instead of [[modulo_de_young]], obtaining a lower velocity of about 3100 m/s. This means a receiver placed at the fixed end would first detect the longitudinal arrival and approximately 0.35 ms later the transverse arrival. This temporal separation is the basis of source localisation techniques using arrival time differences.
