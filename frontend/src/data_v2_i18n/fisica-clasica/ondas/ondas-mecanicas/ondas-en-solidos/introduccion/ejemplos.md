...
- [[modulo_de_young]] (aluminio) = 69 × 10⁹ Pa
- [[rho]] (aluminio) = 2700 kg/m³
- Longitud de la barra: 3 m
- Diámetro: 10 mm (0.010 m)
- [[frecuencia]] dominante del impacto: 5000 Hz
...
Se aplica el modelo de velocidad de onda longitudinal en barra delgada: [[v_fase]] depende de [[modulo_de_young]] y [[rho]]. La condición de barra delgada se cumple porque el diámetro (10 mm) es mucho menor que la longitud de onda esperada. Para el tiempo de tránsito se divide la longitud entre la velocidad. Para la longitud de onda se usa la relación de dispersión fundamental.
