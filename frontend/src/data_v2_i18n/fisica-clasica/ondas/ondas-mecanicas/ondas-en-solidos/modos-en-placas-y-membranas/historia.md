...
También era necesario separar dos mecanismos físicos. Una membrana tensada se comporta como una cuerda extendida a dos dimensiones: la tensión [[tension_superficial_de_la_membrana]] proporciona la fuerza restauradora. Una placa elástica, en cambio, puede vibrar sin tensión aplicada porque la curvatura activa una rigidez a la flexión [[rigidez_a_la_flexion_de_la_placa]]. La distinción entre membrana y placa fue esencial para evitar fórmulas aparentemente parecidas pero físicamente distintas.
...
La elasticidad del siglo XIX permitió introducir magnitudes como [[modulo_de_young]], [[nu_p]] y la rigidez flexional. Con ellas se entendió que el espesor [[h_placa]] no era un detalle secundario: controla fuertemente [[rigidez_a_la_flexion_de_la_placa]] y, por tanto, el espectro modal. En paralelo, la teoría de membranas mostró que la frecuencia dependía de la raíz del cociente entre tensión e inercia superficial, análoga a la cuerda pero con dos índices espaciales.
...
Hoy los modos de placas y membranas se calculan con métodos numéricos, se miden con vibrometría láser y se visualizan mediante análisis modal operacional. Aun así, las ideas elementales siguen siendo las mismas: [[rigidez_a_la_flexion_de_la_placa]] frente a [[tension_superficial_de_la_membrana]], inercia superficial frente a rigidez, y geometría frente a patrón nodal.
