...
- [[modulo_de_young]] es 210 GPa (en SI: 210 × 10⁹ Pa)
- [[momento_de_inercia_de_la_seccion_transversal]] es 20 × 5³ / 12 × 10⁻¹² m⁴, que da 2.08 × 10⁻¹⁰ m⁴
...
Si [[v_fase_flex]] resulta mayor que 5000 m/s para una viga de acero a frecuencia audible, hay un error de unidades: lo más probable es que [[momento_de_inercia_de_la_seccion_transversal]] esté en cm⁴ sin convertir.

## Método de resolución personalizado

Para calcular la velocidad de fase flexional en una viga:

1. Obtener [[modulo_de_young]] del material en Pa (si está en GPa, multiplicar por 10⁹).
2. Calcular [[momento_de_inercia_de_la_seccion_transversal]] de la sección en m⁴. Para sección rectangular de base b y altura h en la dirección de la flexión: b·h³/12.
3. Calcular [[rho_lin]] como [[rho_vol]] × [[area_de_la_seccion_transversal]], donde [[area_de_la_seccion_transversal]] es b·h para sección rectangular.
...
**Viga circular:** [[momento_de_inercia_de_la_seccion_transversal]] es π·r⁴/4, radio de giro r/2. La dispersión flexional determina la frecuencia de vibración de ejes rotantes.
