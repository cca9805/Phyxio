...
## 1. Ensayos no destructivos por ultrasonidos en barras y cables
...
Variable dominante: la impedancia [[impedancia_mecanica_longitudinal_de_la_barra]] de las barras, que debe ser similar a la de la probeta para maximizar la transmision de energia al especimen y minimizar reflexiones parasitas.
...
Variable dominante: [[impedancia_mecanica_longitudinal_de_la_barra]] de la barra de transferencia, que debe estar cuidadosamente ajustada para transmitir suficiente energia a la carga secundaria sin reflexiones excesivas que pudieran generar iniciaciones prematuras por rebote.
