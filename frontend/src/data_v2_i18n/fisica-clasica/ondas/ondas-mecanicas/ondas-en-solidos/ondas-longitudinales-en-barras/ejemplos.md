...
El modelo físico considera magnitudes fundamentales del sistema como [[area_de_la_seccion_transversal]], [[impedancia_mecanica_longitudinal_de_la_barra]], [[k_long]].
...
[[v_barra]] se calcula como la raiz cuadrada de ([[modulo_de_young]] / [[rho_vol]])
...
[[area_de_la_seccion_transversal]] se calcula como pi por d² dividido entre 4

[[impedancia_mecanica_longitudinal_de_la_barra]] se calcula como [[rho_vol]] × [[area_de_la_seccion_transversal]] × [[v_barra]]
...
[[area_de_la_seccion_transversal]] resulta pi × (0.012)² / 4 dando 1.131 × 10⁻⁴ m²

[[impedancia_mecanica_longitudinal_de_la_barra]] resulta 7850 × 1.131 × 10⁻⁴ × 5172 dando **4593 kg/s**
...
Datos del hormigon: [[modulo_de_young]] de 30 × 10⁹ Pa, [[rho_vol]] de 2400 kg/m³, longitud del pilote L de 12 m, diametro de 0.6 m.
...
[[impedancia_mecanica_longitudinal_de_la_barra]] del pilote: 2400 × (pi × 0.3² ) × 3536 dando 2400 × 0.283 × 3536 resultando **2.40 × 10⁶ kg/s**.
