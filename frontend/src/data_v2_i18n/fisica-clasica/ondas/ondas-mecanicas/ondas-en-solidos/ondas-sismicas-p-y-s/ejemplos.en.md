...
The **isotropic infinite elastic medium** model is applied with body wave propagation (P and S). The central magnitudes are [[v_p]], [[v_s]], [[modulo_de_compresibilidad]], [[modulo_de_cizalla]], [[rho_medio]], [[ratio_vp_vs]], [[nu_poisson]], [[delta_t_ps]], and [[d_foco]].
