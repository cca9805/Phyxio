...
## 1. Geotecnia sismica y clasificacion de suelos

Variable dominante: [[v_s]]

Límite de validez: [[lambda_s]] debe ser mayor que la escala de heterogeneidad del estrato.

En geotecnia, la velocidad S media cerca de la superficie permite clasificar el suelo y estimar su capacidad de amplificar movimiento sismico. Un perfil con valores bajos indica material blando, baja rigidez dinamica y mayor deformacion esperable ante un terremoto. La lectura no se limita a un numero: se compara la tendencia con profundidad, se buscan inversiones de velocidad y se revisa si cada capa puede tratarse como aproximadamente homogenea.
...
## 2. Exploracion sismica y litologia

Variable dominante: [[ratio_vp_vs]]

Límite de validez: La anisotropia y la saturacion deben modelarse si alteran la lectura P/S.

En exploracion, la comparacion entre velocidades P y S ayuda a distinguir litologias y contenido de fluidos. El cociente P/S cambia cuando la roca es mas compresible, cuando hay gas o cuando la matriz tiene fisuras. La onda S aporta informacion que una onda P sola no separa, porque responde directamente a la rigidez de corte del esqueleto solido.
...
## 3. Ultrasonidos industriales de corte

Variable dominante: [[lambda_s]]

Límite de validez: La pieza debe comportarse como continuo y la atenuacion no debe ocultar el eco.

Los transductores de corte permiten inspeccionar soldaduras, laminados y piezas metalicas cuando una onda longitudinal no ilumina bien ciertos defectos. La longitud de onda controla la resolucion: frecuencias mayores detectan detalles menores, pero tambien aumentan la atenuacion y pueden dispersarse si la microestructura deja de ser pequena.
...
Variable dominante: [[impedancia_transversal]]

Límite de validez: Las interfaces se interpretan con conversion de modo si la incidencia no es normal.

En sismologia, las ondas S revelan donde el planeta conserva rigidez de corte. Su ausencia en el nucleo externo es una evidencia fisica de estado liquido. En discontinuidades internas, los contrastes de impedancia transversal controlan reflejos, conversiones y cambios de amplitud observados en estaciones lejanas.

La interpretacion global no usa un unico material homogeneo. Se construyen modelos radiales o tridimensionales y se ajustan tiempos de llegada. La idea elemental de [[modulo_de_cizalla]] positivo sigue siendo la clave que separa zonas solidas de zonas incapaces de transmitir corte.
...
## 5. Ingenieria de materiales y control de curado

Variable dominante: [[modulo_de_cizalla]]

Límite de validez: La respuesta debe permanecer en regimen elastico lineal.

Durante el curado de hormigones, polimeros o adhesivos, la velocidad S permite seguir el aumento de rigidez sin destruir la muestra. A medida que la red interna se consolida, [[modulo_de_cizalla]] crece y la onda de corte se propaga mas rapido. La tecnica es sensible a cambios tempranos que no siempre son visibles en ensayos estaticos.
