...
- Variacion de presion hidrostatica para comprobacion volumetrica: [[variacion_de_presion]] de 50 MPa
- Cambio relativo de volumen medido: [[variacion_relativa_de_volumen]] de -3.7 por diez a la menos cuatro
...
El modelo se basa en la ley de Hooke para un solido isotropo en traccion uniaxial. Las magnitudes nucleares del leaf son [[modulo_de_young]], [[nu_poisson]] y [[modulo_de_cizalla]], conectadas por la relacion fundamental entre modulos. La [[sigma]] aplicada produce una [[epsilon]] longitudinal y una [[epsilon_transv]] transversal acopladas por [[nu_poisson]]. El [[modulo_de_cizalla]] se obtiene a partir de [[modulo_de_young]] y [[nu_poisson]] mediante la relacion termodinamica del isotropo.
...
Despejando [[modulo_de_cizalla]]:

{{f:relacion_E_G_nu}}

El modulo de cizalla queda determinado por el modulo de Young y el coeficiente de Poisson.

Si el mismo acero se sometiera a un ensayo tangencial, la tension tangencial [[tau]] seria la carga aplicada y la deformacion angular [[gamma]] seria la respuesta observable asociada a [[modulo_de_cizalla]]; aqui se calcula el modulo de cizalla por coherencia isotropa, no por una medida directa de cizalla.

Como comprobacion volumetrica independiente, se usa la relacion del modulo de compresibilidad entre la variacion de presion [[variacion_de_presion]] y el cambio relativo de volumen [[variacion_relativa_de_volumen]]:
...
Para el modulo de cizalla, dividir 200 GPa entre el producto de 2 por (1 mas 0.30), es decir dividir entre 2.60, resulta aproximadamente 76.9 GPa. Por tanto [[modulo_de_cizalla]] ≈ 76.9 GPa.

Para la comprobacion volumetrica, dividir la variacion de presion [[variacion_de_presion]] de 50 MPa entre el valor absoluto de [[variacion_relativa_de_volumen]] da aproximadamente 135 GPa. Por tanto [[modulo_de_compresibilidad]] queda en el orden esperado para un acero, sin contradecir la respuesta de traccion.
...
A partir de las velocidades y la densidad, el modulo de cizalla se obtiene como el producto de la densidad por el cuadrado de la velocidad transversal. Multiplicar 2700 kg/m³ por el cuadrado de 3100 m/s (9.61×10⁶ m²/s²) da aproximadamente 25.9 GPa. Por tanto [[modulo_de_cizalla]] ≈ 25.9 GPa.
...
El modulo de compresibilidad se obtiene restando cuatro tercios de [[modulo_de_cizalla]] al modulo de onda plana. Restando 34.6 GPa a 108.9 GPa se obtiene aproximadamente 74.3 GPa. Por tanto [[modulo_de_compresibilidad]] ≈ 74.3 GPa.
...
Finalmente, [[modulo_de_young]] se obtiene mediante la relacion fundamental, multiplicar 2 por [[modulo_de_cizalla]] por la suma de 1 mas [[nu_poisson]], lo que da aproximadamente 69.5 GPa.
