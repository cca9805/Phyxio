...
[[modulo_de_young]] measures response to stretching or compression along one direction. [[modulo_de_cizalla]] measures response to shape change, without requiring much volume change. [[modulo_de_compresibilidad]] measures resistance to reducing or increasing volume under uniform pressure. [[nu_poisson]] describes the lateral contraction that accompanies longitudinal extension.
...
The working variables appear here: [[sigma]] and [[epsilon]] for tension, [[tau]] and [[gamma]] for shear, [[variacion_de_presion]] and [[variacion_relativa_de_volumen]] for volumetric compression, and [[epsilon_long]] together with transverse strain for Poisson coupling. All quantities must be expressed coherently: stresses and moduli in pascals, strains as dimensionless ratios, and signs according to the convention of the problem.
...
The deep reason for these relations is the decomposition of stress and strain into volumetric and deviatoric parts. The volumetric part changes the size of a material element; the deviatoric part changes its shape. [[modulo_de_compresibilidad]] governs the first and [[modulo_de_cizalla]] governs the second. [[modulo_de_young]] mixes both because uniaxial tension stretches in one direction and contracts in the others.
...
In metals, [[modulo_de_young]] is usually tens to hundreds of gigapascals. In soft polymers it may fall to megapascals. [[modulo_de_cizalla]] is often smaller than Young's modulus, but of the same order in many solids. [[modulo_de_compresibilidad]] can be very high in nearly incompressible materials, even when they deform easily in shear.
...
This topic connects Hooke's law, waves in solids, seismology, ultrasonics and strength of materials. It also prepares the tensorial reading of stress and strain, where moduli stop being a list of names and become a general constitutive law.
