...
[[modulo_de_young]] mide la respuesta ante estiramiento o compresion en una direccion. [[modulo_de_cizalla]] mide la respuesta ante cambio de forma, sin necesidad de cambiar mucho el volumen. [[modulo_de_compresibilidad]] mide la resistencia a reducir o aumentar el volumen bajo presion uniforme. [[nu_poisson]] describe la contraccion lateral que acompaña a un alargamiento longitudinal.
...
Aqui aparecen las variables de trabajo: [[sigma]] y [[epsilon]] para traccion, [[tau]] y [[gamma]] para cizalla, [[variacion_de_presion]] y [[variacion_relativa_de_volumen]] para compresion volumetrica, y [[epsilon_long]] junto con deformaciones transversales para Poisson. Todas estas magnitudes deben expresarse de forma coherente: los esfuerzos y modulos en pascales, las deformaciones como cocientes adimensionales y los signos segun la convencion del problema.
...
La razon profunda de estas relaciones es la descomposicion del esfuerzo y la deformacion en partes volumetricas y desviadoras. La parte volumetrica cambia el tamaño del elemento material; la parte desviadora cambia su forma. [[modulo_de_compresibilidad]] gobierna la primera y [[modulo_de_cizalla]] gobierna la segunda. [[modulo_de_young]] mezcla ambas porque una traccion uniaxial estira en una direccion y contrae en las otras.
...
En metales, [[modulo_de_young]] suele estar entre decenas y cientos de gigapascales. En polimeros blandos puede caer a megapascales. [[modulo_de_cizalla]] suele ser menor que el modulo de Young, pero del mismo orden en muchos solidos. [[modulo_de_compresibilidad]] puede ser muy alto en materiales casi incompresibles, incluso si se deforman facilmente por corte.
