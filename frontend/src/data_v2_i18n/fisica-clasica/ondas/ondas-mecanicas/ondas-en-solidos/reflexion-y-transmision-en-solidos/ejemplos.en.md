...
The model uses boundary conditions of displacement and normal stress continuity at the interface for a plane wave at normal incidence. The core magnitudes are [[impedancia_acustica_del_medio_1]], [[impedancia_acustica_del_medio_2]], [[impedancia_acustica_generica]], [[coeficiente_de_reflexion_en_amplitud]], [[coeficiente_de_transmision_en_amplitud]], [[coeficiente_de_reflexion_en_energia]], [[coeficiente_de_transmision_en_energia]], [[rho_medio]] and [[v_onda]]. Each medium impedance is calculated with the density-velocity product formula and coefficients are obtained from the acoustic Fresnel relations.
...
The formula is applied to both media: [[impedancia_acustica_del_medio_1]] is the product of steel density and its velocity, and [[impedancia_acustica_del_medio_2]] is the product of aluminium density and its velocity. In general form, each result is a [[impedancia_acustica_generica]] associated with the material through which the wave travels.
...
The final verification is checking that [[coeficiente_de_reflexion_en_energia]] plus [[coeficiente_de_transmision_en_energia]] sums to exactly unity.

## Numerical substitution

Steel impedance: 7800 multiplied by 5900 gives 46.02 times ten to the sixth, i.e. 46.02 MRayl. Therefore [[impedancia_acustica_del_medio_1]] ≈ 46.02 MRayl.

Aluminium impedance: 2700 multiplied by 6350 gives 17.15 times ten to the sixth, i.e. 17.15 MRayl. Therefore [[impedancia_acustica_del_medio_2]] ≈ 17.15 MRayl.

Amplitude reflection coefficient: (17.15 minus 46.02) divided by (17.15 plus 46.02) gives minus 28.87 divided by 63.17, approximately minus 0.457. Therefore [[coeficiente_de_reflexion_en_amplitud]] ≈ −0.457.

Amplitude transmission coefficient: twice 46.02 divided by 63.17 gives 92.04 divided by 63.17, approximately 1.457. Therefore [[coeficiente_de_transmision_en_amplitud]] ≈ 1.457.

Energy reflection coefficient: the square of 0.457 gives approximately 0.209. Therefore [[coeficiente_de_reflexion_en_energia]] ≈ 0.209.

Energy transmission coefficient: 1 minus 0.209 gives 0.791. Therefore [[coeficiente_de_transmision_en_energia]] ≈ 0.791.
...
- Acoustic impedance:
  - Defined using medium density [[rho_medio]] and wave velocity [[v_onda]].
  - Dimensional analysis: `[M L⁻³]` times `[L T⁻¹]` gives `[M L⁻² T⁻¹]` (Pa·s/m) ✓
...
The negative sign of [[coeficiente_de_reflexion_en_amplitud]] indicates the reflected wave inverts its phase: this occurs because the wave goes from a high-impedance medium (steel) to a low-impedance medium (aluminium). It is the case analogous to a string passing from a heavy segment to a light one: the "free" end reflects with inversion.
...
Using the stated impedances, the contrast between steel and air is about 110000 to 1. The energy-reflection relation gives [[coeficiente_de_reflexion_en_energia]] above 0.99998, while the complementary transmission relation leaves [[coeficiente_de_transmision_en_energia]] below 0.00002. In practical terms, a 1 V reference echo from a steel-air delamination would be read as essentially a full-scale return, whereas a steel-aluminium interface in the previous calculation would return only about 20.9% of the incident energy.
