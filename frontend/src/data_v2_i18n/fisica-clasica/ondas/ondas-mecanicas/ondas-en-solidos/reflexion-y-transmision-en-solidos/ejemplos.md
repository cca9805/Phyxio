...
El modelo usa las condiciones de contorno de continuidad de desplazamiento y tension normal en la interfaz para una onda plana a incidencia normal. Las magnitudes nucleares son [[impedancia_acustica_del_medio_1]], [[impedancia_acustica_del_medio_2]], [[impedancia_acustica_generica]], [[coeficiente_de_reflexion_en_amplitud]], [[coeficiente_de_transmision_en_amplitud]], [[coeficiente_de_reflexion_en_energia]], [[coeficiente_de_transmision_en_energia]], [[rho_medio]] y [[v_onda]]. La impedancia de cada medio se calcula con la formula del producto densidad-velocidad y los coeficientes se obtienen de las relaciones de Fresnel acusticas.
...
Se aplica la formula para ambos medios: [[impedancia_acustica_del_medio_1]] es el producto de la densidad del acero por su velocidad, y [[impedancia_acustica_del_medio_2]] es el producto de la densidad del aluminio por su velocidad. En forma general, cada resultado es una [[impedancia_acustica_generica]] asociada al material por el que viaja la onda.
...
La verificacion final es comprobar que [[coeficiente_de_reflexion_en_energia]] mas [[coeficiente_de_transmision_en_energia]] suma exactamente la unidad.

## Sustitución numérica

Impedancia del acero: 7800 multiplicado por 5900 da 46.02 por diez a la sexta, es decir 46.02 MRayl. Por tanto [[impedancia_acustica_del_medio_1]] ≈ 46.02 MRayl.

Impedancia del aluminio: 2700 multiplicado por 6350 da 17.15 por diez a la sexta, es decir 17.15 MRayl. Por tanto [[impedancia_acustica_del_medio_2]] ≈ 17.15 MRayl.

Coeficiente de reflexion en amplitud: (17.15 menos 46.02) dividido entre (17.15 mas 46.02) da menos 28.87 dividido entre 63.17, que es aproximadamente menos 0.457. Por tanto [[coeficiente_de_reflexion_en_amplitud]] ≈ −0.457.

Coeficiente de transmision en amplitud: dos veces 46.02 dividido entre 63.17 da 92.04 dividido entre 63.17, que es aproximadamente 1.457. Por tanto [[coeficiente_de_transmision_en_amplitud]] ≈ 1.457.

Coeficiente de reflexion en energia: el cuadrado de 0.457 da aproximadamente 0.209. Por tanto [[coeficiente_de_reflexion_en_energia]] ≈ 0.209.

Coeficiente de transmision en energia: 1 menos 0.209 da 0.791. Por tanto [[coeficiente_de_transmision_en_energia]] ≈ 0.791.
...
- Impedancia acustica:
  - Definida mediante la densidad del medio [[rho_medio]] y la velocidad de la onda [[v_onda]].
  - Análisis dimensional: `[M L⁻³]` por `[L T⁻¹]` da `[M L⁻² T⁻¹]` (Pa·s/m) ✓
...
El signo negativo de [[coeficiente_de_reflexion_en_amplitud]] indica que la onda reflejada invierte su fase: esto ocurre porque la onda pasa de un medio de alta impedancia (acero) a uno de baja impedancia (aluminio). Es el caso analogo a una cuerda que pasa de un tramo pesado a uno ligero: el extremo "libre" refleja con inversion.
