...
Bajo estas condiciones, el problema tiene solucion analitica cerrada: los coeficientes [[coeficiente_de_reflexion_en_amplitud]] y [[coeficiente_de_transmision_en_amplitud]] se expresan algebraicamente en funcion del cociente de impedancias. No hay conversion de modo, no hay dispersion, no hay disipacion.
...
Los coeficientes en amplitud satisfacen: −1 <= [[coeficiente_de_reflexion_en_amplitud]] <= 1 y 0 <= [[coeficiente_de_transmision_en_amplitud]] <= 2. Los coeficientes en energia satisfacen: 0 <= [[coeficiente_de_reflexion_en_energia]] <= 1 y 0 <= [[coeficiente_de_transmision_en_energia]] <= 1, con [[coeficiente_de_reflexion_en_energia]] + [[coeficiente_de_transmision_en_energia]] exactamente igual a 1.
...
|---|---|---|
| Variables de entrada | [[impedancia_acustica_del_medio_1]], [[impedancia_acustica_del_medio_2]] | [[impedancia_acustica_del_medio_1]], [[impedancia_acustica_del_medio_2]], velocidades P y S, angulo |
