...
[[nu_poisson]] is the parameter governing the partition between the different moduli. A material with [[nu_poisson]] near zero distributes its stiffness evenly between shear and compression. A material with [[nu_poisson]] near 0.5 is nearly incompressible: [[modulo_de_compresibilidad]] soars while [[modulo_de_cizalla]] drops to a small fraction of [[modulo_de_young]].

At the opposite extreme, an auxetic material with negative [[nu_poisson]] expands laterally when stretched. In that case [[modulo_de_cizalla]] exceeds [[modulo_de_young]]/2 and [[modulo_de_compresibilidad]] can be less than [[modulo_de_young]]/3.

The most commonly used relationships in practice connect [[modulo_de_cizalla]] and [[modulo_de_compresibilidad]] with [[modulo_de_young]] and [[nu_poisson]]. They are the fundamental tools for converting tensile test data into the complete material description, but their algebraic form is reserved for the formal level.
...
[[nu_poisson]] has strict thermodynamic limits: it must be greater than -1 and less than or equal to 0.5 for the strain energy to be positive definite. The upper limit 0.5 corresponds to incompressibility ([[modulo_de_compresibilidad]] infinite). The lower limit -1 corresponds to a material with [[modulo_de_cizalla]] infinite relative to [[modulo_de_compresibilidad]].
...
For steel (E approx. 200 GPa, nu approx. 0.3): G approx. 77 GPa, K approx. 167 GPa, lambda approx. 113 GPa. Ratio [[cociente_g_e]] is 0.38 and [[cociente_k_e]] is 0.83.

For aluminium (E approx. 70 GPa, nu approx. 0.33): G approx. 26 GPa, K approx. 69 GPa. Ratio [[cociente_g_e]] of 0.38, [[cociente_k_e]] of 0.98.
