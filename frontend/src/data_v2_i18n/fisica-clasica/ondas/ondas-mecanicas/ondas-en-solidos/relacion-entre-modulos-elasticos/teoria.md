...
El [[nu_poisson]] es el parametro que gobierna la particion entre los distintos modulos. Un material con [[nu_poisson]] cercano a cero reparte su rigidez de forma equilibrada entre cizalla y compresion. Un material con [[nu_poisson]] cercano a 0.5 es casi incompresible: [[modulo_de_compresibilidad]] se dispara mientras [[modulo_de_cizalla]] se reduce a una fraccion pequeña de [[modulo_de_young]].

En el extremo opuesto, un material auxetico con [[nu_poisson]] negativo se expande lateralmente al estirarse. En ese caso [[modulo_de_cizalla]] supera a [[modulo_de_young]]/2 y [[modulo_de_compresibilidad]] puede ser menor que [[modulo_de_young]]/3.

Las relaciones mas usadas en la practica son las que conectan [[modulo_de_cizalla]] y [[modulo_de_compresibilidad]] con [[modulo_de_young]] y [[nu_poisson]]. Son las herramientas fundamentales para convertir datos de un ensayo de traccion en la descripcion completa del material, pero su forma algebraica se reserva para el nivel formal.
...
El [[nu_poisson]] tiene limites termodinamicos estrictos: debe ser mayor que -1 y menor o igual que 0.5 para que la energia de deformacion sea definida positiva. El limite superior 0.5 corresponde a incompresibilidad ([[modulo_de_compresibilidad]] infinito). El limite inferior -1 corresponde a un material con [[modulo_de_cizalla]] infinito respecto a [[modulo_de_compresibilidad]].
...
Para acero (E aprox. 200 GPa, nu aprox. 0.3): G aprox. 77 GPa, K aprox. 167 GPa, lambda aprox. 113 GPa. El cociente [[cociente_g_e]] es 0.38 y [[cociente_k_e]] es 0.83.

Para aluminio (E aprox. 70 GPa, nu aprox. 0.33): G aprox. 26 GPa, K aprox. 69 GPa. Cociente [[cociente_g_e]] de 0.38, [[cociente_k_e]] de 0.98.
