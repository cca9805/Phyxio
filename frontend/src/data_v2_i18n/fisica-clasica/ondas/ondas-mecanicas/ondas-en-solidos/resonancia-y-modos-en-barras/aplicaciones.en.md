...
Dominant variable: [[longitud_de_la_barra]], adjusted to obtain the desired [[f_n]] with the [[velocidad_de_onda_longitudinal_en_barra]] of the chosen material.
...
Dominant variable: [[longitud_de_la_barra]] and [[velocidad_de_onda_longitudinal_en_barra]] of the material (titanium, aluminium, steel), adjusted so that [[f_n]] matches the generator frequency.
Validity limit: at high powers, temperature rises and slightly changes [[modulo_de_young]] and [[rho]], shifting the resonance frequency. Active frequency control is required.
