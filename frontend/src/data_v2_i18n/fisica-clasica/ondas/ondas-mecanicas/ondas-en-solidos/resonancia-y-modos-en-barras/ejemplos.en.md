...
- [[rho]]: 2700 kg/m³
- [[modulo_de_young]]: 70 times ten to the ninth Pa
- [[modulo_de_cizalla]]: 26 times ten to the ninth Pa
- Boundary conditions: free-free
...
Free-free longitudinal resonance formulae are applied using [[velocidad_de_onda_longitudinal_en_barra]] and free-free torsional formulae using [[velocidad_de_onda_de_corte]]. The key magnitudes are [[f_n]], [[n_modo]], [[velocidad_de_onda_longitudinal_en_barra]], [[velocidad_de_onda_de_corte]] and [[longitud_de_la_barra]].
...
[[modulo_de_young]] and [[rho]] are substituted to obtain [[velocidad_de_onda_longitudinal_en_barra]].

Then the fundamental longitudinal frequency (n = 1):

{{f:freq_longitudinal_libre_libre}}

[[n_modo]] = 1, [[velocidad_de_onda_longitudinal_en_barra]] and [[longitud_de_la_barra]] are substituted.

For the third harmonic, the same formula is used with n = 3.

If the bar were instead clamped at one of its ends (fixed-free condition), the formula for its natural longitudinal frequencies would be:
...
[[modulo_de_cizalla]] and [[rho]] are substituted to obtain [[velocidad_de_onda_de_corte]].
...
Longitudinal velocity: square root of 70 times ten to the ninth divided by 2700. This is the square root of 25.93 times ten to the sixth, giving 5092 m/s. Therefore [[velocidad_de_onda_longitudinal_en_barra]] ≈ 5092 m/s.
...
Shear velocity: square root of 26 times ten to the ninth divided by 2700. This is the square root of 9.63 times ten to the sixth, giving 3103 m/s. Therefore [[velocidad_de_onda_de_corte]] ≈ 3103 m/s.
...
- [[velocidad_de_onda_longitudinal_en_barra]]: square root of Pa / (kg/m³) = square root of (kg/(m s²)) / (kg/m³) = square root of m²/s² = m/s ✓
...
The ratio between [[velocidad_de_onda_longitudinal_en_barra]] and [[velocidad_de_onda_de_corte]] is 1.641. Verification with the elastic-moduli relationship gives the same value, so the longitudinal and torsional velocities are coherent with aluminium's Poisson ratio.
...
Physically, the calculation separates two effects that are easy to confuse: geometry fixes the spacing through [[longitud_de_la_barra]], while material stiffness fixes the wave speeds. Because aluminium has a large [[modulo_de_young]] compared with its [[rho]], the longitudinal resonances sit high in the audible band; because [[modulo_de_cizalla]] is smaller, the torsional series starts lower.
...
Solving for [[velocidad_de_onda_longitudinal_en_barra]] from the reference above gives a longitudinal velocity of 8500 m/s for the measured length and frequency.
...
Using the longitudinal bar velocity relationship, the Young modulus obtained from density and [[velocidad_de_onda_longitudinal_en_barra]] is approximately 217 GPa.
