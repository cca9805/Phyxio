...
La frecuencia depende del cociente entre velocidad y longitud, y la velocidad depende de [[modulo_de_young]] y [[rho]]. Dos barras de igual longitud pero distinto material tienen frecuencias muy diferentes. Ademas, un cambio de temperatura puede alterar [[modulo_de_young]] y [[rho]] ligeramente, cambiando la frecuencia de resonancia.
...
Verificar siempre: (1) la condicion de contorno determina si los armonicos son n o (2n-1); (2) la velocidad a usar es [[velocidad_de_onda_longitudinal_en_barra]] para longitudinal y [[velocidad_de_onda_de_corte]] para torsional; (3) las frecuencias torsionales deben ser menores que las longitudinales para el mismo modo; (4) n empieza en 1; (5) la formula dimensional da Hz.