...
Una onda longitudinal viaja por la barra con velocidad [[velocidad_de_onda_longitudinal_en_barra]]. Al llegar a un extremo se refleja. La superposicion de la onda incidente y la reflejada crea una onda estacionaria si la frecuencia es adecuada.
...
donde [[n_modo]] es el numero de modo (1, 2, 3...), [[velocidad_de_onda_longitudinal_en_barra]] es la velocidad longitudinal y [[longitud_de_la_barra]] es la longitud.

La velocidad longitudinal en una barra delgada se calcula como:

{{f:velocidad_longitudinal_barra}}

donde [[modulo_de_young]] es el modulo de Young y [[rho]] es la densidad del material.
...
Dado que [[velocidad_de_onda_de_corte]] es siempre menor que [[velocidad_de_onda_longitudinal_en_barra]] (porque [[modulo_de_cizalla]] es menor que [[modulo_de_young]] para materiales con coeficiente de Poisson positivo), las frecuencias torsionales son siempre menores que las longitudinales para el mismo modo y la misma longitud.
...
con la relacion de dispersion entre frecuencia angular, numero de onda y [[velocidad_de_onda_longitudinal_en_barra]], que es lineal (no dispersiva).
...
En ambos casos, [[f_n]] es proporcional al numero de onda permitido y a [[velocidad_de_onda_longitudinal_en_barra]].
...
La velocidad efectiva queda por debajo de [[velocidad_de_onda_longitudinal_en_barra]] y la correccion crece cuando el radio de la barra se vuelve comparable con la longitud de onda.
...
3. Calcular la velocidad de onda correspondiente: [[velocidad_de_onda_longitudinal_en_barra]] para longitudinal, [[velocidad_de_onda_de_corte]] para torsional.
...
Cuando [[longitud_de_la_barra]] tiende a infinito, el espaciado entre frecuencias adyacentes tiende a cero: el espectro discreto se convierte en un continuo. No hay resonancias discretas; la barra soporta ondas viajeras de cualquier frecuencia. Es la transicion de sistema finito a medio infinito.
...
Si el coeficiente de Poisson es negativo, el cociente entre [[velocidad_de_onda_longitudinal_en_barra]] y [[velocidad_de_onda_de_corte]] se reduce. En el limite termodinamico inferior ambas velocidades tenderian a coincidir; en la practica, los materiales auxeticos reales conservan frecuencias longitudinales mayores que las torsionales.
...
Si. Se mide la frecuencia fundamental de una barra de longitud y densidad conocidas, se usa la relacion libre-libre para obtener [[velocidad_de_onda_longitudinal_en_barra]], y luego la relacion de velocidad longitudinal para obtener [[modulo_de_young]]. Es la base del metodo de impulse excitation (norma ASTM E1876).

**¿Por que los modos torsionales tienen frecuencia menor que los longitudinales?**
Porque la velocidad torsional depende de [[modulo_de_cizalla]] y la longitudinal de [[modulo_de_young]]. En materiales comunes, la rigidez de cizalla es menor que la rigidez longitudinal; por tanto [[velocidad_de_onda_de_corte]] es menor que [[velocidad_de_onda_longitudinal_en_barra]]. Menor velocidad con la misma longitud da menor frecuencia.

## Conexiones transversales y rutas de estudio

- Los modos longitudinales dependen de [[velocidad_de_onda_longitudinal_en_barra]], que se calcula con [[modulo_de_young]] y [[rho]] (ver leaf ondas-longitudinales-en-barras).
- Los modos torsionales dependen de [[velocidad_de_onda_de_corte]], que se calcula con [[modulo_de_cizalla]] y [[rho]].
