...
La velocidad de la onda longitudinal [[velocidad_de_onda_longitudinal_p]] en un solido tridimensional isotropo se calcula a partir del modulo de Young [[modulo_de_young]] y el coeficiente de Poisson [[nu]]:

{{f:vel_longitudinal}}

El factor entre parentesis combina [[modulo_de_young]] y [[nu]] para formar el **modulo confinado**, que es siempre mayor que [[modulo_de_young]] para cualquier [[nu]] positivo. Esta es la razon por la que [[velocidad_de_onda_longitudinal_p]] en un solido 3D es mayor que la velocidad longitudinal en una barra delgada del mismo material.

La velocidad de la onda transversal [[velocidad_de_onda_transversal_s]] depende exclusivamente del modulo de corte [[modulo_de_corte]] y la densidad:

{{f:vel_transversal}}

La sencillez de esta expresion es reveladora: [[velocidad_de_onda_transversal_s]] no depende de como el material responde a la compresion, solo de como responde al corte. Por eso, cuando [[modulo_de_corte]] tiende a cero (limite fluido), [[velocidad_de_onda_transversal_s]] tiende a cero y la onda S desaparece.

La velocidad de la onda de Rayleigh [[velocidad_de_onda_de_rayleigh]] se obtiene como una fraccion de [[velocidad_de_onda_transversal_s]] que depende suavemente de [[nu]] mediante la aproximacion de Viktorov:

{{f:vel_rayleigh}}

Esta formula muestra que [[velocidad_de_onda_de_rayleigh]] siempre esta entre el 87 y el 96 % de [[velocidad_de_onda_transversal_s]], independientemente del material. La jerarquia de velocidades es invariante: [[velocidad_de_onda_longitudinal_p]] mayor que [[velocidad_de_onda_transversal_s]] mayor que [[velocidad_de_onda_de_rayleigh]] en cualquier solido elastico isotropo.
...
La onda transversal, en cambio, es **puramente disipativa de forma**: mueve el material angularmente sin cambiar su volumen. Solo activa [[modulo_de_corte]], y por eso su relacion de velocidad es mas simple y mas lenta que la longitudinal. Esta pureza hace que las mediciones de [[velocidad_de_onda_transversal_s]] sean los mejores estimadores del modulo de corte en ensayos no destructivos.

La **jerarquia de velocidades** no es accidental: puede demostrarse que para cualquier material isotropo estable (con [[nu]] entre cero y 0.5), siempre se cumple que [[velocidad_de_onda_longitudinal_p]] supera a [[velocidad_de_onda_transversal_s]]. La diferencia relativa depende exclusivamente de [[nu]] y se vuelve muy grande cuando [[nu]] se acerca a 0.5 (materiales casi incompresibles como el caucho), porque en ese limite el modulo confinado diverge mientras que [[modulo_de_corte]] permanece finito.
...
Esto tiene consecuencias practicas: un material blando en corte pero rigido en compresion, como el caucho, tiene [[velocidad_de_onda_longitudinal_p]] moderada y [[velocidad_de_onda_transversal_s]] baja. Un material rigido y ligero, como el aluminio, tiene [[velocidad_de_onda_transversal_s]] alta. Medir [[velocidad_de_onda_longitudinal_p]] y [[velocidad_de_onda_transversal_s]] permite estimar modulos elasticos sin deformacion macroscopica.
...
En suelos blandos, [[velocidad_de_onda_transversal_s]] puede bajar a 50 m/s mientras [[velocidad_de_onda_longitudinal_p]] ronda 300 m/s; la separacion relativa crece porque [[nu]] se acerca a 0.5.

Un resultado fisicamente absurdo seria obtener [[velocidad_de_onda_transversal_s]] mayor que [[velocidad_de_onda_longitudinal_p]] en el mismo material: eso implicaria un coeficiente de Poisson fuera del rango fisicamente admisible, o un error en los modulos de entrada.

## Método de resolución personalizado

El proceso de analisis de tipos de onda en un solido sigue un protocolo reproducible:

1. **Identificar los parametros del material**: [[modulo_de_young]], [[modulo_de_corte]], [[rho]] y [[nu]]. Si solo se conocen dos de los cuatro, verificar la relacion elastica que los vincula antes de proceder.

2. **Calcular [[velocidad_de_onda_longitudinal_p]]** con la formula completa del solido 3D si el medio es tridimensionalmente homogeneo; o con la version de barra delgada si el solido esta confinado geometricamente.

3. **Calcular [[velocidad_de_onda_transversal_s]]** con [[modulo_de_corte]] y [[rho]]. Este paso siempre precede al calculo de [[velocidad_de_onda_de_rayleigh]].

4. **Calcular [[velocidad_de_onda_de_rayleigh]]** con la aproximacion de Viktorov si [[nu]] esta entre 0 y 0.5.

5. **Verificar la jerarquia**: [[velocidad_de_onda_longitudinal_p]] mayor que [[velocidad_de_onda_transversal_s]] mayor que [[velocidad_de_onda_de_rayleigh]]. Si no se cumple, hay un error en los datos o en el modelo.

6. **Interpretar**: La razon [[velocidad_de_onda_transversal_s]]/[[velocidad_de_onda_longitudinal_p]] determina [[nu]]; la razon [[velocidad_de_onda_de_rayleigh]]/[[velocidad_de_onda_transversal_s]] es un indicador adicional de [[nu]]. Si las tres velocidades son consistentes entre si, se puede confiar en la caracterizacion del material.

## Casos especiales y ejemplo extendido

**Material casi incompresible ([[nu]] proximo a 0.5)**: en caucho, [[velocidad_de_onda_longitudinal_p]] crece mucho porque el modulo confinado aumenta, mientras [[velocidad_de_onda_transversal_s]] permanece moderada. La separacion P-S se vuelve grande: la onda P parece propia de un fluido rapido, pero la onda S revela que el material sigue siendo solido.

**Material auxetico ([[nu]] negativo)**: en espumas re-entrantes la separacion entre ondas P y S se reduce, y la aproximacion de Viktorov para [[velocidad_de_onda_de_rayleigh]] pierde precision.

**Acero inoxidable 304**: con E de 193 GPa, G de 77 GPa, densidad de 7900 kg/m³ y [[nu]] de 0.25, se obtiene aproximadamente [[velocidad_de_onda_longitudinal_p]] = 5700 m/s, [[velocidad_de_onda_transversal_s]] = 3120 m/s y [[velocidad_de_onda_de_rayleigh]] = 2900 m/s. La jerarquia se verifica y la razon [[velocidad_de_onda_transversal_s]]/[[velocidad_de_onda_longitudinal_p]] es coherente con [[nu]].
...
Porque su modo superficial combina compresion y corte sin maximizar la propagacion. La solucion de [[velocidad_de_onda_de_rayleigh]] queda ligeramente por debajo de [[velocidad_de_onda_transversal_s]].

**¿Que informacion me da la razon [[velocidad_de_onda_transversal_s]]/[[velocidad_de_onda_longitudinal_p]] sobre el material?**
...
Los solidos elasticos albergan ondas longitudinales, transversales y superficiales de Rayleigh. Sus velocidades dependen de combinaciones distintas de modulos elasticos y [[rho]]. La jerarquia [[velocidad_de_onda_longitudinal_p]] mayor que [[velocidad_de_onda_transversal_s]] mayor que [[velocidad_de_onda_de_rayleigh]] resume el diagnostico: las ondas S son la firma dinamica directa de la resistencia al corte.