...
The same thermodynamic control can be expressed through [[fugacidad]], a dimensionless parameter that encodes [[potencial_quimico]]:

{{f:fugacidad_bosonica}}

When [[fugacidad]] approaches one, low-[[energia]] states can accumulate very high [[ocupacion_media]].

For the spatial quantum scale, use:

{{f:longitud_onda_termica_de_broglie}}

The ideal condensation threshold is estimated by comparing [[densidad_particulas]] with [[densidad_critica]]:
