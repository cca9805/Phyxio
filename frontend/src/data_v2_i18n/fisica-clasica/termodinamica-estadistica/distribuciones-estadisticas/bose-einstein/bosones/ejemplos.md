...
Los parámetros del enunciado, expresados en unidades del sistema internacional, son:
...
El mismo control termodinámico puede expresarse mediante la [[fugacidad]], que traduce el [[potencial_quimico]] a un factor adimensional:

{{f:fugacidad_bosonica}}

Cuando [[fugacidad]] se acerca a uno, los estados de baja [[energia]] pueden acumular una [[ocupacion_media]] muy elevada.

Para estimar la escala cuántica espacial se usa:

{{f:longitud_onda_termica_de_broglie}}

El umbral de condensación se evalúa comparando la [[densidad_particulas]] del gas con la [[densidad_critica]] ideal:

{{f:densidad_critica_bose}}

Con la [[longitud_onda_termica]] se forma el producto de degeneración [[densidad_particulas]][[longitud_onda_termica]]^3. Si este producto es del orden de la unidad, las ondas térmicas empiezan a solaparse de forma importante.
