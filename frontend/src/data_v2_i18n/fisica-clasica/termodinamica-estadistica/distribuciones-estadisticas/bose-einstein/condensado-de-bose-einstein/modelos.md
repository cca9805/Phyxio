...
Para gases reales se usa un modelo con interacciones débiles, potencial de trampa y aproximación de densidad local. En ese caso, la [[densidad_particulas]] no es uniforme y la transición se lee como una región central condensada que crece al enfriar. Si el sistema es denso o fuertemente interactuante, conviene pasar al marco de campo medio, Bogoliubov o simulaciones numéricas. Cuando conviene cambiar de modelo depende de si las correcciones por interacciones, geometría de trampa o efectos de tamaño finito producen una modificación visible en la [[fraccion_condensada]] ideal.
