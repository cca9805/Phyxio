...
Before minimizing [[energia]], count the available states and apply
...
requires equilibrium with meaningful [[temperatura_absoluta]] and [[potencial_quimico]].
**Detection signal**
...
gives a compact scale from [[densidad_numerica]].
**Why it is incorrect**
...
**Conceptual correction**
Check the order of the difference before using
