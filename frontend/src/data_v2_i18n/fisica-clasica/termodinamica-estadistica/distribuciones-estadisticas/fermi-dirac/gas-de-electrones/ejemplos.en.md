...
[[densidad_electronica]] has dimension m⁻³. In

{{f:energia_fermi_gas_electrones_3d}}

, the combination of [[constante_planck_reducida]] and [[masa_electron]] must end in joules, an energy unit. In

{{f:temperatura_fermi_gas_electrones}}

, dividing energy by [[constante_boltzmann]] produces kelvin. In [[velocidad_fermi]], combining energy with mass gives m²/s² before the square root, so the final unit is m/s. [[ocupacion_estado]] is dimensionless and must remain between 0 and 1.
