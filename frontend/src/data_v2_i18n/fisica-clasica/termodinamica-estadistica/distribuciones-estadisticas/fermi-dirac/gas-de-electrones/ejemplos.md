...
[[densidad_electronica]] tiene dimensión m⁻³. En

{{f:energia_fermi_gas_electrones_3d}}

, la combinación con [[constante_planck_reducida]] y [[masa_electron]] debe terminar en julios, que son unidades de energía. En

{{f:temperatura_fermi_gas_electrones}}

, dividir una energía por [[constante_boltzmann]] produce kelvin. En [[velocidad_fermi]], combinar energía con masa produce m²/s² antes de la raíz, y por tanto m/s. [[ocupacion_estado]] es adimensional y debe quedar entre 0 y 1.
