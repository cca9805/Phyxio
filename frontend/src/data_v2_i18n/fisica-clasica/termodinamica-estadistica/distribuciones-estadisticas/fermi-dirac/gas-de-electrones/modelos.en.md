...
- Thermal equilibrium: without well-defined [[temperatura_absoluta]] and [[potencial_quimico]],

{{f:ocupacion_fermi_dirac_electrones}}

is not a static distribution.
...
Real solids often require a band model with effective mass instead of free [[masa_electron]]. In semiconductors, electrons and holes are separated and [[potencial_quimico]] depends on doping and temperature. In 2D systems, [[volumen]] density is replaced by surface density. In compact matter or extreme plasmas, a relativistic electron gas may be required. In each case, the threshold for switching models is whether the correction to [[energia_fermi]] or [[ocupacion_estado]] exceeds the precision needed for the physical conclusion being drawn.
