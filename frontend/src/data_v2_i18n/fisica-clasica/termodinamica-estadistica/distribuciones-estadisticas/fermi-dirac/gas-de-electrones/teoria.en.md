...
The main idea is that increasing [[densidad_electronica]] packs more free electrons into the same [[volumen]]. Since electrons are fermions, they cannot all occupy the same quantum state. Low [[energia_estado]] states fill first, and added electrons must move into higher momentum and energy states. The upper edge of this filling is [[energia_fermi]]. At very low [[temperatura_absoluta]], states below that edge are almost occupied and states above it are almost empty.

Raising [[temperatura_absoluta]] softens the edge: some states just above it gain [[ocupacion_estado]], while some just below it lose occupation. Therefore [[densidad_electronica]] fixes the energy scale, while temperature controls how sharp the occupation transition appears.
...
Typical metals have [[densidad_electronica]] around 10²⁸ m⁻³. This gives [[energia_fermi]] of a few eV and [[temperatura_fermi]] of tens of thousands of kelvin, far above room [[temperatura_absoluta]] near 300 K. Thus ordinary metallic electrons are strongly degenerate: the material may feel warm, but the occupation edge remains sharply quantum. For metals such as aluminium, with [[densidad_electronica]] near 1.8·10²⁹ m⁻³, [[energia_fermi]] rises to about 11.7 eV and [[temperatura_fermi]] exceeds 10⁵ K, confirming that Pauli filling dominates across the full practical range of metallic conductors and that thermal rounding only affects the narrow band of states near [[potencial_quimico]].
...
The electron gas shows density as a quantum key: increasing [[densidad_electronica]] raises [[energia_fermi]] through Pauli filling and reshapes [[ocupacion_estado]]. A correct graph turns that forced filling into an increasing energy boundary. Reading the model physically means tracking two coupled effects together: the growth of the Fermi boundary as more electrons are packed into the same volume, and the thermal smoothing of that boundary as temperature rises. Both originate from the same fermionic counting rule, and neither can be separated without losing the physical picture. The graph of [[energia_fermi]] against [[densidad_electronica]] captures the first effect; the Fermi-Dirac curve captures the second. Together they give a complete description of how the electron gas organizes itself in equilibrium.