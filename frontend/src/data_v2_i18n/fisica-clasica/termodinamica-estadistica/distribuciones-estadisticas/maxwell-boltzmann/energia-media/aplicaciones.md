...
Una manera de verificar el modelo es comparar predicciones a distintas [[temperatura]] de pared: si se dobla la [[temperatura]], la [[energia_media]] debe doblarse y la [[energia_total]] del gas residual también, siempre que [[numero_particulas]] se mantenga constante. Esta coherencia es una prueba interna que no requiere conocer la masa molecular ni la presión exacta, solo que el gas esté en equilibrio con las paredes de la cámara.
