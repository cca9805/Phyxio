...
Una comprobación de coherencia consiste en verificar que [[delta_entropia]] resulta positiva cuando el volumen final es mayor: más espacio supone más posiciones compatibles por partícula, de modo que [[numero_microestados_final]] debe superar a [[numero_microestados_inicial]]. Si el resultado fuera negativo con un volumen expandido y un gas ideal clásico, habría que revisar el cálculo, porque un [[ratio_microestados]] menor que uno implicaría que el estado comprimido es estadísticamente más accesible, lo que contradice el modelo. La magnitud [[k_boltzmann]] actúa solo como factor de conversión de unidades y no afecta al signo ni a la dirección del cambio.
