...
**Why it is incorrect**
The relation is logarithmic. Multiplying [[numero_microestados]] adds [[entropia]] contributions; it does not multiply [[entropia]] directly.

**Detection signal**
The student doubles [[numero_microestados]] and doubles [[entropia]] without using
...
**Conceptual correction**
Remember that the logarithm compresses enormous multiplicities and makes [[entropia]] additive for independent systems.
...
, check that both counts belong to the same model.
...
**Conceptual correction**
Require [[numero_microestados]] > 0 before applying
...
**Conceptual correction**
Interpret [[k_boltzmann]] as the bridge between microscopic counting and thermodynamic [[entropia]].

**Mini-example of contrast**
Changing units does not change [[numero_microestados]], but it affects the numerical [[entropia]] scale.
