...
In real systems, [[numero_microestados]] can be astronomically large. That is why logarithms are used: a [[ratio_microestados]] of 10²⁰ gives a [[delta_entropia]] of only a few tens of [[k_boltzmann]], not 10²⁰ [[entropia]] units. For a macroscopic system with about 10²³ particles, small relative changes in constraints can accumulate into measurable [[entropia]]. The essential checks are positivity of [[numero_microestados]] and comparable definitions for the two macrostates.
...
Why is there a logarithm? Because when independent systems are combined, microstates multiply, and the logarithm converts that multiplication into additive [[entropia]].
