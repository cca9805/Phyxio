...
Verifica que [[delta_entropia]] se calcule a partir de multiplicidad de configuraciones accesibles, no de aspecto visual ni extensión espacial.
...
**Corrección conceptual**
Comprueba que la lectura clásica y la estadística se apliquen al mismo cambio de estado del mismo sistema para obtener el mismo valor de [[delta_entropia]].
...
**Corrección conceptual**
Construye un camino reversible equivalente entre los mismos estados antes de dividir calor entre [[temperatura]] para calcular correctamente [[delta_entropia]].
...
**Corrección conceptual**
Asegúrate de que el [[ratio_microestados]] compare multiplicidades del mismo sistema bajo restricciones macroscópicas compatibles.
...
**Corrección conceptual**
Convierte siempre a kelvin antes de usar [[temperatura]] en la relación clásica; sin escala absoluta el cociente carece de significado físico.
...
**Corrección conceptual**
Aplica la escala logarítmica correctamente: duplicar [[numero_microestados]] no duplica [[delta_entropia]], pues la conexión es logarítmica en el cociente entre estados.
...
**Corrección conceptual**
Determina el signo de [[delta_entropia]] comparando multiplicidad final e inicial: [[ratio_microestados]] mayor que uno indica aumento, menor que uno indica reducción de [[entropia]].
...
**Corrección conceptual**
Incluye [[k_boltzmann]] en el resultado estadístico para que tenga unidades J/K y sea directamente comparable con la lectura clásica de [[delta_entropia]].
