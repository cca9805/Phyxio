...
The ideal model compares two equilibrium states of the same system and allows the same [[delta_entropia]] to be read in two ways. The classical reading uses [[calor_reversible]] and [[temperatura]] to measure the change in [[entropia]]. The statistical reading uses [[numero_microestados]] or [[ratio_microestados]] to measure how the microscopic multiplicity compatible with the macrostate changes. Both readings are equivalent when they describe the same physical change. This dual reading is what makes the equivalence between [[delta_entropia]] and [[ratio_microestados]] a rigorous physical bridge, not merely a formal coincidence.
