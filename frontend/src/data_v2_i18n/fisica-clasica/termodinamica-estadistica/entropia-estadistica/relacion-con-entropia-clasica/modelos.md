...
El modelo ideal compara dos estados de equilibrio del mismo sistema y permite leer la misma [[delta_entropia]] de dos maneras. La lectura clásica usa [[calor_reversible]] y [[temperatura]] para medir el cambio de [[entropia]]. La lectura estadística usa [[numero_microestados]] o [[ratio_microestados]] para medir cómo cambia la multiplicidad microscópica compatible con el macroestado. Ambas lecturas son equivalentes cuando describen el mismo cambio físico. Esta doble lectura es lo que convierte la equivalencia entre [[delta_entropia]] y [[ratio_microestados]] en un puente físico riguroso, no solo una coincidencia formal.
