...
La pregunta no requiere fuerzas, trayectorias ni dinámica temporal; requiere comparar accesibilidad estadística. El conjunto canónico es apropiado porque el sistema opera a [[temperatura]] fija, lo que en la práctica significa estar en contacto con un baño térmico mucho más grande: ese baño mantiene la [[temperatura]] constante y permite intercambio de energía con el sistema sin que dicho intercambio altere la escala térmica global. Si el sistema estuviera aislado energéticamente, el modelo adecuado sería el microcanónico, no el canónico; en ese caso, la [[funcion_particion]] no sería la herramienta correcta. El [[peso_boltzmann]] es adecuado aquí porque penaliza una [[energia_microestado]] grande respecto a la escala marcada por [[temperatura]]. La [[razon_energia_termica]] permite decidir de antemano si los estados altos serán raros o si la [[temperatura]] es suficientemente alta para que sus contribuciones sean apreciables. Como los tres estados pertenecen al mismo sistema y están bajo la misma [[temperatura]], sus pesos pueden sumarse en una única [[funcion_particion]] y usarse para normalizar. El modelo fallaría si el sistema no alcanzara equilibrio térmico, si los microestados accesibles cambiaran durante el proceso o si la [[temperatura]] no fuera constante a lo largo de la medida.
