...
La escala térmica aproximada es [[constante_boltzmann]] T ≈ 4,14 x 10^-21 J. Por eso los tres niveles corresponden aproximadamente a razones 0, 1 y 2. Sus pesos relativos son del orden de 1, 0,37 y 0,14. La [[funcion_particion]] vale aproximadamente 1,51. Las probabilidades aproximadas son 0,66, 0,24 y 0,09. La [[energia_media]] queda próxima a 1,7 x 10^-21 J. Si la [[temperatura]] aumentara a 600 K, la escala térmica se doblaría y las razones de energía caerían a la mitad, haciendo que los estados excitados ganen presencia y que [[funcion_particion]] crezca hacia 2. Ese contraste muestra la sensibilidad de la [[probabilidad_microestado]] ante cambios de [[temperatura]] incluso moderados.
...
Si la separación entre configuraciones es del orden de [[constante_boltzmann]] T, varias configuraciones contribuyen de forma apreciable. Si una separación es diez veces mayor, su [[peso_boltzmann]] cae mucho y apenas modifica [[funcion_particion]]. Una estimación razonable consiste en conservar los estados con peso relativo mayor que 10^-3 y descartar los restantes solo si no cambian [[energia_media]] dentro de la precisión buscada. La [[funcion_particion]] calculada con ese subconjunto truncado puede compararse con la suma completa para verificar que el error cometido es aceptable antes de usar la [[probabilidad_microestado]] en predicciones experimentales.

## Interpretación

La aplicación enseña que [[funcion_particion]] funciona como filtro térmico. No basta con enumerar configuraciones; hay que ponderarlas con [[peso_boltzmann]]. Al variar [[temperatura]], cambian las probabilidades y, con ellas, propiedades promedio. Esa es la razón por la que una misma molécula puede mostrar comportamientos macroscópicos distintos sin cambiar su lista de microestados básicos. Si se mide experimentalmente la [[energia_media]] de una propiedad molecular en función de [[temperatura]], la [[funcion_particion]] permite ajustar los parámetros del modelo energético para que las [[probabilidad_microestado]] predichas reproduzcan la curva observada. De este modo, la suma canónica actúa como vínculo entre datos macroscópicos medibles y la escala microscópica de las [[energia_microestado]].