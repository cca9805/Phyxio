...
Falla si la suma de pesos no converge, si aparecen probabilidades negativas, si la suma de [[probabilidad_microestado]] no es uno, o si [[energia_media]] queda fuera del intervalo de energías accesibles. También falla cuando los datos experimentales muestran ocupaciones no compatibles con una única [[temperatura]], o cuando degeneraciones omitidas alteran la distribución. Una señal adicional es que la varianza de las energías muestreadas supere el cuadrado del rango de [[energia_microestado]] disponible, lo que indica que el conjunto de microestados está mal especificado o que el sistema no ha alcanzado equilibrio.
