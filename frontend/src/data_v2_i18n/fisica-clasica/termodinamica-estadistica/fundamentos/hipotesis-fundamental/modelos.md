...
Los tres ensembles comparten la misma hipótesis de fondo: dentro del conjunto accesible definido por sus restricciones, todas las configuraciones permitidas reciben el mismo peso estadístico. Lo que cambia son las magnitudes macroscópicas que fijan ese conjunto: [[energia_total]], [[volumen]] y [[numero_particulas]] para el microcanónico; [[volumen]] y [[numero_particulas]] con temperatura media para el canónico; solo el [[volumen]] y los potenciales químicos para el gran canónico. [[constante_boltzmann]] aparece en los tres ensembles como factor de conversión entre el conteo microscópico de estados y la escala termodinámica medible.
