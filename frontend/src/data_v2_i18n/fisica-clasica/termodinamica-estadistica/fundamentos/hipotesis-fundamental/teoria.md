...
La [[entropia]] conecta el conteo microscópico con una magnitud macroscópica: no mide desorden visual, sino crecimiento logarítmico de [[numero_microestados_accesibles]]. La [[constante_boltzmann]] actúa como factor de conversión que transforma ese conteo puro en una magnitud con unidades de J/K y que vincula el repertorio microscópico con la temperatura macroscópica.
