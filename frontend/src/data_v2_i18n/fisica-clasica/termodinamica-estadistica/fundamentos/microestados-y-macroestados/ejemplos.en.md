...
The [[entropia]] of a [[macroestado]] is associated with the logarithm of its multiplicity.

{{f:entropia_boltzmann_macroestado}}

## Numerical substitution

For four particles and two regions, the total number of [[microestado]] is 16. The [[macroestado]] with two particles on the left has [[multiplicidad_macroestado]] 6. Therefore its [[probabilidad_macroestado]] is 6/16, or 0.375. The [[macroestado]] with zero particles on the left has multiplicity 1 and probability 1/16. The one-particle-left [[macroestado]] has multiplicity 4 and probability 4/16. The [[entropia]] of the two-two [[macroestado]] is proportional to ln(6) through [[constante_boltzmann]].
