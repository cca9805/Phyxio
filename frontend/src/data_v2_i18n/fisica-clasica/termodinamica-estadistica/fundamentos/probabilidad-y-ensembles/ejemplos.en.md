...
The sum of weights is 1 + 2 + 7 = 10. The probabilities are 0.1, 0.2, and 0.7. The [[valor_medio_ensemble]] is computed as 0.1·0 + 0.2·4 + 0.7·10, which gives 7.8 J. For an ideal [[numero_copias_ensemble]] of 1000 copies, the [[conteo_sistemas]] of each state would be 100, 200, and 700. For spread, the weighted squared deviations are 0.1·(0 − 7.8)², 0.2·(4 − 7.8)², and 0.7·(10 − 7.8)². The variance is about 12.36 J², and the [[fluctuacion_ensemble]] is about 3.5 J.
