...
El modelo funciona bien cuando [[numero_copias_ensemble]] es grande, por ejemplo mayor que 10³ para estimaciones escolares y mucho mayor en interpretación termodinámica. Cada [[probabilidad_estado]] debe cumplir 0 ≤ [[probabilidad_estado]] ≤ 1 y la suma total debe ser 1 dentro de tolerancias numéricas menores que 10⁻⁶. Si se usan frecuencias, [[conteo_sistemas]] debe ser suficientemente grande para que [[conteo_sistemas]]/[[numero_copias_ensemble]] no dependa de una sola copia. La [[fluctuacion_ensemble]] debe compararse con el [[valor_medio_ensemble]]: si [[fluctuacion_ensemble]]/[[valor_medio_ensemble]] es del orden de 1, la media necesita acompañarse de dispersión.
