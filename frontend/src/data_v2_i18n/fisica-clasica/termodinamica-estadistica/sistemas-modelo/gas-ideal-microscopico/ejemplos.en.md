...
The following values define the calculation. The gas is a monatomic ideal gas with known temperature and particle mass, and the [[numero_particulas]] and container volume are assumed sufficient for the ideal model to apply.

- Initial [[temperatura]]: 300 K
- Final [[temperatura]]: 600 K
- [[masa_particula]]: 6.64·10^-27 kg
- [[constante_boltzmann]]: 1.38·10^-23 J/K
- [[numero_particulas]]: N (generic, representative of the sample)
...
If the [[numero_particulas]] and container volume are also known, the same microscopic picture allows estimating [[presion]] from wall collisions:

{{f:presion_microscopica_gas_ideal}}

Or equivalently, using the microscopic equation of state that directly connects [[presion]], volume, [[numero_particulas]], and [[temperatura]]:
...
A laboratory vacuum chamber is filled with helium to calibrate a [[presion]] sensor. The individual atoms are not observed, but the sensor response depends on [[presion]], and that [[presion]] comes from microscopic collisions. The technician wants to know whether raising [[temperatura]] from 300 K to 450 K strongly changes the microscopic motion scale.
