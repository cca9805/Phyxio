...
Primero identifica qué escala buscas: [[energia_cinetica_media]], [[velocidad_rms]], [[presion]] o [[temperatura]]. Después comprueba que la [[temperatura]] esté en kelvin y que la [[masa_particula]] esté en kg si aparece una rapidez. Decide si el gas puede tratarse como ideal: baja densidad, equilibrio y partículas sin interacciones relevantes. Elige la fórmula que conecta directamente las magnitudes dadas. Usa

[[energia_cinetica_media]]

para energía por partícula,

[[velocidad_rms]]

para rapidez típica, y

[[presion]]

para estado macroscópico. Al final interpreta el resultado como una media estadística.
