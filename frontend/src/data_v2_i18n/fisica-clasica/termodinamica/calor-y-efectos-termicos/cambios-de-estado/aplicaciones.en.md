...
Validity limit: the real atmosphere does not keep temperature or pressure constant; weather models compute [[T_trans]], humidity, and latent release as distributed quantities with height.

This final check keeps the estimate tied to the leaf quantities rather than to unrelated thermal details.
