...
Variable dominante: [[Q_lat]] extraido por evaporacion de agua sobre la piel.

Límite de validez: el modelo solo estima la energía retirada por evaporacion; no incluye circulacion sanguinea, radiacion, conveccion ni limites fisiologicos de produccion de sudor.

## 5. Nubes, tormentas y liberacion de calor latente
...
En una tormenta intensa, grandes masas de vapor cambian de estado en pocas horas. Aunque cada kilogramo se condense en microgotas, la suma de [[m]] sobre todo el volumen de nube produce una energía enorme. Este mecanismo conecta la termodinámica microscopica del cambio de fase con fenómenos atmosféricos de escala kilometrica.

Variable dominante: masa total de vapor que condensa y [[L]] del agua en las condiciones atmosféricas.

Límite de validez: la atmósfera real no mantiene temperatura ni presión constantes; los modelos meteorologicos calculan [[T_trans]], humedad y liberacion latente de forma distribuida en altura.
