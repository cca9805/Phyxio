...
**Kinetic pressure:** the dimension of [[N]] (dimensionless) times [[m_mol]] (dimension M), times [[v_rms]] squared (dimension L² T⁻²), divided by [[V]] (dimension L³), gives M·L⁻¹·T⁻², which is the dimension of the pascal. ✓
