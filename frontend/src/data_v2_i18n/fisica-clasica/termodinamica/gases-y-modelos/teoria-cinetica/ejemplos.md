...
**Presión cinética:** la dimensión de [[N]] (adimensional) multiplicada por [[m_mol]] (dimensión M), multiplicada por [[v_rms]] al cuadrado (dimensión L² T⁻²), dividida por [[V]] (dimensión L³), da M·L⁻¹·T⁻², que es la dimensión del pascal. ✓
