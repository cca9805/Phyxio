...
Input error: using a datum without unit, scale, or a decision about whether it is constant. In logarithms and exponentials, an isolated number rarely contains all the physical information.
