...
![Proyecciones y componentes](/graphs/matematicas/trigonometria-y-geometria/proyecciones-componentes.svg)
...
| Dato conocido | Componente paralela | Componente perpendicular | Control |
|---|---|---|---|
| modulo y angulo desde x | A cos(theta) | A sin(theta) | mismo modulo al reconstruir |
| modulo y angulo desde y | A sin(theta) | A cos(theta) | cambia la funcion usada |
| componente y angulo | dividir por sin/cos | despejar modulo | revisar dominio |
