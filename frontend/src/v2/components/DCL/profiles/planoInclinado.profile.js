// frontend/src/v2/components/DCL/profiles/planoInclinado.profile.js
...
const planoInclinadoProfile = {
  scene: DCL_SCENE_IDS.BLOCK_ON_INCLINE,
  question: DCL_QUESTION_TYPES.IDENTIFY_FORCES,
  lang: "es",

  meta: {
    id: "dcl-plano-inclinado",
    title: {
      es: "DCL · Plano inclinado",
      en: "FBD · Inclined plane",
    },
    leafId: "plano-inclinado",
    question: {
      es: "¿Cuál es el balance de fuerzas (esfuerzo, rozamiento y normal) en una rampa de plano inclinado?",
      en: "What is the force balance (effort, friction, and normal) on an inclined plane ramp?",
    },
  },
  ...
  interpretation: {
    ...
    reading_focus: {
      ...
      en: "Identify which focus drives motion, which one enforces contact, and which one opposes sliding.",
    },
    physical_insight: {
...
export default planoInclinadoProfile;
