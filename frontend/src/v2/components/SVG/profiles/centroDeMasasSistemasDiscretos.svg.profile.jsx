...
const profile = {
  meta: {
    id: "svg-centro-de-masas-sistemas-discretos",
    leafId: "centro-de-masas-sistemas-discretos",
    title: {
      es: "Centro de masas en sistemas discretos",
      en: "Center of mass in discrete systems",
    },
    subtitle: {
      es: "Suma ponderada de masas puntuales",
      en: "Weighted sum of point masses",
    },
  },
  graph_contract: createSvgProfileContract({
    leafId: "centro-de-masas-sistemas-discretos",
    graphId: "svg-centro-de-masas-sistemas-discretos",
    purpose: {
      es: "Mostrar que el centro de masas queda entre masas puntuales y se desplaza hacia la mayor contribucion ponderada.",
      en: "Show that the center of mass lies between point masses and shifts toward the larger weighted contribution.",
    },
    level: {
    ...
    hypotheses: ["sistema discreto", "masas puntuales", "eje unidimensional"],
    validityDomain: ["masas positivas", "distribucion discreta"],
    visualSimplifications: ["dos masas puntuales", "eje lineal ideal"],
  ...
  infoCards: [
    ...
    },
    {
      ...
      result: ({ p, lang }) => `xcm = ${fmt(safeNum(p?.xcm, 2), 3, lang)} m`,
      resultColor: "#34d399",
    },
  ],
  motion: {
  ...
  graph_identity: {
    pregunta_principal: {
      es: "¿Cómo se calcula la posición del centro de masas de un conjunto de partículas discretas?",
      en: "How is the center of mass position of a set of discrete particles calculated?",
    },
