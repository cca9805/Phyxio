...
const profile = {
  ...
  interpretation_binding: {
    target: "rapidez_de_propagacion",
    magnitudes: [
      "rapidez_de_propagacion",
      "modulo_de_compresibilidad_volumetrica",
      "rho",
      "frecuencia",
      "lambda",
      "impedancia_acustica",
    ],
    formula: "velocidad_longitudinal_fluidos",
  },
  id: "ondas-longitudinales-svg",
  ...
  graph_identity: {
    ...
    magnitud_estrella: "rapidez_de_propagacion",
  },
  ...
  graph_contract: createSvgProfileContract({
    leafId: "ondas-longitudinales",
    graphId: "ondas-longitudinales-svg",
    purpose: {
