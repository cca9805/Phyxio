...
function VentajaMecanicaGraphsCoordView(props) {
  void graphIdentity;
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Ventaja mecánica en palancas (Coord)", "Mechanical advantage in levers (Coord)")}</div>
        <div className="muted" style={{ marginTop: 6 }}>
          <MathInline latex={"VM=\\frac{R}{P}=\\frac{d_P}{d_R}"} /> {tt("(ideal, sin pérdidas).", "(ideal, lossless).")}
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            ...
            <Pill active={mode === "load"} onClick={() => setValue("mode", "load")}>{tt("P vs R", "P vs R")}</Pill>
          ...
          >
            <Pill active={showVM} onClick={() => setValue("showVM", !showVM)}>{tt("VM", "VM")}</Pill>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            <div style={{ fontSize: 13, opacity: 0.85, lineHeight: 1.5 }}>
              ...
              {tt(
                ...
                "The larger the VM, the smaller the input force needed for the same load."
              )}
            </div>
          </div>
        </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Curvas de ventaja mecánica", "Mechanical advantage curves")}</div>
...
const VentajaMecanicaGraphsCoord = createCoordGraph({
  Component: VentajaMecanicaGraphsCoordView,
  displayName: "VentajaMecanicaGraphsCoord",
});

VentajaMecanicaGraphsCoord.graphContract = VentajaMecanicaGraphsCoordView.graphContract;
VentajaMecanicaGraphsCoord.graph_identity = VentajaMecanicaGraphsCoordView.graph_identity;
VentajaMecanicaGraphsCoord.axes = VentajaMecanicaGraphsCoordView.axes;
VentajaMecanicaGraphsCoord.formula = VentajaMecanicaGraphsCoordView.formula;
VentajaMecanicaGraphsCoord.profile = VentajaMecanicaGraphsCoordView.profile;

export default VentajaMecanicaGraphsCoord;
