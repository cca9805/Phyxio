...
const _graph_meta = {
  pregunta_principal: {
    es: "¿Qué condiciones cumple un sistema aislado para que su momento lineal total se conserve?",
    en: "What conditions must an isolated system satisfy for its total linear momentum to be conserved?",
  },
};
...
function SistemasAisladosGraphsCoordView({ title, lang = "es", params, sharedParams }) {
  ...
  const schema = useMemo(
    () => [
      ...
      { key: "v2i", default: toNum((params ?? sharedParams)?.v2i, -2) },
      { key: "v1f", default: toNum((params ?? sharedParams)?.v1f, 1) },
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || t("Sistemas aislados (Coord)", "Isolated systems (Coord)")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t("Comparación inicial/final de momento", "Initial/final momentum comparison")}</div>
...
const SistemasAisladosGraphsCoord = createCoordGraph({
  Component: SistemasAisladosGraphsCoordView,
  displayName: "SistemasAisladosGraphsCoord",
});

SistemasAisladosGraphsCoord.graphContract = SistemasAisladosGraphsCoordView.graphContract;
SistemasAisladosGraphsCoord.graph_identity = SistemasAisladosGraphsCoordView.graph_identity;
SistemasAisladosGraphsCoord.axes = SistemasAisladosGraphsCoordView.axes;
SistemasAisladosGraphsCoord.formula = SistemasAisladosGraphsCoordView.formula;
SistemasAisladosGraphsCoord.profile = SistemasAisladosGraphsCoordView.profile;

export default SistemasAisladosGraphsCoord;
