...
function EncuentrosYPersecucionesGraphsCoordView({ title, params }) {
...
const EncuentrosYPersecucionesGraphsCoord = createCoordGraph({
  Component: EncuentrosYPersecucionesGraphsCoordView,
  displayName: "EncuentrosYPersecucionesGraphsCoord",
});

EncuentrosYPersecucionesGraphsCoord.graphContract = EncuentrosYPersecucionesGraphsCoordView.graphContract;
EncuentrosYPersecucionesGraphsCoord.graph_identity = EncuentrosYPersecucionesGraphsCoordView.graph_identity;
EncuentrosYPersecucionesGraphsCoord.axes = EncuentrosYPersecucionesGraphsCoordView.axes;
EncuentrosYPersecucionesGraphsCoord.formula = EncuentrosYPersecucionesGraphsCoordView.formula;
EncuentrosYPersecucionesGraphsCoord.profile = EncuentrosYPersecucionesGraphsCoordView.profile;

export default EncuentrosYPersecucionesGraphsCoord;
