...
function McuGraphsCoordView({ title, params }) {
...
const McuGraphsCoord = createCoordGraph({
  Component: McuGraphsCoordView,
  displayName: "McuGraphsCoord",
});

McuGraphsCoord.graphContract = McuGraphsCoordView.graphContract;
McuGraphsCoord.graph_identity = McuGraphsCoordView.graph_identity;
McuGraphsCoord.axes = McuGraphsCoordView.axes;
McuGraphsCoord.formula = McuGraphsCoordView.formula;
McuGraphsCoord.profile = McuGraphsCoordView.profile;

export default McuGraphsCoord;
