...
function McuaGraphsCoordView({ title, params }) {
...
const McuaGraphsCoord = createCoordGraph({
  Component: McuaGraphsCoordView,
  displayName: "McuaGraphsCoord",
});

McuaGraphsCoord.graphContract = McuaGraphsCoordView.graphContract;
McuaGraphsCoord.graph_identity = McuaGraphsCoordView.graph_identity;
McuaGraphsCoord.axes = McuaGraphsCoordView.axes;
McuaGraphsCoord.formula = McuaGraphsCoordView.formula;
McuaGraphsCoord.profile = McuaGraphsCoordView.profile;

export default McuaGraphsCoord;
