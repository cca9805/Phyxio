...
function MruaGraphsCoordView({ title, params }) {
...
const MruaGraphsCoord = createCoordGraph({
  Component: MruaGraphsCoordView,
  displayName: "MruaGraphsCoord",
});

MruaGraphsCoord.graphContract = MruaGraphsCoordView.graphContract;
MruaGraphsCoord.graph_identity = MruaGraphsCoordView.graph_identity;
MruaGraphsCoord.axes = MruaGraphsCoordView.axes;
MruaGraphsCoord.formula = MruaGraphsCoordView.formula;
MruaGraphsCoord.profile = MruaGraphsCoordView.profile;

export default MruaGraphsCoord;
