...
function SistemasReferenciaGraphsCoordView({ title, params }) {
...
const SistemasReferenciaGraphsCoord = createCoordGraph({
  Component: SistemasReferenciaGraphsCoordView,
  displayName: "SistemasReferenciaGraphsCoord",
});

SistemasReferenciaGraphsCoord.graphContract = SistemasReferenciaGraphsCoordView.graphContract;
SistemasReferenciaGraphsCoord.graph_identity = SistemasReferenciaGraphsCoordView.graph_identity;
SistemasReferenciaGraphsCoord.axes = SistemasReferenciaGraphsCoordView.axes;
SistemasReferenciaGraphsCoord.formula = SistemasReferenciaGraphsCoordView.formula;
SistemasReferenciaGraphsCoord.profile = SistemasReferenciaGraphsCoordView.profile;

export default SistemasReferenciaGraphsCoord;
