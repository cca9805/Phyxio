...
function TiroHorizontalGraphsCoordView({ title, params }) {
...
const TiroHorizontalGraphsCoord = createCoordGraph({
  Component: TiroHorizontalGraphsCoordView,
  displayName: "TiroHorizontalGraphsCoord",
});

TiroHorizontalGraphsCoord.graphContract = TiroHorizontalGraphsCoordView.graphContract;
TiroHorizontalGraphsCoord.graph_identity = TiroHorizontalGraphsCoordView.graph_identity;
TiroHorizontalGraphsCoord.axes = TiroHorizontalGraphsCoordView.axes;
TiroHorizontalGraphsCoord.formula = TiroHorizontalGraphsCoordView.formula;
TiroHorizontalGraphsCoord.profile = TiroHorizontalGraphsCoordView.profile;

export default TiroHorizontalGraphsCoord;
