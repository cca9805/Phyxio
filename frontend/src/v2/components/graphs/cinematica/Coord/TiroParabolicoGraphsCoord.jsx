...
function TiroParabolicoGraphsCoordView({ title, params }) {
...
const TiroParabolicoGraphsCoord = createCoordGraph({
  Component: TiroParabolicoGraphsCoordView,
  displayName: "TiroParabolicoGraphsCoord",
});

TiroParabolicoGraphsCoord.graphContract = TiroParabolicoGraphsCoordView.graphContract;
TiroParabolicoGraphsCoord.graph_identity = TiroParabolicoGraphsCoordView.graph_identity;
TiroParabolicoGraphsCoord.axes = TiroParabolicoGraphsCoordView.axes;
TiroParabolicoGraphsCoord.formula = TiroParabolicoGraphsCoordView.formula;
TiroParabolicoGraphsCoord.profile = TiroParabolicoGraphsCoordView.profile;

export default TiroParabolicoGraphsCoord;
