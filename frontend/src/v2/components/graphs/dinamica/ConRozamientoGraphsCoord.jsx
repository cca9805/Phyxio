...
export default function ConRozamientoGraphsCoord(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">Plano inclinado con rozamiento (Coord)</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            <div style={{ fontSize: 13, opacity: 0.9, lineHeight: 1.5 }}>
              ...
              <br />
              Angulo critico (a=0): theta_c = arctan(mu) = <b>{fmt((thetaCrit * 180) / Math.PI, 3)}</b> deg.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">Aceleracion vs angulo con rozamiento</div>
