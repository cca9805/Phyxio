...
const graphIdentity = {
  pregunta_principal: {
    es: "¿Qué muestra la curva T(a), tomando a positiva hacia abajo, sobre cómo disminuye la tensión y dónde aparece T = 0 cuando a = g?",
    en: "What does the T(a) curve, taking a as positive downward, show about how tension decreases and where T = 0 appears when a = g?",
  },
};
...
function BloqueColganteGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Bloque colgante (Coord)", "Hanging block (Coord)")}</div>
        <div className="muted" style={{ marginTop: 6 }}>
          {tt("Tomando ", "Taking ")}<b>{tt("a positiva hacia abajo", "a positive downwards")}</b>: <MathInline latex={"T = m(g-a)"} />.
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            <div style={{ fontSize: 13, opacity: 0.9, lineHeight: 1.5 }}>
              T = <b>{fmt(T, 4)}</b> N.
              <br />
              {tt("Si a = g, entonces T = 0 (caida libre ideal del bloque).", "If a = g, then T = 0 (ideal free fall of the block).")}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Tension en funcion de la aceleracion", "Tension as a function of acceleration")}</div>
...
const BloqueColganteGraphsCoord = createCoordGraph({
  Component: BloqueColganteGraphsCoordView,
  displayName: "BloqueColganteGraphsCoord",
});

BloqueColganteGraphsCoord.graphContract = BloqueColganteGraphsCoordView.graphContract;
BloqueColganteGraphsCoord.graph_identity = BloqueColganteGraphsCoordView.graph_identity;
BloqueColganteGraphsCoord.axes = BloqueColganteGraphsCoordView.axes;
BloqueColganteGraphsCoord.formula = BloqueColganteGraphsCoordView.formula;
BloqueColganteGraphsCoord.profile = BloqueColganteGraphsCoordView.profile;

export default BloqueColganteGraphsCoord;
