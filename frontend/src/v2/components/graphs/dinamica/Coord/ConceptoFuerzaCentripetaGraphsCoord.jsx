...
function ConceptoFuerzaCentripetaGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Concepto de fuerza centripeta (Coord)", "Concept of centripetal force (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            <Pill active={view === "v"} onClick={() => setView("v")}>{tt("Barrido en v", "Sweep in v")}</Pill>
            <Pill active={view === "r"} onClick={() => setView("r")}>{tt("Barrido en r", "Sweep in r")}</Pill>
          ...
          >
            ...
            <Pill active={showPoint} onClick={() => setShowPoint(!showPoint)}>{tt("Punto actual", "Current point")}</Pill>
          </div>
        </div>
      </div>
          ...
          <ResponsiveContainer>
            <LineChart data={data} margin={{ top: 10, right: 18, left: 8, bottom: 10 }}>
              ...
              <YAxis
                ...
                label={{ value: tt("Magnitud", "Magnitud"), angle: -90, position: "insideLeft" }}
              />
              <Tooltip
...
const ConceptoFuerzaCentripetaGraphsCoord = createCoordGraph({
  Component: ConceptoFuerzaCentripetaGraphsCoordView,
  displayName: "ConceptoFuerzaCentripetaGraphsCoord",
});

ConceptoFuerzaCentripetaGraphsCoord.graphContract = ConceptoFuerzaCentripetaGraphsCoordView.graphContract;
ConceptoFuerzaCentripetaGraphsCoord.graph_identity = ConceptoFuerzaCentripetaGraphsCoordView.graph_identity;
ConceptoFuerzaCentripetaGraphsCoord.axes = ConceptoFuerzaCentripetaGraphsCoordView.axes;
ConceptoFuerzaCentripetaGraphsCoord.formula = ConceptoFuerzaCentripetaGraphsCoordView.formula;
ConceptoFuerzaCentripetaGraphsCoord.profile = ConceptoFuerzaCentripetaGraphsCoordView.profile;

export default ConceptoFuerzaCentripetaGraphsCoord;
