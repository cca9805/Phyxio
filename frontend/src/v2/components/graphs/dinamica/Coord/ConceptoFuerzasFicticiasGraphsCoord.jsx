...
function ConceptoFuerzasFicticiasGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Concepto de fuerzas ficticias (Coord)", "Concept of fictitious forces (Coord)")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Magnitud de la fuerza ficticia vs aceleracion del marco", "Fictitious-force magnitude vs frame acceleration")}</div>
        <div style={{ width: "100%", height: 350, marginTop: 10 }}>
          <ResponsiveContainer>
            <LineChart data={data} margin={{ top: 10, right: 18, left: 10, bottom: 10 }}>
              ...
              <YAxis
                tickFormatter={(v) => fmt(v, 2)}
                label={{ value: tt("|F_fict| (N)", "|F_fict| (N)"), angle: -90, position: "insideLeft" }}
              />
...
const ConceptoFuerzasFicticiasGraphsCoord = createCoordGraph({
  Component: ConceptoFuerzasFicticiasGraphsCoordView,
  displayName: "ConceptoFuerzasFicticiasGraphsCoord",
});

ConceptoFuerzasFicticiasGraphsCoord.graphContract = ConceptoFuerzasFicticiasGraphsCoordView.graphContract;
ConceptoFuerzasFicticiasGraphsCoord.graph_identity = ConceptoFuerzasFicticiasGraphsCoordView.graph_identity;
ConceptoFuerzasFicticiasGraphsCoord.axes = ConceptoFuerzasFicticiasGraphsCoordView.axes;
ConceptoFuerzasFicticiasGraphsCoord.formula = ConceptoFuerzasFicticiasGraphsCoordView.formula;
ConceptoFuerzasFicticiasGraphsCoord.profile = ConceptoFuerzasFicticiasGraphsCoordView.profile;

export default ConceptoFuerzasFicticiasGraphsCoord;
