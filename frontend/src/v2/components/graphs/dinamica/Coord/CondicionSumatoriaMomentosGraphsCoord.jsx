...
const graphIdentity = {
  pregunta_principal: {
    es: "¿Qué condición sobre la suma algebraica de momentos garantiza que un cuerpo rígido no rota?",
    en: "What condition on the algebraic sum of torques guarantees that a rigid body does not rotate?",
  },
};

function CondicionSumatoriaMomentosGraphsCoordView(props) {
  void graphIdentity;
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Condicion de sumatoria de momentos (Coord)", "Net-torque condition (Coord)")}</div>
        <div className="muted" style={{ marginTop: 6 }}>
          {tt("Equilibrio rotacional cuando", "Equilibrio rotacional cuando")} <MathInline latex={"\\sum \\tau = 0"} />.
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
              <span style={{ fontSize: 13, opacity: 0.85 }}>{tt("theta1", "theta1")}</span>
            ...
            <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
              <span style={{ fontSize: 13, opacity: 0.85 }}>{tt("theta2", "theta2")}</span>
          ...
          >
            ...
            <Pill active={showTau1} onClick={() => setValue("showTau1", !showTau1)}>{tt("tau1", "tau1")}</Pill>
            <Pill active={showTau2} onClick={() => setValue("showTau2", !showTau2)}>{tt("tau2", "tau2")}</Pill>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            <div style={{ fontSize: 13, opacity: 0.85, lineHeight: 1.5 }}>
              tau1 = <b>{fmt(tau1, 3)}</b> {tt("N·m, tau2 =", "N·m, tau2 =")} <b>{fmt(tau2, 3)}</b> N·m, tau_net = <b>{fmt(tauNet, 3)}</b> N·m.
              <br />
              {tt("F2 para equilibrio en theta2:", "F2 para equilibrio en theta2:")} <b>{Number.isFinite(F2eq) ? `${fmt(F2eq, 3)} N` : "infinita"}</b>.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Barrido de theta2", "theta2 sweep")}</div>
...
const CondicionSumatoriaMomentosGraphsCoord = createCoordGraph({
  Component: CondicionSumatoriaMomentosGraphsCoordView,
  displayName: "CondicionSumatoriaMomentosGraphsCoord",
});

CondicionSumatoriaMomentosGraphsCoord.graphContract = CondicionSumatoriaMomentosGraphsCoordView.graphContract;
CondicionSumatoriaMomentosGraphsCoord.graph_identity = CondicionSumatoriaMomentosGraphsCoordView.graph_identity;
CondicionSumatoriaMomentosGraphsCoord.axes = CondicionSumatoriaMomentosGraphsCoordView.axes;
CondicionSumatoriaMomentosGraphsCoord.formula = CondicionSumatoriaMomentosGraphsCoordView.formula;
CondicionSumatoriaMomentosGraphsCoord.profile = CondicionSumatoriaMomentosGraphsCoordView.profile;

export default CondicionSumatoriaMomentosGraphsCoord;
