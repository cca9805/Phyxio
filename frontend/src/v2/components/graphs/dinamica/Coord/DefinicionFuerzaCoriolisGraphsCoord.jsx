...
function DefinicionFuerzaCoriolisGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Definicion de fuerza de Coriolis (Coord)", "Definition of Coriolis force (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            <div style={{ fontSize: 13, opacity: 0.9, lineHeight: 1.5 }}>
              En v_rel = <b>{fmt(vObs, 3)}</b> {tt("m/s: F(theta) =", "m/s: F(theta) =")} <b>{fmt(fObs, 4)}</b> N | F(90) = <b>{fmt(fObs90, 4)}</b> N.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Fuerza de Coriolis vs velocidad relativa", "Coriolis force vs relative velocity")}</div>
...
const DefinicionFuerzaCoriolisGraphsCoord = createCoordGraph({
  Component: DefinicionFuerzaCoriolisGraphsCoordView,
  displayName: "DefinicionFuerzaCoriolisGraphsCoord",
});

DefinicionFuerzaCoriolisGraphsCoord.graphContract = DefinicionFuerzaCoriolisGraphsCoordView.graphContract;
DefinicionFuerzaCoriolisGraphsCoord.graph_identity = DefinicionFuerzaCoriolisGraphsCoordView.graph_identity;
DefinicionFuerzaCoriolisGraphsCoord.axes = DefinicionFuerzaCoriolisGraphsCoordView.axes;
DefinicionFuerzaCoriolisGraphsCoord.formula = DefinicionFuerzaCoriolisGraphsCoordView.formula;
DefinicionFuerzaCoriolisGraphsCoord.profile = DefinicionFuerzaCoriolisGraphsCoordView.profile;

export default DefinicionFuerzaCoriolisGraphsCoord;
