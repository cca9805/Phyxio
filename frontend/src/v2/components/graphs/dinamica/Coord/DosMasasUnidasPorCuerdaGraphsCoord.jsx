...
function DosMasasUnidasPorCuerdaGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Dos masas unidas por cuerda (Coord)", "Two masses connected by a rope (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", padding: "8px 12px", borderRadius: 10, border: "1px solid rgba(59,130,246,0.2)", background: "rgba(59,130,246,0.08)" }}>
            ...
            <button type="button" onClick={exp.resetToCalculator} style={{ marginLeft: "auto", padding: "8px 10px", borderRadius: 14, border: "1px solid rgba(255,255,255,0.14)", background: "rgba(0,0,0,0.35)", color: "rgba(255,255,255,0.88)", fontWeight: 900, cursor: "pointer" }}>{tt("Seguir calculadora", "Follow calculator")}</button>
          </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Aceleracion en funcion de m2", "Acceleration as a function of m2")}</div>
...
const DosMasasUnidasPorCuerdaGraphsCoord = createCoordGraph({
  Component: DosMasasUnidasPorCuerdaGraphsCoordView,
  displayName: "DosMasasUnidasPorCuerdaGraphsCoord",
});

DosMasasUnidasPorCuerdaGraphsCoord.graphContract = DosMasasUnidasPorCuerdaGraphsCoordView.graphContract;
DosMasasUnidasPorCuerdaGraphsCoord.graph_identity = DosMasasUnidasPorCuerdaGraphsCoordView.graph_identity;
DosMasasUnidasPorCuerdaGraphsCoord.axes = DosMasasUnidasPorCuerdaGraphsCoordView.axes;
DosMasasUnidasPorCuerdaGraphsCoord.formula = DosMasasUnidasPorCuerdaGraphsCoordView.formula;
DosMasasUnidasPorCuerdaGraphsCoord.profile = DosMasasUnidasPorCuerdaGraphsCoordView.profile;

export default DosMasasUnidasPorCuerdaGraphsCoord;
