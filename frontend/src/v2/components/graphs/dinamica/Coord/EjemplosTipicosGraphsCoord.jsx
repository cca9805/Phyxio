...
const graph_identity = {
  pregunta_principal: {
    es: "Que fuerza real o que componente real produce la resultante radial en los ejemplos tipicos de movimiento circular?",
    en: "Which real force or real component produces the radial resultant in the typical examples of circular motion?",
  },
...
function EjemplosTipicosGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Ejemplos tipicos de fuerza centripeta (Coord)", "Typical examples of centripetal force (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            <Pill active={example === "cuerda"} onClick={() => setExample("cuerda")}>{tt("Cuerda", "Rope")}</Pill>
            <Pill active={example === "curva"} onClick={() => setExample("curva")}>{tt("Curva", "Curve")}</Pill>
            <Pill active={example === "loop"} onClick={() => setExample("loop")}>{tt("Loop", "Loop")}</Pill>
            <Pill active={example === "orbita"} onClick={() => setExample("orbita")}>{tt("Orbita", "Orbit")}</Pill>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            ...
            <div className="muted" style={{ marginTop: 8 }}>
              {tt(
                ...
                'In every case, "centripetal" refers to the radial resultant of real forces.'
              )}
            </div>
          </div>
        </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Curvas de ejemplo", "Example curves")}</div>
...
const EjemplosTipicosGraphsCoord = createCoordGraph({
  Component: EjemplosTipicosGraphsCoordView,
  displayName: "EjemplosTipicosGraphsCoord",
});

EjemplosTipicosGraphsCoord.graphContract = EjemplosTipicosGraphsCoordView.graphContract;
EjemplosTipicosGraphsCoord.graph_identity = EjemplosTipicosGraphsCoordView.graph_identity;
EjemplosTipicosGraphsCoord.axes = EjemplosTipicosGraphsCoordView.axes;
EjemplosTipicosGraphsCoord.formula = EjemplosTipicosGraphsCoordView.formula;
EjemplosTipicosGraphsCoord.profile = EjemplosTipicosGraphsCoordView.profile;

export default EjemplosTipicosGraphsCoord;
