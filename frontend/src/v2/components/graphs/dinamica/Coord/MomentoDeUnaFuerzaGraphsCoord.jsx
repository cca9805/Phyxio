...
function MomentoDeUnaFuerzaGraphsCoordView(props) {
  void graphIdentity;
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Momento de una fuerza (Coord)", "Moment of a force (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            ...
            <Pill active={showMax} onClick={() => setValue("showMax", !showMax)}>{tt("Marcar maximo", "Mark maximum")}</Pill>
          ...
          <div className="v2-panel" style={{ padding: 12 }}>
            <div style={{ fontSize: 13, opacity: 0.85, lineHeight: 1.5 }}>
              {tt("tau(theta) =", "tau(theta) =")} <b>{fmt(tauNow, 3)}</b> N·m | tau_max = <b>{fmt(tauMax, 3)}</b> N·m.
              <br />
              {tt("En theta = 0 deg o 180 deg, el momento es cero.", "En theta = 0 deg o 180 deg, el momento es cero.")}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Variacion del momento con el angulo", "Moment variation with angle")}</div>
...
const MomentoDeUnaFuerzaGraphsCoord = createCoordGraph({
  Component: MomentoDeUnaFuerzaGraphsCoordView,
  displayName: "MomentoDeUnaFuerzaGraphsCoord",
});

MomentoDeUnaFuerzaGraphsCoord.graphContract = MomentoDeUnaFuerzaGraphsCoordView.graphContract;
MomentoDeUnaFuerzaGraphsCoord.graph_identity = MomentoDeUnaFuerzaGraphsCoordView.graph_identity;
MomentoDeUnaFuerzaGraphsCoord.axes = MomentoDeUnaFuerzaGraphsCoordView.axes;
MomentoDeUnaFuerzaGraphsCoord.formula = MomentoDeUnaFuerzaGraphsCoordView.formula;
MomentoDeUnaFuerzaGraphsCoord.profile = MomentoDeUnaFuerzaGraphsCoordView.profile;

export default MomentoDeUnaFuerzaGraphsCoord;
