...
function ProblemasTipoExamenGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t(lang, "Problema tipo examen (Coord)", "Exam-type problem (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", padding: "8px 12px", borderRadius: 10, border: "1px solid rgba(59,130,246,0.2)", background: "rgba(59,130,246,0.08)" }}>
            ...
            <button type="button" onClick={exp.resetToCalculator} style={{ marginLeft: "auto", padding: "8px 10px", borderRadius: 14, border: "1px solid rgba(255,255,255,0.14)", background: "rgba(0,0,0,0.35)", color: "rgba(255,255,255,0.88)", fontWeight: 900, cursor: "pointer" }}>{t(lang, "Seguir calculadora", "Follow calculator")}</button>
          </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t(lang, "Sensibilidad de la aceleracion al rozamiento", "Acceleration sensitivity to friction")}</div>
...
const ProblemasTipoExamenGraphsCoord = createCoordGraph({
  Component: ProblemasTipoExamenGraphsCoordView,
  displayName: "ProblemasTipoExamenGraphsCoord",
});

ProblemasTipoExamenGraphsCoord.graphContract = ProblemasTipoExamenGraphsCoordView.graphContract;
ProblemasTipoExamenGraphsCoord.graph_identity = ProblemasTipoExamenGraphsCoordView.graph_identity;
ProblemasTipoExamenGraphsCoord.axes = ProblemasTipoExamenGraphsCoordView.axes;
ProblemasTipoExamenGraphsCoord.formula = ProblemasTipoExamenGraphsCoordView.formula;
ProblemasTipoExamenGraphsCoord.profile = ProblemasTipoExamenGraphsCoordView.profile;

export default ProblemasTipoExamenGraphsCoord;
