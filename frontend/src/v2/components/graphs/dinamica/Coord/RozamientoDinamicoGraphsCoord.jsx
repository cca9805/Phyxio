...
const graph_identity = {
  ...
  magnitud_estrella: "fk",
  variable_control: "mu_k",
};
void graph_identity;
...
function RozamientoDinamicoGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Rozamiento dinamico (Coord)", "Kinetic friction (Coord)")}</div>
        <div className="muted" style={{ marginTop: 6 }}>
          {tt("En movimiento:", "En movimiento:")} <MathInline latex={"f_k = \\mu_k N"} />.
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            <Pill active={mode === "horizontal"} onClick={() => setMode("horizontal")}>{tt("Mesa + F", "Mesa + F")}</Pill>
...
const RozamientoDinamicoGraphsCoord = createCoordGraph({
  Component: RozamientoDinamicoGraphsCoordView,
  displayName: "RozamientoDinamicoGraphsCoord",
});

RozamientoDinamicoGraphsCoord.graphContract = RozamientoDinamicoGraphsCoordView.graphContract;
RozamientoDinamicoGraphsCoord.graph_identity = RozamientoDinamicoGraphsCoordView.graph_identity;
RozamientoDinamicoGraphsCoord.axes = RozamientoDinamicoGraphsCoordView.axes;
RozamientoDinamicoGraphsCoord.formula = RozamientoDinamicoGraphsCoordView.formula;
RozamientoDinamicoGraphsCoord.profile = RozamientoDinamicoGraphsCoordView.profile;

export default RozamientoDinamicoGraphsCoord;
