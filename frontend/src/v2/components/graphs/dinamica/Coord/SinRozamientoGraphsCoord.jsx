...
const graphIdentity = {
  pregunta_principal: {
    es: "Como cambia la aceleracion con el angulo theta en la curva a(theta) de un plano inclinado ideal sin rozamiento",
    en: "How acceleration changes with angle theta on the a(theta) curve of an ideal frictionless incline",
  },
};

function SinRozamientoGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Plano inclinado sin rozamiento (Coord)", "Frictionless inclined plane (Coord)")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Aceleracion en funcion del angulo", "Acceleration as a function of angle")}</div>
...
const SinRozamientoGraphsCoord = createCoordGraph({
  Component: SinRozamientoGraphsCoordView,
  displayName: "SinRozamientoGraphsCoord",
});

SinRozamientoGraphsCoord.graphContract = SinRozamientoGraphsCoordView.graphContract;
SinRozamientoGraphsCoord.graph_identity = SinRozamientoGraphsCoordView.graph_identity;
SinRozamientoGraphsCoord.axes = SinRozamientoGraphsCoordView.axes;
SinRozamientoGraphsCoord.formula = SinRozamientoGraphsCoordView.formula;
SinRozamientoGraphsCoord.profile = SinRozamientoGraphsCoordView.profile;

export default SinRozamientoGraphsCoord;
