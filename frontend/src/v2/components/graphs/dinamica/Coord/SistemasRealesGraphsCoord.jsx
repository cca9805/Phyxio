...
function SistemasRealesGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t(lang, "Sistemas reales (Coord)", "Real systems (Coord)")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          <div className="v2-panel" style={{ padding: 12, fontSize: 13, opacity: 0.9 }}>
            F_net = <b>{fmt(fNet, 4)}</b> N | a = <b>{fmt(a, 4)}</b> {tt("m/s2 | eta =", "m/s2 | eta =")} <b>{fmt(eff, 4)}</b> ({fmt(eff * 100, 2)}%).
          </div>
        </div>
      </div>

      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t(lang, "Impacto de perdidas", "Loss impact")}</div>
...
const SistemasRealesGraphsCoord = createCoordGraph({
  Component: SistemasRealesGraphsCoordView,
  displayName: "SistemasRealesGraphsCoord",
});

SistemasRealesGraphsCoord.graphContract = SistemasRealesGraphsCoordView.graphContract;
SistemasRealesGraphsCoord.graph_identity = SistemasRealesGraphsCoordView.graph_identity;
SistemasRealesGraphsCoord.axes = SistemasRealesGraphsCoordView.axes;
SistemasRealesGraphsCoord.formula = SistemasRealesGraphsCoordView.formula;
SistemasRealesGraphsCoord.profile = SistemasRealesGraphsCoordView.profile;

export default SistemasRealesGraphsCoord;
