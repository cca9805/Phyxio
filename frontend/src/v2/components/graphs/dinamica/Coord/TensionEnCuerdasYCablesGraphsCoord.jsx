...
function TensionEnCuerdasYCablesGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Tension en cuerdas y cables (Coord)", "Tension in ropes and cables (Coord)")}</div>
        <div className="muted" style={{ marginTop: 6 }}>
          {tt("Relaciones tipicas:", "Relaciones tipicas:")} <MathInline latex={"T=mg"} /> {tt("y en Atwood", "y en Atwood")} <MathInline latex={"T=m_1(g-a)=m_2(g+a)"} />.
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            <Pill active={mode === "mass"} onClick={() => setMode("mass")}>{tt("Masa colgante", "Hanging mass")}</Pill>
            <Pill active={mode === "atwood"} onClick={() => setMode("atwood")}>{tt("Atwood", "Atwood")}</Pill>
...
const TensionEnCuerdasYCablesGraphsCoord = createCoordGraph({
  Component: TensionEnCuerdasYCablesGraphsCoordView,
  displayName: "TensionEnCuerdasYCablesGraphsCoord",
});

TensionEnCuerdasYCablesGraphsCoord.graphContract = TensionEnCuerdasYCablesGraphsCoordView.graphContract;
TensionEnCuerdasYCablesGraphsCoord.graph_identity = TensionEnCuerdasYCablesGraphsCoordView.graph_identity;
TensionEnCuerdasYCablesGraphsCoord.axes = TensionEnCuerdasYCablesGraphsCoordView.axes;
TensionEnCuerdasYCablesGraphsCoord.formula = TensionEnCuerdasYCablesGraphsCoordView.formula;
TensionEnCuerdasYCablesGraphsCoord.profile = TensionEnCuerdasYCablesGraphsCoordView.profile;

export default TensionEnCuerdasYCablesGraphsCoord;
