...
export default function IdentificacionDeFuerzasGraphsDcl(props) {
  ...
  const sceneLabel =
    scene === "table"
      ? "Bloque en mesa"
      : scene === "incline"
      ? `Plano inclinado (${theta.toFixed(0)}°)`
      : "Masa colgante";

  return (
    <SvgFrame
      title="Identificacion de fuerzas (DCL)"
      subtitle="Aisla el cuerpo y dibuja solo fuerzas reales"
      badgeLabel="MODO"
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <div className="v2-panel m-3 mb-1">
            ...
            <div style={{ marginTop: 10, display: "grid", gap: 2 }}>
              ...
              <div className="v2-panel m-1 mt-1" style={{ background: "rgba(0, 0, 0, 1)" }}>
                <div style={{ fontSize: 12, opacity: 0.75 }}>Paso clave</div>
          ...
          <div className="v2-panel m-2 mt-0" style={{ background: "rgba(0, 0, 0, 0.40)" }}>
            ...
            <div style={{ marginTop: 8, fontSize: 13, opacity: 0.82, lineHeight: 1.45 }}>
              Escenario activo: <b style={{ color: "#93c5fd" }}>{sceneLabel}</b>
              <br />
              Selecciona solo fuerzas que realmente actuan.
            </div>
          </div>
        </div>
      }
    >
      ...
      <g>
        ...
        {scene === "hanging" && showTension ? (
          <Arrow x1={origin.x} y1={origin.y} x2={origin.x} y2={origin.y - lenT} color="#16a34a" label="T" labelOffset={14} />
        ) : null}
      </g>
