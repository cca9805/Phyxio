...
import { makeSeries, defaultParams } from "../../../engine/models/dinamica/pesoDefinicion";
...
export default function PesoGraphs({ params }) {
  ...
  return (
    <div>
      <div className="v2-card">
        <div className="v2-card-title">Parámetros (Peso: P = m·g)</div>
        ...
        <div style={{ display: "grid", gap: 10 }}>
          <div className="v2-card">
            <div className="v2-card-title">Preset de gravedad</div>
            <select
      ...
      <div className="v2-card" style={{ marginTop: 12 }}>
        <div className="v2-card-title">P(t) (constante)</div>
        <div style={{ width: "100%", minHeight: 320 }}>
          <ResponsiveContainer width="100%" height={320}>
            <LineChart data={data}>
              ...
              <XAxis dataKey="t" />
              <YAxis />
              <Tooltip formatter={(v, n) => [fmt(v, 4), n]} labelFormatter={(l) => `t=${fmt(l, 3)} s`} />
              <Legend />
      ...
      <div className="v2-card" style={{ marginTop: 12 }}>
        <div className="v2-card-title">Cómo afecta g al peso (a masa fija)</div>
        <div className="muted" style={{ marginBottom: 8 }}>
          P crece linealmente con g para la misma masa.
        </div>
