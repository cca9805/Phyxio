...
function EnergiaOrbitalGraphsCoordView({ title, params, sharedParams, lang = "es" }) {
  ...
  const schema = useMemo(
    () => [
      ...
      { key: "m", default: toNum(paramBridge?.m, 800) },
      { key: "rMin", default: toNum(paramBridge?.rMin, 6.8e6) },
      { key: "rMax", default: toNum(paramBridge?.rMax, 4.2e7) },
      { key: "showU", default: paramBridge?.showU ?? true },
      { key: "showK", default: paramBridge?.showK ?? true },
      { key: "showE", default: paramBridge?.showE ?? true },
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || tt("Energia orbital (Coord)", "Orbital energy (Coord)")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Energia mecanica en orbita circular", "Mechanical energy in circular orbit")}</div>
...
const EnergiaOrbitalGraphsCoord = createCoordGraph({
  Component: EnergiaOrbitalGraphsCoordView,
  displayName: "EnergiaOrbitalGraphsCoord",
});

EnergiaOrbitalGraphsCoord.graphContract = EnergiaOrbitalGraphsCoordView.graphContract;
EnergiaOrbitalGraphsCoord.graph_identity = EnergiaOrbitalGraphsCoordView.graph_identity;
EnergiaOrbitalGraphsCoord.axes = EnergiaOrbitalGraphsCoordView.axes;
EnergiaOrbitalGraphsCoord.formula = EnergiaOrbitalGraphsCoordView.formula;
EnergiaOrbitalGraphsCoord.profile = EnergiaOrbitalGraphsCoordView.profile;

export default EnergiaOrbitalGraphsCoord;
