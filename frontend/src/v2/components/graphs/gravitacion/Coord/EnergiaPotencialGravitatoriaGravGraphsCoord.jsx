...
export default function EnergiaPotencialGravitatoriaGravGraphsCoord({ title, params, lang = "es" }) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || tt("Energia potencial gravitatoria (Coord)", "Gravitational potential energy (Coord)")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Variacion de energia con la distancia", "Energy variation with distance")}</div>
