...
export default function LeyDeGravitacionUniversalGraphsCoord({ title, params }) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || "Ley de gravitacion universal (Coord)"}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">Dependencia inversa al cuadrado</div>
