...
import profile from "./EnergiaOrbitalGraphsSvg.profile.js";
...
function EnergiaOrbitalGraphsSvgView({ title, params }) {
...
const EnergiaOrbitalGraphsSvg = createSvgGraph({
  Component: EnergiaOrbitalGraphsSvgView,
  displayName: "EnergiaOrbitalGraphsSvg",
});

EnergiaOrbitalGraphsSvg.graphContract = EnergiaOrbitalGraphsSvgView.graphContract;
EnergiaOrbitalGraphsSvg.graph_identity = EnergiaOrbitalGraphsSvgView.graph_identity;
EnergiaOrbitalGraphsSvg.profile = EnergiaOrbitalGraphsSvgView.profile;

export default EnergiaOrbitalGraphsSvg;
