...
import profile from "./LeyesDeKeplerGraphsSvg.profile.js";
...
function LeyesDeKeplerGraphsSvgView({ title, params }) {
...
LeyesDeKeplerGraphsSvgView.profile = profile;

const LeyesDeKeplerGraphsSvg = createSvgGraph({
  Component: LeyesDeKeplerGraphsSvgView,
  displayName: "LeyesDeKeplerGraphsSvg",
});

LeyesDeKeplerGraphsSvg.graphContract = LeyesDeKeplerGraphsSvgView.graphContract;
LeyesDeKeplerGraphsSvg.graph_identity = LeyesDeKeplerGraphsSvgView.graph_identity;
LeyesDeKeplerGraphsSvg.profile = LeyesDeKeplerGraphsSvgView.profile;

export default LeyesDeKeplerGraphsSvg;
