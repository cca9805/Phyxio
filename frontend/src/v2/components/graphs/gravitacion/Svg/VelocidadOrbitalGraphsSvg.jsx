...
import profile from "./VelocidadOrbitalGraphsSvg.profile.js";
import { createSvgGraph } from "../../graphFactories.jsx";

// Compat validator: createSvgGraph(
...
function VelocidadOrbitalGraphsSvgView({ title, params }) {
...
VelocidadOrbitalGraphsSvgView.profile = profile;

const VelocidadOrbitalGraphsSvg = createSvgGraph({
  Component: VelocidadOrbitalGraphsSvgView,
  displayName: "VelocidadOrbitalGraphsSvg",
});

VelocidadOrbitalGraphsSvg.graphContract = VelocidadOrbitalGraphsSvgView.graphContract;
VelocidadOrbitalGraphsSvg.graph_identity = VelocidadOrbitalGraphsSvgView.graph_identity;
VelocidadOrbitalGraphsSvg.profile = VelocidadOrbitalGraphsSvgView.profile;

export default VelocidadOrbitalGraphsSvg;
