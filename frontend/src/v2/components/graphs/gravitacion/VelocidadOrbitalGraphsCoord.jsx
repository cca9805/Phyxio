...
export default function VelocidadOrbitalGraphsCoord({ title, params }) {
  const schema = useMemo(
    () => [
      { key: "M", default: toNum(params?.M, 5.97e24) },
      { key: "rMin", default: toNum(params?.rMin, 6.7e6) },
      { key: "rMax", default: toNum(params?.rMax, 4.2e7) },
      { key: "showVorb", default: params?.showVorb ?? true },
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || "Velocidad orbital (Coord)"}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">Comparacion de velocidades caracteristicas</div>
