...
function MecanicaAnaliticaGraphsCoordView({
  title,
  params,
  sharedParams,
  leafRelPath,
...
const MecanicaAnaliticaGraphsCoord = createCoordGraph({
  Component: MecanicaAnaliticaGraphsCoordView,
  displayName: "MecanicaAnaliticaGraphsCoord",
});

MecanicaAnaliticaGraphsCoord.graphContract = MecanicaAnaliticaGraphsCoordView.graphContract;
MecanicaAnaliticaGraphsCoord.graph_identity = MecanicaAnaliticaGraphsCoordView.graph_identity;
MecanicaAnaliticaGraphsCoord.axes = MecanicaAnaliticaGraphsCoordView.axes;
MecanicaAnaliticaGraphsCoord.formula = MecanicaAnaliticaGraphsCoordView.formula;
MecanicaAnaliticaGraphsCoord.profile = MecanicaAnaliticaGraphsCoordView.profile;

export default MecanicaAnaliticaGraphsCoord;
