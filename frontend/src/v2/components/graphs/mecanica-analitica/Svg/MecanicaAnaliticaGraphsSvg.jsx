...
function MecanicaAnaliticaGraphsSvgView({
  title,
  params,
  sharedParams,
  leafRelPath,
...
const MecanicaAnaliticaGraphsSvg = createSvgGraph({
  Component: MecanicaAnaliticaGraphsSvgView,
  displayName: "MecanicaAnaliticaGraphsSvg",
});

MecanicaAnaliticaGraphsSvg.graphContract = MecanicaAnaliticaGraphsSvgView.graphContract;
MecanicaAnaliticaGraphsSvg.graph_identity = MecanicaAnaliticaGraphsSvgView.graph_identity;

export default MecanicaAnaliticaGraphsSvg;
