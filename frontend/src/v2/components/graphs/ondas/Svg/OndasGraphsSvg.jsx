...
} from "../Coord/ondasModels";
import { getOndaLeafProfile } from "../Coord/leafProfiles";
...
OndasGraphsSvgView.graph_identity = {
  pregunta_principal: {
...
OndasGraphsSvgView.pregunta_principal = OndasGraphsSvgView.graph_identity.pregunta_principal;
OndasGraphsSvgView.magnitud_estrella = OndasGraphsSvgView.graph_identity.magnitud_estrella;

const OndasGraphsSvg = createSvgGraph({
  Component: OndasGraphsSvgView,
  displayName: "OndasGraphsSvg",
});

OndasGraphsSvg.graphContract = OndasGraphsSvgView.graphContract;
OndasGraphsSvg.graph_identity = OndasGraphsSvgView.graph_identity;

export default OndasGraphsSvg;
