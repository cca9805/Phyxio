...
function OscilacionesGraphsCoordView({ title, params, leafRelPath }) {
...
const OscilacionesGraphsCoord = createCoordGraph({
  Component: OscilacionesGraphsCoordView,
  displayName: "OscilacionesGraphsCoord",
});

OscilacionesGraphsCoord.graphContract = OscilacionesGraphsCoordView.graphContract;
OscilacionesGraphsCoord.graph_identity = OscilacionesGraphsCoordView.graph_identity;
OscilacionesGraphsCoord.axes = OscilacionesGraphsCoordView.axes;
OscilacionesGraphsCoord.formula = OscilacionesGraphsCoordView.formula;
OscilacionesGraphsCoord.profile = OscilacionesGraphsCoordView.profile;

export default OscilacionesGraphsCoord;
