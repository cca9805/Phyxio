...
function CinematicaRotacionalGraphsCoordView({ title, params }) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || tt("Cinematica rotacional (Coord)", "Rotational Kinematics (Coord)")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Evolucion temporal", "Temporal evolution")}</div>
...
const CinematicaRotacionalGraphsCoord = createCoordGraph({
  Component: CinematicaRotacionalGraphsCoordView,
  displayName: "CinematicaRotacionalGraphsCoord",
});

CinematicaRotacionalGraphsCoord.graphContract = CinematicaRotacionalGraphsCoordView.graphContract;
CinematicaRotacionalGraphsCoord.graph_identity = graph_identity;
CinematicaRotacionalGraphsCoord.axes = CinematicaRotacionalGraphsCoordView.axes;
CinematicaRotacionalGraphsCoord.formula = CinematicaRotacionalGraphsCoordView.formula;
CinematicaRotacionalGraphsCoord.profile = CinematicaRotacionalGraphsCoordView.profile;

export default CinematicaRotacionalGraphsCoord;
