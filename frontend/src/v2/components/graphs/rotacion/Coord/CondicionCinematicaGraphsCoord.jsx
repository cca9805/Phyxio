...
function CondicionCinematicaGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Condicion cinematica de rodadura (Coord)", "Rolling kinematic condition (Coord)")}</div>
        <div className="muted" style={{ marginTop: 6 }}>
          {tt("Sin deslizamiento:", "Sin deslizamiento:")} <MathInline latex={"v = \\omega R"} />.
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            <Pill active={showLine} onClick={() => setValue("showLine", !showLine)}>{tt("Recta v(omega)", "Line v(omega)")}</Pill>
            <Pill active={showPoint} onClick={() => setValue("showPoint", !showPoint)}>{tt("Punto actual", "Current point")}</Pill>
            <Pill active={showZero} onClick={() => setValue("showZero", !showZero)}>{tt("Ejes", "Axes")}</Pill>
          </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Relacion lineal entre v y omega", "Linear relation between v and omega")}</div>
...
const CondicionCinematicaGraphsCoord = createCoordGraph({
  Component: CondicionCinematicaGraphsCoordView,
  displayName: "CondicionCinematicaGraphsCoord",
});

CondicionCinematicaGraphsCoord.graphContract = CondicionCinematicaGraphsCoordView.graphContract;
CondicionCinematicaGraphsCoord.graph_identity = CondicionCinematicaGraphsCoordView.graph_identity;
CondicionCinematicaGraphsCoord.axes = CondicionCinematicaGraphsCoordView.axes;
CondicionCinematicaGraphsCoord.formula = CondicionCinematicaGraphsCoordView.formula;
CondicionCinematicaGraphsCoord.profile = CondicionCinematicaGraphsCoordView.profile;

export default CondicionCinematicaGraphsCoord;
