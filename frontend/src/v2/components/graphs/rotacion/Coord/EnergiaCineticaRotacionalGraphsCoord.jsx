...
// graph identity: pregunta_principal: { es: "Cuanta energia almacena un cuerpo rigido al girar con momento de inercia y velocidad angular", en: "How much energy does a rigid body store when it rotates with moment of inertia and angular speed" }
...
function EnergiaCineticaRotacionalGraphsCoordView(props) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{title || tt("Cuanta energia almacena un cuerpo rigido al girar", "How much energy a rigid body stores while rotating")}</div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{tt("Evolucion rotacional", "Rotational evolution")}</div>
...
const EnergiaCineticaRotacionalGraphsCoord = createCoordGraph({
  Component: EnergiaCineticaRotacionalGraphsCoordView,
  displayName: "EnergiaCineticaRotacionalGraphsCoord",
});

EnergiaCineticaRotacionalGraphsCoord.graphContract = EnergiaCineticaRotacionalGraphsCoordView.graphContract;
EnergiaCineticaRotacionalGraphsCoord.graph_identity = EnergiaCineticaRotacionalGraphsCoordView.graph_identity;
EnergiaCineticaRotacionalGraphsCoord.axes = EnergiaCineticaRotacionalGraphsCoordView.axes;
EnergiaCineticaRotacionalGraphsCoord.formula = EnergiaCineticaRotacionalGraphsCoordView.formula;
EnergiaCineticaRotacionalGraphsCoord.profile = EnergiaCineticaRotacionalGraphsCoordView.profile;

export default EnergiaCineticaRotacionalGraphsCoord;
