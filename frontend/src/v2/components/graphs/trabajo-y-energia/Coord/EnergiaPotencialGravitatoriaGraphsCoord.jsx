...
function Component({ title, params }) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t("Crecimiento lineal de Ug con la altura", "Linear growth of Ug with height")}</div>
...
const EnergiaPotencialGravitatoriaGraphsCoord = createCoordGraph({
  Component,
  displayName: "EnergiaPotencialGravitatoriaGraphsCoord",
});

EnergiaPotencialGravitatoriaGraphsCoord.graph_identity = graph_identity;

export default EnergiaPotencialGravitatoriaGraphsCoord;
