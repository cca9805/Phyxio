...
export default function RozamientoYDisipacionGraphsCoord({ title, params }) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="v2-card" style={{ padding: 12 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          ...
          >
            ...
            {t("Seguir calculadora", "Follow calculator")}
            </button>
          </div>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t("Trabajo y disipacion a lo largo del recorrido", "Work and dissipation along the path")}</div>
