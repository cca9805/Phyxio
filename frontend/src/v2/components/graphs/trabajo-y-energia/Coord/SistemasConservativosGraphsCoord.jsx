...
const graph_identity = {
  ...
  magnitud_estrella: "Em",
  formula: "Em_f = Em_i + Wnc, Wc = -dU",
...
export default function SistemasConservativosGraphsCoord({ title, params }) {
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      ...
      <div className="v2-card" style={{ padding: 12 }}>
        <div className="v2-card-title">{t("Criterio conservativo por balance energetico", "Conservative criterion from energy balance")}</div>
...
SistemasConservativosGraphsCoord.graph_identity = graph_identity;
