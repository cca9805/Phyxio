...
**Conceptual correction**
Define initial phase, final phase, and sign convention before using {{f:salto_entropia_latente}}.
...
**Conceptual correction**
Fit scale and exponent separately with {{f:exponente_parametro_orden}}.
