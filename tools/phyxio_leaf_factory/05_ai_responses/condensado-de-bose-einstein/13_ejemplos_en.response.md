...
## Symbolic solution
First estimate [[densidad_particulas]] from the ratio of [[numero_particulas]] to [[volumen]]. Then compute the ideal critical temperature:
