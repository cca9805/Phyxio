...
La definición de Boltzmann es adecuada porque el enunciado no pide dinámica detallada de cada partícula, sino la relación entre macroestado y multiplicidad microscópica. El dato central es [[ratio_microestados]], que compara cuántas veces aumenta la accesibilidad estadística. Como el sistema es el mismo antes y después, la comparación de [[numero_microestados_final]] con [[numero_microestados_inicial]] tiene sentido. Además, el aumento de un millón de veces indica un cambio de escala estadística, no un cambio lineal de [[entropia]]. El logaritmo convierte ese factor multiplicativo en una suma de entropía.
