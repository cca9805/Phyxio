...
Con esa variable se construye la [[funcion_particion]] sumando los pesos de cada [[energia_microestado]] accesible.
...
Finalmente, si se estudia cómo cambia [[energia_media]] con [[temperatura]], aparece [[capacidad_calorifica]].
