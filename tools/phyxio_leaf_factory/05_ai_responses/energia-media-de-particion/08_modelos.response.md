...
Para un cálculo discreto simple conviene que la suma de [[funcion_particion]] incluya todos los estados con peso relativo mayor que 1e-4 respecto al estado dominante. La [[temperatura]] debe ser positiva, T > 0 K, y [[beta]] > 0. Si una separación energética ΔE cumple ΔE/(k_B T) > 20, su contribución suele ser despreciable; si ΔE/(k_B T) < 0.1, varios niveles participan casi por igual. La [[energia_media]] debe quedar dentro del intervalo energético accesible ponderado por los estados incluidos. La [[capacidad_calorifica]] calculada por diferencias requiere pasos de [[temperatura]] pequeños frente a la escala donde cambia la pendiente, por ejemplo ΔT/T < 0.05.
