...
**Corrección conceptual**
Comprueba equilibrio antes de aplicar {{f:funcion_particion_canonica}}.
...
**Corrección conceptual**
Revisa {{f:energia_media_desde_derivada_beta}} y conserva el signo.
...
**Corrección conceptual**
Usa {{f:energia_media_desde_derivada_temperatura}} solo con todos los factores térmicos.
...
**Corrección conceptual**
Compara siempre E_i con k_B T mediante [[beta]].

**Mini-ejemplo de contraste**
A 300 K, energías del orden de 1e-21 J son térmicas; 1 J por molécula no lo es.

## Regla de autocontrol rápido
Antes de aceptar [[energia_media]], comprueba: unidad de energía, signo correcto, [[beta]] positiva, microestados suficientes y escala comparable con k_B T.
