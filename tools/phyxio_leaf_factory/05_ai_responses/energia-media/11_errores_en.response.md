...
**Mini-example of contrast**
A light gas at a few kelvin may require quantum statistics instead of only {{f:energia_media_particula}}.
...
**Detection signal**
{{f:energia_total_temperatura}} is used for hot molecules without checking internal modes.
**Conceptual correction**
...
**Mini-example of contrast**
{{f:energia_media_particula}} must end in joules, not degrees or particles.
