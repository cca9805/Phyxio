...
La dimensión de [[k_boltzmann]] es energía dividida por temperatura, J/K. Al multiplicar por [[temperatura]] en K, la unidad final de [[energia_media]] es J. En {{f:energia_total_gas_ideal}}, [[numero_particulas]] es un conteo sin dimensión, por lo que multiplicar por [[energia_media]] mantiene la unidad J. La validación confirma que tanto [[energia_media]] como [[energia_total]] son energías, aunque describen escalas distintas.
