...
The unit of [[k_boltzmann]] is energy divided by temperature, J/K. Multiplying it by [[temperatura]] in K gives joules, so [[energia_media]] has the correct energy unit. In {{f:energia_total_gas_ideal}}, [[numero_particulas]] is a dimensionless count, so multiplying by [[energia_media]] keeps the final unit as joules. The dimensional check confirms that both [[energia_media]] and [[energia_total]] are energies, but they refer to different physical scales.
