...
Se cambia de modelo cuando los estados no son libres ni uniformes. En sólidos se usa una descripción de bandas y densidad de estados; en sistemas muy densos se incorporan correcciones relativistas; en materiales correlacionados se introducen interacciones. Si el sistema está fuera de equilibrio, se sustituyen las ocupaciones de equilibrio por distribuciones dependientes del proceso. La fórmula {{f:fermi_dirac_ocupacion}} sigue siendo una referencia, pero no siempre la historia completa.
