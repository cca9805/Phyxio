...
Antes de pensar en mínima [[energia]], cuenta los estados disponibles y aplica {{f:exclusion_pauli_ocupacion_maxima}}.
...
**Por qué es incorrecto**
{{f:fermi_dirac_ocupacion}} exige equilibrio con [[temperatura_absoluta]] y [[potencial_quimico]] bien definidos.
**Señal de detección**
...
**Por qué parece correcto**
{{f:energia_fermi_gas_3d}} da una escala sencilla con [[densidad_numerica]].
**Por qué es incorrecto**
...
**Corrección conceptual**
Comprueba el orden de la diferencia antes de usar {{f:parametro_reducido_fermi}}.
**Mini-ejemplo de contraste**
