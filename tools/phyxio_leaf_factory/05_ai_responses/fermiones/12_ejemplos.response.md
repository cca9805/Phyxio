...
La estructura simbólica muestra el límite esencial: aunque haya dos subestados disponibles, cada uno mantiene una ocupación media acotada.

## Sustitución numérica

La escala térmica vale aproximadamente [[constante_boltzmann]][[temperatura_absoluta]] = 8,617·10^-5 eV/K · 300 K = 0,02585 eV. Por tanto, [[energia_reducida]] ≈ 0,060 eV / 0,02585 eV ≈ 2,32. La ocupación de Fermi-Dirac da [[ocupacion_estado]] ≈ 1/(exp(2,32)+1) ≈ 0,089. Para [[degeneracion_estado]] = 2, el [[numero_ocupacion]] medio del nivel agrupado es aproximadamente 2 · 0,089 ≈ 0,18. El valor es pequeño, pero no nulo, porque la [[temperatura_absoluta]] finita suaviza la frontera.
...
Con [[densidad_numerica]] del orden de 10^28 m^-3, la fórmula {{f:energia_fermi_gas_3d}} da una [[energia_fermi]] típica de unos pocos eV. Al convertir esa escala con {{f:temperatura_fermi}}, se obtiene una [[temperatura_fermi]] del orden de 10^4 K. Comparada con una [[temperatura_absoluta]] de 300 K, la escala térmica ordinaria es mucho menor. Por tanto, la mayoría de estados profundamente por debajo del [[potencial_quimico]] siguen ocupados, y los estados muy por encima siguen casi vacíos. Solo una región energética de anchura aproximada [[constante_boltzmann]][[temperatura_absoluta]] participa de forma sensible.
