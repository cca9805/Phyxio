...
**Detection signal**
Impossible occupations appear, or {{f:ocupacion_fermi_dirac_electrones}} is ignored.
...
**Why it is incorrect**
{{f:energia_fermi_gas_electrones_3d}} assumes [[volumen]] and 3D state counting.

**Detection signal**
A volume [[densidad_electronica]] is used for a 2D layer.
...
**Conceptual correction**
Use {{f:velocidad_fermi}} and check kg, J, and m/s.
