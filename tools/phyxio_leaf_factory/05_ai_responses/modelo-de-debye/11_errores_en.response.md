...
### Error 1: Treating [[temperatura_debye]] as a phase-transition temperature

**Why it seems correct**
It contains the word temperature and often appears as a boundary on graphs.
...
**Mini-example of contrast**
At 10 K, a solid with [[temperatura_debye]] of 300 K is far from its high-temperature [[calor_especifico_molar]].
...
**Why it is incorrect**
In metals, electrons near the Fermi level can add a low-temperature contribution.
...
### Error 5: Reversing the reduced temperature ratio
...
**Detection signal**
A low-temperature case is classified as high-temperature behavior.
...
**Detection signal**
A student predicts high room-temperature [[calor_especifico_molar]] for diamond only because its [[temperatura_debye]] is high.
