...
El modelo falla si el [[parametro_de_orden]] no distingue las fases observadas, si hay histéresis intensa, si el valor depende mucho de la historia térmica o si el supuesto cero no representa realmente simetría restaurada. También falla cuando la [[susceptibilidad]] cambia con el tamaño de la perturbación, porque eso indica respuesta no lineal. Cerca de la [[temperatura_critica]], fluctuaciones fuertes pueden exigir un modelo más rico.
