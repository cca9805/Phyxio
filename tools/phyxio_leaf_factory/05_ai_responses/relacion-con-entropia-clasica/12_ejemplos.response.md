...
## Interpretación
La aplicación muestra que medir calor no basta: hay que saber a qué [[temperatura]] se intercambia y si el camino puede tratarse como reversible. La lectura estadística añade profundidad: una pequeña [[delta_entropia]] macroscópica puede significar un cambio inmenso en multiplicidad. El puente conceptual está en que la [[entropia]] no cuenta energía total, sino formas compatibles de distribuirla bajo restricciones macroscópicas.
