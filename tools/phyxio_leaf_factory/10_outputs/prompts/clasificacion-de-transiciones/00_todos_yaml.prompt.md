...
Create a downloadable ZIP file named `clasificacion-de-transiciones_yaml.zip` containing exactly: meta.yaml, formulas.yaml, magnitudes.yaml, graficos.yaml.
...
- representacion_dominante must be "Svg".
...
id: clasificacion-de-transiciones
name: Clasificacion de transiciones
status: draft
nombre:
