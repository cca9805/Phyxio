...
Create a downloadable YAML file named `fenomenos-criticos_interpretacion.yaml`.
...
dependencies:
  formulas: temperatura_reducida_critica, parametro_orden_ley_critica, susceptibilidad_critica, longitud_correlacion_critica,
    calor_especifico_critico
  magnitudes: temperatura, temperatura_critica, temperatura_reducida, parametro_de_orden, amplitud_critica, exponente_critico_beta,
    susceptibilidad, amplitud_susceptibilidad, exponente_critico_gamma, longitud_correlacion, amplitud_correlacion, exponente_critico_nu,
    calor_especifico, amplitud_calor_especifico, exponente_critico_alpha
...
graph_reading_policy:
  enabled: true
  primary_variable: temperatura_reducida
  reading_sequence:
...
targets:
  ...
  amplitud_critica:
    ...
    summary_rules:
    - id: amplitud_critica_summary_base
      when: 'true'
      status: ok
      text:
        es: El resultado [[amplitud_critica]] indica la magnitud física principal que se está interpretando.
        en: The result [[amplitud_critica]] indicates the main physical quantity being interpreted.
    physical_reading_rules:
    - id: amplitud_critica_physical_reading_base
      when: 'true'
      status: info
      text:
        es: Lee [[amplitud_critica]] junto con su unidad, su signo y el contexto físico del leaf.
        en: Read [[amplitud_critica]] together with its unit, sign, and the physical context of the leaf.
    coherence_rules:
    - id: amplitud_critica_coherence_base
      when: 'true'
      status: ok
      text:
        es: Comprueba que [[amplitud_critica]] sea coherente con las magnitudes de entrada y con la dimensión esperada.
        en: Check that [[amplitud_critica]] is consistent with the input quantities and the expected dimension.
    model_validity_rules:
    - id: amplitud_critica_model_validity_base
      when: 'true'
      status: info
      text:
        es: Interpreta [[amplitud_critica]] solo dentro de las hipótesis físicas del modelo usado en este leaf.
        en: Interpret [[amplitud_critica]] only within the physical assumptions of the model used in this leaf.
    graph_rules:
    - id: amplitud_critica_graph_base
      when: 'true'
      status: info
      text:
        es: Relaciona [[amplitud_critica]] con la lectura gráfica disponible en el leaf.
        en: Relate [[amplitud_critica]] to the graph reading available in the leaf.
    likely_errors:
    - id: amplitud_critica_likely_error_base
      when: 'true'
      status: warning
      text:
        es: No interpretes [[amplitud_critica]] como un número aislado. Su sentido depende del modelo, la unidad y el signo.
        en: Do not interpret [[amplitud_critica]] as an isolated number. Its meaning depends on the model, unit, and sign.
    next_step_rules:
    - id: amplitud_critica_next_step_base
      when: 'true'
      status: info
      text:
        es: Después de obtener [[amplitud_critica]], revisa la coherencia física y vuelve a la calculadora si necesitas otro
          despeje.
        en: After obtaining [[amplitud_critica]], check the physical consistency and return to the calculator if another rearrangement
          is needed.
    physical_intuition:
    - id: amplitud_critica_physical_intuition_base
      when: 'true'
      status: info
      text:
        es: Intuitivamente, [[amplitud_critica]] resume cómo responde el sistema cuando cambian las magnitudes relevantes.
        en: Intuitively, [[amplitud_critica]] summarizes how the system responds when the relevant quantities change.
    limiting_cases:
    - id: amplitud_critica_limiting_case_base
      when: 'true'
      status: info
      text:
        es: Analiza los casos límite de [[amplitud_critica]] comprobando qué ocurre si una magnitud dominante crece, disminuye
          o se anula.
        en: Analyze the limiting cases of [[amplitud_critica]] by checking what happens if a dominant quantity grows, decreases,
          or becomes zero.
    sign_convention_reminder:
      enabled: false
      text:
  ...
  exponente_critico_beta:
    ...
    summary_rules:
    - id: exponente_critico_beta_summary_base
      when: 'true'
      status: ok
      text:
        es: El resultado [[exponente_critico_beta]] indica la magnitud física principal que se está interpretando.
        en: The result [[exponente_critico_beta]] indicates the main physical quantity being interpreted.
    physical_reading_rules:
    - id: exponente_critico_beta_physical_reading_base
      when: 'true'
      status: info
      text:
        es: Lee [[exponente_critico_beta]] junto con su unidad, su signo y el contexto físico del leaf.
        en: Read [[exponente_critico_beta]] together with its unit, sign, and the physical context of the leaf.
    coherence_rules:
    - id: exponente_critico_beta_coherence_base
      when: 'true'
      status: ok
      text:
        es: Comprueba que [[exponente_critico_beta]] sea coherente con las magnitudes de entrada y con la dimensión esperada.
        en: Check that [[exponente_critico_beta]] is consistent with the input quantities and the expected dimension.
    model_validity_rules:
    - id: exponente_critico_beta_model_validity_base
      when: 'true'
      status: info
      text:
        es: Interpreta [[exponente_critico_beta]] solo dentro de las hipótesis físicas del modelo usado en este leaf.
        en: Interpret [[exponente_critico_beta]] only within the physical assumptions of the model used in this leaf.
    graph_rules:
    - id: exponente_critico_beta_graph_base
      when: 'true'
      status: info
      text:
        es: Relaciona [[exponente_critico_beta]] con la lectura gráfica disponible en el leaf.
        en: Relate [[exponente_critico_beta]] to the graph reading available in the leaf.
    likely_errors:
    - id: exponente_critico_beta_likely_error_base
      when: 'true'
      status: warning
      text:
        es: No interpretes [[exponente_critico_beta]] como un número aislado. Su sentido depende del modelo, la unidad y el
          signo.
        en: Do not interpret [[exponente_critico_beta]] as an isolated number. Its meaning depends on the model, unit, and
          sign.
    next_step_rules:
    - id: exponente_critico_beta_next_step_base
      when: 'true'
      status: info
      text:
        es: Después de obtener [[exponente_critico_beta]], revisa la coherencia física y vuelve a la calculadora si necesitas
          otro despeje.
        en: After obtaining [[exponente_critico_beta]], check the physical consistency and return to the calculator if another
          rearrangement is needed.
    physical_intuition:
    - id: exponente_critico_beta_physical_intuition_base
      when: 'true'
      status: info
      text:
        es: Intuitivamente, [[exponente_critico_beta]] resume cómo responde el sistema cuando cambian las magnitudes relevantes.
        en: Intuitively, [[exponente_critico_beta]] summarizes how the system responds when the relevant quantities change.
    limiting_cases:
    - id: exponente_critico_beta_limiting_case_base
      when: 'true'
      status: info
      text:
        es: Analiza los casos límite de [[exponente_critico_beta]] comprobando qué ocurre si una magnitud dominante crece,
          disminuye o se anula.
        en: Analyze the limiting cases of [[exponente_critico_beta]] by checking what happens if a dominant quantity grows,
          decreases, or becomes zero.
    sign_convention_reminder:
      enabled: false
      text:
    ...
    - id: susceptibilidad_limiting_case_base
      ...
      text:
        es: Analiza los casos límite de [[susceptibilidad]] comprobando qué ocurre si una magnitud dominante crece, disminuye
          o se anula.
        en: Analyze the limiting cases of [[suscept
