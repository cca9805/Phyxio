...
You must create a downloadable ZIP file named `gas-ideal-microscopico_md.zip`.
...
Generate `teoria.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: español.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.

Physics target:
- Leaf title: Gas ideal microscopico
- Central physical question: ¿Cómo relaciona el gas ideal microscópico la temperatura con la energía cinética media de sus partículas?
- Short description: Modelo microscópico que conecta partículas, temperatura, presión y energía cinética.

Available magnitudes. Use exactly these ids when tagging quantities:
- [[temperatura]] | T | temperatura absoluta | Parámetro macroscópico que mide la agitación térmica microscópica del gas.
- [[energia_cinetica_media]] | K_media | energía cinética media | Energía cinética traslacional promedio por partícula en el gas ideal.
- [[constante_boltzmann]] | k_B | constante de Boltzmann | Constante que convierte temperatura en escala energética por partícula.
- [[presion]] | p | presión | Fuerza normal media por unidad de área debida a choques de partículas.
- [[volumen]] | V | volumen | Espacio disponible para el movimiento de las partículas del gas.
- [[numero_particulas]] | N | número de partículas | Cantidad de partículas microscópicas representadas por el gas ideal.
- [[masa_particula]] | m | masa de partícula | Masa de una partícula individual del gas.
- [[velocidad_rms]] | v_rms | velocidad cuadrática media | Rapidez típica asociada a la energía cinética media de las partículas.

Available formulas. Use exactly these references when a formula is needed:
- {{f:energia_cinetica_media_temperatura}} | Energía cinética media traslacional | La temperatura absoluta mide la energía cinética media traslacional por partícula en un gas ideal monoatómico.
- {{f:presion_microscopica_gas_ideal}} | Presión microscópica del gas ideal | La presión macroscópica surge del impulso transferido por muchas partículas al chocar con las paredes.
- {{f:ecuacion_estado_gas_ideal_particulas}} | Ecuación de estado microscópica | Conecta presión, volumen, número de partículas y temperatura desde la interpretación microscópica del gas ideal.
- {{f:velocidad_cuadratica_media}} | Velocidad cuadrática media | La rapidez microscópica típica aumenta con la temperatura y disminuye con la masa de la partícula.
...
Generate `teoria.en.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: English.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.

Physics target:
- Leaf title: Microscopic Ideal Gas
- Central physical question: How does the microscopic ideal gas relate temperature to the mean kinetic energy of its particles?
- Short description: Microscopic model linking particles, temperature, pressure, and kinetic energy.

Available magnitudes. Use exactly these ids when tagging quantities:
- [[temperatura]] | T | absolute temperature | Macroscopic parameter measuring the gas microscopic thermal agitation.
- [[energia_cinetica_media]] | K_media | mean kinetic energy | Average translational kinetic energy per particle in the ideal gas.
- [[constante_boltzmann]] | k_B | Boltzmann constant | Constant converting temperature into energy scale per particle.
- [[presion]] | p | pressure | Mean normal force per unit area due to particle collisions.
- [[volumen]] | V | volume | Space available for gas particle motion.
- [[numero_particulas]] | N | number of particles | Number of microscopic particles represented by the ideal gas.
- [[masa_particula]] | m | particle mass | Mass of an individual gas particle.
- [[velocidad_rms]] | v_rms | root-mean-square speed | Typical speed associated with the mean kinetic energy of particles.

Available formulas. Use exactly these references when a formula is needed:
- {{f:energia_cinetica_media_temperatura}} | Mean translational kinetic energy | Absolute temperature measures the mean translational kinetic energy per particle in a monatomic ideal gas.
- {{f:presion_microscopica_gas_ideal}} | Microscopic pressure of an ideal gas | Macroscopic pressure arises from momentum transfer by many particles colliding with the walls.
- {{f:ecuacion_estado_gas_ideal_particulas}} | Microscopic ideal-gas equation of state | Connects pressure, volume, particle number, and temperature from the microscopic interpretation of an ideal gas.
- {{f:velocidad_cuadratica_media}} | Root-mean-square speed | Typical microscopic speed increases with temperature and decreases with particle mass.
...
Generate `modelos.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: español.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `modelos.en.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: English.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `errores.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: español.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `errores.en.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: English.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `ejemplos.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: español.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `ejemplos.en.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: English.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `aplicaciones.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: español.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `aplicaciones.en.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: English.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `historia.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: español.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Generate `historia.en.md` for the Phyxio leaf `gas-ideal-microscopico`.
Language: English.
Return only the Markdown file content. Do not wrap it in code fences. Do not add explanations.
...
Return only the downloadable file `gas-ideal-microscopico_md.zip`.
