...
Create a downloadable ZIP file named `oscilador-armonico-estadistico_yaml.zip` containing exactly: meta.yaml, formulas.yaml, magnitudes.yaml, graficos.yaml.
...
id: oscilador-armonico-estadistico
name: Oscilador armonico estadistico
status: draft
nombre:
