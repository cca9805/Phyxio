...
Create a downloadable ZIP file named `radiacion-termica_yaml.zip` containing exactly: meta.yaml, formulas.yaml, magnitudes.yaml, graficos.yaml.
...
id: radiacion-termica
nombre: {'es': 'Radiacion termica', 'en': 'Thermal Radiation'}
area: fisica-clasica
bloque: termodinamica
subbloque: transferencia-de-calor
parent_id: transferencia-de-calor
ruta_relativa: fisica-clasica/termodinamica/transferencia-de-calor/radiacion-termica
orden: 257300
...
- version must be "1.0".
- leaf must be "radiacion-termica".
...
- id and graphId: "radiacion-termica-Coord"; type and graphType: "Coord".
...
Dcl required fields:
- id and graphId: "radiacion-termica-Dcl"; type and graphType: "Dcl".
...
Svg required fields:
- id and graphId: "radiacion-termica-Svg"; type and graphType: "Svg".
...
id: radiacion-termica
name: Radiacion termica
status: draft
nombre:
  es: Radiacion termica
