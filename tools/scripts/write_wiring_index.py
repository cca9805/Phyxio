"""
write_wiring_index.py

Genera el index.js wiring-only para cantidad-de-movimiento.
Elimina todo el contenido semántico que ya vive en graficos.yaml.
"""
...
out_path = repo_root / "frontend/src/v2/components/graphs/cantidad-de-movimiento/index.js"
